...
Si lo prefiere, usted puede comprobar la información relativa a la reserva de su pedido a través de [API](https://developers.vtex.com/reference/reservations#createreservation).
