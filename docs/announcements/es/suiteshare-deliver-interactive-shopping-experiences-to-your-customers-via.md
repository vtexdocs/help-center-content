...
<div style="background-color:#FFF3CD; border-left: 2px solid #F0AD4E; border-top-left-radius: 2px; border-bottom-left-radius: 2px; padding-left: 10px">
  Debe tener una cuenta activa de Suiteshare para usar la aplicación ya que el identificador de la integración se utilizará en el momento de la implementación.  Para crear una cuenta, acceda a la <a href="https://suiteshare.com/auth/signup">página de registro de Suiteshare</a>.
</div>
