...
Para implementar **Sugerencias de productos similares**, sigue los pasos del artículo [Configurar producto similar, sugerencias, accesorios y genéricos](https://help.vtex.com/es/tutorial/configurando-produto-similar-sugestoes-acessorios-e-genericos--tutorials_280).

Para configurar **Venta de inventario local** en tu tienda, consulta el artículo [Habilitar Venta de inventario local en VTEX Sales App](https://help.vtex.com/es/tutorial/habilitar-venta-en-mano-en-vtex-sales-app--54eQN4rOH5yBYPGG2w8v9q).
...
* [Sales App - Usando la aplicación](https://help.vtex.com/es/tracks/instore-usando-o-app--4BYzQIwyOHvnmnCYQgLzdr)
