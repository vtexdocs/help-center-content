...
- **Activar la integración de los puntos de recogida*:** cuando está activado, habilita el recurso de recoger los productos en los [puntos de recogida](https://help.vtex.com/es/tracks/configurar-integracao-do-mercado-livre--2YfvI3Jxe0CGIKoWIGQEIq/52C1lm8gMovN8v68s6v89d) registrados en VTEX para la tienda principal.
- **Activar la integración de los puntos de recogida para las cuentas franquicia*:** cuando está activado, habilita el recurso de recoger los productos en los puntos de recogida registrados en VTEX para las cuentas franquicia.
- **Activar stock para entrega y cotización de flete para cuentas franquicia*:** cuando está activado, habilita el recurso de utilizar el [stock de las cuentas franquicia](https://help.vtex.com/es/tracks/configurar-integracao-do-mercado-livre--2YfvI3Jxe0CGIKoWIGQEIq/52C1lm8gMovN8v68s6v89d).
- **Estrategia de envío de stock (solo es válida si la configuración de stock y cotización para cuentas franquicia está activa):** si tiene una cuenta franquicia, seleccione una de las siguientes opciones:
   * **Total de los stocks:** utiliza la suma de los stocks de las cuentas franquicia más el stock de la tienda principal.
   * **Stock máximo:** utiliza solo el mayor stock disponible de la cuenta franquicia.
- **Estrategia de envío para cotización de flete (solo es válida si la configuración de stock y cotización para cuentas franquicia está activa):** si tiene una cuenta franquicia, seleccione una de las siguientes opciones:
   * **Más barato:** al optar por un flete más barato, el plazo de entrega es más largo.
   * **Más rápido:** al optar por un flete más rápido, el precio es más alto.
- **ID de la tienda oficial en Mercado Libre:** identificador numérico de tres o cuatro dígitos que proporciona Mercado Libre en su contrato comercial cuando un usuario alcanza el status de [Tienda Oficial](https://www.mercadolibre.com.ar/tiendas-oficiales). Debe rellenarse si su tienda tiene este status para que la integración funcione correctamente.
