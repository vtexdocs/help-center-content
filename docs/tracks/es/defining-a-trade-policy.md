...
slug: definir-la-politica-comercial
trackId: 7h8KvIC4DbRRc8VlyJ8PFc
trackSlugES: integracion-de-facebook
---

Después de crear su cuenta en el administrador comercial, el próximo paso para la integración con Facebook es definir la [política comercial](https://help.vtex.com/es/tutorial/como-funciona-uma-politica-comercial--6Xef8PZiFm40kg2STrMkMV) que utilizará. [Configurar una política comercial para marketplace](https://help.vtex.com/es/tutorial/configurando-a-politica-comercial-para-marketplace/) determina cuáles productos se enviarán a Facebook y cuál será el precio que tendrán en la plataforma.
...
* Ofrecer una selección diferente de productos en Facebook.
* Enviar precios diferentes a Facebook.
