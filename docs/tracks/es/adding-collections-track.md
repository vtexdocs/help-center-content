...
<div class = "alert alert-warning">
  <p>Antes de crear una colección, es necesario haber configurado la autorización. Para eso, debe tener un perfil de acceso con el recurso <b>Write Collections</b>, en la sección <b>Collection</b> de los perfiles de Catalog. Vea <a href="https://help.vtex.com/es/tutorial/perfiles-de-acceso--7HKK5Uau2H6wxE1rH5oRbc">aquí</a> cómo configurar un recurso.</p>
</div>
