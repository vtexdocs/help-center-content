...
slug: configurando-a-integracao-rappi
locale: pt
...
- Deﬁnir uma [estratégia de envio](https://help.vtex.com/pt/tutorial/estrategia-de-envio--58vLBDbjYVQzJ6rRc5QNz3) diferente.    
...
A contratação de política comercial adicional para integrar com [conector nativo, conector certificado(parceiro)](https://help.vtex.com/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrado-a-conector-nativo-vtex) ou outras lojas VTEX é isenta de taxas.  
