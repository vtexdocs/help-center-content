...
Atualmente, apenas pedidos feitos com <strong>cartão de crédito</strong> permitem assinaturas. Ative todas as condições de cartão de crédito já definidas para <a href="https://help.vtex.com/pt/tutorial/configurar-recorrencia-em-condicoes-de-pagamento--6EGuoAytLqU2CqUuaI2GUW">compras recorrentes</a> nas suas formas de pagamento. Além disso, é necessário que o seu conector de pagamentos aceite pagamento recorrente. Entre em contato com o adquirente da sua loja e certifique-se que ele aceita transações de compras recorrentes oriundas de cartões tokenizados (sem CVV).
</div>
