...
Para mais informações, basta consultar os artigos [O que a VTEX considera como receita no cálculo da fatura?](https://help.vtex.com/pt/tutorial/o-que-a-vtex-considera-como-receita-para-apuracao--58j4cfoXfisWyemASACwSq) e [Compreendendo o valor da receita](https://help.vtex.com/pt/tutorial/compreenda-o-valor-da-receita-aprovada--tutorials_4322).

## Alteração dos dados cadastrais da loja

Após o [primeiro acesso](https://help.vtex.com/pt/tracks/trilha-da-loja-vtex--eSDNk26pdvemF3XKM0nK9/4EPwTXx5oFdSG1dA3zIchz), é possível alterar os dados cadastrais da loja como:
