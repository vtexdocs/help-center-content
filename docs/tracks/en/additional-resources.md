...
| Locale  | The binding locale to which you wish to apply content changes. For example, English (en-GB), Portuguese (pt-BR), and Spanish (es-AR). Related article: [Managing content per binding](https://help.vtex.com/en/tutorial/gerenciando-conteudo-por-binding--5CZjZPMqi0ZNpuqzF6AUOn?&utm_source=autocomplete) |
...
| Content version  | A block's version is a copy of its content at a specific point in time. For example, a Carousel may have predefined versions for future marketing campaigns, such as Black Friday and Valentine's Day, with banners of specific content. Related article:[Managing content versions](https://help.vtex.com/en/tutorial/gerenciando-versoes-de-conteudo--4loXo98CZncY0NnjKrScbG).|
