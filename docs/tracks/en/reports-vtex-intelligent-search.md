...
<div class = "alert alert-info">
  <p>The <b>Analytics</b> page is native to VTEX Intelligent Search. You cannot disable it in the Admin.</p>
</div>
...
<div class="alert alert-info">
  <p>The data displayed in the report is limited to the top 10,000 search terms. If you want the complete search data for your store, you must <a href="https://help.vtex.com/en/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb/3JcuptYAkwr1GLZEM3IQ2m#exporting-reports">export the report</a>.</p>
</div>
...
<div class = "alert alert-info">
  <p>The file will be available for download for 48 hours.</p>
</div>
