...
tag: Connections
slug: ordens-que-estao-em-aguardando-autorizacao-para-despacho-na-vtex-mas-que-ainda-estao-gastandodepagamento-na-dafiti
locale: pt
kiStatus: Fixed
...
_**Root Couse:**_ Encomendas
Motivo:**_ Atualização do status do pedido
...
Revisão do fluxo para status solicitado após nova implementação de status realizada no Dafiti
