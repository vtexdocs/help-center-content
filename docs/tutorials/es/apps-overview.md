...
<div class="alert alert-info">
  Si es una persona desarrolladora, consulte el <a href = "https://developers.vtex.com">Developer Portal</a> para obtener más información sobre cómo desarrollar sus propias apps en VTEX.
  </div> 
