...
En VTEX es posible la integración con el proveedor de pagos Scalapay. Con este conector, tu tienda puede realizar ventas a través de tarjeta de crédito y Scalapay.

Para configurar la afiliación Scalapay, siga los pasos a continuación:
...
<ui>3. Haga clic en el conector __Scalapay__.</ui>
