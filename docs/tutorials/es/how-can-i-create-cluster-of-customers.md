...
1. El primer paso es crear un campo en MasterData con el nombre del clúster que desee. Ej .: Distribuidores. De esta forma, se destacarán los clientes que son distribuidores, y se les puede ofrecer una promoción exclusiva, por ejemplo. [Acceda a nuestro manual sobre cómo crear un campo](/es/faq/como-crear-un-campo-en-master-data/).
2. A continuación, cree este campo en el formulario para que se puedan ver los datos. [Para esto, vea nuestro manual](/es/faq/como-crear-un-campo-en-master-data/).
