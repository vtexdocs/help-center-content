...
En VTEX es posible la integración con el proveedor de pagos Bamboo. Con este conector, su tienda puede realizar ventas a través de tarjetas de credito, debito, private y cobranded labels, y boletos.

Para configurar tu afiliación Bamboo, acceda a [Registrar afiliaciones de gateway](https://help.vtex.com/es/tutorial/afiliacoes-de-gateway--tutorials_444#).
