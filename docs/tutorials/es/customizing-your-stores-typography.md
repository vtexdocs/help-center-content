...
5. En el campo **Familia de fuentes**, crea un nombre para la fuente.
    ...
    ![familia-de-fontes-giff-es](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/personalizar-la-tipografia-de-tu-tienda-0.gif)
...
3. Haz clic en **Editar > Tipografía > Tokens de tipo**.
    ...
    ![tokens-tipo-giff-es](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/personalizar-la-tipografia-de-tu-tienda-1.gif)
