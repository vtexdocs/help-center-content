...
Para configurar los métodos de pago predeterminados a procesar por MercadoPagoV2, acceda a [Configurar condiciones de Pago](https://help.vtex.com/es/tutorial/condiciones-de-pago--tutorials_455).
