...
En VTEX es posible la integración con el proveedor de pagos Ebanx. Con este conector, su tienda puede realizar ventas a través de boletos bancarios, tarjetas de crédito y PIX.

Para configurar la afiliación Ebanx, siga los pasos a continuación:
