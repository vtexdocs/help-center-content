---
title: 'Configurar pago con Unlimit'
...
slug: configurar-pago-con-unlimit
locale: es
legacySlug: configurar-pago-con-unlimit
subcategory: 3tDGibM2tqMyqIyukqmmMw
---

En VTEX es posible la integración con el proveedor de pagos Unlimit. A través de este proveedor, tu tienda puede realizar ventas utilizando diferentes métodos de pago, como: tarjetas (crédito, débito, tienda cobranded, tienda red propia), boletos y PIX.

Para configurar Unlimit siga los pasos a continuación:

1. En el Admin VTEX, accede a __Configuración de la tienda > Pago > Proveedores__, o escribe __Proveedores__ en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre __Unlimit__ en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En __Autorización del proveedor__, rellene los campos de registro __Clave de aplicación__ y __Token de aplicación__ con los datos proporcionados por su cuenta Unlimit.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Unlimit en la pantalla VTEX Admin, ingrese la información en el campo __Nombre__ en __Información general__.
...
Para configurar los métodos de pago a procesar por Unlimit, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/tutorial/condiciones-de-pago--tutorials_455#).

Para establecer condiciones especiales en los métodos de pago, acceda al [Configurar condiciones especiales de Pago](https://help.vtex.com/es/tutorial/condiciones-especiales--tutorials_456#).

Después de seguir los pasos indicados, Unlimit puede tardar hasta 10 minutos en aparecer en el checkout de tu tienda como una opción de pago.
