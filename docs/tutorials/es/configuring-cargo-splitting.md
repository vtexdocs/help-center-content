...
El reparto de carga es la configuración que permite que se divida una compra en varias entregas cuando el cálculo total de peso sobrepasa el límite del transportista.
