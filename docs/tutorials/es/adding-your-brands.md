...
Se requiere el [registro de marca](/es/tutorial/registrando-marcas) para la activación de sus productos y SKUs. Si la tienda no funciona con marcas, se puede registrar una marca predeterminada y asociar todos los productos a ella.

_El video presentado en este artículo aún no se ha traducido al español. Estamos trabajando para ofrecer más contenido en español. Gracias por la comprensión._
