...
3. Crear un producto de “HTML Personalizado” como se en la siguiente imagen:![payU 1](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-0.png)
...
<script>
   ...
   vtexjs.checkout.getOrderForm().done(function(orderForm){ // hala el valor de userProfileId
       ...
       document.getElementById('gtm').innerHTML = '<p style="background:url(https://maf.pagosonline.net/ws/fp?id='+deviceSessionId+'80200)"></p>'+'<img src="https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-9.png">';
...
![payU 2](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-1.png)

Después hay que realizar la configuración avanzada tal cual está en la siguiente imagen:![payU 3](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-2.png)

Para configurar el evento, siga los pasos abajo:

1. Entrar en la pestaña More:![payU 4](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-3.png)
2. Crear un evento personalizado:![payU 5](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-4.png)
3. Llenarlo de la siguiente manera:![payU 6](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-5.png)
4. Guardamos el evento y posteriormente le damos guardar a la etiqueta (tag):![payU 7](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-6.png)
5. Una vez que ya se guardó la etiqueta es necesario publicarla:![payU 8](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-7.png)
...
![payU 9](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/es/configurar-fingerprint-para-payu-8.png)
