...
En una estructura de pago, se utilizan varios términos para definir acciones, procesos u órganos.

A continuación, encontrará un glosario con los principales términos utilizados en el ámbito de pagos y VTEX.

| Término     | Definición     |
| ---------- | ---------- |
| __3DS__       | __3DS__ es un protocolo de seguridad que proporciona una capa adicional de protección para las compras online con tarjeta de crédito y débito. [Haga clic aquí](https://help.vtex.com/es/tutorial/o-que-e-3d-secure--1eWPdop8mECuaEomQgkAIa) para más información.       |
| __Banco adquirente (Adquirente)__       | El banco adquirente es un banco o institución financiera que procesa los pagos con tarjeta de crédito o débito en nombre de un comerciante. <ul><li>Para más información, [haga clic aquí](https://help.vtex.com/en/tutorial/what-is-an-acquirer--7N1oRTG8dGmOiIugC0cs4E) para acceder a nuestra documentación.       |
| __Proveedor antifraude__       | Una institución/empresa antifraude que recibe solicitudes de transacciones y evalúa el riesgo de fraude basándose en la información del consumidor, la información de la compra y la categoría de la tienda, como dirección IP, huella digital del dispositivo,  ubicación habitual del consumidor, información de la tarjeta de crédito y otros.        |
| __Autorización__       | La autorización se solicita cuando un cliente realiza una compra. El banco emisor del cliente proporciona esta autorización y confirma la validez de la tarjeta del titular, la capacidad de pago y la presencia de fondos suficientes, etc. <ul><li>Una vez completada, los fondos se retienen y el saldo se deduce del límite de crédito del cliente, pero aún no se transfiere a la cuenta del comerciante.    |
| __BACEN__       | El Banco Central de Brasil, en portugués «Banco Central do Brasil», al igual que otros bancos centrales es la principal autoridad monetaria del país.          |
| __Conciliacion bancaria__       | Un extracto de conciliación bancaria es un documento que coteja el saldo de efectivo en el balance de una empresa con el importe correspondiente en su extracto bancario. <ul><li>La conciliación de las dos cuentas ayuda a determinar si se necesitan cambios contables.</li><li>Las conciliaciones bancarias se realizan a intervalos regulares para garantizar que los registros de efectivo de la empresa son correctos. También ayudan a detectar el fraude y cualquier manipulación de efectivo.       |
| __BIN__       |   Los 6 primeros dígitos de la tarjeta de crédito que identifican la red, el banco y el tipo de tarjeta (débito o crédito) __B__ank __I__dentification __N__umber.       |
| __Sucursal__       |  Lugar de venta al público donde el banco o la institución financiera ofrece un amplio conjunto de servicios presenciales y automatizados a sus clientes.       |
| __Red__       | Las redes de tarjetas facilitan los pagos con tarjetas de crédito y débito. Esencialmente, prestan fondos a los comerciantes y posteriormente son reembolsados por el titular de la tarjeta. <ul><li>Ejemplos de redes de tarjetas son Visa, Mastercard, American Express y Discover.      |
| __Titular de la tarjeta__       | El titular de la tarjeta es la persona a la que está registrada la tarjeta de crédito y, normalmente, su nombre está impreso en la tarjeta.       |
| __Crecimiento a tipo de cambio constante__       | Crecimiento a tipo de cambio constante es una medida de rendimiento utilizada para eliminar el efecto de las fluctuaciones de la moneda al calcular el crecimiento en el tiempo. <ul><li>Se utiliza habitualmente en las empresas en las que una parte de los ingresos se percibe en moneda extranjera. </li><li> Les permite mostrar los resultados a los inversores, independientemente de los movimientos en moneda extranjera.        |
| __Desafío__       | Paso adicional de autenticación requerido por el banco responsable de aprobar la solicitud de pago. <ul><li>Este paso puede realizarse normalmente después de que el banco haya analizado los datos de la transacción.        |
| __Contracargo__       | Los clientes pueden impugnar un cargo en un plazo de 60 días a partir de la fecha del extracto. Entonces se inicia el proceso de interacción entre el banco emisor y el comerciante.<ul><li>Como resultado, se toma la decisión de devolver los fondos del cargo disputado. |
| __Condición comercial__       | Cada SKU está asociado a una condición comercial. Esta puede indicar información específica sobre el SKU. <ul><li>En la configuración del método de pago puede establecer condiciones comerciales de ese método de pago, de modo que solo estará disponible para SKU específicos.      |
| __Disputa__       | Es un flujo de operación que comienza con el cliente a través de la red de la tarjeta o emisor de la tarjeta, para protestar por una transacción incorrecta o desconocida.   |
| __Comisión__       |Remuneración que cobra la red en cada transacción por medio de un impuesto (aunque se haya cancelado). Pagado por el banco y por el adquirente.     |
| __Cuenta franquicia__       | Una Cuenta Franquicia es una cuenta que comparte el catálogo de un ambiente principal. <ul><li>Como cuenta independiente, la Cuenta Franquicia tiene su propia logística y realiza su propia gestión de pedidos.</li><li> Además, la Cuenta Franquicia puede tener su propio precio, pero también puede heredar el precio de la cuenta principal.      |
| __Tarjeta de regalo__       | Tarjeta prepago emitida por una tienda privada como C&A, Riachuelo o incluso restaurantes. <ul><li>El crédito puede utilizarse en compras online y offline, __generalmente creando un descuento durante el *checkout*__, antes de que se complete la transacción.</li><li> Algunas redes también han comenzado a emitir tarjetas de regalo digitales, que es solo un código (sin la tarjeta física).       |
...
| __SKU__       | En la gestión de *stock*, una unidad de mantenimiento de *stock* (SKU) es un tipo distinto de ítem para la venta, como un producto o servicio, y todos los atributos asociados con el tipo de ítem que lo distinguen de otros tipos de ítems.       |
