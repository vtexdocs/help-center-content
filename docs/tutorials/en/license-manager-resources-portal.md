---
title: 'License Manager resources - Portal'
...
slug: license-manager-resources-portal
locale: en
legacySlug: 
...
<table class="w-100 center mv7 bb b--gray" style="border-spacing: 0px; border-collapse: collapse;">
  ...
  <tr class="bb b--muted-3">
   ...
   <td class="t-body pa5" style="min-width: 15rem;">Create and edit templates, shelves and pages in CMS (Portal).
   </td>
  </tr>
</table>
