---
title: Setting up payments with DeunaNow
...
slug: setting-up-payments-with-deunanow
legacySlug: setting-up-payments-with-deunanow
subcategory: 3tDGibM2tqMyqIyukqmmMw
---

At VTEX, it is possible to integrate with the DeunaNow payment provider. With this connector, your store can make sales through DeunaNow.
...
3. Click on the __DeunaNow__ connector.
4. Fill in the __Application Key__ and __Application Token__ fields with data provided by DeunaNow.
...
3. Click the __DeunaNow__ payment method.
...
After following the indicated steps, DeunaNow connector may take up to 10 minutes to appear at your store's checkout as a payment option.
