...
At VTEX, it is possible to integrate with the Credit Key payment provider. With this connector, your store can make sales through Credit Key.

To configure Credit Key affiliation, follow the steps below:
...
3. Click on the __CreditKey__ connector.
...
After following the indicated steps, Credit Key connector may take up to 10 minutes to appear at your store's checkout as a payment option.
