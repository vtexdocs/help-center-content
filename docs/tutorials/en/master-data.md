...
<table class="w-100 center mv7 bb b--gray" style="border-spacing: 0px; border-collapse: collapse;">
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;"><b>Functionality</b>
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><b>v1</b>
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><b>v2</b>
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><b>Learn more</b>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Graphical interface
   </td>
...
<li><a href="https://developers.vtex.com/vtex-rest-api/reference/master-data-api-v2-overview">Master Data v2 API</a></li></ul>
  ...
  <tr class="bb b--muted-3">
   ...
   <td class="t-body pa5" style="min-width: 15rem;">
<ul><li><a href="https://help.vtex.com/en/tutorial/importing-data-into-master-data--tutorials_1135#">Import data into Master Data v1</a></li> <li><a href="https://help.vtex.com/en/tutorial/exporting-data--tutorials_1125#">Export data from Master Data v1</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Attachments (imagens)
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Yes
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">No
  ...
  <tr class="bb b--muted-3">
   ...
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href=”#triggers”>Triggers</a></li><li><a href="https://help.vtex.com/en/tutorial/creating-trigger-in-master-data--tutorials_1270#">Creating triggers with Master Data v1</a></li><li><a href="https://developers.vtex.com/vtex-rest-api/docs/setting-up-triggers-in-master-data-v2">Creating triggers with Master Data v2</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   ...
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href="http://json-schema.org/">JSON schemas</a></li><li><a href="https://spacetelescope.github.io/understanding-json-schema">Understanding JSON schemas</a></li><li><a href="https://developers.vtex.com/vtex-rest-api/docs/starting-to-work-on-master-data-with-json-schema">Starting to work with JSON schemas in Master Data v2</a></li><li><a href="https://developers.vtex.com/vtex-rest-api/docs/master-data-schema-lifecycle">Schema life cycle in Master Data v2</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Nested properties
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">No
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Yes
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href=”#nested-properties”>Nested properties</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Data entities
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Referenced by acronyms composed of two capital letters. For example, the 'CL' entity stores client data from the store and 'AD' stores addresses. Cannot be created via API.
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Referenced by their names. For example, 'Client' and 'Address'. Can only be created via API.
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href=”#data-entities”>Data entities</a></li><li><a href="https://help.vtex.com/en/tutorial/criando-entidade-de-dados--tutorials_1265">Data entities in Master Data v1</a></li><li><a href="https://developers.vtex.com/vtex-rest-api/docs/creating-relationships-between-data-entities-using-api">Creating relationships between Master Data v2 data entities</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Fields
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">They must be filled in in the specific format configured in the data entity.
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Firstly, there is no restriction on fields and formats. Format validation is made through JSON schemas.
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href="https://help.vtex.com/en/tutorial/criando-entidade-de-dados--tutorials_1265#entendendo-os-tipos">Field types in Master Data v1</a></li><li><a href=”#v2-schemas”>JSON schemas</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
   <td class="t-body pa5" style="min-width: 15rem;">Indexes
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Yes
   </td>
   <td class="t-body pa5" style="min-width: 15rem;">Yes
   </td>
   <td class="t-body pa5" style="min-width: 15rem;"><ul><li><a href="https://help.vtex.com/en/tutorial/setting-up-an-index-on-master-data--tutorials_785">How to set up indexes in Master Data v1</a></li><li><a href="https://developers.vtex.com/vtex-rest-api/reference/putindices">How to set up indexes with Master Data v2 API</a></li></ul>
   </td>
  </tr>
  <tr class="bb b--muted-3">
