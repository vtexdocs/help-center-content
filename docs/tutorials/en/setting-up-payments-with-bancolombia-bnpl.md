...
At VTEX, it is possible to integrate with the Bancolombia BNPL payment provider. With this connector, your store can make sales through Bancolombia BNPL (Buy Now Pay Later).

To configure Bancolombia BNPL affiliation, follow the steps below:
...
3. Click on the __BancolombiaBNPL__ connector.
