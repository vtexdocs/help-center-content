...
If you want to find new partners to sell in your marketplace, use the __Find sellers__, which facilitates the identification and the communication between marketplaces and sellers operating in the VTEX ecosystem, as well as certified partners.
</div>
