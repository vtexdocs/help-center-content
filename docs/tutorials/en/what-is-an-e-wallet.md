...
A digital wallet (also called an e-wallet) is a secure environment where bank and/or credit card information can be stored. This information is encrypted in the system and, when accessed by its owner, can be used to make purchases on the internet.
