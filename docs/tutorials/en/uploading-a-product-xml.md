...
[Preparing an XML file is one of the ways to send products to partners](/en/tutorial/configuring-xml/) like search engines, for example. By default, VTEX already comes configured with several XML models, you just need to associate them a collection to start using!
