...
slug: setting-up-payments-with-paghiperv2
locale: en
...
To configure the payment methods to be processed by PagHiperV2, access [Configuring Payment Conditions](https://help.vtex.com/en/tutorial/how-to-configure-payment-conditions--tutorials_455#).
