...
In VTEX, you can configure the __Sitef__ gateway. If you would like to receive payments from Sitef, follow the steps below:

## Setting up Sitef gateway affiliation

1. In the VTEX Admin, go to **Store Settings** > **Payment** > **Settings**, or type **Settings** in the search bar at the top of the page.
2. On the __Gateway Affiliations__ tab, click the __+__ button.
3. Click the __Sitef__ connector.
