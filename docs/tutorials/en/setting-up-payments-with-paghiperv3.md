...
slug: setting-up-payments-with-paghiperv3
locale: en
...
To configure the payment methods to be processed by PagHiperV3, access [Configuring Payment Conditions](https://help.vtex.com/en/tutorial/how-to-configure-payment-conditions--tutorials_455#).
