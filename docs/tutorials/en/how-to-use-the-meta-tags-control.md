...
If you don't want to use the canonical tag (&lt;link rel="canonical"&gt;), you can disable it using a <a href="https://developers.vtex.com/docs/guides/control-to-disable-the-canonical-tag">specific control</a>.
</div>
