...
- [Tarifas de envio](https://help.vtex.com/pt/tutorial/tarifas-de-envio--1Balpg3rv0854udEPedvMM): como as tarifas de envio são calculadas e como cadastrá-las.  
- [Gerenciar tarifas de envio](https://help.vtex.com/pt/tutorial/gerenciar-tarifas-de-envio--tutorials_141): como gerenciar uma tarifa de envio específica utilizando o código postal.  
- [Planilha de frete](https://help.vtex.com/pt/tutorial/planilha-de-frete--tutorials_127): como cadastrar tarifas de envio em massa, em vez de usar o cadastro individual.  

## Simulador de envio

O simulador de envio é a ferramenta utilizada para validar as [tarifas de envio](https://help.vtex.com/pt/tutorial/tarifas-de-envio--1Balpg3rv0854udEPedvMM). A simulação verifica as condições de entrega, dando ao lojista a capacidade de averiguar a disponibilidade de itens, as formas de entrega, os custos e os prazos.
...
Confira o artigo [Simulador de envio](https://help.vtex.com/pt/tutorial/simulador-de-envio--tutorials_144) para entender o funcionamento do simulador e ver como são apresentados os detalhes da simulação.
