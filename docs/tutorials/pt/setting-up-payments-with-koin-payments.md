...
Na VTEX, é possível realizar a integração com o provedor de pagamento Koin-Payments. Por meio deste conector, sua loja pode realizar vendas por meio do cartões de crédito, débito, PIX e BoletoParceladoKoin.

Para configurar a afiliação Koin-Payments, siga os passos abaixo:

1. No Admin VTEX, acesse **Configurações da loja** > **Pagamentos** > **Configurações**, ou digite **Configurações** na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão `+`.
3. Clique no conector __Koin-Payments__.
