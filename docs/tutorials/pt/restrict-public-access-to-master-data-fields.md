...
slug: restringir-acesso-publico-a-campos-do-master-data
locale: pt
...
4. Em **Configurações**, clique em **Estrutura de dados**.
   ...
   ![2-master-data-confidential-data-pt](https://images.ctfassets.net/alneenqid6w5/3F2667ZvZymEE03zyoHSsh/524173ebe8a58a71711ac518b571218b/2-master-data-confidential-data-pt.png)
5. Clique na aba **Entidades de dados**.
6. Na linha da entidade de dados, clique no botão de edição <i class="fas fa-edit"></i>.

   ![3-master-data-confidential-data-pt](https://images.ctfassets.net/alneenqid6w5/4yZP09vrLVx5FtLUAW8Q1b/8a5d88237d95243515b0528ff1b7a4b0/3-master-data-confidential-data-pt.png)
7. Na linha do campo que contém um dado confidencial, clique na engrenagem <i class="fas fa-cog"></i>.

   ![4-master-data-confidential-data-pt](https://images.ctfassets.net/alneenqid6w5/5FZRbvfibWYENZIeoGGvXk/7c1f6afa0c6d7cda830b03b1532d22ed/4-master-data-confidential-data-pt.png)
8. Desmarque as opções a seguir:
   ...
   * **Permitir filtrar sem credencial**
   ...
   ![5-master-data-confidential-data-pt](https://images.ctfassets.net/alneenqid6w5/1FTKHYceHs2H5HkDV6lwCv/caf25f3c588303febe067d9a219dd9f2/5-master-data-confidential-data-pt.png)
