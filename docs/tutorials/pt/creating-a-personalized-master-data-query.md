---
title: 'Criar consulta personalizada no Master Data'
id: tutorials_799
status: PUBLISHED
...
author: authors_3
slug: criando-uma-consulta-personalizada-no-master-data
locale: pt
legacySlug: criando-uma-consulta-personalizada-no-master-data
subcategory: 2AThnkEZAYbk4G4EIs53rL
---

Consulta customizada é um filtro ou um conjunto de filtro que, para serem usamos mais facilmente, são salvos em uma consulta que pode ser acessada na listagem do formulário.

Para criar uma consulta, é necessário que [seja realizado um filtro na listagem](/pt/tutorial/filtrando-dados-no-master-data/). 
...
3. Na aplicação em que deseja alterar o formulário, clique no símbolo de engrenagem.
4. Abrirá a listagem de formulários, clique no símbolo lápis no formulário que deseja criar o filtro.
