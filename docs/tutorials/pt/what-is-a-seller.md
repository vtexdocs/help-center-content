...
Um __seller__ pode exibir seu catálogo para venda numa loja de terceiros, seja ela VTEX ou não; este seller pode também vender seus produtos em uma loja própria, sendo assim a loja atua como __seller__ e __marketplace__ de forma simultânea, neste caso o seller é chamado de [seller white label](https://help.vtex.com/pt/tutorial/definicoes-de-conta-franquia-e-seller-white-label--5orlGHyDHGAYciQ64oEgKa).

Neste cenário a loja responsável pela venda atua como [marketplace](https://help.vtex.com/pt/tutorial/o-que-e-um-marketplace), sendo responsável por efetivar a venda e receber o pagamento do cliente, enquanto o __seller__ tem a função de realizar a entrega do pedido.

O sortimento de produtos enviados a um marketplace, é definido no momento de escolha da [política comercial](https://help.vtex.com/pt/tutorial/como-funciona-uma-politica-comercial--6Xef8PZiFm40kg2STrMkMV).
...
- [O que é um marketplace?](https://help.vtex.com/pt/tutorial/what-is-a-marketplace)  
- [Configurar seller](https://help.vtex.com/pt/tutorial/configurando-seller)  
