...
Na VTEX, é possível realizar a integração com o provedor de pagamentos CrecosCorp. Com este conector, sua loja pode realizar vendas por meio de cartões private labels.

Para configurar a afiliação CrecosCorp, acesse [Cadastrar afiliações de gateway](https://help.vtex.com/pt/tutorial/afiliacoes-de-gateway--tutorials_444#).
...
Depois de seguir os passos indicados, o conector CrecosCorp pode demorar até 10 minutos para aparecer no checkout da sua loja como uma opção de pagamento. 
