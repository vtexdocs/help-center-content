...
<p>Caso você deseje implementar o VTEX Sales App nas suas lojas físicas, não recomendamos configurar meios de pagamentos próprios para as contas franquia. O ideal é que as contas franquias utilizem os meios de pagamento da conta principal, para evitar conflitos de pagamento.</p>
</div>
