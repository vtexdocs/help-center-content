...
slug: configurar-pagamento-com-malga
locale: pt
...
Caso deseje mais informações sobre a integração da Malga na VTEX, acesse a <a href="https://docs.malga.io/sdks/plugins/vtex-connector">documentação externa Malga</a>.
</div>
