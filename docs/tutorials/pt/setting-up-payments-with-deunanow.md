...
slug: configurar-pagamento-com-deunanow
legacySlug: configurar-pagamento-com-deunanow
subcategory: 3tDGibM2tqMyqIyukqmmMw
---

Na VTEX, é possível realizar a integração com o provedor de pagamento DeunaNow. Com este conector, sua loja pode realizar vendas por meio do DeunaNow.

Para configurar a afiliação DeunaNow, siga os passos abaixo:

1. No Admin VTEX, acesse __Configurações da loja > Pagamentos > Configurações__, ou digite __Configurações__ na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão `+`.
3. Clique no conector __DeunaNow__.
4. Preencha os campos __Application Key__ e __Application Token__ com as informações da sua conta DeunaNow.
...
3. Clique no método de pagamento __DeunaNow__.
...
Depois de seguir os passos indicados, o conector DeunaNow pode demorar até 10 minutos para aparecer no checkout da sua loja como uma opção de pagamento. 
