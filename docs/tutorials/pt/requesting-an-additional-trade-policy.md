...
Na VTEX, a contratação de políticas comerciais adicionais é isenta de taxas para integrações com conectores nativos, conectores certificados (parceiros) ou outras lojas VTEX. Saiba mais em [Estratégias de marketplace na VTEX](https://help.vtex.com/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402).
