...
## Configurar afiliação de gateway Alignet
1. No Admin VTEX, acesse **Configurações da loja** > **Pagamentos** > **Configurações**, ou digite **Configurações** na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão __+__.
3. Clique no conector __Alignet__.
...
Outra opção para você habilitar essa condição de pagamento é usar o conector [Pay-me](/pt/tutorial/configurar-gateway-pay-me).
