...
slug: gerenciamento-de-centro-de-custo-no-b2b
locale: pt
legacySlug: gerenciamento-de-centro-de-custo-no-b2b
...
Os campos personalizados permitem que os usuários adicionem informações relevantes para a empresa. Para mais informações, acesse [Campos personalizados no cadastro de organização](https://help.vtex.com/pt/tutorial/campos-personalizados-no-cadastro-de-organizacao--2MqEVusOvcbqagNwOuHA7f).
