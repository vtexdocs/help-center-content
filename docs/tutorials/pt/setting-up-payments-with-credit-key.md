...
Na VTEX, é possível realizar a integração com o provedor de pagamento Credit Key. Com este conector, sua loja pode realizar vendas por meio do Credit Key.

Para configurar a afiliação Credit Key, siga os passos abaixo:

1. No Admin VTEX, acesse __Configurações da loja > Pagamentos > Configurações__, ou digite __Configurações__ na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão `+`.
3. Clique no conector __CreditKey__.
...
Depois de seguir os passos indicados, o conector Credit Key pode demorar até 10 minutos para aparecer no checkout da sua loja como uma opção de pagamento. 
