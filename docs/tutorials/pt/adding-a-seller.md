...
>ℹ️ Se quiser encontrar novos parceiros para venderem em seu marketplace, utilize o __Encontrar sellers__, que facilita a identificação e contato entre marketplaces e sellers que operam no ecossistema VTEX, além de conectores certificados (parceiros).
