...
Na VTEX, é possível realizar a integração com o provedor de pagamento Bancolombia BNPL. Por meio deste conector, sua loja pode realizar vendas por meio do BNPL (Buy Now Pay Later) do Bancolombia.

Para configurar a afiliação Bancolombia BNPL, siga os passos abaixo:

1. No Admin VTEX, acesse __Configurações da loja > Pagamentos > Configurações__, ou digite __Configurações__ na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão `+`.
3. Clique no conector __BancolombiaBNPL__.
...
Depois de seguir os passos indicados, o conector Bancolombia BNPL pode demorar até 10 minutos para aparecer no Checkout da sua loja como uma opção de pagamento. 
