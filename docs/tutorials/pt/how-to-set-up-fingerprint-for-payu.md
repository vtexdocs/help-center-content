...
3. Criar um produto de “HTML Personalizado” como se vê na imagem a seguir:![payU 1](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-0.png)
...
<script>
   ...
   vtexjs.checkout.getOrderForm().done(function(orderForm){ // hala el valor de userProfileId
       ...
       document.getElementById('gtm').innerHTML = '<p style="background:url(https://maf.pagosonline.net/ws/fp?id='+deviceSessionId+'80200)"></p>'+'<img src="https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-10.png">';
...
![payU 2](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-1.png)

Depois é preciso realizar a configuração avançada tal como consta na imagem a seguir:![payU 3](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-2.png)

Para configurar o evento, siga os passos abaixo:

1. Entre na aba More:![payU 4](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-3.png)
2. Crie um evento personalizado:![payU 5](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-4.png)
3. Preencha-o da seguinte maneira:![payU 6](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-5.png)
4. Salve o evento e posteriormente salve a etiqueta (tag):![payU 7](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-6.png)
5. Uma vez salva a etiqueta, é necessário publicá-la:![payU 8](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-7.png)
...
![cms js](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-8.png)
...
![payU 9](https://raw.githubusercontent.com/vtexdocs/help-center-content/main/images/pt/configurar-fingerprint-para-payu-9.png)
