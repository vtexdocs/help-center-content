...
4. No campo __Validade da promissória em dias Max(180)__, defina quantos dias seu cliente terá para pagar a promissória antes que ela perca a validade.
5. Em __Autorizar automaticamente__, informe se deseja aprovar o pagamento de imediato. Só recomendamos a escolha dessa opção para casos em que o pagamento é feito na entrega ou na retirada do pedido na loja. Ao escolher _Yes_, o pedido passa automaticamente para o status _Preparando Entrega_, sem passar por nenhuma verificação de pagamento.
