...
Veja abaixo os principais termos utilizados em pagamentos na VTEX:

| Termo     | Definição     |
| ---------- | ---------- |
| __3DS__ | __3DS__ é um protocolo de segurança que oferece uma camada extra de proteção para compras online feitas com cartão de crédito e débito. [Clique aqui](https://help.vtex.com/en/tutorial/o-que-e-3d-secure--1eWPdop8mECuaEomQgkAIa) para obter mais informações.       |
| __Banco adquirente (Acquirer)__ | Um banco adquirente é um banco ou instituição financeira que processa pagamentos com cartão de crédito ou débito em nome do comerciante. <ul><li>[Clique aqui](https://help.vtex.com/en/tutorial/what-is-an-acquirer--7N1oRTG8dGmOiIugC0cs4E) para acessar nossa documentação.</li><li>       |
| __Provedor antifraude__       | Instituição/empresa antifraude que recebe solicitações de transação e avalia o risco de fraude baseada em informações do consumidor, informações de compra e categorias de armazenamento, como endereço IP, impressão digital do dispositivo, localização habitual do consumidor, informações de cartão de crédito, entre outros.       |
| __Autorização__      | A autorização é solicitada quando um cliente faz uma compra. Esta autorização é fornecida pelo banco emissor do cliente e confirma a validade do cartão e se há fundos suficientes. <ul><li>Após a conclusão desta etapa, os fundos são mantidos e o saldo é deduzido do limite de crédito do cliente, mas ainda não é transferido para a conta do comerciante.</li><li>       |
| __BACEN__       | Refere-se ao "Banco Central do Brasil". É a principal autoridade monetária do país.         |
| __Conciliação bancária__      | Um extrato de conciliação bancária é um documento que compara o saldo do controle de caixa interno de uma empresa com o valor correspondente do seu extrato bancário. <ul><li>Conciliar as duas contas ajuda a determinar se são necessárias mudanças contábeis.</li><li> <ul><li>As conciliações bancárias são realizadas em intervalos regulares para garantir que os registros de caixa da empresa estejam corretos. Elas também ajudam a detectar fraudes e manipulações de dinheiro.</li><li>       |
| __BIN__       | Os primeiros 6 dígitos do cartão de crédito que identificam a sua bandeira, o banco e o tipo de cartão (débito ou crédito). A sigla vem de __B__ank __I__dentification __N__ umber (Número de Identificação Bancária).       |
| __Filial__       | Local de venda onde o banco ou instituição financeira oferece um amplo conjunto de serviços presenciais e automatizados aos seus clientes.       |
| __Bandeira__       | As bandeiras de cartões facilitam os pagamentos com cartão de crédito e débito. Basicamente, elas emprestam fundos aos comerciantes e depois são reembolsadas pelo titular do cartão. <ul><li>Exemplos de bandeiras de cartão: Visa, Mastercard, American Express, Discover, etc.</li><li>     |
| __ Titular do cartão__       | Titular do cartão é a pessoa a quem o cartão de crédito está registrado e, normalmente, cujo nome está impresso no cartão.       |
| __Taxa constante de crescimento da moeda__ | A taxa constante de crescimento da moeda é uma medida de desempenho utilizada para eliminar o efeito das flutuações na moeda ao calcular o crescimento ao longo do tempo. <ul><li> Essa taxa é comumente usada em empresas onde parte da receita é recebida em moedas internacionais.</li><li> <ul><li>Ela possibilita mostrar resultados aos investidores, independentemente da variação da moeda internacional.</li><li>       |
| __Desafio__       | Etapa adicional de autenticação exigida pelo banco responsável por aprovar o pedido de pagamento. <ul><li>Em geral, ela pode ser feita após o banco ter analisado os dados da transação.</li><li>        |
| __Contestação__ | Os clientes podem contestar uma cobrança em até 60 dias a partir da data de fechamento da fatura. Em seguida, é iniciado o processo de interação entre o banco emissor e o comerciante. <ul><li>Como resultado, chega-se a uma decisão sobre estornar o valor contestado.</li><li>      |
| __Condição comercial__       | Cada SKU é associado a uma condição comercial. Ela pode conter informações específicas sobre o SKU. <ul><li> Nas configurações do meio de pagamento, você pode definir as condições comerciais dele. Dessa forma, ele pode ficar disponível apenas para SKUs específicos.</li><li>       |
| __Disputa__       | É um fluxo de operações que começa com o cliente através da bandeira ou do emissor do cartão, a fim de protestar contra uma transação incorreta ou desconhecida.        |
| __Comissão__       | Remuneração que a bandeira cobra por meio de uma taxa em cada transação (mesmo que a transação tenha sido cancelada). Valor pago pelo banco e pelo adquirente       |
| __Conta franquia__       | Uma conta franquia é uma conta que compartilha o catálogo de um ambiente principal. <ul><li>Por ser uma conta independente, a conta franquia tem sua própria logística e realiza sua própria gestão de pedidos.</li><li> <ul><li> Além disso, a conta franquia pode ter seu próprio preço, mas também pode herdar o preço da conta principal.</li><li>       |
| __Vale-compra (Giftcard)__       | Cartão pré-pago emitido por uma loja privada, como C&A, Riachuelo, inclusive restaurantes. <ul><li> O crédito pode ser utilizado em compras online e offline, __geralmente criando um desconto durante o processo de checkout__, antes que a transação seja concluída. </li><li> Algumas marcas também começaram a emitir giftcards digitais, que é apenas um código (sem o cartão físico).       |
| __Volume bruto de mercadorias (GMV)__       | O Volume Bruto de Mercadorias (GMV) é um termo utilizado no varejo online para indicar o valor total de vendas (em dólares) de mercadorias que foram vendidas por meio de um determinado marketplace em um período de tempo específico.        |
