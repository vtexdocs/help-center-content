---
title: 'Redefinindo sua configuração de aplicativo de autenticação de dois fatores'
...
1. Acesse este endereço para ver a página de login da sua conta:
```
...
## Alterando configurações de verificação de dois fatores
...
1. Acesse a página de configuração de verificação em duas etapas da sua conta neste endereço:
```
https://{accountName}.myvtex.com/admin/myuser/twostepverification
```
2. Clique em **Alterar** na seção **App Google Authenticator**.
3. Caso não tenha o aplicativo Google Authenticator instalado, o instale no seu dispositivo móvel.
4. Escaneie o código QR usando o aplicativo Google Authenticator.
5. Insira o código exibido no aplicativo no campo indicado na página.
