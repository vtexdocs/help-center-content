...
A divisão de carga é a configuração que permite que uma compra seja dividida em várias entregas quando o cálculo total de peso ultrapassar o limite da transportadora.

Essa configuração é muito importante pois, caso a divisão de carga não seja permitida, pode impossibilitar o fechamento de uma compra. Isso caso o a soma do peso de todos os produtos do carrinho for maior que o limite máximo de peso cadastrado nas transportadoras.
