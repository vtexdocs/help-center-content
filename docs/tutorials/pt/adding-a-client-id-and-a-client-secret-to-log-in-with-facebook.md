...
author: authors_84
slug: cadastrar-client-id-e-segredo-do-cliente-para-login-com-facebook
locale: pt
...
5. Clique em **Permitir que as pessoas entrem com a própria conta do Facebook**, dentre as opções ilustradas abaixo.
   ...
   ![2-login-fb-pt](https://images.ctfassets.net/alneenqid6w5/3zv1li5neUPsSK8VhPaRy0/c5d74282b8459d40d3a0ac9026591787/2-login-fb-pt.png)

6. Clique em `Avançar`.
7. Preencha o nome do app e o email de contato do responsável pelo aplicativo, nos campos ilustrados abaixo.

   ![3-login-fb-pt](https://images.ctfassets.net/alneenqid6w5/1Yg8Du8HKxU7rW15ZsL6vD/2cf04b1ea40c6e4e4ed2d843296bb256/3-login-fb-pt.png)
...
1. Clique em **Produtos** no menu lateral ou no **Painel **do Meta for Developers, destacado a seguir.
   ...
   ![4-login-fb-pt](https://images.ctfassets.net/alneenqid6w5/2wNKd6gswgFQAghpNdvEVq/9b7ff04d05523c1d9ec09f5b3f563d34/4-login-fb-pt.png)

2. Clique em `Configurar` e, em seguida, na opção `Configurações`.

   ![5-login-fb-pt](https://images.ctfassets.net/alneenqid6w5/vMQDtOfYgSZfo7EOYuNel/f64b512f3583de4ab35032ec1f3dcb23/5-login-fb-pt.png)
...
1. No menu lateral do Meta for Developers, vá em **Configurações do app** e clique em **Básico:**
   ...
   ![7-login-fb-pt](https://images.ctfassets.net/alneenqid6w5/4rhVhY9V6N117s3XwZ59No/e0a0037af04e1e1d8b465520f804d9a0/7-login-fb-pt.png)
