...
Na VTEX, é possível realizar a integração com o provedor de pagamento Pine Labs. Por meio deste provedor, sua loja pode realizar vendas por meio de cartões de crédito, boleto bancário e promissórias.

Para configurar Pine Labs, siga os passos abaixo:

1. No Admin VTEX, acesse __Configurações da loja > Pagamentos > Provedores__, ou digite __Provedores__ na barra de busca no topo da página.
2. Na tela de provedores, clique no botão `Novo provedor`.
3. Digite o nome __Pinelabs connector__ na barra de busca e clique sobre o nome do provedor.
...
Depois de seguir os passos indicados, Pine Labs pode demorar até 10 minutos para aparecer no checkout da sua loja como uma opção de pagamento. 
