...
Após o cadastro do parceiro, cadastre seu usuário correspondente, para que tenha um login e senha de acesso ao sistema. Confira nossa documentação sobre criação de [usuários VTEX Tracking](https://help.vtex.com/pt/tutorial/usuarios-vtex-trackin--1zn5nrvkoWtx0pcabbRhSZ#consultar-usuario) para saber mais. 
