...
updatedAt: 2023-03-28T22:57:51.457Z
publishedAt: 2023-03-28T22:57:51.457Z
...
Para editar as informações do cliente é necessário seguir os seguintes passos:

1. No Admin VTEX, acesse **Configurações da loja** > **Storefront** > **Master Data**.
2. Selecione a aba **Endereços**. Lá você vai encontrar todos os usuários que tenham registrado pelo menos um endereço.
3. Busque o cliente desejado.
4. Na coluna **Ações** da tabela, clique na opção **Editar**.
5. Crie ou edite as informações desejadas.
6. Clique em **Salvar**.
