...
Na VTEX, é possível realizar a integração com o gateway Aarin. Com este conector, sua loja pode realizar vendas por meio do PIX.

Para configurar a afiliação Aarin, siga os passos abaixo:

1. No Admin VTEX, acesse **Configurações da loja** > **Pagamentos** > **Configurações**, ou digite **Configurações** na barra de busca no topo da página.
2. Na aba __Afiliações de Gateways__, clique no botão `+`.
3. Clique no conector __Aarin__.
