...
excerpt: "An incorrectly long holiday range makes VTEX apply a shorter automatic window, which changes the promised delivery date."
...
When there is an error associated with the number of days of a [holiday](/en/docs/tutorials/registering-holidays), for security reasons, the platform configures an automatic range that may be affecting the order's delivery date.
...
For more information, see the article [Registering Holidays](/en/docs/tutorials/registering-holidays).
