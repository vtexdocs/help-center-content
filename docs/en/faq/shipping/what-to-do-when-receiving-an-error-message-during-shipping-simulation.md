...
excerpt: "Shipping simulation returns the Logistics calculation API result. Walk through docks, inventory, carriers, and postal code coverage to find the gap."
