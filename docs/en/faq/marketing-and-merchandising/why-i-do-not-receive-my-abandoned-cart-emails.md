...
In some cases, the [Trigger settings](/en/tutorial/how-to-create-a-trigger-in-Master-Data--tutorials_1270) for [Cart abandonment](/en/tutorial/setting-up-abandoned-carts--tutorials_740#) may not work properly. This occurs because of improper configuration settings. These errors may however easily be corrected through [Master Data](/en/tutorial/--4otjBnR27u4WUIciQsmkAw).
