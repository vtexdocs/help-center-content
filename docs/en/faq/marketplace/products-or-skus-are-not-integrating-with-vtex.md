---
title: 'Why are some products, SKUs, or orders not integrating with VTEX?'
excerpt: "Product and SKU sync is handled by the ERP or integrator, not by VTEX. Check that team's logs to find and fix the failure."
