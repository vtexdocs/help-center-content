...
excerpt: "Promotion seals are a VTEX storefront CSS/HTML flag. Marketplaces only receive the discounted price, so stamps must be configured on the marketplace."
