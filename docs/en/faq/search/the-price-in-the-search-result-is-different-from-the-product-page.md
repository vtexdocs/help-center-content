...
excerpt: "Intelligent Search can show stale prices when simulationBehavior is set to skip. Change that setting if you need live price and stock in search."
