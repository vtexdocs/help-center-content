...
excerpt: "If the payment connector fails its initial validations, the order is canceled and never sent to anti-fraud. Canceled orders cannot be resubmitted."
