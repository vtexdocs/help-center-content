...
excerpt: "This PagSeguro connector is being discontinued. Redirect errors usually come from an incorrect redirect URL; configure it with or without redirect."
