...
excerpt: "Start from the transaction log in Admin. It shows every request and response between VTEX and the gateway or antifraud partner."
...
![2017-04-11-17 28 32-4820587- -VTEX-PCI-Gateway-300x65](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/payments/what-should-i-do-when-there-are-problems-with-a-transaction_1.png) 

On April 3, the gateway returns an error in the Status.
![2017-04-11-17 26 40-4820587- -VTEX-PCI-Gateway-300x87](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/payments/what-should-i-do-when-there-are-problems-with-a-transaction_2.png)
