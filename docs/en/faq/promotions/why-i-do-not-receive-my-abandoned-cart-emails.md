---
title: "Why don't I receive my abandoned cart emails?"
excerpt: "Abandoned-cart emails fail because of incorrect Master Data trigger settings. Review the trigger in Data Structure and fix the conditions."
...
In some cases, the [Trigger settings](/en/docs/tutorials/creating-trigger-in-master-data) for [Cart abandonment](/en/tutorial/setting-up-abandoned-carts--tutorials_740#) may not work properly. This occurs because of improper configuration settings. These errors may however easily be corrected through [Master Data](/en/docs/tutorials/master-data).
...
4. You will be redirected to a new page. Use your __VTEX login__ to authenticate.
...
The __“Conditions”__ tab contains the main settings that set off the Trigger. You can thus ensure that data was included correctly and also remedy possible errors. 
...
The "error notification email" field should not be filled out. If you find it filled out during your data check, clear it.

- __Origin Email__
The "Origin Email" field should also be left blank.

- __Display name of origin email__ 
It's not possible to fill out the display name of the origin email. If anything is written there, delete it and leave the field empty.
