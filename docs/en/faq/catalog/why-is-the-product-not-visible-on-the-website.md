...
excerpt: "A product appears only when it is active, priced, in stock, and shippable through logistics. Any missing piece hides it from the storefront."
...
2. Find the product you want to display in the list, as illustrated below.
    ...
    ![01-produto-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_1.PNG)
...
![02-campos-produto-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_2.png)

<p align="center">*Fields you must check on the product information page.*

![03-aba-especificacoes-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_3.png)
...
1. In **Products > Catalog > Products and SKUs**, find the SKU you want to investigate in the list.
    ...
    |Button | Description |
    |-|-|
    | ![04-botao-precos](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_4.png) | Allows you to access the __Price list__ to check if the desired sales channel has a valid price associated with the product SKUs. For more information, check the [Prices](#prices) section. |
    | ![05-botao-logistica](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_5.png) | Allows you to access the __Inventory management__ page to check if the SKU is available in stock.  For more information, check the [Logistics](#logistics) section. |
    | ![06-botao-indexed-info](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_6.png) | Allows you to view each **Seller** selling the SKU, the sales channel (**Policy**), the price (**Value**) and the SKU quantity in inventory (**Quantity**). |
...
5. If a SKU appears as `Inactive`, click `Update` to view the SKU detailed information.
    ...
    ![07-catalogo-skus-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_7.png)
...
![08-aba-imagens-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_8.png)

<p align="center">***Images** tab*

![09-sku-imagens-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_9.PNG)
...
![10-indexed-info-code](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_10.png)
...
![11-indexed-info-code-active](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_11.png)
...
![12-precos-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_12.PNG)
...
3. Check the template name in the **Default** field and in the **Conditional** field, if available.
    ...
    ![16-templates-cms-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/catalog/why-is-the-product-not-visible-on-the-website_13.PNG)
