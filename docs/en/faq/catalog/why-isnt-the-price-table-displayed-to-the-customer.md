...
excerpt: "The SKU must be active, and the customer's Master Data record must contain the price table ID. Otherwise checkout keeps the default prices."
...
To learn more, read the article [Setting up Price Tables for specific users](/en/docs/tutorials/setting-up-price-tables-for-specific-users).
