...
excerpt: "A fixed price on the SKU overrides list price. Remove or adjust that fixed price if you need list price to show again."
...
In some circumstances, the List Price may not appear in the front-end of the store. This happens due to configuration errors of the [Pricing](/en/tutorial/--tutorials_4394). 
