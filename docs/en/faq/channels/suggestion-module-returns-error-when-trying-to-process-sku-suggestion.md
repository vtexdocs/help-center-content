...
8. If one of them is in red and has status `400`, as in the image below, click on this call.
        ![erroSuggestion3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/faq/channels/suggestion-module-returns-error-when-trying-to-process-sku-suggestion_3.png)
