...
Remember! You can monitor the status of the indexation and the status of the integration of the inventories. To do this, access the [indexation report](/en/tutorial/utilizar-o-relatorio-de-indexação?locale=pt) and the [Integrations module](/en/tutorial/bridge/).
