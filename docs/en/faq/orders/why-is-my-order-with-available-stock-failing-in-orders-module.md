...
excerpt: "Late payment approval can expire the reservation. Another sale may then take the last units, so this order fails even if stock later looks available."
