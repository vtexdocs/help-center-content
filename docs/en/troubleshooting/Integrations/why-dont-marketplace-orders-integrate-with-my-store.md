...
| **Unavailable inventory** | The SKU is not being displayed in the marketplace.<br> <br>See the full list of [Inventory integration errors with marketplaces.](/en/docs/tutorials/inventory-integration-errors-with-marketplaces).<br>  | Apply the required fix based on the error identified in the documentation [Inventory integration errors with marketplaces.](/en/docs/tutorials/inventory-integration-errors-with-marketplaces)<br>  |
