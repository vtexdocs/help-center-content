...
|:---:|:---:|:---:|
| **Incomplete shipping information** | The delivery information is incomplete or incorrect. | Correct or complete the requested information following the documentation [Order flow and status.](/en/tutorial/fluxo-e-status-de-pedidos--tutorials_196) |
