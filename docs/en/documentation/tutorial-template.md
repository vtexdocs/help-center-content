...
| **Step title**  | In tutorial step titles, start with a verb using the verb in the gerund form to describe actions, such as `Adding a loading dock` or `Setting up your environment`. This emphasizes the ongoing nature of the task and aligns with the instructional tone of the tutorial. It indicates that the user will be actively engaged in performing the action described.|
