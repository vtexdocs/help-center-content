...
| --------- | --------------- | ------------------- | ---------------- | ---------------- | ------------ | ---------------- |
| **Goal** | Informing users of known issues within the platform and products and their workarounds or solutions. | Providing step-by-step instructions to solve specific problems or errors. | Communicating new features, changes, or important product information. | Communicating changes, improvements, or bug fixes. | Teaching users how to perform specific tasks or use a particular tool or feature. |
