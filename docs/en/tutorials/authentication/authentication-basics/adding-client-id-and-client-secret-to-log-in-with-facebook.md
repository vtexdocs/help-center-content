---
title: 'Adding Client ID and Client secret to log in with Facebook'
...
To enable login via Facebook, in your VTEX Admin, go to **Account Settings > Authentication** and complete the **Client ID** and **Client secret** fields, as described in the [Configuring login with Facebook and Google](https://help.vtex.com/docs/tutorials/configuring-login-with-facebook-and-google) article.
