...
[Inventory](/en/tutorial/warehouse--6oIxvsVDTtGpO7y6zwhGpb) updates occur when a store changes the quantity of units of an SKU. This update occurs via **[Inventory](/en/tutorial/managing-stock-items--tutorials_139)** on the VTEX platform.
...
2. Search for a product or combine filters to find the items you want. Learn more about how to use the filters in the article [Inventory management](/en/tutorial/managing-stock-items--tutorials_139#filters).  
