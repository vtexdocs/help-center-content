...
>⚠️ The [total shipping cost](https://help.vtex.com/en/tutorial/total-shipping-cost--5bwhIO108VA5Y2YOpef9lV) to the customer includes the shipping rate, [additional shipping costs](https://help.vtex.com/en/tutorial/additional-shipping-costs--2vqGwMn0LabkOHY6zSHYNV) and, a loading dock fee.

![Tarifa envio EN](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Shipping/Shipping%20rates/shipping-rates_1.svg)
...
>⚠️ The **[shipping rate template**](https://help.vtex.com/en/tutorial/shipping-rate-template--tutorials_127) is the only option for configuring the location polygon (geolocation), the **insurance cost** and **additional shipping costs**.

>ℹ️ If you need to update or add multiple shipping rates, we recommend using the [shipping rate template](https://help.vtex.com/en/tutorial/shipping-rate-template--tutorials_127) instead of the **Shipping rates** module. If you want to check out how shipping rates are added and displayed to the end customer, use the **[Shipping simulator**](https://help.vtex.com/en/tutorial/shipping-simulation--tutorials_144) module.
