...
To configure Live Desk preferences, go to **Settings > Live Desk**. Learn more in the article [Configure Live Desk](https://help.vtex.com/en/docs/tutorials/configure-live-desk).
...
> ⚠️ To display the CSAT widget, it must be native in at least one of the project's departments. If it's not active, you need to click the `Activate` button and activate it in a department. For more information about departments, read the article [Configure Live Desk](https://help.vtex.com/en/docs/tutorials/configure-live-desk).
...
To learn how to add, remove, or edit custom breaks, read the article [Configure Live Desk](https://help.vtex.com/en/docs/tutorials/configure-live-desk).
