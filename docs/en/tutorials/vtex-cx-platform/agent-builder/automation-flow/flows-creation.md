...
2. Once you're on the flows page, click the "Create Flow" button on the left side of the screen.
...
- **Type** : A required field that defines the method used by your flow.
