...
This article presents the official VTEX CX Platform agents and the credentials necessary to assign them to a team in Agent Builder. For more information on how to configure the agents in your store, see [Assigning and testing agents](https://help.vtex.com/docs/tutorials/assigning-and-testing-agents-in-agent-builder).
