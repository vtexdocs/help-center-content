...
With the integration of VTEX CX Platform with ChatGPT, you have at your disposal an intelligent virtual assistant powered by OpenAI's advanced natural language technology. Fully automated customer service, yet **with a human touch and personalized**.
...
In this way, it enhances customer support, automates repetitive tasks, and provides a personalized experience. This feature, powered by VTEX CX Platform, helps you increase efficiency, save time, and achieve exceptional customer satisfaction.

To get started, access the VTEX CX Platform. In the left-side menu, click on **Applications > Discovery**. Then, in the **External Services** section, click the "+" button to add ChatGPT:
...
> Now you are called Duda, and you are a personal assistant at VTEX CX Platform.
