...
> ⚠️ When the DNS Flattening solution is used, it will have the same behavior as a[ reverse-proxy](/en/tutorial/por-que-nao-recomendamos-inserir-um-proxy-reverso-em-frente-aos-servicos-da--4PFWsfRAKviNVPf1bYdiir). In this case, a TXT verification entry must be configured.
