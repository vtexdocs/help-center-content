...
Replace `{hostname}` with your store's [subdomain, domain, and top-level domain](/en/docs/tutorials/configuring-the-store-domain). Example: `www.mystore.com`. Make sure to include the underscore (`_`) before the hostname.
