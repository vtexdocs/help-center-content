...
Replace `{hostname}` with your store's [subdomain, domain, and top-level domain](/en/tutorial/configurar-o-dominio-da-loja--tutorials_2450). Example: `www.mystore.com`. Make sure to include the underscore (`_`) before the hostname.
