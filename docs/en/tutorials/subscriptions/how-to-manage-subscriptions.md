...
To see how to configure the **Subscriptions** functionality in your store, read [this article](/en/docs/tutorials/how-to-configure-subscriptions).
...
![EN Dashboard Assinatura única](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/how-to-manage-subscriptions_1.png)
...
![EN Dashboard Pedidos Assinatura](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/how-to-manage-subscriptions_2.png)
...
- In addition to listing the details of the errors that occurred during the Subscription orders flow, it is also possible to perform a **manual retry** of orders with errors. Check out our article on [Troubleshooting of Subscription orders issues](/en/docs/tutorials/troubleshooting-errors-in-subscription-orders) to learn more.

![EN Log Pedidos Assinatura](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/how-to-manage-subscriptions_3.png)
