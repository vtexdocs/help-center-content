...
![cicloscomproblema EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/troubleshooting-errors-in-subscription-orders_1.png)
...
![errosdepagamento EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/troubleshooting-errors-in-subscription-orders_2.png)
...
4. Identify the order you want to analyze and click on its ID, as illustrated in the image below. You will be redirected to the order details page in the **All Orders** module.
  ![EN Log Erro de pagamento](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/subscriptions/troubleshooting-errors-in-subscription-orders_3.png)
