...
To install the Subscriptions module, open a request with [our Support](https://help.vtex.com/support), indicate the name of your VTEX account, and select the **Technical** option.

The request is expected to be answered within 24 hours, following [our service SLA](https://help.vtex.com/pt/tutorial/como-funciona-o-suporte-da-vtex--2eAT5EyOvaLoHdIWDVaxC3#support-plans).
