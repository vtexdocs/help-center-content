...
> ℹ️ If you use the **Subscriptions** module in the VTEX Admin, we recommend creating a subscription plan through this module. For more information, see the article [Creating a subscription plan](/en/docs/tutorials/creating-a-subscription-plan).

[Subscriptions](/en/docs/tutorials/how-subscriptions-work) is the VTEX solution that allows merchants to sell to subscribing customers on a recurring, automatic basis based on a specified frequency.

There are two ways your store's products can be purchased via subscription:

* Creating [subscription plans](/en/docs/tutorials/creating-a-subscription-plan) via the **Subscriptions** module.
...
* [How subscriptions work](/en/docs/tutorials/how-subscriptions-work)
