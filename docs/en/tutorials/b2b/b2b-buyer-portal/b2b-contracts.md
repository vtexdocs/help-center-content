...
Contracts are stored in the `CL` data entity of [Master Data v1](https://help.vtex.com/docs/tutorials/master-data). This is the same entity that stores buyer information in B2C scenarios; however, for B2B contracts, it follows specifications that enable the [B2B Buyer Portal](https://help.vtex.com/en/docs/tutorials/b2b-buyer-portal) feature.
