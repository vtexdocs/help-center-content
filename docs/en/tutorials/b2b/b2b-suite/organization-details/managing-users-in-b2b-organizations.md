---
title: 'Managing users in B2B organizations (B2B Suite)'
...
<ol>
    ...
    <li>Complete the user information as shown below:
        <ul>
            ...
            <li>**Role:** Role that the user will have in the store. See more details on the available roles in the [Permissions management in B2B Suite documentation](/en/docs/tutorials/permissions-management-in-b2b-suite).</li>
        </ul>
    </li>
    <li>Click `Save`.</li>
</ol>
