...
| [VTEX Intelligent Search](https://developers.vtex.com/vtex-developer-docs/docs/search) | It enables product searches (only available for stores developed with VTEX IO).                                                                                                                                                          |
