...
- **[White label seller](/en/docs/tutorials/white-label-seller):** The seller remains unknown to the customer during their shopping experience and is automatically selected by the VTEX platform to deliver the order. 

> ℹ️ At VTEX, a franchise account is associated with a main account, and it acts as a white label seller of the main account. This business model is strategic for retailers who want to connect physical stores to their digital sales channel. Learn more in [What is a franchise account?](/en/docs/tutorials/what-is-a-franchise-account).
...
When a customer is browsing the marketplace from an undefined location, only the products in the inventory of the main seller, also called Seller 1, and of the [comprehensive sellers](/en/docs/tutorials/comprehensive-seller) will be displayed. A seller must be configured as comprehensive when it is able to ship orders to all regions covered by the marketplace operation. In cases of more than one comprehensive seller, the checkout selects the one with the highest amount in stock for the item in question, among all comprehensive sellers.

### Window display when customer location is defined

When the marketplace has access to the customer's location, either through captured geolocation or customer provided data, the VTEX platform queries for all the sellers covering that specific region to display the product price and availability in the window display and select the seller offering the lowest price. Learn more in [Setting up price and availability of SKUs by Region](/en/docs/tutorials/setting-up-price-and-availability-of-skus-by-region).
...
As long as the marketplace doesn't know the customer’s location, product availability and price are limited to the ones offered by the main seller and the [comprehensive sellers](/en/docs/tutorials/comprehensive-seller). A seller must be configured as comprehensive when it is able to ship orders to all regions covered by the marketplace operation. In cases of more than one comprehensive seller, the checkout selects the one with the highest amount in stock for the item in question, among all comprehensive sellers.
...
- Cheapest cost in the [shipping rate template](/en/docs/tutorials/shipping-rate-template) of the seller's [shipping policy](/en/docs/tutorials/shipping-policy).
...
- [Pickup](#shipping-method-pickup): the customer picks up the order from a [pickup point](/en/docs/tutorials/pickup-points).
...
2. The sellers who ship at least one item from the SKU list in the customer's region are selected. Sellers who don't have in their [inventory](/en/docs/tutorials/managing-stock-items) all the units of at least one SKU are disregarded.
...
A customer added five SKUs to the shopping cart. Each of the sellers delivering in the customer's region (sellers A, B, C, and D) has only part of the ordered items in [stock](/en/docs/tutorials/managing-stock-items), as illustrated below: 

![print_selecao_seller_white_label_1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/omnichannel/omnichannel-overview/white-label-sellers-selection_1.png)
...
![print_selecao_seller_white_label_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/omnichannel/omnichannel-overview/white-label-sellers-selection_2.png)
...
A customer added five SKUs to the shopping cart and there are four sellers delivering in their region: sellers A, B, C, and D. None of them has all of the items in [stock](/en/docs/tutorials/managing-stock-items), as illustrated below:

![print_selecao_seller_white_label_3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/omnichannel/omnichannel-overview/white-label-sellers-selection_3.png)
...
![print_selecao_seller_white_label_4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/omnichannel/omnichannel-overview/white-label-sellers-selection_4.png)
...
![print_selecao_seller_white_label_5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/omnichannel/omnichannel-overview/white-label-sellers-selection_5.png)
...
The selection of up to six sellers is made for the customer to get all shopping cart items from a single [pickup point](/en/docs/tutorials/pickup-points). The selection follows the steps below:
...
- Choose a [pickup point](/en/docs/tutorials/pickup-points) if they decide to pick up the order.
