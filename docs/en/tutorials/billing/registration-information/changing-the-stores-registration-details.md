...
To do this, you need to open a [ticket](https://supporticket.vtex.com/support) communicating your decision to the Financial team and select the option corresponding to the one that you want to change. For example, ["Amendment of CNPJ - Transfer of Contractual Liability"](/en/docs/tutorials/how-do-i-change-my-cnpj-new).
