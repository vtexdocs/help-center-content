...
> ℹ️ Section information *Most searched terms* and *Search suggestions* are updated daily using the data from the last 14 days of the customers' interaction with the search.
