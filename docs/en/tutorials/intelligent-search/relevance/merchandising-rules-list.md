...
There are two types of editor to create or modify Merchandising rules: the [Manual Editor](/en/docs/tutorials/creating-merchandising-rules-manual-editor) and the [Visual Editor](/en/docs/tutorials/creating-merchandising-rules-visual-editor).
