...
> ℹ️ The data displayed in the report is limited to the top 10,000 search terms. If you want the complete search data for your store, you must [export the report](/en/docs/tutorials/analytics#exporting-reports).
