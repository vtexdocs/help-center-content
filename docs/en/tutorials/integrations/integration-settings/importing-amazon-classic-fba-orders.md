...
> ℹ️ You need to ensure that the [trade policy](https://help.vtex.com/pt/tutorial/como-funciona-uma-politica-comercial--6Xef8PZiFm40kg2STrMkMV) you choose is specifically for Amazon to guarantee that another integration will not use the inventory you create. 
