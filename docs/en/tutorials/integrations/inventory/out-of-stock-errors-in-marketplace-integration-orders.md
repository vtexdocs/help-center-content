...
- **Item not in collection or sales channel:** check if the SKU is marked correctly in the collection or sales channel defined for the marketplace. Learn more in the article [Associating SKUs with a sales channel](/en/docs/tutorials/associate-a-sku-to-a-trade-policy).
