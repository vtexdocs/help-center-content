...
> ℹ️ Once you have [configured the Price Divergence rule](/en/docs/tutorials/configuring-price-divergence-rule), it will apply to all marketplaces where you are a seller.
