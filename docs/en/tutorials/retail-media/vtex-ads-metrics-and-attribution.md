...
| **Revenue**                                             | Total revenue attributed directly to the ad. Considers sales of the advertised products only, excluding assisted sales.                                              | -                                         |
...
### Direct conversion and assisted sales
...
- **Assisted sale:** Sale of **another, non-advertised product** purchased in the same order and influenced by the ad. In other words, it's the revenue generated by items bought alongside the advertised product.

For example, an ad for sneakers leads the customer to buy the sneakers (direct conversion) and, in the same order, a pair of socks (assisted sale).
...
- **Direct revenue:** Revenue from direct conversions of the advertised product. Used as a counterpart to assisted revenue.
- **Assisted revenue:** Revenue generated by assisted sales, meaning other non-advertised products purchased in the same order influenced by the ad.
...
| **Assisted ROAS**     | Return on assisted revenue: Revenue from other products in the order that weren't the advertised one but were influenced by the ad, divided by the investment.                                                                       | Assisted revenue / Cost                                   |
| **Total ROAS**         | Total ROAS: Adds the direct revenue (advertised product) and the assisted revenue (other products in the same order). Measures the total campaign impact on the entire order. | (Direct revenue + Assisted revenue) / Cost |
...
Assisted sales metrics measure an ad's indirect impact on sales of other non-advertised products purchased in the same order.

| Metric               | What it measures                                                                                       | Formula |
| -------------------- | ------------------------------------------------------------------------------------------------------ | ------- |
| **Assisted orders**  | Number of orders with at least one assisted item.                                      | -       |
| **Assisted revenue** | Revenue from non-advertised products purchased in the same order influenced by the ad. | -       |
| **Assisted items**   | Number of assisted items sold.                                                         | -       |
