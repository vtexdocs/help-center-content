...
- [Campaign audiences](https://help.vtex.com/en/docs/tutorials/campaign-audiences)
- [Campaign audiences list](https://help.vtex.com/en/docs/tutorials/campaign-audiences-list)
- [Creating a campaign audience](https://help.vtex.com/en/docs/tutorials/creating-a-campaign-audience)
- [Creating a campaign promotion](https://help.vtex.com/en/docs/tutorials/campaign-promotion)
...
- [Creating a promotion for a customer cluster](https://help.vtex.com/en/docs/tutorials/creating-promotion-for-a-customer-cluster)
- [Regular Promotion](https://help.vtex.com/en/docs/tutorials/regular-promotion)
...
- [Configuring promotions for marketplaces](https://help.vtex.com/en/docs/tutorials/configuring-promotions-for-marketplaces)
- [Promotions Simulator ](https://help.vtex.com/en/docs/tutorials/promotions-simulator-beta)
...
- [How to create surcharges/taxes](https://help.vtex.com/en/docs/tutorials/creating-surchargestaxes)
- [Archiving rates/taxes](https://help.vtex.com/en/docs/tutorials/how-to-archive-ratestaxes)
- [Send the item price, with tax shown separately, to the Gateway or the ERP](https://help.vtex.com/en/docs/tutorials/send-item-price-with-tax-shown-separately)
