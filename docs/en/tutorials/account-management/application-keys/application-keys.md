...
To export the keys, go to _Account settings > Application keys_ and click the <span style="display: inline-block;"><img src="https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/account-management/application-keys/application-keys_4.png" alt="export-button"/> **Export**</span> button.
