...
In other words, the __account name__ identifies your account in VTEX and allows you to set up your stores. To do this, you must first define the [__store names__](/en/docs/tutorials/what-is-the-store-name) action which is performed in the [Account management](/en/docs/tutorials/account-management) page.
