...
For security reasons, only the [Sponsor user](/en/tutorial/what-is-the-master-user--3oPr7YuIkEYqUGmEqIMSEy) has access to Database Maintenance operations. If any other user tries to access this page, a message informing the account manager's email address will be displayed, and all buttons will become inactive.
