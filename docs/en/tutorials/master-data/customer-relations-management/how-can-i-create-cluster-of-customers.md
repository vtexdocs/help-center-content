...
<ol start="2">
    <li>The second step is to create this field in the form so that it is possible to view the data. [For that, see our manual.](https://help.vtex.com/en/tutorial/como-crio-um-campo-no-master-data)</li>
</ol>
