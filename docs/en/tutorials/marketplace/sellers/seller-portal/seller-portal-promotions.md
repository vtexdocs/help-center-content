...
![seller-portal-promo-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/marketplace/sellers/seller-portal/seller-portal-promotions_1.png)
...
To create a new promotion, click the `Create Promotion` button. For more information, read the guide [Seller Portal: Creating a promotion](/en/docs/tutorials/seller-portal-creating-a-promotion).
...
By default, the maximum number of active promotions is 100. If you need to increase this limit, please contact [our Support](https://support.vtex.com/hc/en-us/requests) team.
 ...
 ![seller-portal-promo-ativas-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/marketplace/sellers/seller-portal/seller-portal-promotions_2.png)
