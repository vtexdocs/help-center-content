---
title: 'License Manager resources - Suggestion'
...
<table class="w-100 center mv7 bb b--gray" style="border-spacing: 0px; border-collapse: collapse;">
  ...
  <tr class="bb b--muted-3">
   ...
   <td class="t-body pa5" style="min-width: 15rem;">Unrestricted access to all components of the SKUs page received, including viewing page data, as well as ad approval actions. 
   </td>
  </tr>
</table>
