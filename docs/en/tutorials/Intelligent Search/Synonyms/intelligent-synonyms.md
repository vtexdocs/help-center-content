...
<div class="alert alert-info">
  <p>This feature is available for accounts that have at least 100,000 monthly searches so that the artificial intelligence model can be trained. To check the number of monthly searches in your store, in the VTEX Admin, go to <em>Storefront > Intelligent Search > Analytics</em> and filter by the last 30 days. If you’re interested in implementing Intelligent Synonyms, please contact <a href="https://support.vtex.com/hc/pt-br/requests">our support</a>. Additional fees may apply in the future.</p>
</div>
...
![synonym-suggestion-list-es](https://images.ctfassets.net/alneenqid6w5/YxS5i9kNqByGvZkPXyioK/abd9312a5c10df0cfd77e01effd2225b/synonym-suggestion-list-es.png)
