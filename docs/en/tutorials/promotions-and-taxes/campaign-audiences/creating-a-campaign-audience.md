...
Configuring the target audience allows you to segment users based on specific conditions. For more information on the target audience for campaign audiences, please read the article [Campaign audience](/en/docs/tutorials/campaign-audiences).
