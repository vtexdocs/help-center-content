...
To find a specific coupon, use the search field. You can search by coupon code, by [UTM source](/en/docs/tutorials/what-are-utm-source-utm-campaign-and-utm-medium) or by [UTM campaign](/en/docs/tutorials/what-are-utm-source-utm-campaign-and-utm-medium).
...
2. Select the filter you want to use:
   ...
   * **Coupon type:** Indicates if it is a single coupon or a coupon batch. For a better understanding of different coupon types, please read [Coupons](/en/docs/tutorials/coupons-beta).
...
| `type` | Indicates whether it is a `single` coupon or a coupon `batch`. For more information on each coupon type, please refer to [Coupons](/en/docs/tutorials/coupons-beta). To learn how to export the codes generated in a coupon batch, please read [Exporting coupon batch codes](#exporting-coupon-batch-codes). |
...
* **Coupon type:** Indicates if it is a [single coupon or a coupon batch](/en/docs/tutorials/coupons-beta).
* **UTM source:** Indicates the [UTM source](/en/docs/tutorials/what-are-utm-source-utm-campaign-and-utm-medium) linked to the coupon, if any.
* **UTM campaign:** Indicates the [UTM campaign](/en/docs/tutorials/what-are-utm-source-utm-campaign-and-utm-medium) linked to the coupon, if any.
