...
Moreover, at checkout, the information is hidden using a certified payment security standard [PCI-DSS](/en/tutorial/what-is-the-pci-ssc--4jo3Vkox3amSO2w4qIWa0E#). According to this standard, the last digits of a card do not need to be hidden. The displayed information allows recognizing the payment method, but it's not enough for making a purchase.
