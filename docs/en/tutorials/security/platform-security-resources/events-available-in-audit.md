...
| Action | Event description | Event details |
|---|---|---|
| DELIVERY_OPTION_CREATE | Creation of a delivery option. | Delivery option ID. |
| DELIVERY_OPTION_UPDATE | Update of a delivery option. | Delivery option ID. |
| DELIVERY_OPTION_DELETE | Deletion of a delivery option. | Delivery option ID. |
| DELIVERY_OPTION_UPDATE_ACCOUNT_CONFIG | Update of Delivery Options account settings, such as storefront display preferences. | Account name. |
| DELIVERY_OPTION_CHANGED_FILTER | Change in the delivery options used as storefront filters. | Delivery option ID. |
| DELIVERY_OPTION_AUTOGENERATE_CREATE | Automatic creation of a delivery option from a suggestion. | Delivery option ID. |
| DELIVERY_OPTION_AUTOGENERATE_UPDATE | Merchant update of an autogenerated delivery option, which then stops being treated as automatically generated. | Delivery option ID. |
