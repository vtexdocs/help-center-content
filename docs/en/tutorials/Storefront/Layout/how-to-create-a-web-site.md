...
1. In VTEX Admin, go to **Storefront > Layout**..
2. Click on **CMS > Sites and channels** and select **new website**.
...
| **Parent website** | Website to which your new website will be linked. If you don't want to link your website to another one, leave the field blank. |
| **Mobile website** | Mobile version of the website. If you do not want to create one, leave the field blank. |
| **Tablet website** | Tablet version of the website. If you do not want to create one, leave the field blank. |
