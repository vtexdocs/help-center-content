...
When the user performs a search in the store, VTEX system tries to bring results according to a priority order of filters. Understand the search in the article [How Legacy Search works](/en/docs/tutorials/how-does-legacy-search-work).
