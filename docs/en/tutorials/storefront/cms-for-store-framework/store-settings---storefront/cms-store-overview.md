...
![CMS Store](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/storefront/cms-for-store-framework/store-settings---storefront/cms-store-overview_1.png)
...
| PWA      | Configure your store's native Progressive Web App (PWA) to offer useful features to your clients, such as navigating your store offline and downloading your store website as an app. |

## Next steps

Check out the  tutorial below to start managing your storefront content:

- [Enabling PWA push notifications in your store](/docs/tutorials/enabling-pwa-push-notifications-in-your-store)
