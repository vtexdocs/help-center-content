...
5. In the **Font family** field, create a name for the font.
    ...
    ![familia-de-fontes-giff-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/storefront/cms-for-store-framework/styles/customizing-your-stores-typography_1.gif)
...
3. Click **Edit > Typography > Type tokens**.
    ...
    ![tokens-tipo-giff-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/storefront/cms-for-store-framework/styles/customizing-your-stores-typography_2.gif)
