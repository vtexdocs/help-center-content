...
After [creating a new content version in Site Editor](/docs/tutorials/managing-content-versions), you can schedule it to be published on your store by using the **Visibility** feature.
