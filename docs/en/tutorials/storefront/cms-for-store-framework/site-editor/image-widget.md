...
Image widget is a modal repository for blocks that allow image uploads in [Site Editor](/docs/tutorials/site-editor-subcategory). With this modal repository, you can upload, store, and manage your store’s images and use them on different pages, such as Home, Product, or Newsletter.
