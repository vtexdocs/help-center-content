...
> ℹ️ Before editing this template, you must [create the List Type](/en/docs/tutorials/creating-a-type-of-list) that will be offered in your store. <!--Reescrever o artigo de tipo de lista -->
