...
Requesting additional trade policies to integrate with certified marketplaces or other VTEX stores is free of charge. For more information, read our article [Marketplace strategies at VTEX](https://help.vtex.com/en/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402).

To request a trade policy for a sales channel outside the VTEX ecosystem, such as a marketplace for which there is no [native connector](https://help.vtex.com/en/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrating-with-a-native-connector-vtex)<span style="text-decoration:underline;">,</span> for example, follow the flow of [Requesting a trade policy for the international market](https://help.vtex.com/en/tutorial/contratacao-de-politica-comercial-adicional--61vuFOw4yGh6nwSmkLJL1X#requesting-a-trade-policy-for-the-international-market)
