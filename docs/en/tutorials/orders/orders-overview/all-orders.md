...
![Order Listing EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/orders/orders-overview/all-orders_1.gif)
...
The data in the file will be the content of the page at the time of export, including the filters applied. Learn more about each field in the report in [Order report](/en/docs/tutorials/order-report).
...
To learn more about all the filter options, read the article [Filtering orders on All Orders](/en/docs/tutorials/filtering-all-orders).
...
By selecting an order from the list, you will be redirected to the [Order details](/en/docs/tutorials/order-details-page) page.    

Learn more about each column.

* **Status:** indicates in which phase of the flow the order is. To learn more, read the article [Order flow and status](/en/docs/tutorials/order-flow-and-status).  
...
![VTEX Do overview EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/orders/orders-overview/all-orders_2.gif)

[VTEX DO](/en/docs/tutorials/vtex-do-interface) manages tasks automatically created by the VTEX Admin that require manual action by the ecommerce team. 
