...
After this procedure, the integration with the CSU is configured, and the Seller's [sponsor user](/en/docs/tutorials/what-is-the-sponsor-user) must request a reindexation of his catalog to accelerate the sending of the SKUs to CSU.
