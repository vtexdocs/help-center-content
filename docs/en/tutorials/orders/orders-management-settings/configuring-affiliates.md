...
At VTEX, the [affiliate](/en/docs/tutorials/what-is-an-affiliate) is an identification code of the marketplace for the seller. The [VTEX seller](/en/tutorial/integrating-with-marketplace/#being-a-vtex-seller) needs to configure an affiliate code in order to integrate with a [VTEX marketplace](/en/docs/tutorials/marketplace-strategies-at-vtex#being-a-vtex-marketplace), and this configuration is only necessary when both marketplace and seller are VTEX stores.

When the marketplace is not a VTEX store (as in [external integrations](/en/docs/tutorials/marketplace-strategies-at-vtex#integrating-with-an-external-marketplace)), or when the store integrates with a [certified marketplace](/en/docs/tutorials/marketplace-strategies-at-vtex#integrating-with-a-certified-marketplace) (such as Amazon or Mercado Livre), the affiliate code is automatically created by the platform.
...
> For [external marketplaces](/en/docs/tutorials/marketplace-strategies-at-vtex#integrating-with-an-external-marketplace), fill in the value: `https://{endpointDoAfiliado}/api/notification/`.   
