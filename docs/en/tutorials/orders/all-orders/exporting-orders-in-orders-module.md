...
In this process, the system generates a report in .csv format containing details about your store's orders. Find out what information is in the report in [our tutorial on the order spreadsheet fields](/en/docs/tutorials/order-report).
...
2. [Filter orders](/en/docs/tutorials/filtering-all-orders) considering the 50,000 limit.
3. Click the button `Export`, and a link with a file in .csv format will be sent to your [user](/en/docs/tutorials/managing-admin-users) email.
4. Open your email and download the link within 72 hours; the link will expire after that period.

## Related articles

- [What do the fields in the order spreadsheet mean?](/en/docs/tutorials/order-report)
- [Filtering orders in Orders Management](/en/docs/tutorials/filtering-all-orders)
