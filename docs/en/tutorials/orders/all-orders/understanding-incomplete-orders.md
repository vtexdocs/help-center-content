...
Whenever an order is not listed on the [All Orders](/en/docs/tutorials/all-orders) page with no filter, it may be incomplete.
...
On the **All Orders** page, the [filters](/en/docs/tutorials/filtering-all-orders) include the tab **Status**, with the **Completed Status** options. If you mark the option `Incomplete`, all orders in this situation will be displayed.
