...
Every action taken on an order is registered in the **Orders** module. To view this log, you must enter the [order details page](/en/docs/tutorials/order-details-page) and click `View Interactions`.
