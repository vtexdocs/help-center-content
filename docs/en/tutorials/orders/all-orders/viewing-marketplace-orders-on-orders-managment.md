...
In the [All Orders](/en/docs/tutorials/all-orders) page, the column **Order ID** shows the order identification code. Orders made in marketplaces have a sufix `-01`, for example.

On the column **Origin**, it is also written `Marketplace` when the order was made in one.

## Order details page

In the [order details page](/en/docs/tutorials/order-details-page), in the **Payment** section, it is possible to view the name of the merchant associated with the order. 
