...
One of the ways to find out if an order was successfully placed is to check whether its corresponding [transactional emails](/en/docs/tracks/how-message-center-works) have been sent to the customer. To do so, follow these steps:
