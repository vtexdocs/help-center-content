...
> ℹ️ You can change the [carrier](/en/docs/tutorials/carriers-on-vtex) associated with the order when registering the tax receipt tracking. To do so, in the **Order Tracking** section, click *Carrier* and select the desired option.
