...
One of the ways of finding out details of errors in orders is using the **Show interactions** link available on the [order details page](/en/docs/tutorials/order-details-page), that can be found as shown below:
