...
|:---:|:---:|
| **Data source** | Obtained from information in the [Audit](/en/tutorial/searching-for-events-on-audit--5RXf9WJ5YLFBcS8q8KcxTA). |
...
- **Most Used Gift Cards:** Combining this data model with [order](/en/tutorial/precos-data-pipeline-beta--3NMGJ8dtv73Bwvo9PSz1fz) data, you can understand how gift cards are being utilized and monitor their usage.  
- **Impact on Sales:** Similarly, combining with [order](/en/tutorial/precos-data-pipeline-beta--3NMGJ8dtv73Bwvo9PSz1fz) data allows you to assess how gift cards influence sales.  
