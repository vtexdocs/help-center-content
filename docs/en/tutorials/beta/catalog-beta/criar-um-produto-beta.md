...
1. Click the `+` button.![image8](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/beta/catalog-beta/criar-um-produto-beta_7.png)
2. Add the link to your image in the 🔗 field. You can add more than one image to your SKU. To do this, click `+ Add Image` and add the new link. ![image6](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/beta/catalog-beta/criar-um-produto-beta_8.png)
3. Click `Save`.
