...
> ❗ Every time you import a template including image information, the system uploads a new image for the SKU concerned. We advise you to be on the lookout for potential duplications. If you reimport a template with information previously sent to VTEX, the first image won't be overwritten during import: the image will be duplicated in the SKU registration.
...
> ℹ️ Special characters and accents are not allowed in this field. The **Label** and **TextoImagem** fields should have different values.
...
> ℹ️ This is a mandatory field. Special characters, accents or blank spaces are not admitted. The **Label** and **TextoImagem** fields should have different values.
...
The SKU ID is the code that identifies the SKU to which the image will be linked to. You can get this code by exporting **Products and SKUs**. For further information, read [How to export a product spreadsheet](/en/docs/tutorials/how-to-export-a-product-spreadsheet).
