---
title: "Understanding the Index Report"
...
The **Index Report** shows the indexing status of all products in the store.

![Indexingreport](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/catalog/catalog-reports/how-to-use-the-index-report_1.png)

> ℹ️ For more information, see [Understanding how indexing works](/en/docs/tutorials/understanding-how-indexation-works).
...
This implies, for example, that the current estimate is that it takes up to 3 minutes for a product to be indexed. This means that if you have 10 products to index, indexing takes about 3 minutes in total — not 3 minutes per product — because products are generally indexed in parallel.
