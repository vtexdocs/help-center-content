---
title: 'Including metadata when exporting a prices spreadsheet'
...
![2019 05 27 18 56 22 Price list.jpg?h=250](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/catalog/prices/price-list/how-to-include-metadata-when-exporting-a-prices-spreadsheet_1.png)
...
5. A new window will slide onto the screen, check the box next to **include metadata in exported tables**
6. Click on the blue **export table** button
![2019 05 27 18 57 59 Price list.jpg?h=250](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/catalog/prices/price-list/how-to-include-metadata-when-exporting-a-prices-spreadsheet_2.png)
