...
To make customer searches more accurate, Legacy Search engine ignores some terms that are very common. Some examples are the words "com" and "todo", from Portuguese, "that" and "with", from English, and "hace" and "uno", from Spanish. [See here the complete list of blocked terms](/en/faq/why-legacy-search-engine-ignores-some-terms).
...
Legacy Search engine returns several types of results, following the order of priority below:
