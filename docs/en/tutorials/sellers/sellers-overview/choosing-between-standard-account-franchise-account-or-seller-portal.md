...
- **Standard account:** It has all the VTEX platform module configurations and acts as a standard seller, known as [VTEX seller](/en/docs/tutorials/marketplace-strategies-at-vtex#being-a-vtex-seller).
...
| [Sales channel](/en/docs/tutorials/how-trade-policies-work) | A single sales channel is allowed. | [Multiple sales channels](/en/docs/tutorials/requesting-an-additional-trade-policy) are allowed. | A single sales channel is allowed. |
...
| Possibility of using [Manual Pricing](/en/docs/tutorials/telesales-features#manual-pricing) | Yes. | Yes. | Yes. |
