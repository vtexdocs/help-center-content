...
8. In the **Links** field, click `Add`.
    ...
    ![cms-layout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/vtex-admin/account-management/accounts/managing-a-multistore_1.png)
