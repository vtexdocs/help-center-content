...
> ℹ️ To change the contacts who receive the invoice and other financial communications, see the article [Changing the store's registration data](/en/docs/tutorials/changing-the-store-information).
