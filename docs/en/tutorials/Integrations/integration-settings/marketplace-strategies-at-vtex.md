...
Each integration with a marketplace needs to be linked to a [trade policy](https://help.vtex.com/en/tutorial/como-funciona-uma-politica-comercial--6Xef8PZiFm40kg2STrMkMV), because it is through the trade policy that you define the settings that will be applied to your products in that marketplace.
...
To [purchase additional trade policies](https://help.vtex.com/pt/tutorial/contratacao-de-politica-comercial-adicional--61vuFOw4yGh6nwSmkLJL1X), simply request it via a ticket in Support, selecting the **Commercial** option and the request type `Creation of Trade Policy`.
