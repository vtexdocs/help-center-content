...
3. Click the gear <i class="fas fa-cog"></i> next to **Profile System**:
   ...
   ![1-master-data-confidential-data-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_1.png)
4. In **Settings**, click **Data structure**.

   ![2-master-data-confidential-data-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_2.png)
5. Click the **Data Entities** tab.
6. In the data entity row, click the edit <i class="fas fa-edit"></i> button.

   ![3-master-data-confidential-data-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_3.png)
7. Click the gear icon <i class="fas fa-cog"></i> in the row of a field that contains confidential data.

   ![4-master-data-confidential-data-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_4.png)
8. Uncheck the following options:
   ...
   * **Allow filtering without credentials**
   ...
   ![5-master-data-confidential-data-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_5.png)
9. Click `Save`.
