...
![Facebook OAuth EN](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_1.PNG)
...
5. Click **Allow people to log in with their Facebook** account from the options shown below.
   ...
   ![2-login-fb-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_2.png)

6. Click `Next`.
7. Enter the app name and the email address of the person in charge of the app in the fields illustrated below.

   ![3-login-fb-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_3.png)
...
1.	Click **Products** in the side menu or the Meta for Developers **Dashboard**, as in the image below.
   ...
   ![4-login-fb-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_4.png)

2. Click `Configure` and select `Settings`.

   ![5-login-fb-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_5.png)

3. Set the options as in the image below:

   ![Configuração URI OAuth Facebook EN](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_6.png)
...
1.	In the Meta for Developers side menu, go to **App settings** and click **Basic:**
   ...
   ![7-login-fb-en](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_7.png)
