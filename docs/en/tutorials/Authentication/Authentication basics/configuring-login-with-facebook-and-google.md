...
2. Click **Account settings > Authentication**.
  ...
  ![List Authentication](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_1.png)
...
4. Complete the form with the `Client ID` and `Client Secret` from the [previous step](#obtaining-credentials-from-providers) and click `Save`.
  ...
  ![Facebook OAuth EN](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_2.PNG)
6. On the **Authentication** page, enable the provider by clicking the toggle switch.

  ![List Authentication Switch On Highlight](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_3.png)
