...
- Shopping cart (`cart.cart-item.after`, `cart.cart-list.after`) and checkout (`cart.order-summary.after`):
  ...
  ![extensibilidade_vtex_sales_app_1_cart_checkout_EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/vtex-sales-app/extensibilidade_vtex_sales_app_1_cart_checkout_EN.png)

- Product details page (`pdp.sidebar.before`, `pdp.sidebar.after`, `pdp.content.after`):

  ![extensibilidade_vtex_sales_app_4_pdp_EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/vtex-sales-app/extensibilidade_vtex_sales_app_4_pdp_EN.png)

- Menu (`menu.item`) and side modal (`menu.drawer-content`):

  ![extensibilidade_vtex_sales_app_2_menu_EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/vtex-sales-app/extensibilidade_vtex_sales_app_2_menu_EN.png)

  ![extensibilidade_vtex_sales_app_3_drawer_EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/vtex-sales-app/extensibilidade_vtex_sales_app_3_drawer_EN.png)
