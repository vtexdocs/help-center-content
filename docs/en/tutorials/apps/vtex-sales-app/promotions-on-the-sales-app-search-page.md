...
> ℹ️ If you want the promotion to be exclusive to Sales App, you need to configure a dedicated [sales channel](/en/docs/tutorials/how-trade-policies-work) for Sales App.
...
![promoção em destaque](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/vtex-sales-app/promotions-on-the-sales-app-search-page_1.png)
