...
![ls-cms](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_1.png)
...
![ls-livechat](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_2.png)
...
2. In the **Questions** section, create questions to be displayed to the audience using the `New question` button. You can choose between quizzes and polls, and define the time frame during which they will be displayed. The answers received will be stored in the same section.
  ![ls-question](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_3.png)
...
2. In the **Streaming Studio** section, select one of the following options:
  ...
  ![ls-profile](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_4.png)
...
2. In the **Products within collection** section, choose the desired products to show during the live stream by activating the `Actions` toggle.
  ![ls-products](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_5.png)
...
3. Change the event status to `Live` by enabling the `Turn on` toogle.
  ![ls-event-details](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_6.png)
...
5. Find the **Live Shopping** block in your storefront, based on the template you used, and select it.
  ![ls-transmission](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_7.png)
...
4. On the **Look and Feel** page, you will find two options: mobile and desktop. By selecting each option, you can configure and customize the components specific to those views, customizing both the products and chat sections of the Live Shopping player.
  ![ls-look-feel](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_8.png)
...
![ls-event-info](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_9.png)
...
2. Check out the engagement and sales KPIs related to the event as in the following:
  ![ls-analytics](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/apps/live-shopping/live-shopping-events_10.png)
