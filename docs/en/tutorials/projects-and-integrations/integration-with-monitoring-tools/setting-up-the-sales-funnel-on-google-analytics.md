...
> ⚠️ The funnel settings in this article have been updated to follow the new version of [SmartCheckout shared cart](/en/tutorial/what-is-the-shared-cart). For comparison purposes, see below the old settings: <ol> <li>Product: `/p($|\?)` (not required)</li> <li>Cart: `^/checkout/(#/cart)?$`</li> <li>Identification: `^/checkout/#/email`</li> <li>Personal Data: `^/checkout/#/profile`</li> <li>Delivery: `^/checkout/#/shipping`</li> <li>Payment: `^/checkout/#/payment`</li> </ol>
