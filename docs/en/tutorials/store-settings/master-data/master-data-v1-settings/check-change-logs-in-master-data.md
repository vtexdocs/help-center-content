...
At VTEX, logs function as a detailed account of changed made to an online store. Once the platform undergoes any configuration, the related information is stored on a databank called [Master Data](/en/docs/tutorials/master-data).
...
> ℹ️ In the lower right corner of the page in the "changelogs" option, you can select "show more logs". This option allows you to view a larger number of logs by page. However, each document has a limit of data that it can display per screen.
