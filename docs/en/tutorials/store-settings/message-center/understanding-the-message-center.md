...
![busca-templates-central-mensagens en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/store-settings/message-center/understanding-the-message-center_1.png)
