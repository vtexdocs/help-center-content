...
Ecommerce operations often involve integrating different systems and technologies. Keeping the [store architecture](/en/tracks/trilha-da-loja-vtex--eSDNk26pdvemF3XKM0nK9/4yPqZQyj0t675QpcG7H6yl#arquitetura-da-loja) documentation up-to-date is strategic for ensuring optimal performance from both the structure and the professionals involved.
...
* **Control app key permissions:** [App keys](/en/docs/tutorials/api-keys) used in integrations can also access your VTEX store. Please follow our [Best practices for using application keys](/en/docs/tutorials/best-practices-api-keys).
...
The VTEX platform architecture allows stores to act both as [marketplaces and sellers](/en/docs/tutorials/marketplace-strategies-at-vtex), and on [Marketplaces and Integrations](/en/docs/tutorials/marketplaces-and-integrations) they can discover and communicate with each other. In addition, VTEX offers native integrations with several [certified marketplaces](/en/docs/tutorials/marketplace-strategies-at-vtex#integrating-with-a-certified-marketplace) and [partners](/en/docs/tutorials/marketplace-strategies-at-vtex#integrating-with-marketplaces-partners) (such as Amazon and Mercado Libre).
