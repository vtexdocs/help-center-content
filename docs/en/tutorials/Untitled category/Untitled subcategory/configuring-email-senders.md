...
This step assures that emails sent by the store arrive to customers with the sender from being the store. It can be done even if the store doesn&#8217;t have an email server setup — we provide one for free.
