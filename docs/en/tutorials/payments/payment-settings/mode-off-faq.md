...
> ℹ️ If payment is made by [PIX (Brazilian instant payment method)](/pt/tutorial/configurar-pix-como-meio-de-pagamento--5sbNavMSJY4jyLmLKRHiOf) or the payment cancellation time is set between 5 minutes and 1 hour, retry calls will occur every 5 minutes.
