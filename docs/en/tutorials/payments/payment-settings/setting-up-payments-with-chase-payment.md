---
title: 'Setting up payments with Chase Payment'
id:
status: PUBLISHED
...
legacySlug: setting-up-payments-with-chase-payment
locale: en
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

At VTEX, it is possible to integrate with the Chase Payments payment provider. Through this provider, your store can make sales using through credit cards and  Apple Pay.

To configure Chase Payments, follow the steps below:

1. In the VTEX Admin, go to **Store Settings > Payment > Providers**, or type **Providers** in the search bar at the top of the page.
2. On the providers screen, click the `New Provider` button.
3. Type the name **ChasePayment** in the search bar and click on the name of the provider.
4. In **Provider Authorization**, fill in the **App key** and **App token** fields with data provided by your account Chase Payments.
5. If you wish to modify the identification name to be displayed for the Chase Payments provider on the VTEX Admin screen, enter the information in the **Name** field in **Basic Information**.
