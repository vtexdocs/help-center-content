...
To configure the payment methods to be processed by PayPalCheckout, access [Configuring Payment Conditions](/en/docs/tutorials/how-to-configure-payment-conditions).
