...
At VTEX, it is possible to integrate with the PagarMeV3 payment provider. With this provider, your store can make sales through credit, debit, private labels, cobranded cards, bank invoice, PIX and Safetypay.
...
To configure the payment methods to be processed by PagarMeV3, access [Configuring Payment Conditions](/en/tutorial/how-to-configure-payment-conditions--tutorials_455#).
