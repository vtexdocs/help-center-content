...
3. Type the name **PrometeoA2A** in the search bar and click on the name of the provider.
4. In **Provider Authorization**, fill in the **App key** and **App token** fields with with your Prometeo account information.
5. If you wish to modify the identification name to be displayed for the Prometeo provider on the VTEX Admin screen, enter the information in the **Name** field in **Basic Information**.
