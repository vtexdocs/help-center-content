...
Mundipagg offers a version of its [gateway](/en/docs/tutorials/what-is-a-payment-gateway) with anti-fraud functionality. Mundipagg Fraud Prevention brings even more security to the processing of purchases made with Boletos, bank transfers and major credit card brands.
