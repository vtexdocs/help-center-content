...
4. Fill in the __App key__ and __App token__ fields with data provided by ePayco.
...
To configure the payment methods to be processed by ePayco, access [Configuring Payment Conditions](/en/docs/tutorials/how-to-configure-payment-conditions).
