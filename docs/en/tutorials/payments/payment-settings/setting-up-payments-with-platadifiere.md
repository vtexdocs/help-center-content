---
title: 'Setting up payments with PlataDifiere'
...
At VTEX, it is possible to integrate with the PlataDifiere payment provider. With this provider, your store can make sales through PlataDifiere.

To configure PlataDifiere, follow the steps below:

1. In the VTEX Admin, go to **Store Settings > Payment > Providers**, or type **Providers** in the search bar at the top of the page.
2. On the providers screen, click the `New Provider` button.
3. Type the name **PlataDifiere** in the search bar and click on the name of the provider.
...
After following the indicated steps, PlataDifiere may take up to 10 minutes to appear at your store's checkout as a payment option.
