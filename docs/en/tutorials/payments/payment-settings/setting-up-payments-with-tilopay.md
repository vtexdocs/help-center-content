...
To configure the payment methods to be processed by Tilopay, access [Configuring Payment Conditions](/en/docs/tutorials/how-to-configure-payment-conditions).
