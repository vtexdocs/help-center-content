...
To learn how to add a new commercial condition, and link it to a SKU, read the document [Registering a commercial condition](/en/docs/tutorials/registering-a-commercial-condition).
