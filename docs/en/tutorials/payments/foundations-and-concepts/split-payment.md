...
To guarantee that our [marketplace](/en/docs/tutorials/what-is-a-marketplace) clients automatically divide the payment between all [sellers](/en/docs/tutorials/what-is-a-seller), set a commission based on a fixed percentage, and remain operating in accordance with current regulations, VTEX offers the __Split Payment__.
...
| __Payment providers integrated__       | See which payment providers use Payout Split in the [List of Payment Providers by Country](/en/docs/tutorials/list-of-payment-providers-by-country) | All payment providers integrated to VTEX.       |
...
![Payout Split](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/foundations-and-concepts/split-payment_1.png)
...
![Receivables](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/foundations-and-concepts/split-payment_2.png)
...
![Transaction Split](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/foundations-and-concepts/split-payment_3.png)
...
![Report](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/foundations-and-concepts/split-payment_4.png)
