...
When a banking institution wants to create new card profiles or issue new cards for an existing model, new BINs are required. This also applies when a card [brand](/en/docs/tutorials/what-is-a-credit-card-brand) is acquired by another.
