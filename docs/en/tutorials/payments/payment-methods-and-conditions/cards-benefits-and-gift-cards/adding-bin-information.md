...
![BIN_image_digits_EN_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/payment-methods-and-conditions/cards-benefits-and-gift-cards/adding-bin-information_1.png)

When a banking institution wants to create new card profiles or issue new cards for an existing model, new BINs are required. This also applies when a card [brand](/en/docs/tutorials/financial-agents-in-the-payment-flow#credit-card-brand) is acquired by another.
...
To add a new BIN or update an existing one on VTEX, please open a ticket with [VTEX Support](https://supporticket.vtex.com/support).
...
![Bin_spreadsheet](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/payment-methods-and-conditions/cards-benefits-and-gift-cards/adding-bin-information_2.PNG)
