...
Mundipagg offers a version of its [gateway](/en/docs/tutorials/financial-agents-in-the-payment-flow#gateway) with anti-fraud functionality. Mundipagg Fraud Prevention brings even more security to the processing of purchases made with Boletos, bank transfers and major credit card brands.
...
> ℹ️ The steps **8**, **9**, **11** and **12** must be completed if you want to offer Boleto as a payment condition in your store.
