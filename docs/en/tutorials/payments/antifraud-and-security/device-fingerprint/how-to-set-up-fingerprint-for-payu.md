...
3. Crete an “HTML Personalized” product with the following image:
  ![payU 1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_1.png)
...
<script>
   ...
   vtexjs.checkout.getOrderForm().done(function(orderForm){ // hala el valor de userProfileId
       ...
       document.getElementById('gtm').innerHTML = '<p style="background:url(https://maf.pagosonline.net/ws/fp?id='+deviceSessionId+'80200)">'+'<img src="https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_1.png"+deviceSessionId+'80200">';
...
![payU 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_2.png)

It is then necessary to continue on to advanced set up in accordance with the following image:
  ![payU 3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_3.png)

To set up the event, follow these steps:

1. Click on the tab More:
  ![payU 4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_4.png)
2. Create a personalized event:
  ![payU 5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_5.png)
3. Fill it in as follows:
  ![payU 6](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_6.png)
4. We save the event and subsequently save the tag (tag):
  ![payU 7](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_7.png)
5. Once the tag has been saved, it is necessary to publish it:
  ![payU 8](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_8.png)
...
![cms js](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_9.png)

__Attachment__: [md5.js](https://cdn.statically.io/gh/vtexdocs/help-center-content/files-migration-script/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/md5.js)
...
![payU 9](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-set-up-fingerprint-for-payu_10.png)
