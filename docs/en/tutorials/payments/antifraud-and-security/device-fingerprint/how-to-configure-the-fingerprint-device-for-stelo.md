...
2. Select **Configuração da tag** and then type **HTML personalizado**.![Tela1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-configure-the-fingerprint-device-for-stelo_1.jpg)
...
1. Click on **Acionamento**, Novo acionador (**+** symbol in the top right corner) and on **Configuração do acionador.**![Tela2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-configure-the-fingerprint-device-for-stelo_2.jpg)
2. Select **Evento personalizado** and enter the name **payment**.
2. Select the flag **Alguns eventos personalizados**.
3. In the first two boxes underneath, select: **Event** and **é igual a**. In the third one, type **payment**.![Tela3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-configure-the-fingerprint-device-for-stelo_3.jpg)
4. Save the trigger and the tag.
5. In the side menu, click on **Variáveis** and then **Nova**.
6. Click on **Configuração da variável** and select **JavaScript personalizado**.![Tela4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/payments/antifraud-and-security/device-fingerprint/how-to-configure-the-fingerprint-device-for-stelo_4.jpg)
