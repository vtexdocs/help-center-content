...
It's responsible for sending this information to acquirers, card brands and [issuing banks](/en/docs/tutorials/what-is-the-issuing-bank) then obtain a response about the continuation of the process or its cancellation. 
...
- [What is a connector?](/en/docs/tutorials/what-is-the-connector)
