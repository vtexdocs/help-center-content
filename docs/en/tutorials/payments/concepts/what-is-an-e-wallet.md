...
After the identity is confirmed and the payment method is chosen, the purchase returns to normal the flow and the order is completed. Some digital wallets also function as sub-acquirers, allowing even a non-registered person to be able to purchase through their environment.
