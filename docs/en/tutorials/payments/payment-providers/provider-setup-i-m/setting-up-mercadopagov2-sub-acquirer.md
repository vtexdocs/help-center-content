...
17. In __Modo de processamento__ ("Processing Mode"), choose how you want to use MercadoPagoV2: as a subacquirer (aggregator) or gateway. For more information, see [What is a sub-acquirer?](/en/docs/tutorials/financial-agents-in-the-payment-flow#sub-acquirer) and [What is a payment gateway?](/en/docs/tutorials/financial-agents-in-the-payment-flow#gateway).
...
To configure exclusive Mercado Pago payment methods, go to [setting up Mercado Pago Offline and Wallet as payment methods](/en/docs/tutorials/setting-up-offline-payment-conditions-using-mercadopago).
