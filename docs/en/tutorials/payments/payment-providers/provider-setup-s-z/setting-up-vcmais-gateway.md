...
On the VTEX platform, you may set up VC+ [gateway](/en/docs/tutorials/financial-agents-in-the-payment-flow#gateway) to receive payments through Notes Payable.
