...
- [Configure the DMN Url in the Cloud](#configuring-dmn-url-on-nuvei)
...
9.  To fill in the fields **Merchant Id**, **Merchant Site Id** and **Client Secret** (Secret Key), access the information available in **Settings > My Integration Settings** within the control panel of your account in the Nuvei environment.
    ...
    > ⚠️ Nuvei has specific credentials (Merchant Id, Merchant Site Id and Client Secret) for each type of environment. Access the test [Integration](https://sandbox.nuvei.com) and [Live](https://cpanel.nuvei.com) environments to identify the credentials relating to each of them.
