...
- __Receives newsletter?:__ Ensures compliance with the [rights of data subjects](/en/docs/tutorials/data-subject-rights), since only customers subscribed to the newsletter will receive abandoned cart emails. Subscription to your store's newsletter can be managed at checkout or in the [My Account](/en/docs/tutorials/how-my-account-works#perfil) section of your store. The trigger will be enabled if the value is true.
