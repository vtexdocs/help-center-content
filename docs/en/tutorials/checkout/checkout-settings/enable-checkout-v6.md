...
5. Click `Save`.
6. [Access your store in beta/test environment](/en/docs/tutorials/accessing-the-beta-environment) and implement the necessary style adjustments. Checkout v6 has new _CSS_ classes that you need to be mindful of when performing style customizations.
