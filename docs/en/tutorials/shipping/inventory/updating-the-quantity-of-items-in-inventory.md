...
[Inventory](/en/docs/tutorials/warehouse) updates occur when a store changes the quantity of units of an SKU. This update occurs via **[Inventory](/en/docs/tutorials/managing-stock-items)** on the VTEX platform.
