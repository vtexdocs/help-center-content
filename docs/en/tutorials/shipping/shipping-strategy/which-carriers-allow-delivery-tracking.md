...
As detailed [in this known issue](/en/known-issues/a-integracao-de-rastreamento-nao-esta-atualizando-de-forma-automatica), automatic tracking updates by integrated carriers **is currently disabled** on VTEX stores.
...
As detailed [in this known issue](/en/known-issues/atualizacao-automatica-do-rastreio-de-entregas-via-correios), native tracking integration with Correios is currently disabled.
