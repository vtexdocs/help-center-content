...
In the [All Orders](/en/tutorial/todos-os-pedidos--2QTduKHAJMFIZ3BAsi6Pi) page, the column **Order ID** shows the order identification code. Orders made in marketplaces have a sufix `-01`, for example.
...
- [Order flow and status](/en/tutorial/fluxo-e-status-de-pedidos--tutorials_196)
