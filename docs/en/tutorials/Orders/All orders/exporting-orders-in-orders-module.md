...
In this process, the system generates a report in .csv format containing details about your store's orders. Find out what information is in the report in [our tutorial on the order spreadsheet fields](/en/tutorial/orders-worksheet--31m1ewsmsEe0WS4So2aGMY).
...
2. [Filter orders](/en/tutorial/filtering-orders-in-oms--tutorials_192) considering the 50,000 limit.
3. Click the button `Export`, and a link with a file in .csv format will be sent to your [user](/en/tutorial/gerenciar-usuarios--tutorials_512) email.
4. Open your email and download the link within 72 hours; the link will expire after that period.

## Related articles

- [What do the fields in the order spreadsheet mean?](/en/tutorial/orders-worksheet--31m1ewsmsEe0WS4So2aGMY)
- [Filtering orders in Orders Management](/en/tutorial/filtering-orders-in-oms--tutorials_192)
