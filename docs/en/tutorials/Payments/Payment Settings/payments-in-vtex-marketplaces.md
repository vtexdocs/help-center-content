...
In this article, we will cover the different scenarios related to payments in[ VTEX marketplaces](https://help.vtex.com/en/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#ser-um-marketplace-vtex) and the configurations involved.
...
When you [Add a seller](https://help.vtex.com/en/tutorial/adicionar-seller--tutorials_392), the marketplace configures commissions by product, freight, or category for their orders. To configure commissions for your sellers, follow the steps below in the VTEX Admin.
...
For the marketplace system to process payments, you need to access the [Payments](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG) section in the VTEX environment and configure the following:

- [Gateway affiliations](https://help.vtex.com/en/tutorial/afiliacoes-de-gateway)  
- [Payment conditions](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG/6bzGxlz4inf8sKmvZ1c7i3)  
- [Payment connector](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG/7pAEMAo4iqNHwYOarZ3zgm)  
- [Anti-fraud solution](https://help.vtex.com/en/tutorial/como-configurar-antifraude--tutorials_446)  

To finish configuring a marketplace as the payment processor, when [Configuring an affiliate](https://help.vtex.com/en/tutorial/como-configurar-afiliado--tutorials_187), the **Use my payment method** option must be unchecked.

### VTEX Seller processing payments

For the seller's system to process payments, the seller needs to access the[ Payments](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG) section in the VTEX environment and configure the steps described in this article. This option also applies to physical stores registered as white label sellers.

- [Trade policies for marketplaces](https://help.vtex.com/en/tutorial/configurando-a-politica-comercial-para-marketplace--tutorials_404)  
- [Gateway affiliations](https://help.vtex.com/en/tutorial/afiliacoes-de-gateway)  
- [Payment conditions](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG/6bzGxlz4inf8sKmvZ1c7i3)  
- [Payment connector](https://help.vtex.com/en/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG/7pAEMAo4iqNHwYOarZ3zgm)  
- [Anti-fraud solution](https://help.vtex.com/en/tutorial/como-configurar-antifraude--tutorials_446)  

Once the Payments system is configured, when [Configuring an affiliate](https://help.vtex.com/en/tutorial/como-configurar-afiliado--tutorials_187) for the marketplace in question, the seller needs to select the **Use my payment method** option.
