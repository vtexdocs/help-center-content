...
At VTEX, it is possible to integrate with the VentiPay payment provider. With this provider, your store can make sales through the VentiPay.

To configure VentiPay, follow the steps below:
