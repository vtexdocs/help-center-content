...
3. Type the name __Scalapay Connector__ in the search bar and click on the name of the provider.
4. In __Provider Authorization__, fill in the __App Key__ and __App token__ fields with data provided by Scalapay.
5. If you wish to modify the identification name to be displayed for the Scalapay provider on the VTEX Admin screen, enter the information in the __Name__ field in __Basic Information__.
