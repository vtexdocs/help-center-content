...
<div class="alert alert-warning" role="alert">If your store is not a marketplace, read <a href="https://help.vtex.com/en/tutorial/setting-up-payments-with-easypay--3xJQqjMIn0ARDI1HcwK88J">Setting up payment with easypay</a> or <a href="https://help.vtex.com/en/tutorial/setting-up-payments-with-easypay-seller--5mYMCM1tiRiZO6PozuUncE">Setting up payments with easypay seller</a>.</div>
...
![easypay_pt_1](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_1.png)
...
<blockquote><ui>1. In the <a href="https://backoffice.easypay.pt/">easypay environment</a>, click the easypay logo in the top left corner of the screen and the arrow of the marketplace account.</ui>

![easypay_pt_10](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_2.PNG)

<blockquote><ui>2. Go to <b>Web Services > Configuration API 2.0 > Keys</b>.</ui>

<blockquote><ui>3. In the <b>Alias</b> menu, <b>Create Payment Details</b> option, click <b>Keys</b>.</ui>

![easypay_en_11](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_3.png)

<blockquote><ui>4. Copy and save the <b>ID</b> and <b>Key</b> information. To create a new key, click <b>+ New</b>.</ui>

![easypay_en_12](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_4.png)
...
![easypay_pt_5](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_5.PNG)

<blockquote><ui>2. Copy and save the <b>Account UID</b> information.</ui>

![easypay_en_6](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_6.png)

__Margin account UID__: identification of the margin account. 

1. In the side menu of the <a href="https://backoffice.easypay.pt/">easypay environment</a>, click __Beneficiary__.
2. Copy the information and save the __Account UID__ information available in __Margin Account__.

![easypay_en_13](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_7.png)

__Refund account ID and Refund account key__: easypay refund keys ID and value.

<blockquote><ui>1. In the <a href="https://backoffice.easypay.pt/">easypay environment</a> side menu, go to <b>Web Services > Configuration API 2.0 > Keys</b>.</ui>

<blockquote><ui>2. In the <b>Alias</b> menu, <b>Margin Account</b>, click <b>Keys</b>.</ui>

![easypay_en_14](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_8.png)

<blockquote><ui>3. Click <b>+ New</b>.</ui>

![easypay_en_15](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_9.png)

<blockquote><ui>4. Complete the <b>Name</b> field with the <b>Refund Account</b>.</ui>

![easypay_en_16](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_10.png)

<blockquote><ui>5. Click <b>Save</b>.</ui>

<blockquote><ui>6. Copy and save the <b>ID</b> and <b>Key</b> information.</ui>

![easypay_pt_17](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_11.png)

<div class="alert alert-warning" role="alert">Refunds are debited directly from a marketplace account. Later, the marketplace must request the refunded amount from the seller.</div>
...
![easypay_en_7](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_12.png)
...
![easypay_en_8](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_13.png)
...
<blockquote><ui>1. In the <a href="https://backoffice.easypay.pt/">easypay environment</a>, click the easypay logo in the top left corner of the screen, then click the arrow of the desired marketplace account.</ui>

![easypay_pt_2](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_14.PNG)
...
![easypay_en_9](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tutorials/Payments/Payment%20Settings/setting-up-payments-with-easypay-marketplace_15.png)

<div class="alert alert-warning" role="alert">If there is more than one payment account in your marketplace, add a link to each of the existing accounts.</div>
