...
To configure the payment methods to be processed by Stark Bank, access [Configuring Payment Conditions](/en/tutorial/how-to-configure-payment-conditions--tutorials_455#).
