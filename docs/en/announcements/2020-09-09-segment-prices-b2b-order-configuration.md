...
Regardless of the version of your store, check [our documentation](/en/tutorial/what-is-order-configuration--2t6UQoFrFSSGW8CGEbA0r5 "What is Order Configuration") to see how to start using the B2B Order Configuration app in your store.
