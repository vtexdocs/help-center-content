...
The pages for creating or editing [products and SKUs](/en/docs/tutorials/products-and-skus), previously in beta, are now in general availability (GA) for VTEX stores in all regions.
...
> ℹ️ For more information, see the following articles:<ul><li>[Products and SKUs](/en/docs/tutorials/products-and-skus)</li><li>[Adding or editing products](/en/docs/tutorials/adding-or-editing-products)</li><li>[Adding or editing SKUs](/en/docs/tutorials/adding-or-editing-skus)</li></ul>
