...
- **Shipping methods**: Requires a [role](/en/docs/tutorials/roles) with the [resource](/en/docs/tutorials/license-manager-resources) **LogisticsInternal**, related to the **Logistics** product.
- **Payment Methods**: Requires a [role](/en/docs/tutorials/roles) with the [resource](/en/docs/tutorials/license-manager-resources) **View Payment Data,** related to the **PCI Gateway** product.
