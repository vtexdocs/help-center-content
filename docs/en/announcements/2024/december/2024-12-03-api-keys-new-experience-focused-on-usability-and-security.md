...
We've introduced a new [API Key](/en/tutorial/api-keys) management experience to give you more efficient control over your credentials.
...
* [Configuring the duration of API keys](/en/tutorial/configuring-alerts-to-renew-api-tokens)  
