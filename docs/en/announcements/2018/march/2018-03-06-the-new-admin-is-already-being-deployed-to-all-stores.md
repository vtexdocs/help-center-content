...
If you can't wait to try the __new Admin__, type `https://{accountName}.myvtex.com/admin` in your browser, replacing `{accountName}` with your store's account name.
