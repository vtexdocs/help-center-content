...
- __How I do this__: Read our [catalog integration guide with external services](/en/docs/tutorials/integration-guide-consuming-catalog-information-for-use-in-an-external-service).
