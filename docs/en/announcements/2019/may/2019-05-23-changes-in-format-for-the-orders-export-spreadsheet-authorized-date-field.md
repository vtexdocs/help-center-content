...
Starting June 12<sup>th<sup>, 2019, we will change the format of the `Authorized Date` field, found in the [orders report](/en/docs/tutorials/exporting-orders-in-orders-module) which is exported from the Order Management module.
