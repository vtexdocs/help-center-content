...
> ℹ️ The workflow removal from the purchase closing critical path for Fulfillment orders has already been done. Read the following article for more on [fulfillment orders workflow removal.](/en/announcements/2019-06-12-discontinuation-of-order-completed-order-create-error-and-order-creation)
