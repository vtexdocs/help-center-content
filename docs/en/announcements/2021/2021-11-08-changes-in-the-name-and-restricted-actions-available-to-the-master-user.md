...
That is why each VTEX account has a single [Sponsor user](https://help.vtex.com/en/tutorial/what-is-the-sponsor-user) – the only one who is granted full access to every section in the Admin. If you are with us for a while now, you might have thought: 
...
![Sponsor management gif](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/announcements/2021/2021-11-08-changes-in-the-name-and-restricted-actions-available-to-the-master-user_1.gif)
...
Before, only the Sponsor user could create and manage appKey and appToken pairs for [API integration authentication](https://help.vtex.com/en/tutorial/application-keys--2iffYzlvvz4BDMr6WGUtet). Now, as announced in [Improvements in Application Key management](https://help.vtex.com/announcements/improvements-in-application-key-management--6DsPdiQ65RKNUNl7p93zHJ), the Sponsor user can delegate the responsibility of creating authentication credentials as needed, giving more flexibility to store owners.

## Learn more

* [What is the Sponsor user?](https://help.vtex.com/en/tutorial/what-is-the-sponsor-user)
* [Transferring store ownership](https://help.vtex.com/en/tutorial/transferring-store-ownership)
* [Authentication](https://help.vtex.com/en/tutorial/application-keys--2iffYzlvvz4BDMr6WGUtet)
