...
Check out the step-by-step instructions in the documentation [Configuring Stripe gateway affiliation](/en/docs/tutorials/configuring-stripe-gateway-affiliation).
