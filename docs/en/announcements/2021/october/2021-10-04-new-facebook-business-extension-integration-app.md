...
> ⚠️ Even if you have already configured the [Facebook Integration](/en/tracks/integracao-com-o-facebook--7h8KvIC4DbRRc8VlyJ8PFc), we recommend you to integrate your store with the *Facebook Business Extension and Conversions API* app. This will give you access to improved services and new features.
