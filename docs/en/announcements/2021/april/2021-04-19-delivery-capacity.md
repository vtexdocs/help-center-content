...
You can now configure the Delivery Capacity of your Shipping Policies to manage how many items or orders your store can deliver in each [Scheduled Delivery](/en/docs/tutorials/scheduled-delivery) window.
...
To learn how to configure it for your scheduled deliveries, read the article [Delivery Capacity](/en/docs/tutorials/managing-delivery-capacity).
