...
> ℹ️ You can request the new Subscriptions UI by contacting our customer [support](/en/docs/tutorials/opening-tickets-to-vtex-support). Your store needs to enable and install [Intelligent Search](/en/docs/tracks/overview-intelligent-search) in order to use the new UI.
