...
<div style="background-color:#FFF3CD; border-left: 2px solid #F0AD4E; border-top-left-radius: 2px; border-bottom-left-radius: 2px; padding-left: 10px">
  You must have an active Suiteshare account to use the application, as the integration identifier will be used when you implement it. To create an account, go to the [Suiteshare registration page](https://suiteshare.com/auth/signup).
</div>
