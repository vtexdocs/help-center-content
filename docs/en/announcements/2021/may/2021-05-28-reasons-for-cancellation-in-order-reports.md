...
Learn how to export orders in our tutorial [Exporting orders in Orders management](/en/docs/tutorials/exporting-orders-in-orders-module) and learn more about the report structure in our article[Order report](/en/docs/tutorials/order-report).
