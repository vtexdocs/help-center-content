...
<div class="alert alert-warning">
  The active functionality may impact the <b>Orders module</b>, considering that the standard is to display the delivery time grouped by the longest duration. This creates a discrepancy between what is shown in the VTEX Admin and what is presented to the customer.
</div>
