...
Go to the [VTEX App Store](https://apps.vtex.com/vtex-wishlist/p) and proceed to the app’s  step by step installation as highlighted in the [technical documentation](https://vtex.io/docs/components/all/vtex.wish-list@1.2.0/). 
