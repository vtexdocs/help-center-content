...
To define interest rates on Customer Credit, follow the standard flow [to configure a payment condition](/en/docs/tutorials/how-to-configure-payment-conditions).
...
For more details on Customer Credit, check out our [introductory track on this app](/en/docs/tutorials/customer-credit-overview).
