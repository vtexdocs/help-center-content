...
The login providers configuration screen in your VTEX store admin has a new interface. As of October 21st, you will be able to access the new interface in **Account Settings** > **Authentication** in your admin menu. For more information, read [this article](/en/tutorial/integracao-google-e-facebook-para-login--tutorials_513).
