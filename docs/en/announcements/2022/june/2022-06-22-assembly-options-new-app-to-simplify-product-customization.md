...
Customizing products is a common need in the online shopping experience. On the VTEX platform, you can customize products using [Assembly Options](/en/docs/tutorials/assembly-options) — [attachments](/en/docs/tutorials/what-is-an-attachment) for complex scenarios in which you need to manage different combinations of products, quantities, additional items and costs.
...
To simplify this feature, we developed the Assembly Options app, which provides an interface for configuring and managing custom options. The app is only available for stores using [VTEX IO](https://developers.vtex.com/docs/guides/store-framework).

![assembly-options-app-en](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/announcements/2022/june/2022-06-22-assembly-options-new-app-to-simplify-product-customization_1.PNG)

## What has changed?

Previously, you had to create Assembly Options manually in **Products > Catalog > Attachments**, as described in [Implementing Assembly Options](/en/docs/tutorials/assembly-options).
...
For more details on using this app in VTEX Admin, check out the article [Assembly Options app](/en/docs/tutorials/assembly-options-app).
