...
To help you navigate, we have created a [new Help Center](/en/v4) dedicated to the redesigned experience, where you will be able to access [help articles for the new pages](/en/docs/tutorials/vtex-admin-start-here) and keep track of the releases as we redesign the entire platform.
