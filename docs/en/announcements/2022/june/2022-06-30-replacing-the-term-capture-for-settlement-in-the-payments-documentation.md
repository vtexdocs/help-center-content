...
There is more information available about how settlement works in Payments in the article[ Transaction flow in Payments](/en/docs/tutorials/transaction-flow-in-payments).
