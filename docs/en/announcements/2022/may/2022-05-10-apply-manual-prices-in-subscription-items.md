...
When using [Subscriptions](/en/docs/tutorials/how-subscriptions-work) — the app developed by VTEX to facilitate recurring sales — merchants might need to configure a manual price for each item to provide better deals to recurrent shoppers. 
