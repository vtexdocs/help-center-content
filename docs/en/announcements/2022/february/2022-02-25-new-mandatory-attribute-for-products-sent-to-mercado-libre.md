...
When a VTEX store integrated with Mercado Livre wants to [send products](/en/docs/tracks/mapping-product-categories-and-attributes-to-mercado-libre) to the marketplace catalog, it must map the categories and attributes of these products.
