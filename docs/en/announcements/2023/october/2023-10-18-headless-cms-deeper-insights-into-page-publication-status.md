---
title: 'Headless CMS (Legacy): Deeper insights into page publication status'
...
announcementSynopsisEN: 'Publishing status on Headless CMS (Legacy) Pages will be discontinued in favor of Build Status for detailed deployment tracking.'
---

Starting November 1st, 2023, the **Publishing** status on Pages in the Headless CMS (Legacy) will be discontinued. Instead, you can track the deployment status of pages through the **Build Status** tool, as [previously announced](/en/announcements/2023-08-21-headless-cms-stay-informed-on-your-publication-progress). This tool offers a more detailed view of the deployment process of your pages.
...
Now, by integrating the Build Status tool with other systems like [Releases](/en/docs/tutorials/planner-releases-page-beta), WebOps, and [FastStore](https://www.faststore.dev/), the Headless CMS (Legacy) provides more comprehensive insights into the status of these systems.

## Why are we making this change?
The introduction of the Build Status tool aims to improve clarity and transparency in the deployment workflow.

## What needs to be done?
This feature will be implemented into the Headless CMS (Legacy) by November 1st, 2023, and no action is required on your side.
