...
Starting from May 31st, we are launching for all VTEX stores the beta version of the new **Shipping Strategy** interfaces, which consist of the [Shipping Policies](/en/docs/tutorials/shipping-policy), [Loading Docks](/en/docs/tutorials/loading-dock), and [Warehouses](/en/docs/tutorials/warehouse) pages.

The **Shipping Strategy** pages have been updated according to the new VTEX design system, as shown below:

![nova_estrategia_envio_announcement_boards_EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/announcements/2023/may/2023-05-31-introducing-the-new-shipping-strategy-interfaces_1.png)
...
* **New activation flow:** You can easily activate or deactivate your [shipping policies](/en/docs/tutorials/shipping-policy) by choosing the desired option in the menu <i class="fas fa-ellipsis-v"></i> in the shipping policy row.
