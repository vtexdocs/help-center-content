...
<div class = "alert alert-info">
  <p>The <b>Catalog Legacy</b> (previously <b>Catalog</b>) product remain active, but only give access to the old catalog management screens if they are still being used in your store.</p>
</div>
