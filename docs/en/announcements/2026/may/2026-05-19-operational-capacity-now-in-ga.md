...
![operational_capacity_image_1_PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/shipping/operational-capacity/operational-capacity_1.png)

## What has changed?

Previously available only in Beta, the Operational Capacity feature now includes significant infrastructure improvements, such as the ability to segment capacity by [sales channel](/en/docs/tutorials/how-trade-policies-work), making management more flexible and efficient.

## What needs to be done?

No action is required, as all VTEX stores in all regions have already been migrated to the globally available version. To start using this feature, enable the module in the VTEX Admin under **Shipping > Operational capacity**.
...
For more details, see the [Operational capacity](/en/docs/tutorials/operational-capacity) article.
