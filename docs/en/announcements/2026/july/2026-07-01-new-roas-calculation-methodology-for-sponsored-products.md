...
Before this update, the ROAS of sponsored product campaigns considered only conversions generated by click. Now, the calculation will also include conversions attributed to users who viewed the offer without clicking. The click conversion window can be seven or 14 days depending on the format, while view conversions use their own 1-day window.
