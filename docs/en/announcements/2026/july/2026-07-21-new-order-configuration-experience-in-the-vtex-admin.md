...
Accessing the page still requires the [License Manager](https://help.vtex.com/en/announcements/2025-10-21-new-license-manager-resources-order-configurations) resources: `Save Order Configuration` and `Save OrderForm Configuration`.
