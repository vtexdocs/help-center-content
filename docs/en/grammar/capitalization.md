...
| Do ✅ | Don't ❌ |
| --------- | ------------ |
| • Black Friday will be on November 24 <br> • Intelligent Search determines the relevance of each product by combining weights. <br> • Contact the VTEX Support team. <br> • Contact the Support team \- Short alternative option for \*VTEX Support team\*. <br> • Requesting a trade policy for the Brazilian market. <br> • Personal Shopper is available in the following languages: English, Spanish, Portuguese, French, and German. <br> • Export to Excel <br> • Install Intelligent Search <br> • VTEX App Store | • Black friday will be on november 24 <br> • Intelligent search determines the relevance of each product by combining weights. <br> • Contact the support team. <br> • Requesting a trade policy for the brazilian market. <br> • Personal Shopper is available in the following languages: english, spanish, portuguese, french, and german. <br> • Export to excel <br> • Install intelligent search <br> • VTEX app store |
...
| Do ✅ | Don't ❌ |
| --------- | ------------ |
| • VTEX <br> • VTEX <br> • SAP <br> • ServiceNow | • Vtex <br> • vtex <br> • Sap <br> • Servicenow |
...
| Do ✅ | Don't ❌ |
| --------- | ------------ |
| • To configure the easypay affiliation, follow the steps below: <br> • Checkout customization for easypay <br> • VTEX is the highest-ranked “Leader” | • To configure the Easypay affiliation, follow the steps below: <br> • easypay checkout customization <br> • Vtex is the highest-ranked “Leader” |
...
| Do ✅ | Don't ❌ |
| --------- | ------------ |
| • Edit <br> • Export file <br> • Import file | • edit <br> • export file <br> • import file |

| Do ✅ | Don't ❌ |
| --------- | ------------ |
| Filter by status: <br> • Confirmed <br> • Expired <br> • Handled | Filter by status: <br> • confirmed <br> • expired <br> • handled |
...
| Do ✅ | Don't ❌ |
| --------- | ------------ |
| On the \*\*Projects\*\* page, click \`Create new\`. <br> In the \*\*New project\*\* page, complete the fields. <br> After setting each field of the page, click \`Create\`.  | on the \*\*Projects\*\* page, click \`Create new\`. <br> in the \*\*New project\*\* page, complete the fields. <br> after setting each field of the page, click \`Create\`. |
