...
> For example, when you start an event, it won’t be finalized automatically after the mentioned time frame, but after you stop streaming it, if no new transmission begins within 1h30, then the event is finalized.
