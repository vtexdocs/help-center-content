...
5. On the **Stream method** page, in **Option 1 - Web Studio**, click `Open Web Studio`. You’ll be redirected to a new window on the **Device settings** page in Bundle. Restricted for administrators only.
