...
4. In the **EAN** field, fill in the barcode value.
5. Click `Save`.

>ℹ️ The **EAN** information can take up to 10 minutes to update. After this procedure, it will be possible to add the SKU to the **VTEX Sales App** cart through the barcode reader machine.
