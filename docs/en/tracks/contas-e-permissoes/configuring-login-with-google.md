...
3. Fill in the fields with the _Client Id_ and _Client Secret_ added to **Google**.
    ![Google OAuth](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/en/tracks/contas-e-permissoes/configuring-login-with-google_1.png)
