...
- __Amazon Seller Id*__: fill in the **seller ID** informed by Amazon at the step in which you [Authorize VTEX in your Amazon dashboard](/en/tracks/amazon-integration-setup--6sgd4Pagy3wNsWKBvmIFrP/43L0dpbjLBz6tcim1BbTzf). 
- __Amazon Auth Token*__: fill in the MWS authorization token provided by Amazon at the step in which you [Authorize VTEX in your Amazon dashboard](/en/tracks/amazon-integration-setup--6sgd4Pagy3wNsWKBvmIFrP/43L0dpbjLBz6tcim1BbTzf).
