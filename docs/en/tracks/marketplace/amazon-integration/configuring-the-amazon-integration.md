...
- __Sales Channel*__: the [sales channel](/en/tracks/configurar-integracao-com-a-amazon--6sgd4Pagy3wNsWKBvmIFrP/37hdzaRUhJqRfXH1bIRXAa#defining-the-trade-policy-in-amazon) that will define the catalog assortment and the prices of the items that will be sent to Amazon. 
...
- __Amazon Auth Token*__: fill in the MWS authorization token provided by Amazon at the step in which you [Authorize VTEX in your Amazon dashboard](/en/docs/tracks/amazon-account-settings).
