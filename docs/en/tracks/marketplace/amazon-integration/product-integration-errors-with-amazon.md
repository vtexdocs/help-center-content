...
- **The SKU you tried to submit is inactive on VTEX**
  ...
  The [SKU](/en/docs/tracks/sku-concept-definition) is not active on VTEX. Only active SKUs can be integrated. Sometimes this error is generated by old [collections](/en/docs/tutorials/how-to-delete-a-collection) linked to the Amazon sales channel that contain inactive SKUs.
