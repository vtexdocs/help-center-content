...
Once the integration with the _Meta Business Extension and Conversions API_ app is complete, in **VTEX Admin > Marketplace e Integrações > Facebook** you will have access to the commands to configure and manage new Facebook assets.
