...
> ⚠️ Once the price divergence rule is created, it is applied to all marketplaces where you act as a seller. These can be VTEX marketplaces, external marketplaces, <a href= "/en/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrating-with-a-certified-connector-partner">certified connectors (partners)</a>, and other <a href= "/en/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrating-with-a-native-connector-vtex">native connectors</a> besides Amazon.
