...
<br/>
To learn more about the financial agents involved in the payment flow, check out [this article](/en/docs/tutorials/financial-agents-in-the-payment-flow). <br/>
<br/>
