...
If you want to learn more about the concepts of gateway, acquirer, sub-acquirer, brand, issuing banks and anti-fraud, check out our [article on financial agents in the payment flow](/en/docs/tutorials/financial-agents-in-the-payment-flow).
