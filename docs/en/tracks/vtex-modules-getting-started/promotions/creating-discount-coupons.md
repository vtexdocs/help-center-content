...
> ℹ️ It is not necessary to create an `utm_source` and an `utm_campaign`, but it is necessary to create **at least one** of them.<br> Read the article [What are utm_source, utm_campaign, and utm_medium](/en/tutorial/what-are-utm-source-utm-campaign-and-utm-medium--2wTz7QJ8KUG6skGAoAQuii) to better understand what these UTMs are.
