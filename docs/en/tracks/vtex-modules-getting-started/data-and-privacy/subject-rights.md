...
To learn more, check the [Data subject rights](/en/tutorial/data-subject-rights--6imchxTx09icupKMbzHVIM) guide.
...
If you manage a VTEX store and need help erasing user data, see [Erasing customer data](/en/tutorial/erasing-customer-data--1R9Fn7A06Ifj4R9YD4JTKU). 

## Editing data

All your customers' personal data is editable on the[ My Account](/en/tutorial/how-my-account-works--2BQ3GiqhqGJTXsWVuio3Xh) page, except for their email addresses. In this case, you can delete the old profile and create a new one using a different email address.
