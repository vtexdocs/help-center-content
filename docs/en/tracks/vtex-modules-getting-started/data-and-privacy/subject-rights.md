...
To learn more, check the [Data subject rights](/en/docs/tutorials/data-subject-rights) guide.
...
If you manage a VTEX store and need help erasing user data, see [Erasing customer data](/en/docs/tutorials/erasing-customer-data). 

## Editing data

All your customers' personal data is editable on the[ My Account](/en/docs/tutorials/how-my-account-works) page, except for their email addresses. In this case, you can delete the old profile and create a new one using a different email address.
