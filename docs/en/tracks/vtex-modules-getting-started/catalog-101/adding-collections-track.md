...
4. Fill in the [Collection fields](/en/docs/tutorials/creating-collections-beta#campos-de-cadastro-de-colecao).
5. Click on `Create` to update the information filled in the form.
6. Then, [select the products](/en/docs/tutorials/creating-collections-beta#selecao-de-produtos) that will be part of the collection.
