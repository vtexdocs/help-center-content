...
> ⚠️ We recommended that you register holidays after configuring the [shipping strategies](/en/tutorial/shipping-strategy--58vLBDbjYVQzJ6rRc5QNz3).
...
> ℹ️ Shipping also depends on the [shipping cost](/en/tutorial/total-shipping-cost--5bwhIO108VA5Y2YOpef9lV) that your store offers to customers. This subject will be covered in the following articles. For more information about how carriers are chosen to for deliveries, read the article [ How shipping is calculated](/en/tutorial/hoy-shipping-calculation-works--tutorials_116).
