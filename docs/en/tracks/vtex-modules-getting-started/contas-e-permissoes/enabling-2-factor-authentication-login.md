...
> ℹ️ As some companies restrict the use of cell phones by telesales operators, users with the [ telesales role](/pt/tutorial/perfis-de-acesso--7HKK5Uau2H6wxE1rH5oRbc#call-center-operator) do not have to enable the 2FA when logging in with email and password.
