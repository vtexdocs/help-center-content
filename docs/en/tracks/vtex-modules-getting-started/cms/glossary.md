...
| Locale  | The binding locale to which you wish to apply content changes. For example, English (en-GB), Portuguese (pt-BR), and Spanish (es-AR). Related article: [Managing content per binding](/en/docs/tutorials/managing-content-per-binding) |
| Preview    | The preview mode allows you to view a version of your storefront content immediately in the [Site Editor](/en/docs/tutorials/site-editor-overview) module.|
