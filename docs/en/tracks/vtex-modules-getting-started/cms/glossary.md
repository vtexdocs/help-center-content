...
| Content version  | A block's version is a copy of its content at a specific point in time. For example, a Carousel may have predefined versions for future marketing campaigns, such as Black Friday and Valentine's Day, with banners of specific content. Related article:[Managing content versions](/en/tutorial/gerenciando-versoes-de-conteudo--4loXo98CZncY0NnjKrScbG).|
