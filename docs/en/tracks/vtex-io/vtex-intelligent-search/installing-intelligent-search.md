...
| Previous versions of `vtex.edition-store` | Not compatible with Intelligent Search. If you want to migrate to a compatible version, please contact [Support](https://help.vtex.com/en/support). |
| `vtex.edition-business@0.x` | Not compatible with Intelligent Search. If you want to migrate to a compatible version, please contact [Support](https://help.vtex.com/en/support). |
