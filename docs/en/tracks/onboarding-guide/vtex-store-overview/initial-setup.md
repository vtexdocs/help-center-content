...
* [MSA (Master Services Agreement)](https://vtex.com/en-us/trust/agreements) link.
...
If you already have a partnership with VTEX, the MSA can be found at the top of the Appendix 1 Order Form or on the [Agreements Archive page](https://vtex.com/en-us/trust/agreements-archive/), depending on the region and the date the Appendix 1 was signed.
...
[Authentication](https://developers.vtex.com/docs/guides/authentication) is essential in API integrations for connecting your VTEX account with external systems and for developing [apps for the VTEX platform](/en/tracks/vtex-store-overview--eSDNk26pdvemF3XKM0nK9/7euXDZR5CCnVFSrXyczIhu#extensions-and-apps). Authentication guarantees authorized user access to platform resources using credentials such as app keys or tokens.
