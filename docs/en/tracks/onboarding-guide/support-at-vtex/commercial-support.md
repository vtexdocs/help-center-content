...
Only the main account can request new environments, which can be for testing (QA), B2C, B2B, and others. This request is made through [VTEX Support](/en/support).
