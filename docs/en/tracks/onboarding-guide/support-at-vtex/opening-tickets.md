...
- [Commercial support](/en/docs/tracks/commercial-support): Request additional [sales channels](/en/tracks/suporte-na-vtex--4AXsGdGHqExp9ZkiNq9eMy/3KQWGgkPOwbFTPfBxL7YwZ#requesting-an-additional-trade-policy), [environments](/en/tracks/suporte-na-vtex--4AXsGdGHqExp9ZkiNq9eMy/3KQWGgkPOwbFTPfBxL7YwZ#requesting-a-new-environment), franchise accounts, or changes to the [main user](/en/docs/tutorials/what-is-the-sponsor-user).
