...
![Meta Business Extension](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/en/tracks/commerce-channels/marketplace/integration-with-meta-business-extension/interface-da-integracao-configurada_1.png)
...
You can remove the _Meta Business Extension and Conversions API_ app integration at any time. This must be performed in two steps: one via the VTEX Admin and one via the VTEX IO Toolbelt.

Uninstalling the app via the VTEX Admin interrupts the catalog synchronization and revokes your user access to the system created for the integration. This means that the integration will be deconfigured, but it can be reconfigured at any time. To do so, go to **VTEX Admin > Marketplace and Integrations > Facebook** and click on the **Uninstall** button. On the pop-up window, click on **Uninstall**.
...
- **Integration details:** redirects the user to the integration page of products sent to FBE. This page can also be found in _VTEX Admin > Marketplace and Integrations > Integrations > Products_.
