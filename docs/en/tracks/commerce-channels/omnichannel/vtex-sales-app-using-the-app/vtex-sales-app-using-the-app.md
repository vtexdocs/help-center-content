...
* **[VTEX Sales App - Getting started and setting up](/en/docs/tracks/vtex-sales-app-getting-started-and-setting-up)**: concepts, prerequisites and instructions for you to set up VTEX Sales App.
...
* **[VTEX Sales App - Using the app](/en/docs/tracks/vtex-sales-app-using-the-app)**: the VTEX Sales App app features and how to use them. **You are on this track.**
