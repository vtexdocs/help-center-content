...
These are examples of digital wallets you can configure in your VTEX store for making payments: [Google Pay](/en/docs/tracks/google-pay), [Apple Pay](/en/docs/tracks/apple-pay), [Samsung Pay](/en/docs/tutorials/configuring-samsung-pay-as-a-payment-method), [Paypal](/en/docs/tutorials/setting-up-payments-with-paypalv2), among others.
