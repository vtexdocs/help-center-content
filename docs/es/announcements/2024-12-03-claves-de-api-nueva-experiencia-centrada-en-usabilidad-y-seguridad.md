...
Presentamos la nueva experiencia de gestión de [claves de API](/es/tutorial/claves-de-api--4bFEmcHXgpNksoePchZyy6) que permite controlar las credenciales de forma más eficiente.
...
![apikeys-es](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/announcements/2024-12-03-claves-de-api-nueva-experiencia-centrada-en-usabilidad-y-seguridad_1.png)
...
* [Configurar la duración de las claves de API](/es/tutorial/configurar-la-duracion-de-las-claves-de-api--kcGIFysFt02FDuhsfjQwZ)  
