...
Existen múltiples opciones de [aprobación de SKUs Recibidos](/es/tutorial/manual-sku-cataloging--tutorials_396). Además de los endpoints que [activan y desactivan](/es/announcements/2020-10-26-marketplace-mejoras-en-el-modulo-skus-recibidos) la aprobación automática de SKUs en su *marketplace*, añadimos nuevos endpoints a nuestra API para configurar reglas de aprobación. La configuración puede ser aplicada a sellers específicos o a toda la cuenta del *marketplace*. La API permite configurar los siguientes campos:  
