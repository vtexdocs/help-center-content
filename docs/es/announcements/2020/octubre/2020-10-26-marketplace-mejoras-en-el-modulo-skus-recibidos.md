...
No se requiere ninguna configuración para activar esta funcionalidad, se instalará automáticamente en la plataforma VTEX. Para saber más sobre el bloqueo de SKUs, en el panel del módulo de SKUs recibidos, vea nuestro artículo sobre [Catalogación manual de SKUs](/es/docs/tutorials/catalogacion-manual-de-skus).
