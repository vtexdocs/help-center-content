...
## ¿Cómo funciona? 
Para definir intereses en Customer Credit, debe seguir el flujo predeterminado para [configurar una condición de pago](/es/docs/tutorials/condiciones-de-pago).
...
Para conocer más detalles sobre Customer Credit, consulte nuestra [guía introductoria sobre esa app](/es/docs/tutorials/customer-credit-vision-general).
