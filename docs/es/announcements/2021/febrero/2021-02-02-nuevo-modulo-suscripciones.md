...
La suscripción ahora consiste en una lista de SKUs y una configuración de compra determinada. Esto significa que eliminamos el concepto de «Grupos de suscripción» de nuestro sistema. Vea más información en nuestro artículo [Cómo funciona la suscripción](/es/docs/tutorials/como-funciona-suscripciones). El siguiente diagrama muestra el nuevo concepto de suscripción:  
...
> ℹ️ Solicita la nueva interfaz de Suscripciones a nuestro [soporte](/es/docs/tutorials/abrir-tickets-para-el-soporte-vtex). La tienda debe contar con la instalación de Search of Biggy ([Intelligent Search](/es/docs/tracks/vision-general-intelligent-search)) para activar la nueva interfaz.
