...
![Sales Perf Dash ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/announcements/2021/octubre/2021-10-19-nuevo-dashboard-desempeno-de-ventas_1.gif)
...
La página Desempeño de Ventas ya está disponible automáticamente en tu Admin VTEX. Para acceder a ella, en el menú lateral haz clic en **Analytics > Desempeño de Ventas**.  En algunas versiones del Admin VTEX, la página se encuentra en __Apps > Aplicaciones instaladas__. Descubre cómo sacar el máximo provecho del dashboard en el artículo [Desempeño de Ventas](/es/docs/tutorials/desempeno-de-ventas).
