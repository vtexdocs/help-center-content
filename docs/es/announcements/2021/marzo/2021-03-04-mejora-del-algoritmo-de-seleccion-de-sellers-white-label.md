...
> ⚠️ Atención: La actualización del algoritmo se aplica a Sellers White Label, e incluye a [Cuentas Franquicia](/es/docs/tutorials/seller-white-label). El algoritmo de selección de seller es aplicado cuando el cliente consulta las opciones de entrega. Esto significa que se aplica a la previsión de entrega en el carrito o en la etapa de entrega y recogida del checkout.
