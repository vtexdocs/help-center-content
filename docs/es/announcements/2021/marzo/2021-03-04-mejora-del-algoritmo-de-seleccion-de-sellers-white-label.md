...
> ⚠️ Atención: La actualización del algoritmo se aplica a Sellers White Label, e incluye a [Cuentas Franquicia](/es/tutorial/definicoes-de-conta-franquia-e-seller-white-label--5orlGHyDHGAYciQ64oEgKa). El algoritmo de selección de seller es aplicado cuando el cliente consulta las opciones de entrega. Esto significa que se aplica a la previsión de entrega en el carrito o en la etapa de entrega y recogida del checkout.
