...
> ⚠️ Para los [conectores nativos](/es/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrado-con-un-conector-nativo-vtex), aunque el seller no [configura la regla de Divergencia de precios](/es/tutorial/configuracao-da-regra-de-divergencia-de-valores--awAKP0sS5J8jgLs2g7pPe), se retienen los pedidos con divergencia de valores. Puede consultarlos en su VTEX Admin, en **MARKETPLACE > Integraciones > Pedidos**.
