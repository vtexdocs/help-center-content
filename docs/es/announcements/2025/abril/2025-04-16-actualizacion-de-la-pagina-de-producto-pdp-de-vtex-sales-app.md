...
Hemos actualizado la Página de Producto (PDP) de [VTEX Sales App](https://help.vtex.com/es/tracks/instore-usando-o-app--4BYzQIwyOHvnmnCYQgLzdr/6cq4E1JCmA6vCvBCCtAgIM) para mejorar la experiencia de navegación, facilitar la visualización de la información y optimizar las funcionalidades.
...
* **Envío y recogida:** presenta información clara sobre las opciones de envío y recogida según el código postal del cliente, con la posibilidad de ordenar los [puntos de recogida](https://help.vtex.com/es/tutorial/como-funcionam-pontos-de-retirada--2fljn6wLjn8M4lJHA6HP3R) por proximidad, costo o rapidez.
