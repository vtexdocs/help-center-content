...
Consulta las optimizaciones realizadas desde el lanzamiento de la [versión beta](/es/announcements/2024-09-25-nueva-pagina-para-agregar-productos-y-skus).
...
> ℹ️ Para más información, consulta los siguientes artículos:<ul><li>[Productos y SKUs](/es/docs/tutorials/productos-y-skus)</li><li>[Agregar o editar productos](/es/docs/tutorials/agregar-o-editar-productos)</li><li>[Agregar o editar SKUs](/es/docs/tutorials/agregar-o-editar-skus)</li></ul>
