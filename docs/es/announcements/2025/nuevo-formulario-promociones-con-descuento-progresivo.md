...
No se requiere ninguna acción para acceder al nuevo formulario. La actualización se aplicará a todas las tiendas VTEX automáticamente. Para conocer la nueva arquitectura de la página accede a [Cómo funciona la promoción Descuento progresivo](https://help.vtex.com/es/tutorial/desconto-progressivo--tutorials_324).
