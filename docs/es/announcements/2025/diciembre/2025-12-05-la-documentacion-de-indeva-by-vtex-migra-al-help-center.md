---
title: 'La documentación de Indeva by VTEX migra al Help Center'
status: PUBLISHED
...
Antes, la documentación de Indeva estaba disponible en el portal de Indeva. Ahora, ese portal fue descontinuado y todo el contenido se migró al VTEX Help Center, en la categoría **Indeva by VTEX**.

El contenido se ha reorganizado en subcategorías que reflejan los principales flujos y módulos de la plataforma, lo que facilita la navegación y la ubicación de la información.  

En el Help Center puedes consultar las siguientes subcategorías:

| Subcategoría | Descripción | Roles de usuario |
| ----- | ----- | ----- |
| [Información general Indeva](https://help.vtex.com/es/docs/tutorials/vision-general-indeva-subcategoria) | Introducción al producto y sus principales componentes. | Todos los roles |
| [Cuenta de usuario](https://help.vtex.com/es/docs/tutorials/cuenta-de-usuario-subcategoria) | Información sobre acceso, permisos y autenticación de accesos. | Gerentes y administradores |
| [Registro de colaboradores](https://help.vtex.com/es/docs/tutorials/cadastros-de-colaboradores-subcategoria) | Orientaciones sobre creación y gestión de roles de usuario. | Gerentes |
| [Tienda](https://help.vtex.com/es/docs/tutorials/loja-indeva-subcategoria) | Configuración y monitoreo de las unidades de venta. | Gerentes |
| [Tablet y seguimiento de vendedores](https://help.vtex.com/es/docs/tutorials/tableta-y-lista-del-turno-actual-subcategoria) | Control para definir el vendedor que atenderá al próximo cliente en puntos de venta físicos.  | Vendedores |
| [Vendedores](https://help.vtex.com/es/docs/tutorials/vendedores-subcategoria) | Gestión de metas, resultados y seguimiento del desempeño individual. | Vendedores |
| [Gerentes](https://help.vtex.com/es/docs/tutorials/gerentes-subcategoria) | Visión gerencial y consolidación de resultados por equipo. | Gerentes |
| [Metas](https://help.vtex.com/es/docs/tutorials/metas-subcategoria) | Visualización y seguimiento de los objetivos de ventas. | Gerentes y vendedores |
