...
Cuando una tienda VTEX integrada con Mercado Libre quiere [enviar sus productos](/es/docs/tracks/mapear-categorias-y-atributos-de-los-productos-para-mercado-libre-mapper) al catálogo del marketplace, debe mapear las categorías y atributos de estos productos.
...
Después de registrar el nuevo atributo, mapea la categoría y el atributo para enviar el producto a Mercado Libre. Para más información sobre este procedimiento, lee la guía [Enviar productos a Mercado Libre](/es/docs/tracks/mapear-categorias-y-atributos-de-los-productos-para-mercado-libre-mapper).
