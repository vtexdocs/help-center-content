...
A partir del 1 de febrero de 2023, la nueva interfaz del módulo **Todos los pedidos** será oficial en todas las tiendas VTEX globalmente. Si todavía utilizas la experiencia antigua, sugerimos consultar el artículo de [preguntas frecuentes](/es/docs/tutorials/preguntas-frecuentes-nueva-interfaz-modulo-pedidos), que aborda algunos de los principales puntos que pueden generar dudas.

Además de este cambio, la versión oficial de la interfaz introduce nuevas funcionalidades como la [búsqueda de pedidos sin límite de fecha](/es/docs/tutorials/filtrar-todos-los-pedidos), mediante la cual se puede buscar en todos los pedidos independientemente de la fecha de creación. Otra novedad es que ahora también es posible ver el diagrama del pedido.
...
* **Búsqueda de pedidos sin límite de fecha:** se puede buscar pedidos sin límite de fecha y ver todos los pedidos relacionados con el criterio utilizado, independientemente de la fecha de creación del pedido. Esta búsqueda no puede ser asociada a otros filtros. Sin embargo, puedes seleccionar un periodo de búsqueda personalizado de hasta seis meses y combinarlo con los filtros. Aprende más en el artículo [Filtrar pedidos en Todos los pedidos](/es/docs/tutorials/filtrar-todos-los-pedidos).
...
Después de esta fecha, no se podrá revertir a la versión antigua de la interfaz. Si no has utilizado la versión beta, algunas de las principales preguntas sobre la transición han sido respondidas en [Preguntas frecuentes sobre la nueva interfaz del módulo de pedidos](/es/docs/tutorials/preguntas-frecuentes-nueva-interfaz-modulo-pedidos).
