...
- Comprueba con el proveedor de pagos que has elegido si PSE ya está integrado en el conector del PPP ([Payment Provider Protocol](/es/docs/tutorials/payment-provider-protocol)). Si aún no está disponible, solicite al proveedor que realice la [configuración del conector](https://developers.vtex.com/docs/guides/pse-payment-method).
- En el [VTEX Support Portal](https://supporticket.vtex.com/support) solicita, a través de un ticket, la habilitación del medio de pago PSE e informa qué proveedor de pagos utilizará este medio.
- Instala y configura la aplicación Banks for PSE y configura PSE en tu tienda. Obtén más información en [Configurar el medio de pago PSE](/es/docs/tutorials/configurar-pago-con-pse).
