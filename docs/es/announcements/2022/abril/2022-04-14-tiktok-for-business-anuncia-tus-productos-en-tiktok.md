...
La aplicación es totalmente compatible con las tiendas que utilizan [VTEX IO](/es/docs/tracks/cms-vtex-io) y parcialmente compatible con las tiendas que utilizan [CMS Heredado](/es/docs/tracks/cms-portal-legado) o [CMS Headless](https://faststore.dev/tutorials/cms/0#vtex-headless-cms).
