...
Para entender más sobre el funcionamiento del feed, acceda a nuestro artículo sobre [cómo funciona el módulo de Gestión de Pedidos](/es/tutorial/como-funciona-el-feed-v3-del-modulo-de-gestion-de-pedidos--5SzSKee2f666YCoWkm0eQC).

Si desea utilizar la funcionalidad de Hook, acceda a nuestro artículo para obtener más información sobre [configuración y funcionamiento del Hook del Feed  v3](/es/tutorial/configurar-hook-del-feed-v3--6JkYQpIlU8ptysUiGIp4Px).
