---
title: 'Nueva metodología de cálculo de ROAS para productos patrocinados'
...
locale: es
announcementSynopsisES: 'A partir del 1 de julio de 2026, el cálculo del ROAS de productos patrocinados en VTEX Ads incluirá las conversiones por clic y por visualización, alineándose con los demás formatos de anuncio.'
tags:
  - Mejora
  - VTEX Ads
---
...
Antes de esta actualización, el ROAS de campañas de productos patrocinados solo consideraba conversiones generadas por clic, en una ventana de 7 días. Con el cambio, el cálculo también incluirá conversiones atribuidas a usuarios que vieron el anuncio sin hacer clic. La ventana de conversión por clic se mantiene en 7 días, mientras que las conversiones por visualización tendrán una ventana de un día.

La fórmula del ROAS consolidado se mantiene: ingresos atribuidos a clics y visualizaciones divididos por el costo total. El cambio afecta únicamente al numerador del ROAS de productos patrocinados, que ahora incluye ingresos atribuidos a visualizaciones.
...
La estandarización elimina la incoherencia metodológica entre formatos dentro de la misma plataforma y ofrece al anunciante una visión más completa del retorno real de la inversión publicitaria, ya que parte de las conversiones generadas por productos patrocinados ocurre después de la visualización del anuncio, sin un clic directo.
