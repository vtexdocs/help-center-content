...
Para más información sobre callback URL, consulta [Payment Provider Protocol](/es/docs/tutorials/payment-provider-protocol#callback-url) y [Create Payment endpoint](https://developers.vtex.com/docs/api-reference/payment-provider-protocol#post-/payments).
