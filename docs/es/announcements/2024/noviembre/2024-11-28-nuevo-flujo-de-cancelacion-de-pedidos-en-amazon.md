...
Antes, la integración no tenía un flujo automatizado, y los sellers debían realizar las cancelaciones manualmente a través del Admin de VTEX. Hasta que el pedido no se integraba con VTEX, los SKUs permanecían reservados, comprometiendo el [stock](/es/docs/tutorials/gestionar-items-en-inventario) de la tienda.  

Ahora, los [pedidos cancelados](/es/docs/tutorials/denegar-solicitud-de-cancelacion-del-pedido) en Amazon se cancelan automáticamente en VTEX, y los SKUs reservados se liberan, quedando disponibles para nuevas ventas. El nuevo flujo de cancelación es válido para cancelaciones realizadas tanto por el seller, por Amazon o por el cliente.  
