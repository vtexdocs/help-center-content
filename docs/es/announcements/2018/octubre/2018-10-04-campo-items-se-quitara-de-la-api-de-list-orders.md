...
<div class="alert">
Request de la API de List Orders: `http://{{accountName}}.{{environment}}.com.br/api/oms/pvt/orders`
</div>
...
<div class="alert">
Request de la API de Get Order: `http://{{accountName}}.{{environment}}.com.br/api/oms/pvt/orders/{{orderId}}`
</div>
