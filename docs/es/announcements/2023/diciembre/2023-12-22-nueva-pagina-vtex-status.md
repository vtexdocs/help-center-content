...
Consulta el artículo [Página VTEX Status](/es/docs/tutorials/pagina-vtex-status), para más información sobre cada componente.
...
Accede a la nueva página en [status.vtex.com](https://status.vtex.com/) y consulta la guía [Página VTEX Status](/es/docs/tutorials/pagina-vtex-status) para más información.
