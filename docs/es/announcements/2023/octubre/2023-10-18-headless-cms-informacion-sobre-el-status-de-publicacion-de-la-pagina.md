---
title: 'Headless CMS (Legacy): información sobre el status de publicación de la página'
...
announcementSynopsisES: 'Estado de publicación en Headless CMS (Legacy) se descontinuará a favor del Build Status para seguimiento detallado del deploy.'
---

A partir del 1 de noviembre de 2023, se descontinuará el estado **Publicando** en las páginas de Headless CMS (Legacy). En su lugar, puedes realizar un seguimiento del status del deploy de las páginas a través de la herramienta **Build Status**, como [ya habíamos anunciado](/es/announcements/2023-08-21-headless-cms-mantente-informado-sobre-el-progreso-de-tus-publicaciones). Esta herramienta ofrece una vista más detallada del proceso de deploy de tus páginas, manteniendo a los usuarios informados acerca de las fases de compilación (build).
...
Ahora, al integrar la herramienta Build Status con otros sistemas como [Releases](/es/docs/tutorials/planner-pagina-de-releases-beta), WebOps y [FastStore](https ://www.faststore.dev/), Headless CMS (Legacy) proporciona información más completa sobre el status de estos sistemas.
...
Esta funcionalidad se implementará en Headless CMS (Legacy) a partir del 1 de noviembre de 2023, y no requiere ninguna acción por tu parte.
