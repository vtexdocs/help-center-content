...
![order_global_search_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/announcements/2023/octubre/2023-10-17-barra-de-busqueda-global-del-admin-vtex-ahora-permite-buscar-pedidos_1.gif)

Al hacer clic en un resultado, se te redirigirá a la [página de detalles](/es/docs/tutorials/pagina-de-detalles-del-pedido) del pedido. Además, los últimos 10 pedidos buscados se registran como historial de búsquedas recientes para mayor facilidad de acceso. El registro de búsqueda se almacena a nivel de [usuario](/es/docs/tutorials/gestionar-usuarios-administradores) y no se comparte entre diferentes usuarios.

> ℹ️ Para acceder a los pedidos a través de la búsqueda global del Admin VTEX, el [rol](/es/docs/tutorials/roles) del usuario debe estar asociado al recurso **View order** (clave OMSViewier) del *Order Management System* (OMS).
