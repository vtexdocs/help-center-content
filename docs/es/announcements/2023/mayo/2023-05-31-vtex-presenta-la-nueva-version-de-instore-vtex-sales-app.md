...
La sección Desempeño de ventas permite al administrador de la tienda acceder a las métricas de ventas de su tienda, mostrando la comparación de desempeño entre periodos de ventas y también de los empleados. Más información en el artículo [VTEX Sales App: Rendimiento de Ventas](/es/docs/tutorials/sales-app-rendimiento-de-ventas).
