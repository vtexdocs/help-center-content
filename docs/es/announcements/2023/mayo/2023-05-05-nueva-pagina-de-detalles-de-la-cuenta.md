...
VTEX pone a tu disposición una nueva [página de detalles de cuenta](/es/docs/tutorials/gestion-de-la-cuenta), que ofrece una experiencia intuitiva y eficiente para tu operación.
...
La nueva [página de detalles de la cuenta](/es/docs/tutorials/gestion-de-la-cuenta) está disponible automáticamente para todas las cuentas. No se requiere ninguna acción.
