...
| [Promociones](/es/docs/tutorials/vision-general-promociones)                              | Gestión de promociones, cupones y campañas.                                                                                                 |
...
| [Envío](/es/docs/tutorials/vision-general-envio)                                         | Registro y control de los stocks, gestión de las tarifas de envío, control de la disponibilidad de los ítems y seguimiento de las entregas. |
...
| [Configuración de la tienda](/es/docs/tutorials/vision-general-configuraciones-de-la-tienda)   | Configuración de pagos, pedidos, plantillas de email, envío, productos, storefront, canales, Intelligent Search y calendario.               |
| [Configuración del usuario](/es/docs/tutorials/vision-general-configuraciones-de-usuario) | Configuración aplicada a tu tienda, que incluye tu storefront.                                                                              |
| [Configuración de la cuenta](/es/docs/tutorials/vision-general-configuraciones-de-la-cuenta)  | Configuración aplicada a tu perfil personal en el Admin, que no están relacionadas a tu tienda o cuenta de negocio en VTEX.                 |
| [Facturación](/es/docs/tutorials/vision-general-facturacion)                                | Gestión de todos los aspectos financieros de tu cuenta VTEX.                                                                                |

## ¿Por qué realizamos este cambio?

Nuestro objetivo es aportar coherencia a tu experiencia, reduciendo la complejidad innecesaria. Para lograrlo, estamos rediseñando varias partes de la experiencia e implementando cambios estructurales en la forma en que utilizas el Admin VTEX. La [nueva página de inicio](/es/docs/tutorials/vista-general-de-la-tienda) también se ha rediseñado para que actúe como un panel de control para toda tu operación comercial, con datos procesables que te ayuden a tomar decisiones.
