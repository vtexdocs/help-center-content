...
4. Remueve los roles conflictivos y concede únicamente los necesarios para las operaciones que el usuario realiza en la tienda, siguiendo las instrucciones para [Gestionar usuarios](/es/docs/tutorials/gestionar-usuarios-administradores#editar-usuarios).
