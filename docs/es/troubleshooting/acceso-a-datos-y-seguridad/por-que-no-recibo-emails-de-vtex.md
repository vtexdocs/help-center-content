...
En VTEX puede utilizarse el servidor de correo nativo o [configurar un servidor SMTP externo](/es/docs/tutorials/personalizando-el-smtp-de-vtex). Si utilizas un servidor SMTP externo, comprueba los escenarios que se indican a continuación.
...
![copia_email_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/troubleshooting/acceso-a-datos-y-seguridad/por-que-no-recibo-emails-de-vtex_1.png)
