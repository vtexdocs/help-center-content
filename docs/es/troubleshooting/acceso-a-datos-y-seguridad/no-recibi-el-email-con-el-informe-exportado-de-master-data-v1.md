...
5. Si el **Status** es **Realizado - Descargar**, haz clic en `Descargar` para descargar el archivo.
    ...
    ![download-report-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/troubleshooting/acceso-a-datos-y-seguridad/no-recibi-el-email-con-el-informe-exportado-de-master-data-v1_1.png)
