...
3. Verifica el ID registrado en el campo `ID de tienda oficial de Mercado Libre`.
4. Si el campo está vacío o contiene un ID incorrecto, ingresa la información correcta.
...
1. Busca el conector de **Mercado Libre.**
2. Haz clic en `Editar`.
3. Haz clic en `Realizar mapeo`.
4. Haz clic en la categoría que presenta error.
5. Realiza nuevamente el mapeo de acuerdo con las categorías y atributos existentes en Mercado Libre.
