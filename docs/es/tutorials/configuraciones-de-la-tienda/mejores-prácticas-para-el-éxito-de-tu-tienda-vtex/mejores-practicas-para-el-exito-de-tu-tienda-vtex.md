...
* **Controla el permiso de las claves de aplicación:** el acceso a tu tienda VTEX también puede realizarse mediante [claves de aplicación](/es/docs/tutorials/claves-de-api) utilizadas en integraciones. Es importante seguir nuestras recomendaciones de [Mejores prácticas para el uso de claves de aplicación](/es/docs/tutorials/buenas-practicas-claves-de-api).
