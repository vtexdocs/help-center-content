...
La plantilla de email que se enviará debe configurarse en el CMS Portal (Legado), siguiendo los pasos a continuación. Para ayudarte con la configuración, puedes utilizar la [plantilla de ejemplo](https://cdn.statically.io/gh/vtexdocs/help-center-content/files-migration-script/docs/es/tutorials/configuraciones-de-la-tienda/master-data/triggers-de-master-data-v1/product-visited-es.zip).
