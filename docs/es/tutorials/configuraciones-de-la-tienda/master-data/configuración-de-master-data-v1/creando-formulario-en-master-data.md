...
- **Consultas de visualización**: Activa una nueva sección en el formulario de visualización, con registros de una entidad relacionada con la entidad del formulario. Las informaciones mostradas serán relacionadas con el registro que está sendo visualizado.
   ...
   ![registrosRelacionados-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/configuraciones-de-la-tienda/master-data/configuración-de-master-data-v1/creando-formulario-en-master-data_1.png)
...
- **Consultas:** Sirve solamente para exhibir las [consultas creadas en la lista](/es/docs/tutorials/crear-consulta-personalizada-en-master-data-v1).
