...
![Master Data schemas](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/master-data/conceitos-básicos-do-master-data/master-data_1.jpg)
...
Además de las [entidades nativas](#entidades-nativas-de-master-data) que VTEX crea automáticamente, como `CL` (clientes), `AD` (direcciones) y demás entidades predeterminadas de la plataforma de comercio, tu operación puede crear entidades de datos personalizadas para almacenar información específica de tu negocio.
...
Para ver los valores aplicables a tu operación, consulta tu contrato comercial o ponte en contacto con el [Soporte de VTEX](https://help.vtex.com/es/support).
