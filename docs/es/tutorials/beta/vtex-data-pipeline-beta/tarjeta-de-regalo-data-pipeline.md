...
- **Tarjetas de regalo más usadas:** combinando este modelo de datos con los datos de [pedidos](/es/docs/tutorials/precios-data-pipeline-beta), es posible entender cómo se están utilizando las tarjetas y monitorear su uso.  
- **Impacto en las ventas:** de manera similar, al combinar con datos de [pedidos](/es/docs/tutorials/precios-data-pipeline-beta), es posible evaluar cómo las tarjetas de regalo influyen en las ventas.  

### Conheça outros Conjuntos de dados

- [Catálogo](/es/docs/tutorials/catalogo-data-pipeline)
- [Inventário](/es/docs/tutorials/stock-data-pipeline-beta)
- [Navegação](/es/docs/tutorials/navegacion-data-pipeline)
- [Pagamentos](/es/docs/tutorials/pagos)
- [Pedidos](/es/docs/tutorials/pedidos-data-pipeline-beta)
- [Promoção](/es/docs/tutorials/promociones)
- [Logs do Bridge](/es/docs/tutorials/registros-del-bridge-data-pipeline)
