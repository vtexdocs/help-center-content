...
Esta funcionalidad se encuentra en fase beta, lo que significa que estamos trabajando para optimizarla. Si tienes dudas, ponte en contacto con [nuestro Soporte](https://help.vtex.com/es/support).
