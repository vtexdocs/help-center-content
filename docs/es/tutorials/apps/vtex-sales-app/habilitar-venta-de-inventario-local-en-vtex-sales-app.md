...
4. En la pestaña lateral, selecciona `checkout-instore-custom-js`.
   ![instore-custom-js-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/vtex-sales-app/habilitar-venta-de-inventario-local-en-vtex-sales-app_2.png)
5. En la clave `window.INSTORE_CONFIG`, agrega la flag `venderSinStockEnMano: true`.
   ![sellWithoutStockInHands-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/vtex-sales-app/habilitar-venta-de-inventario-local-en-vtex-sales-app_3.png)
