...
* Tener una cuenta de _[Seller en Amazon](https://sell.amazon.com/)_ Para más información, consulta el artículo [Configuración de la cuenta en Amazon](/es/docs/tracks/configuracion-de-la-cuenta-amazon).
...
Para realizar la integración, consulta y sigue los pasos del tutorial [Registro de la integración de Amazon](/es/docs/tracks/configurar-la-integracion-de-amazon).
