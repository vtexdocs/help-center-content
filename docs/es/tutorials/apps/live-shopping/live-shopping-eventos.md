...
3. Haz clic en `Vista previa` para previsualizar la aplicación Live Shopping de acuerdo con los ajustes que definiste.
  ![ls-cms](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_1.png)
...
![ls-livechat](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_2.png)
...
2. En la sección **Preguntas**, crea las preguntas que se mostrarán a la audiencia mediante el botón `Nueva pregunta`. Puedes elegir entre preguntas y encuestas, y definir el periodo de tiempo durante el que se mostrarán. Las respuestas recibidas se almacenarán en la misma sección.
  ![ls-question](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_3.png)
...
2. En la sección **Estudio de streaming** selecciona una de las siguientes opciones:
    ...
    * `Acceder`: haz clic para acceder al estudio de streaming como anfitrión. Al hacer clic en `Acceder`, se abrirá una nueva ventana que te redirigirá al estudio de streaming.
    ![ls-profile](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_4.png)
...
![ls-products](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_5.png)
...
![ls-event-details](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_6.png)
...
5. Busca el bloque **Live Shopping** en tu storefront, de acuerdo con el template que utilizaste, y selecciónalo.
  ![ls-transmission](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_7.png)
...
4. En la página **Apariencia** encontrarás dos opciones: móvil y escritorio. Al seleccionar cada opción, puedes configurar y personalizar los componentes específicos de esas vistas, personalizando tanto los productos como las secciones de chat del reproductor de Live Shopping.
  ![ls-look-feel](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_8.png)
...
![ls-event-info](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_9.png)
...
![ls-analytics](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/apps/live-shopping/live-shopping-eventos_10.png)
