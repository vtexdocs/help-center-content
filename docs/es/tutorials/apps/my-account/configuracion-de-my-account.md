...
El nuevo [My Account](/es/docs/tutorials/como-funciona-mi-cuenta) ya está instalado en todas las cuentas VTEX en un **ambiente de prueba**, permitiendo ajustes en la nueva página sin impactos en la experiencia de usuario.
