...
![Configuración de proxy de Cloudflare](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/infraestructura/cdn-service/deshabilitar-proxy-cloudflare_1.png)
