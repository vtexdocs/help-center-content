...
| Order changed | vtexcommerce-order-changed-v2 | Notificación de que [el pedido fue modificado](https://help.vtex.com/es/tutorial/como-alterar-pedidos--7btlG91rb6sHpW1dkd2kBw). | Checkout notifica un evento de modificación (aumento o reducción de precio, adición, remoción o sustitución de ítems, cambio de peso). |
