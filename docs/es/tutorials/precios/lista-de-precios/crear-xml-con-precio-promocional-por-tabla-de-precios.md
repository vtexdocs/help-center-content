...
Comprenda mejor la funcionalidad de XML en VTEX en el artículo [¿Cómo funciona la actualización del XML?](/es/tutorial/como-se-hace-la-actualizacion-del-xml--tutorials_297#).
...
Para aplicar un precio diferenciado a los productos por XML, es necesario asociar una tabla de precios de SKU. Para esto, realice los siguientes pasos:
  ...
  2. Busque el archivo XML que se modificará y haga clic en `Editar`. Si quiere crear uno nuevo, lea nuestro artículo [Configurar XML](/es/tutorial/como-configurar-xml--tutorials_242).
...
![PT-tabela de precos](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/precios/lista-de-precios/crear-xml-con-precio-promocional-por-tabla-de-precios_1.png)
...
![XML-exemplo](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/precios/lista-de-precios/crear-xml-con-precio-promocional-por-tabla-de-precios_2.png)
