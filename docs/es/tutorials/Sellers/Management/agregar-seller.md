...
Si quieres encontrar nuevos partners para vender en tu marketplace, utiliza  <b>Encontrar sellers,</b> que facilita la identificación y contacto entre marketplaces y sellers que operan en el ecosistema VTEX, además de conectores certificados (partners).
</div> 
