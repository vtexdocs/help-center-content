...
> ℹ️ Si quieres empezar a vender tus productos en otros *marketplaces*, usa [Marketplaces e integraciones](https://help.vtex.com/es/tutorial/encontre-marketplaces-e-sellers-no-ecossistema-vtex--2bzC7tXlVgLEEjxo4ixcAM). Esta funcionalidad facilita la identificación y el contacto entre *marketplaces* y *sellers* que operan en el ecosistema VTEX.
