...
El modelo y los objetivos de tu negocio definirán cuál es tu mejor opción para operar en el ecosistema VTEX. Obtén más información en <a href="https://help.vtex.com/es/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402">Estrategias de marketplace en VTEX</a>.
</div>
...
| **Aspecto** | **Seller Portal** | **Cuenta estándar** | **Cuenta franquicia** |
|---------- | ---------- | ---------- | ---------- |
| El _seller_ puede crear [promociones](https://help.vtex.com/es/tracks/promocoes--6asfF1vFYiZgTQtOzwJchR/2a2D0K85Ahvs4hLnL3Ag7N) | El seller crea y configura promociones directamente en el Seller Portal. Para más detalles sobre el proceso de creación, consulte el documento [Seller Portal: Crear una promoción](https://help.vtex.com/es/tutorial/seller-portal-creating-a-promotion--kzNPEaiJE8EWkDzO9dbBI). | Puede crear y configurar promociones, además de simular promociones. | Puede crear y configurar promociones, además de simular promociones. |
...
| **Aspecto** | **Seller Portal** | **Cuenta estándar** | **Cuenta franquicia** |
|---------- | ---------- | ---------- | ---------- |
| Reflejar todos los medios de [pago](https://help.vtex.com/es/tracks/pagamentos--6GAS7ZzGAm7AGoEAwDbwJG/7pAEMAo4iqNHwYOarZ3zgm) en el _marketplace_ VTEX | Sí. | Sí. | Sí. |
...
| Configurar pago con [tarjeta de la tienda](https://help.vtex.com/es/tutorial/setting-up-private-label-payments--428FgVdSGQUeAOoogkaIw4) (red propia) | No. | Sí. | Sí, pero solo cuando todos los productos del pedido pertenecen a la cuenta franquicia. Si el pedido incluye a distintos _sellers_ ([_split_ de pedidos](https://help.vtex.com/es/tutorial/split-de-pagamento--6k5JidhYRUxileNolY2VLx)), la configuración de la tarjeta de la tienda no aparece como disponible. |
| Tiene el módulo [Suscripciones](https://help.vtex.com/es/tutorial/como-gerenciar-assinaturas--6Jk50FPbv6iuz1OsFypv8x) | No. | Sí. | Sí. |
| Usar la [tarjeta de regalo (GiftCard)](https://help.vtex.com/es/tutorial/gift-card--tutorials_995) de VTEX | Sí, pero la configuración de la [GiftCard](https://help.vtex.com/es/tutorial/gift-card--tutorials_995) se hace en la cuenta del _marketplace_ VTEX. Luego, se debe activar la opción de pago en [**Gestión de sellers**](https://help.vtex.com/es/tutorial/adicionar-seller--tutorials_392) para que el seller acepte la tarjeta de regalo. | Sí, pero la configuración de la GiftCard se hace en la cuenta del marketplace VTEX. Luego, se debe habilitar la opción de pago en **Gestión de sellers** para que el seller acepte la tarjeta de regalo. | Sí, pero la configuración de la GiftCard se hace en la cuenta principal. Luego, se debe habilitar la opción de pago en **Gestión de sellers** para que el seller acepte la tarjeta de regalo. |

## Logística

| **Aspecto** | **Seller Portal** | **Cuenta estándar** | **Cuenta franquicia** |
|---------- | ---------- | ---------- | ---------- |
| Segmentar [estrategias de envío](https://help.vtex.com/es/tutorial/estrategia-de-envio--58vLBDbjYVQzJ6rRc5QNz3) para distintos _marketplaces_ | No, porque el _seller_ vende en un único _marketplace_ VTEX. | Sí. | No, solo para la cuenta principal. |
| Tener _stock_ de seguridad nativo de la plataforma | No. | No. | No. |
| Tener capacidad de entrega para [Entregas programadas](https://help.vtex.com/es/tutorial/entrega-agendada--22g3HAVCGLFiU7xugShOBi) | Sí. | Sí. | Sí. |
| Configurar [puntos de recogida](https://help.vtex.com/es/tutorial/pontos-de-retirada--2fljn6wLjn8M4lJHA6HP3R) | Sí.  | Sí. | Sí. |
| Registrar polígonos de [geolocalización](https://help.vtex.com/es/tutorial/gerenciar-geolocalizacao--tutorials_138) | Sí. | Sí. | Sí. |
...
| **Aspecto** | **Seller Portal** | **Cuenta estándar** | **Cuenta franquicia** |
|---------- | ---------- | ---------- | ---------- |
| Realizar búsqueda con [Intelligent Search](https://help.vtex.com/es/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb/3qgT47zY08biLP3d5os3DG) en el _marketplace_ VTEX para presentar resultados del 1P (_first-party_) antes del 3P (_third-party_) | No. | No. | No. |

## Seller

| **Aspecto** | **Seller Portal** | **Cuenta estándar** | **Cuenta franquicia** |
|---------- | ---------- | ---------- | ---------- |
| Conectar _seller_ al _marketplace_ VTEX | El _seller_ se conecta por medio de una [invitación](https://help.vtex.com/es/tutorial/marketplace-convite-de-sellers-beta--6rb2FkcslmDueJ689Ulb9A) que envía el _marketplace_ VTEX. | El _seller_ VTEX se conecta a un _marketplace_ VTEX cuando este último lo [agrega](https://help.vtex.com/es/tutorial/adicionar-seller--tutorials_392) a través de **Gestión de sellers**. | La cuenta franquicia se crea automáticamente como seller de la cuenta principal. |
