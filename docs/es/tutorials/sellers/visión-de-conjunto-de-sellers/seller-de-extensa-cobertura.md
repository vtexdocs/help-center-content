...
En los casos de más de un *seller* de extensa cobertura registrado, el *checkout* selecciona el que tiene mayor saldo en stock para el artículo en cuestión, entre todos los *seller* de extensa cobertura. Aprende más en [Selección de sellers white label](/es/docs/tutorials/seleccion-de-sellers-white-label).
