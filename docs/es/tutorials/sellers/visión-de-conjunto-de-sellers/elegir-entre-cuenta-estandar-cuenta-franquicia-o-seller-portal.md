...
- **Cuenta estándar:** tiene las configuraciones de todos los módulos de la plataforma VTEX y actúa como _seller_ normal. Recibe el nombre de [_seller_ VTEX](/es/docs/tutorials/estrategias-de-marketplace-en-vtex#como-seller-vtex).
...
| Tiene [Manual Pricing](/es/docs/tutorials/funcionalidades-de-televentas#ingresar-precio-manual) | Sí. | Sí. | Sí. |
