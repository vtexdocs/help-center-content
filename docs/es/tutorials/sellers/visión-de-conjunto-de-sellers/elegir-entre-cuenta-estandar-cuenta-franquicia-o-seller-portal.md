...
- **Cuenta franquicia:** en el momento en que se crea, se asocia a una cuenta estándar, de la cual hereda el catálogo. La [cuenta franquicia](/es/docs/tutorials/que-es-una-cuenta-franquicia) puede configurar su propia logística, pagos y precios, y tiene los módulos de la plataforma VTEX en forma parcial, además de un [seller white label](/es/docs/tutorials/seller-white-label).
- **Seller Portal:** el [Seller Portal](/es/docs/tutorials/como-configurar-su-tienda-en-seller-portal) es una edición de la plataforma VTEX que les permite a los _sellers_ conectarse y vender productos en _marketplaces_ del ecosistema VTEX, independientemente de si el _seller_ ya tiene una cuenta en VTEX o no. El Seller Portal brinda acceso parcial a los módulos de la plataforma, y el _seller_ puede ser normal o [white label](/es/docs/tutorials/seller-white-label).
...
> ℹ️ El modelo y los objetivos de tu negocio definirán cuál es tu mejor opción para operar en el ecosistema VTEX. Obtén más información en [Estrategias de marketplace en VTEX](/es/docs/tutorials/estrategias-de-marketplace-en-vtex).
...
| [Política comercial](/es/docs/tutorials/como-funciona-una-politica-comercial) | Permite tener una única política comercial. | Permite [contratar múltiples políticas comerciales](/es/docs/tutorials/contratacion-de-politicas-comerciales-adicionales). | Permite tener una única política comercial. |
| Modalidad [kit](/es/docs/tutorials/registrar-kit) | No es posible usar la modalidad kit. | Es posible usar la modalidad kit. | Es posible usar la modalidad kit. Si un producto forma parte de un kit en la cuenta principal y se restablece su stock, dicho producto se considerará automáticamente como disponible en la cuenta franquicia, aunque, en principio, la cuenta franquicia no deba venderlo. |
| [Registrar anexo](/es/docs/tutorials/registrar-un-anexo) | No es posible registrar un anexo. | Es posible registrar un anexo. | Es posible registrar un anexo en la cuenta principal y que eso se refleje en la cuenta franquicia. |
...
| Configurar pago con [tarjeta de la tienda](/es/docs/tutorials/configurar-pagos-con-private-label) (red propia) | No. | Sí. | Sí, pero solo cuando todos los productos del pedido pertenecen a la cuenta franquicia. Si el pedido incluye a distintos _sellers_ ([_split_ de pedidos](/es/docs/tutorials/split-de-pagos)), la configuración de la tarjeta de la tienda no aparece como disponible. |
| Tiene el módulo [Suscripciones](/es/docs/tutorials/como-gestionar-suscripciones) | No. | Sí. | Sí. |
| Usar la [tarjeta de regalo (GiftCard)](/es/docs/tutorials/gift-card) de VTEX | Sí, pero la configuración de la [GiftCard](/es/docs/tutorials/gift-card) se hace en la cuenta del _marketplace_ VTEX. Luego, se debe activar la opción de pago en [**Gestión de sellers**](/es/docs/tutorials/agregar-seller) para que el seller acepte la tarjeta de regalo. | Sí, pero la configuración de la GiftCard se hace en la cuenta del marketplace VTEX. Luego, se debe habilitar la opción de pago en **Gestión de sellers** para que el seller acepte la tarjeta de regalo. | Sí, pero la configuración de la GiftCard se hace en la cuenta principal. Luego, se debe habilitar la opción de pago en **Gestión de sellers** para que el seller acepte la tarjeta de regalo. |
...
| Tener capacidad de entrega para [Entregas programadas](/es/docs/tutorials/entrega-programada) | Sí. | Sí. | Sí. |
| Configurar [puntos de recogida](/es/docs/tutorials/puntos-de-recogida) | Sí.  | Sí. | Sí. |
| Registrar polígonos de [geolocalización](/es/docs/tutorials/gestionar-geolocalizacion) | Sí. | Sí. | Sí. |
...
| El _marketplace_ VTEX puede integrar productos recibidos del _seller_ en la página [SKU recibidos](/es/docs/tutorials/catalogacion-manual-de-skus) | Los productos que creó el _seller_ se deben catalogar manualmente en la página **SKU recibidos**. Una vez que el _marketplace_ VTEX [comparte productos](/es/docs/tutorials/seller-portal-productos-compartidos) con el _seller_, la aprobación de [VTEX Matcher](/es/docs/tutorials/como-funcionan-los-puntos-del-vtex-matcher) es automática, y eso queda registrado en la página **SKU recibidos**. | Sí. La funcionalidad VTEX Matcher evalúa los SKU que enviaron los _sellers_ y acelera el proceso de [catalogación](/es/docs/tutorials/catalogacion-manual-de-skus). | No, porque el catálogo se hereda de la cuenta principal. |
| Necesita [mapear categorías, marcas y especificaciones](/es/docs/tutorials/mapeo-de-categorias-y-marcas-para-marketplace) en el _marketplace_ VTEX | Cuando el seller crea el producto, se debe realizar el mapeo. No es necesario mapear los productos compartidos. | Sí. | No, porque el catálogo se hereda de la cuenta principal. |
