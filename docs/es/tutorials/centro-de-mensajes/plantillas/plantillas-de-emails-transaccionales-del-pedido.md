...
| Buyer Portal Sequential approval required (Buyer) | buyer-portal-buyer | Notificación enviada al comprador cuando un pedido requiere aprobación. | Cuando un pedido no cumple con las políticas comerciales establecidas por la organización, el comprador debe aprobarlo manualmente. El status del pedido permanece en `waiting-for-authorization` hasta que sea aprobado o rechazado. |
| Buyer Portal Sequential approval required (Approver) | buyer-portal-approver | Notificación enviada al aprobador cuando un pedido requiere aprobación. | Cuando un pedido no cumple con las políticas comerciales establecidas por la organización, el aprobador debe aprobarlo manualmente. El status del pedido permanece en `waiting-for-authorization` hasta que sea aprobado o rechazado. |
| Buyer Portal Order Denied (Buyer) | buyer-portal-order-denied-buyer | Notificación enviada al comprador para indicar que el pedido fue rechazado. | El aprobador rechazó el pedido según las políticas de la organización y el status del pedido se actualiza a `rejected`. |
