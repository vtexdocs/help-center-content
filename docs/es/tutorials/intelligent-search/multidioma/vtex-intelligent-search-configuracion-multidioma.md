...
- **Intelligent Search API v1**: las traducciones se obtienen de forma nativa desde la API de [Catalog multi-language](https://developers.vtex.com/docs/guides/catalog-multi-language-integration-guide), por lo que no es necesario usar Messages.
