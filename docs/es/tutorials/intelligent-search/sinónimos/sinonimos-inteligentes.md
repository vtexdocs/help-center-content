...
![synonym-suggestion-list-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/sinónimos/sinonimos-inteligentes_1.png)
...
4. Verás un modal con la primera sugerencia de sinónimo. Cada sugerencia indica el término buscado y el término que se agregará como sinónimo, y también el número de veces que los clientes de tu tienda reescribieron el término original por el segundo término en los últimos 30 días.
   ...
   ![synonym-suggestion-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/sinónimos/sinonimos-inteligentes_2.png)
...
4. Para revisar cada sugerencia, elige una de las siguientes opciones:
    ...
    * <i class="fas fa-pencil-alt"></i> **Editar**: modifica los campos de la configuración de sinónimos sugeridos. Después de editar, debes hacer clic en <i class="fas fa-check-circle"></i> para guardar los cambios. Para más información sobre los campos disponibles, consulta [Configurar sinónimos](/es/docs/tutorials/crear-sinonimos).
...
> ❗ Cuando se realiza una acción no es posible deshacerla, ya que se muestra inmediatamente la siguiente sugerencia disponible.

## Más información

* [Sinónimos](/es/docs/tutorials/sinonimos)
* [Configurar sinónimos](/es/docs/tutorials/crear-sinonimos)
