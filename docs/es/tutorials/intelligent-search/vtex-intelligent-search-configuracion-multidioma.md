...
Cuando tiene VTEX Intelligent Search Multidioma instalada, la información del Catálogo de su tienda necesita ser traducida para poder mostrarse en cada idioma configurado en la tienda. La necesidad de usar Messages depende de la versión de la API de Intelligent Search utilizada por la tienda:
