...
legacySlug: crear-regla-de-merchandising-editor-visual
locale: es
...
![visual-merch-rules-ES-v2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/relevancia/crear-regla-de-merchandising-editor-visual_1.png)
...
<ol class="mv7" type="I">
    ...
    <li class="t-body c-on-base mb5 lh-copy">Definir [filtros](#agregar-filtros-y-condiciones) para aplicar la regla de merchandising.</li>
    ...
    <li class="t-body c-on-base mb5 lh-copy">Ver detalles del producto. La información mostrada es:<br /><br />
	   <ul>
		  <li class="t-body c-on-base mb5 lh-copy">**Disponible:** indica si el producto está o no disponible en la tienda.</li>
			<li class="t-body c-on-base mb5 lh-copy">**Clics:** número de clics durante los últimos 90 días.</li>
			<li class="t-body c-on-base mb5 lh-copy">**Pedidos:** número de pedidos realizados que incluyen el producto en los últimos 90 días.</li>
			<li class="t-body c-on-base mb5 lh-copy">**Ingresos:** ingresos que generó el producto en los últimos 90 días.</li>
...
![filtros-merchrules-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/relevancia/crear-regla-de-merchandising-editor-visual_2.gif)
...
3. Rellena las condiciones que deseas crear. Las opciones disponibles se describen en [Condiciones de las reglas de merchandising](/es/docs/tutorials/condiciones-de-las-reglas-de-merchandising).
