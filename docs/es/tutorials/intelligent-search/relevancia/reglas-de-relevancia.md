...
![criterios-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/relevancia/reglas-de-relevancia_1.png)
...
- **Promoción:** criterio que comprueba si existen [Audiencias de las campañas](/es/docs/tutorials/pantalla-inicial-del-modulo-de-pricing-promociones#audiencia-de-campanas) o [Promociones](/es/docs/tracks/como-funcionan-las-promociones) vinculadas al artículo para determinar si el producto clasifica como promoción.
- **Puntuación del catálogo:** criterio de desempate del orden basado en el valor del campo **Puntuación** registrado en el producto. A efectos de la composición de la relevancia, cuanto mayor sea la puntuación, mayor será el peso, es decir, el comportamiento es descendente: se da prioridad a los productos con una puntuación más alta. Más información sobre el campo y su comportamiento en la guía [¿Cómo funciona el campo Puntuación?](/es/docs/tutorials/como-funciona-el-campo-puntuacion).
...
4. Haz clic en los íconos flecha abajo <i class="fas fa-chevron-down"></i> o flecha arriba <i class="fas fa-chevron-up"></i> para definir el número deseado.
   ...
   ![criterios-prioritarios-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/intelligent-search/relevancia/reglas-de-relevancia_2.gif)
