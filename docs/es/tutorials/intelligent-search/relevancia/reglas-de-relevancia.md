...
- **Promoción:** criterio que comprueba si existen [Audiencias de las campañas](/es/tutorial/overview-2--tutorials_326#audiencia-de-campanas) o [Promociones](/es/docs/tracks/como-funcionan-las-promociones) vinculadas al artículo para determinar si el producto clasifica como promoción.
