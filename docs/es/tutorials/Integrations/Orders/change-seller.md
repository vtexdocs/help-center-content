...
![seller_cancela_pedido_ES](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/Integrations/Orders/change-seller_1.png)
...
![mkt_cancela_seller_ES](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/Integrations/Orders/change-seller_2.png)
...
- Cambio a un nuevo *seller *que no es de VTEX cuando hay servicios u [assembly options](https://help.vtex.com/es/tutorial/assembly-options--5x5FhNr4f5RUGDEGWzV1nH) involucrados.
...
- En caso de que el *marketplace* decida cambiar de *seller*, el cambio solo podrá realizarse en los [status](https://help.vtex.com/es/tutorial/fluxo-e-status-de-pedidos--tutorials_196) `Pago pendiente` y `Esperando confirmación del seller`.
