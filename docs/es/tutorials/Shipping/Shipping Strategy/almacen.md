...
* Para saber cómo registrar, modificar y hacer un seguimiento de los almacenes, consulte el artículo [Gestión del almacén](/es/tutorial/gerenciar-estoque--tutorials_137).
* Para hacer un seguimiento y gestionar los ítems del almacén, consulte [Gestión del stock](/es/tutorial/gerenciar-itens-em-estoque--tutorials_139).
* Para configurar y gestionar la relación entre los almacenes y la retirada de pedidos, consulte [Gestión de muelles](/pt/tutorial/gerenciar-doca--7K3FultD8I2cuuA6iyGEiW).
...
<body>
<ol>
<li><a href="https://help.vtex.com/en/tutorial/politica-de-envio--tutorials_140">Política de envío</a></li>
