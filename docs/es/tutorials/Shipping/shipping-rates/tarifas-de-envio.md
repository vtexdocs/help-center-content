...
![Tarifa envio ES](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/Shipping/shipping-rates/tarifas-de-envio_1.svg)
...
> ℹ️ Cuando tenga que actualizar o registrar varios precios de envío, recomendamos utilizar la [plantilla de flete](https://help.vtex.com/es/tutorial/plantilla-de-flete--tutorials_127) en vez del módulo **Tarifas de envío**. Si desea comprobar cómo se mostrarán las tarifas de envío registradas al cliente final, utilice el módulo **[Simulador de envío**](https://help.vtex.com/es/tutorial/simulador-de-envio--tutorials_144).
