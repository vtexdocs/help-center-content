...
- [​​Audiencias de campañas](https://help.vtex.com/es/docs/tutorials/audiencias-de-campanas)
- [Lista de audiencias de campañas](https://help.vtex.com/es/docs/tutorials/lista-de-audiencias-de-campanas)
- [Crear audiencias de campaña](https://help.vtex.com/es/docs/tutorials/crear-audiencias-de-campana)
- [Crear una promoción de campaña](https://help.vtex.com/es/docs/tutorials/promocion-de-campana)
...
- [Crear promoción para un clúster de clientes](https://help.vtex.com/es/docs/tutorials/creando-promociones-cluster-clientes)
- [Promoción Regular](https://help.vtex.com/es/docs/tutorials/registro-promocion-regular)
...
- [Configurar promoción para marketplace](https://help.vtex.com/es/docs/tutorials/configurar-promocion-para-marketplace)
- [Simulador de Promociones ](https://help.vtex.com/es/docs/tutorials/simulador-de-promociones-beta)
...
- [Crear tasa/impuesto](https://help.vtex.com/es/docs/tutorials/creando-la-tasaimpuesto)
- [Archivar tasas / impuestos](https://help.vtex.com/es/docs/tutorials/como-archivar-tasas-impuestos)
- [Enviar al Gateway o al ERP el precio del item ya con el impuesto separado](https://help.vtex.com/es/docs/tutorials/como-destacar-el-impuesto-en-vtex)
