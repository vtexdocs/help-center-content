...
Las tags solo se asignan a un pedido una vez que ha sido finalizado. Sin embargo, cuando un pedido se [modifica](/es/docs/tutorials/como-modificar-pedidos#status-del-pedido-a-modificar), las tags se vuelven a procesar, ya que el cambio puede afectar las condiciones del take rate que se cobrará.
...
* [Tags de origen del pedido:](#tags-de-origen-del-pedido) indica el contexto de [marketplace y seller](/es/docs/tutorials/estrategias-de-marketplace-en-vtex).
...
* **IsCallCenter:** solución VTEX Sales App. Esta tag se aplica cuando la venta fue promovida por un vendedor, agente o consultor, como es el caso de [televentas](/es/docs/tutorials/como-configurar-las-funcionalidades-de-televentas).
...
![marcacao_pedidos_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/facturacion/facturas/tags-de-pedidos-utilizadas-por-el-modulo-de-facturacion_1.png)
