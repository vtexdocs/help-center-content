...
El informe financiero presenta todos los pedidos aprobados en el periodo de la factura, es decir, la base de pedidos considerada en esa facturación. Puedes generar el informe en el módulo **Facturación > Facturas** del Admin VTEX.
