...
- Para tiendas desarrolladas con Store Framework, consulta [Gestionar contenido de páginas y templates](/es/docs/tutorials/gestionar-contenido-de-paginas-y-templates).

### Definir políticas comerciales

Para diferenciar productos y/o precios en cada tienda, debes utilizar políticas comerciales. Para más información, consulta [Cómo funciona una política comercial](/es/docs/tutorials/como-funciona-una-politica-comercial) y [Crear una política comercial](/es/docs/tutorials/crear-una-politica-comercial).
...
8. En el campo **Links**, haz clic en `Add`.
    ...
    ![cms-layout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/cuentas/gestionar-multitienda_1.png)
...
10. En el campo **Available sales channel**, marca las políticas comerciales que se deben asociar a esta tienda.
    ...
    > ⚠️ Si la tienda utiliza más de una (1) política comercial, asegúrate de ordenarlas en **Configuración de la tienda > Canales > Políticas comerciales**. Para más información, consulta [Cómo funciona la relación entre sitios web y políticas comerciales](/es/docs/tutorials/gestionar-multitienda).

11. Haz clic en `Save Binding` y después en `Save Website`.

### Configurar dominio del XML

Para generar el archivo XML de la nueva tienda automáticamente, sigue las instrucciones de la guía [Configurar dominio del XML](/es/docs/tutorials/configurar-dominio-del-xml).
...
- [Elegir entre arquitectura multitienda o entorno adicional](/es/docs/tutorials/elegir-entre-arquitectura-multitienda-o-entorno-adicional)
