...
Para cambiar el Usuario Titular, por favor, contacte con nuestro equipo de Growth Operations a través del [Soporte](https://supporticket.vtex.com/support), seleccionando la opción **Comercial** y el tipo de solicitud `Cambio de Usuario Titular`. Debe rellenar los campos requeridos y enviar una copia del contrato social.
...
Para cambiar el Usuario Titular, póngase en contacto con nuestro equipo de Growth Operations a través del [Soporte](https://supporticket.vtex.com/support) seleccionando la opción **Comercial** y el tipo de solicitud `Cambio del Usuario Titular`. Debe rellenar los campos requeridos.
