...
3. Haz clic en `Seleccionar rol` y en uno de los roles predefinidos que aparecen en el menú desplegable. No elijas la opción **Custom**, ya que está destinada a perfiles personalizados.
    ...
    ![Nuevo perfil de acceso](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/control-de-acceso/crear-nuevo-rol_1.png)
...
4. Agrega usuarios administrativos al rol rellenando el email del usuario en **Agregar usuarios para este rol** y haciendo clic en `Agregar`.
    ...
    ![Usuarios de perfil](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/control-de-acceso/crear-nuevo-rol_2.PNG)
...
4. Haz clic en el menú desplegable en **Seleccionar un producto** y, a continuación, haz clic en uno de los productos que aparece en la lista.
    ...
    ![Configurando producto](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/control-de-acceso/crear-nuevo-rol_3.png)
...
8. Agrega usuarios administrativos al rol rellenando el email del usuario en **Agregar usuarios para este rol** y haciendo clic en `Agregar`.
      ...
      ![Usuarios de perfil](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/control-de-acceso/crear-nuevo-rol_4.PNG)
