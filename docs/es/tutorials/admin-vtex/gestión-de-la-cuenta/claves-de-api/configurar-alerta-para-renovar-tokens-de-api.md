...
![token-renewal-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/claves-de-api/configurar-alerta-para-renovar-tokens-de-api_1.png)
...
![renew-recommended-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/claves-de-api/configurar-alerta-para-renovar-tokens-de-api_2.png)

La alerta naranja indica que el token superó el plazo de uso recomendado por un periodo inferior a 3 meses.

![renew-highly-recommended-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/claves-de-api/configurar-alerta-para-renovar-tokens-de-api_3.png)
