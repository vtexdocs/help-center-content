...
![one-time-link-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/claves-de-api/renovar-token-de-api_1.png)
...
3. En la fila de una clave de API que tenga la alerta *Eliminación pendiente - Token antiguo*, haz clic en el menú (⋮) y luego en <i class="far fa-trash-alt"></i> `Eliminar token antiguo`.  
   ...
   ![delete-pending-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/admin-vtex/gestión-de-la-cuenta/claves-de-api/renovar-token-de-api_2.png)
