...
El contrato VTEX o acuerdo comercial consta de dos partes, el [MSA (Master Service Agreement)](https://vtex.com/es-mx/trust/agreements) y el **Anexo 1 Order Form** para la prestación de servicios a empresas o [MPA (Master Partner Agreement)](https://vtex.com/es-mx/trust/agreements#:~:text=Master%20Services%20Agreement,Partner%20Agreement) y **Términos y condiciones específicos de la asociación**.
...
El Master Agreement aplicable está disponible en la sección **Política de privacidad > Archivo de contratos > [Master Agreements](https://vtex.com/es-mx/trust/agreements-archive/#:~:text=Master%20Agreements,September%2006%2C%202020%5D)** para clientes y **Política de privacidad > Archivo de contratos > [Partner Agreement](https://vtex.com/es-mx/trust/agreements-archive/#:~:text=Contratos%20Anteriores,Partner%20Agreement)** para partners, dependiendo de la región y de la fecha en que se firmó el **Anexo 1** o los **Términos y condiciones específicos de la asociación**. El **Anexo 1** y los **Términos y condiciones** firmados con VTEX pueden solicitarse directamente al CS de tu cuenta poniéndote en contacto con el [soporte VTEX](/es/support?/cultureInfo=pt-br).

También puedes encontrar los Master Agreements más actualizados, es decir, los aplicables a nuevos clientes y partners, en la página [Contratos VTEX](https://vtex.com/es-mx/trust/agreements).
