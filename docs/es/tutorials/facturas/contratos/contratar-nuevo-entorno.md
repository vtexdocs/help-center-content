...
Para contratar un nuevo entorno VTEX, ponte en contacto con nuestro [Soporte](https://supporticket.vtex.com/support) seleccionando la opción Comercial y el tipo de ticket `Crear entorno adicional`. Para saber más, consulta el artículo [Abrir tickets con el Soporte VTEX](/es/docs/tutorials/abrir-tickets-para-el-soporte-vtex).
