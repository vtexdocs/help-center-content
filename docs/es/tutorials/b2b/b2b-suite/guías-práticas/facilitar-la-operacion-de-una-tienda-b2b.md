---
title: 'Facilitar la operación de una tienda B2B (B2B Suite)'
...
| [VTEX Intelligent Search](https://developers.vtex.com/vtex-developer-docs/docs/search) | Habilita búsquedas de productos (solo está disponible para tiendas desarrolladas con VTEX IO).                                                                                                                                                          |
...
En VTEX, todas las tiendas cuentan con el recurso [kit de productos](/es/tutorial/kit-registration), a través del cual se puede vender un conjunto de ítems por un precio determinado. 
...
VTEX cuenta con [My account](/es/docs/tutorials/como-funciona-mi-cuenta), una herramienta que está disponible en las tiendas de todos nuestros clientes. 
