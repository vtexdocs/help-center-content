---
title: 'Qué es Order Configuration (B2B Suite)'
...
Por API, usted debe asociar una [tabla de precios](/es/docs/tracks/tablas-de-precio-definicion-de-concepto) con cada escenario, creando una correlación entre ambos. De esta manera, cuando el usuario configure sus condiciones de compra, recibirá los precios que se refieren a esa regla.
