...
2. Cree un formulario utilizando el tutorial para [crear formularios en Master Data](/es/tutorial/criando-formulario-no-master-data/ "crear formularios en Master Data").
