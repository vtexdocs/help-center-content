...
![lista-sinonimos-es](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/Intelligent Search/Synonyms/lista-de-sinonimos_1.PNG)
  ...
  <tbody>
    <tr class="bb b--muted-3">
      ...
      <td class="t-body pa5">
        ...
        <a
          href="https://help.vtex.com/es/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb/1pxAWPEglBey1UFdvcetZV#tipos-de-sinonimos"
          target="_blank"
          rel="noopener noreferrer"
          >Tipos de sinónimos</a>.
      </td>
    </tr>
    <tr class="bb b--muted-3">
