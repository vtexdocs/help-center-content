...
<blockquote><ui>6. Si aparece un mensaje de alerta que indica la necesidad de instalar la aplicación, haga clic en el botón **Instalar aplicación** y siga las instrucciones de instalación.</ui>

<blockquote><ui>7. Haga clic en **Guardar.**</ui>
