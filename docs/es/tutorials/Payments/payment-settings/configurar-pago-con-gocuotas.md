...
En VTEX es posible la integración con el proveedor de pagos GOcuotas. Con este proveedor, su tienda puede realizar ventas a través de GOcuotas.

Para configurar GOcuotas, siga los pasos a continuación:
