---
title: 'Configurar pago con Lyra'
...
En VTEX es posible la integración con el proveedor de pagos Lyra.

Con este proveedor, su tienda puede realizar ventas a través de Lyra.

Para configurar Lyra, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **Lyra** en la barra de búsqueda y haga clic en el nombre del proveedor.
...
9. En **Campos del Proveedor**, seleccione o complete los campos **Clave pública, Clave HMAC-SHA-256, Pago por token, Modo de ingreso de datos de pago, Número de intentos de pago con tarjeta, Tema, Modo compacto** según las instrucciones del proveedor.
...
6. Si lo deseas, también puedes [configurar condiciones de pago especiales](https://help.vtex.com/es/tutorial/condiciones-especiales--tutorials_456).
