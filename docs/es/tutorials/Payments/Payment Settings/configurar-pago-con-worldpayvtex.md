...
Para configurar los métodos de pago a procesar por WorldpayVTEX, acceda al [Configurar Condiciones de Pago](/es/tutorial/condiciones-de-pago--tutorials_455#).
