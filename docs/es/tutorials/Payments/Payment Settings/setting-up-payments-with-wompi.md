...
En VTEX es posible la integración con el proveedor de pagos Wompi. Con este proveedor, tu tienda puede realizar ventas a través de tarjetas de crédito y débito, transacciones bancarias, Nequi y PSE (sistemas de pago colombianos) y corresponsales bancarios.

Para configurar Wompi, siga los pasos a continuación:
