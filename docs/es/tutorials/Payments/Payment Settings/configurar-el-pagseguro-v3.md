...
__, __Gostaria de ativar o repasse do liable das transações para o seller com maior valor a receber?__, y __Prazo de expiração do QR Code PIX__ según las instrucciones del proveedor.
10. Haga clic en __Guardar__.

<div class="alert alert-warning" role="alert">PagBank también ofrece la opción de captura automática programada hasta en 5 días. Si desea utilizarlo en su tienda, siga los pasos indicados en esta <a href="https://help.vtex.com/es/known-issues/no-aparece-la-captura-automatica-programada--1cuvGbgUvd1ATeHEG6Il98">documentación</a>.</div>
