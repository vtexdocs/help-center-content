...
slug: configurar-pago-con-payuv2
locale: es
...
Para configurar los métodos de pago a procesar por PayUv2, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/tutorial/condiciones-de-pago--tutorials_455#).
