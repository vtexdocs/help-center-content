...
6. Desmarque el campo __Activo | Categoría está activa en la tienda__, según se muestra en esta imagen: ![img inativarcategoria ES](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/categor%C3%ADas/borrar-una-categoria_1.png)
...
> ⚠️ Por razones de seguridad, solo el [usuario Titular](/es/tutorial/o-que-e-o-usuario-master--3oPr7YuIkEYqUGmEqIMSEy) de la cuenta tiene acceso a la limpieza de la base. Si otro usuario intenta acceder a esta página, todos los botones estarán inactivos.
