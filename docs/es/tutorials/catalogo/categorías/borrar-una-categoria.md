...
Otra opción es [limpiar el catálogo](/es/docs/tutorials/mantenimiento-de-base-de-datos-full-cleanup) y eliminar todas las «Categorías», «Marcas» y «Especificaciones» al mismo tiempo. Para eso, es necesario «Eliminar los productos y SKUs» antes. Siga los pasos a continuación:
...
> ⚠️ Por razones de seguridad, solo el [usuario Titular](/es/docs/tutorials/que-es-el-usuario-titular) de la cuenta tiene acceso a la limpieza de la base. Si otro usuario intenta acceder a esta página, todos los botones estarán inactivos.
