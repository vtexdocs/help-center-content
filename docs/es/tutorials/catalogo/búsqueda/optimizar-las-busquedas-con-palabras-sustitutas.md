...
> ⚠️ No recomendamos el uso de [Palabras sustitutas](/es/docs/tutorials/optimizar-las-busquedas-con-palabras-sustitutas) cuando se utilice Intelligent search. Para asociar palabras con productos es preferible emplear [Sinónimos](/es/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb/1pxAWPEglBey1UFdvcetZ), ya que permiten gestionar los términos por producto de una forma más escalable. Para más información, ponte en contacto con [nuestro equipo de soporte](https://support.vtex.com/hc/es/requests).
...
> ℹ️ Ver más detalles de [como funciona la búsqueda](/es/docs/tutorials/como-funciona-la-busqueda-de-vtex) en VTEX.
