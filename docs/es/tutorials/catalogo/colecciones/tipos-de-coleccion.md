...
> ⚠️ La coleciones creadas en el módulo CMS y con más de un <a href = "/es/tutorial/cadastro-de-colecoes-cms--2YBy6P6X0NFRpkD2ZBxF6L">grupo</a> no pueden ser reordenadas en el nuevo módulo de Colecciones Beta. Aconsejamos que no cambie el orden, ya que puede comprometer la eficiencia de la funcionalidad.
