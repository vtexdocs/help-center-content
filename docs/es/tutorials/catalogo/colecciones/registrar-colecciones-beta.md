...
Para crear una colección, debe tener el [perfil de acceso](/es/docs/tutorials/roles) _Owner (Admin Super)_ o crear otro perfil con el recurso **Write Collections**, en la sección **Collection** de los perfiles de **Catalog**. Vea aquí [cómo crear un perfil de acceso](/es/docs/tutorials/roles#creando-un-perfil-de-acceso).
