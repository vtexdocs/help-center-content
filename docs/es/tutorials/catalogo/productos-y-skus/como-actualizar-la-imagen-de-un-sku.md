...
¡Listo! Ahora su producto entrará en la [fila de indexación](/es/docs/tutorials/entendiendo-el-funcionamento-de-la-indexacion). Después de ser indexado, el SKU se mostrará con las nuevas imágenes.
