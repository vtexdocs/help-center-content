...
Al hacer clic en el botón `Agregar producto`, se abrirá la página de [agregar producto](/es/docs/tutorials/agregar-o-editar-productos) en el catálogo. Para más información sobre cómo llenar los campos, consulta el artículo [Llenar campos de registro de producto](/es/tutorial/campos-de-cadastro-de-produto).
...
* [Marca](/es/docs/tracks/marcas-definicion-de-concepto)
* [Categoría](/es/docs/tracks/categorias-definicion-de-concepto)
* [Seller](/es/docs/tutorials/que-es-un-seller)
* [Kit](/es/docs/tutorials/que-es-un-kit)
* [Visibilidad de la tienda](/es/tutorial/campos-de-cadastro-de-produto--4dYXWIK3zyS8IceKkQseke?&utm_source=autocomplete)
* [Política comercial](/es/docs/tutorials/como-funciona-una-politica-comercial)
* Fecha de creación
...
*  <i class="fas fa-cube" aria-hidden="true"></i> **Editar stock:** dirige a la pantalla de gestión de stock en el Admin VTEX para editar la cantidad del SKU disponible para la venta en stock. Consulta el artículo [Gestión del stock](/es/docs/tutorials/gestionar-items-en-inventario) para más información.
...
Para editar información de registro de un producto, puedes hacer clic en cualquier parte de la fila del producto. De esta manera, accederás a la página de [agregar producto](/es/docs/tutorials/agregar-o-editar-productos) y podrás editar la información deseada.
...
* **Editar producto:** dirige a la pantalla de [agregar producto](/es/docs/tutorials/agregar-o-editar-productos) para modificar la información.
* **Ver lista de SKUs:** dirige a la pantalla de la lista de SKU.
* **Editar categoría similar:** dirige a la pantalla de registro de categoría similar, que permite asociar una categoría al producto. Para más información, consulta el artículo [Configurar categoría similar](/es/docs/tutorials/configurando-categoria-similar).
...
* **Editar stock:** dirige a la pantalla de gestión de stock en el Admin VTEX para editar la cantidad de cada SKU del producto disponible para la venta en stock. Consulta el artículo [Gestión del stock](/es/docs/tutorials/gestionar-items-en-inventario) para más información.
* **Ver en la tienda:** dirige a la página de detalles del producto (PDP) en el [storefront](/es/docs/tutorials/vision-general-storefront) de la tienda.
