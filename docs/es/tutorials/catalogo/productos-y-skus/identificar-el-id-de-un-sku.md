...
2. Para mostrar los [SKUs de un producto](/es/docs/tutorials/agregar-o-editar-skus), haz clic en la flecha al lado del nombre del producto.
...
![finding_sku_id_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/productos-y-skus/identificar-el-id-de-un-sku_1.png)

## Identificar el ID del SKU por la URL

Cuando haces clic en un SKU y accedes a su [página de edición](/es/docs/tutorials/agregar-o-editar-skus), la URL del navegador tiene el siguiente formato:
