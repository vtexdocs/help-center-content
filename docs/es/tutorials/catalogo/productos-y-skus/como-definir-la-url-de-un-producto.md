---
title: 'Definiendo la URL de un producto'
...
En VTEX, la URL de un producto se compone del dominio de la tienda agregado al valor del campo obligatorio **textLink** cuando se [registra un producto](/es/docs/tutorials/agregar-o-editar-productos), más `/p`, que significa «producto». Ejemplo: en una tienda cuyo dominio es `storename.com`, al rellenar el campo textLink de un producto con `camisa-polo`, la estructura final de la URL del producto será `storename.com/camisa-polo/p`.
...
- [Registrar productos](/es/docs/tutorials/agregar-o-editar-productos)
- [Llenar los campos de registro de producto](/es/docs/tutorials/agregar-o-editar-productos)
