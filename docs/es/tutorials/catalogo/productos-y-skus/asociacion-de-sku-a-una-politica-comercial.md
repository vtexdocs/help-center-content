---
title: 'Asociación de SKU a una política comercial'
...
legacySlug: asociacion-de-sku-a-una-politica-comercial
locale: es
...
2. Después, haga clic en **Todos los productos**.
3. Busque el SKU que desea editar.
4. En el lado derecho de la pantalla, haga clic en el botón `Alterar` correspondiente al SKU deseado.
5. En el formulario, localice el campo **Políticas Comerciales**.
...
Cada cambio realizado en un SKU necesita tiempo para procesarse completamente, incluidas las asociaciones a las Políticas Comerciales. Usted puede conocer más detalles en el artículo [Cómo funciona la indexación](/es/docs/tutorials/entendiendo-el-funcionamento-de-la-indexacion).
