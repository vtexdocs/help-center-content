...
7. Rellena la información del campo que estás creando:
    ...
    * **Grupo**: nombre del [grupo de especificaciones](/es/docs/tutorials/crear-grupo-de-especificaciones-en-una-categoria) del cual formará parte ese campo.
