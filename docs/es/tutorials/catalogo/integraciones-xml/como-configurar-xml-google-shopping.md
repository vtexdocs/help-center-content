...
> ℹ️ Desenvolvemos um novo tipo de integração com o Google Shopping por API, que permite acompanhamento em tempo real. Saiba mais em [Integración con Google Shopping](/es/docs/tracks/marketplace-de-google-shopping).
