...
Para aplicar un precio diferenciado a los productos por XML, es necesario asociar una tabla de precios de SKU. Para esto, realice los siguientes pasos:
  ...
  2. Busque el archivo XML que se modificará y haga clic en `Editar`. Si quiere crear uno nuevo, lea nuestro artículo [Configurar XML](/es/docs/tutorials/como-configurar-xml).
...
![PT-tabela de precos](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/precios/lista-de-precios/crear-xml-con-precio-promocional-por-tabla-de-precios_1.png)
...
![XML-exemplo](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/precios/lista-de-precios/crear-xml-con-precio-promocional-por-tabla-de-precios_2.png)
