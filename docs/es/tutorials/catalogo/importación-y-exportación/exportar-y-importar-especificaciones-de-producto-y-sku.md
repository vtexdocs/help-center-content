...
Después de definir el árbol de categorías y registrar las [especificaciones de los productos y de los SKU](/es/docs/tracks/especificaciones-definicion-de-concepto) en su tienda, debe rellenar los valores de las especificaciones que ha creado. En VTEX Admin, este proceso puede realizarse mediante una plantilla o manualmente en el registro de [producto](/es/docs/tutorials/registrar-especificaciones-o-campos-de-producto#registro-de-producto) y en el [registro del SKU](/es/docs/tutorials/registrar-especificaciones-o-campos-de-sku#registro-del-sku).
...
3. Haz clic en la pestaña __Especificaciones de producto__ o **Especificaciones de SKU**, en función de sus necesidades.
    ![skuexport1.es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/importación-y-exportación/exportar-y-importar-especificaciones-de-producto-y-sku_1.png)
...
![skuexport2.es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/importación-y-exportación/exportar-y-importar-especificaciones-de-producto-y-sku_2.png)
...
![skuexport3.es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/catalogo/importación-y-exportación/exportar-y-importar-especificaciones-de-producto-y-sku_3.png)
