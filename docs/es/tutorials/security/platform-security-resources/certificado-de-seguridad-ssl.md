...
<p>Algunas tiendas pueden necesitar certificados personalizados para cumplir con requisitos de compliance o seguridad. Para atender esa necesidad, la página <strong>Certificados SSL</strong> permite instalar y gestionar certificados personalizados. Está disponible en el Admin VTEX para tiendas que utilizan <a href="https://help.vtex.com/es/tutorial/vtex-shield--2CVk6H9eY2CBtHjtDI7BFh">VTEX Shield</a> y elijan este recurso. Para más información, consulta la guía <a href="https://help.vtex.com/es/tutorial/certificados-ssl-personalizados--1hoaDEbU50PDZSe6AYep9q">Certificados SSL personalizados</a>.</p>
</div>
