...
Después de agregar un [producto o SKU](https://help.vtex.com/es/tutorial/produtos-e-skus--2ig7TmROlirWirZjFWZ3By) a tu catálogo, no puedes eliminarlo individualmente porque la plataforma VTEX solo permite la eliminación en masa de productos y SKUs mediante [Mantenimiento de base de datos (full cleanup)](https://help.vtex.com/es/tutorial/manutencao-de-base-full-cleanup--34P9LGs7BCIQK6acQom802). Sin embargo, puedes desactivar un producto o SKU para evitar que se muestre en el storefront. 
...
2. Haz clic en la fila del producto deseado. Si lo prefieres, puedes utilizar la [barra de búsqueda](https://help.vtex.com/es/tutorial/produtos-e-skus--2ig7TmROlirWirZjFWZ3By#buscar-productos).
...
1. En el Admin VTEX, accede a **Catálogo > Productos y SKUs** o ingresa **Productos y SKUs** en la barra de búsqueda en la parte superior de la página.
2. Haz clic en la flecha hacia abajo junto al nombre del producto para mostrar los SKUs vinculados. Puedes utilizar la [barra de búsqueda](https://help.vtex.com/es/tutorial/produtos-e-skus--2ig7TmROlirWirZjFWZ3By#buscar-productos) si lo deseas.
...
* [Productos y SKUs](https://help.vtex.com/es/tutorial/produtos-e-skus--2ig7TmROlirWirZjFWZ3By)
* [Agregar o editar productos](https://help.vtex.com/es/tutorial/adicionar-ou-editar-produto--29IkdEu6GofCFlltsZh2H8)
* [Agregar o editar SKUs](https://help.vtex.com/es/tutorial/adicionar-ou-editar-sku--4ryZ6J45kwn3jDiQBxGiiN)
