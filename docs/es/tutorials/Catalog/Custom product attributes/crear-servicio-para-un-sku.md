...
Puedes configurar los servicios de SKU a través del <b>Catalog API</b> utilizando los endpoints de <a href="https://developers.vtex.com/docs/api-reference/catalog-api#post-/api/catalog/pvt/skuservicetype">SKU service</a>.
</div>
