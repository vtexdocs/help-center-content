...
2. Copia el valor del campo **Identificador de la aplicación**. Debes ingresar este valor en el campo **Client ID** al [configurar el Inicio de sesión con Facebook en el Admin VTEX](/es/docs/tutorials/configurar-inicio-de-sesion-con-facebook-y-google).
3. En **Clave secreta de aplicación**, haz clic en el botón **Mostrar** y, a continuación, copia el valor del campo. Debes ingresar este valor en el campo **Secreto del cliente** al [configurar el inicio de sesión con Facebook en el Admin VTEX](/es/docs/tutorials/configurar-inicio-de-sesion-con-facebook-y-google).
