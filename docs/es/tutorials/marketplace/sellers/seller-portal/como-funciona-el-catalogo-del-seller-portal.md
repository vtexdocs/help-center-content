...
![ilustra-catalogoES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/marketplace/sellers/seller-portal/como-funciona-el-catalogo-del-seller-portal_1.png)
...
- **Anuncios:** nombre que le damos a un producto o variación de un seller que posee condiciones propias de precio y stock, y que ha sido enviado a un canal, el marketplace. Vea más sobre [anuncios](/es/docs/tutorials/anuncios-y-envio-de-productos-al-marketplace).  
