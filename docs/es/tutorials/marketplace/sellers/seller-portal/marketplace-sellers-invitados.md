...
![ES Seller invite](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/marketplace/sellers/seller-portal/marketplace-sellers-invitados_1.jpg)
...
4. Rellene los **Datos generales** del seller:  
    - **Nombre del seller:** nombre del representante comercial del seller, que orquestará la conexión junto con él. Esta persona debe [tener un perfil de acceso al OMS](/es/docs/tutorials/roles#oms-full-access).
