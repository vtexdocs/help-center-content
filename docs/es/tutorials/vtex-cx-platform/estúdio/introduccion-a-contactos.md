...
- Importar Contactos: Botón para importar una hoja de cálculo (con algunas reglas de construcción) con contactos externos a la plataforma. Si el usuario está en esa hoja, la VTEX CX Platform lo reconoce y puede tratarlo por el nombre registrado desde el primer mensaje enviado por la plataforma.
