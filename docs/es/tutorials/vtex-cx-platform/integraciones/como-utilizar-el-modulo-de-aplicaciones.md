...
Para facilitar y agilizar la atención de tus clientes, VTEX CX Platform te permite realizar integraciones con tu chatbot, de forma rápida y sencilla, en varios tipos de canales de comunicación, entre ellos:
...
[**Telegram**](https://docs.weni.ai/l/es/modulo-aplicaciones/c-mo-crear-un-canal-en-telegram) , puedes conectarte con una de las principales aplicaciones de mensajería para tu audiencia en la VTEX CX Platform. Envía y recibe textos, videos y audios a través de este canal, asegurando la comodidad de tu público, así como los recursos disponibles en la plataforma.

[**VTEX CX Platform Web Chat**](https://docs.weni.ai/l/es/configuraciones/canal-weni-web-chat) , para tener la experiencia de atención humanizada de laVTEX CX Platformtaforma VTEX CX Platform en tu sitio web o plataforma online. Al integrar el canal, puedes personalizar aspectos como: color, separación entre mensajes, indicadores de mensajes, avatar, ¡y mucho más! Así, garantizas un chatbot con la imagen de tu marca.
