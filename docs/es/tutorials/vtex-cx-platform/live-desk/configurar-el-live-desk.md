...
Al igual que los otros módulos de la VTEX CX Platform, el módulo **Live Desk** está dentro de un proyecto, por lo que es necesario que el usuario que lo configure sea administrador o moderador de dicho proyecto.

Para que un agente pueda utilizar el módulo Live Desk, es necesario que esté asignado a un **sector**, que es el nombre dado a un grupo de atención. Cada sector está compuesto por al menos un gerente, una cola y un agente.
...
Toda esta gestión se lleva a cabo dentro del proyecto, en **Configuraciones > Live Desk**.
...
Si un agente está asignado a más de una cola, ya sea dentro del mismo sector o en sectores diferentes, el módulo **Live Desk** distribuirá los atendimientos al agente según el **orden de llegada**.
