...
3. Abre un ticket para nuestro [Soporte](/es/support?/cultureInfo=es-419) para registrar el aviso de vulnerabilidad de seguridad. No olvides adjuntar el modelo de comunicación de vulnerabilidades y rellena todos los datos solicitados en el ticket de soporte.
...
VTEX se compromete a responder a los tickets que reciba el equipo de [Soporte](/es/support?/cultureInfo=es-419) lo antes posible, notificando la corrección de la vulnerabilidad o proporcionando motivos coherentes por los que los análisis o las correcciones puedan no llevarse a cabo.
