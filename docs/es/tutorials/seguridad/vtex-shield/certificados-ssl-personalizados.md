...
* Ser un usuario asociado a un [rol](/es/docs/tutorials/roles) con los siguientes [recursos de License Manager](/es/docs/tutorials/recursos-del-license-manager) para ver y gestionar la información de la página:
