...
| SddDiffCleanlinessProbe | Sondeo de limpieza de diffs (SDD). | Evento de verificación emitido durante una comprobación de auditoría de intercambio de token on-behalf-of (OBO). |
