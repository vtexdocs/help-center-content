...
> ⚠️ Algunas tiendas pueden necesitar certificados personalizados para cumplir con requisitos de compliance o seguridad. Para atender esa necesidad, la página **Certificados SSL** permite instalar y gestionar certificados personalizados. Está disponible en el Admin VTEX para tiendas que utilizan [VTEX Shield](/es/tutorial/vtex-shield--2CVk6H9eY2CBtHjtDI7BFh) y elijan este recurso. Para más información, consulta la guía [Certificados SSL personalizados](/es/tutorial/certificados-ssl-personalizados--1hoaDEbU50PDZSe6AYep9q).
