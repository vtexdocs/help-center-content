...
Si necesitas cambiar el valor de un encabezado de respuesta de seguridad en una tienda Store Framework, abre un ticket con el [soporte VTEX](https://supporticket.vtex.com/support).
