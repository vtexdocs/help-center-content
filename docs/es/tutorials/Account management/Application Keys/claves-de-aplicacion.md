...
Como las claves de aplicación permiten que sistemas externos accedan a tu cuenta, solo pueden ser creadas por usuarios con el recurso `License Manager / Services access control / Save user` en sus [roles](/es/tutorial/roles-de-acceso--7HKK5Uau2H6wxE1rH5oRbc).
...
Para que una clave de aplicación pueda realizar requests de API a tu cuenta, debe estar activa y tener [roles](/es/tutorial/perfis-de-acesso--7HKK5Uau2H6wxE1rH5oRbc) que especifiquen los recursos de la cuenta a los que puede acceder. 
