...
**Modificar pedido** utiliza nuevas plantillas para los [emails transaccionales](https://help.vtex.com/es/tutorial/templates-de-emails-transacionais--3g2S2kqBOoSGcCaqMYK2my) (Message Center) que se ajustan a las funcionalidades innovadoras de la solución.
...
| :---: | :--- |
| **Polling**Baja complejidad | Después de la operación de modificación del pedido se genera un código único que la identifica, `requestId`, y que permite dar seguimiento a los detalles del request a través del endpoint [Get order modifications details](https://developers.vtex.com/docs/api-reference/orders-api#get-/api/order-system/orders/-changeOrderId-/changes/-changeRequestId-). Tras la modificación del pedido, la propiedad del cuerpo de respuesta `finished` pasa a tener el valor `true` en este endpoint.Además, [Get order modifications details](https://developers.vtex.com/docs/api-reference/orders-api#get-/api/order-system/orders/-changeOrderId-/changes/-changeRequestId-) también se puede utilizar para obtener información sobre fallos y errores que dieron lugar a la cancelación de la operación de modificación del pedido, según se describe en la sección [Requests con errores y fallos](#requests-con-errores-y-fallos). |
| **Preview**Mediana complejidad | Antes de enviar un request a [Create order modifications](https://developers.vtex.com/docs/api-reference/orders-api#patch-/api/order-system/orders/-changeOrderId-/changes), la integración tiene la opción de obtener una vista previa que produce un cuerpo de respuesta exactamente igual al del request de modificación. Para ello, solo hay que utilizar el mismo cuerpo de request en el request enviado al endpoint [Preview order modifications](https://developers.vtex.com/docs/api-reference/orders-api#post-/api/order-system/orders/-changeOrderId-/changes/preview).Esta vista previa es una simulación de la modificación y no genera efectos reales de modificar el pedido. El uso de [Preview order modifications](https://developers.vtex.com/docs/api-reference/orders-api#post-/api/order-system/orders/-changeOrderId-/changes/preview) es útil para obtener los valores totales asociados a la modificación del pedido en cuestión y también para validar los detalles del requests con un cuerpo de request válido.Tras recibir una respuesta de éxito `200 OK` para obtener la vista previa de la modificación, la integración puede proceder con el request a [Create order modifications](https://developers.vtex.com/docs/api-reference/orders-api#patch-/api/order-system/orders/-changeOrderId-/changes) para modificar el pedido.Luego, puedes adaptar la integración a escenarios tales como:<ul><li>**Creación optimista:** los datos de las validaciones obtenidas con la simulación de la modificación cubren la mayor parte de los casos de éxito `200 OK`.</li><li>**Implementación de polling:** mencionado anteriormente.</li></ul> |
...
| :--- | :--- |
| Modificar pedidos en el Admin VTEX:<ul><li>[Cómo funciona Modificar pedido](https://help.vtex.com/es/tutorial/como-funciona-a-alterar-pedido-beta--56TO0bOFXsfmpc7YZ3wIUZ)</li><li>[Cómo modificar pedidos](https://help.vtex.com/es/tutorial/como-alterar-pedidos-beta--7btlG91rb6sHpW1dkd2kBw)</li></ul> | Modificar pedidos vía API:<ul><li>[Create order modifications](https://developers.vtex.com/docs/api-reference/orders-api#patch-/api/order-system/orders/-changeOrderId-/changes)</li><li>[Preview order modifications](https://developers.vtex.com/docs/api-reference/orders-api#post-/api/order-system/orders/-changeOrderId-/changes/preview)</li><li>[Get order modifications details](https://developers.vtex.com/docs/api-reference/orders-api#get-/api/order-system/orders/-changeOrderId-/changes/-changeRequestId-)</li><li>[Get order modifications history](https://developers.vtex.com/docs/api-reference/orders-api#get-/api/order-system/orders/-changeOrderId-/changes)</li><li>[Retry modifications change](https://developers.vtex.com/docs/api-reference/orders-api#post-/api/order-system/orders/-changeOrderId-/changes/-changeRequestId-/retry)</li><li>[Cancel modifications change](https://developers.vtex.com/docs/api-reference/orders-api#post-/api/order-system/orders/-changeOrderId-/changes/-changeRequestId-/cancel)</li></ul> |
