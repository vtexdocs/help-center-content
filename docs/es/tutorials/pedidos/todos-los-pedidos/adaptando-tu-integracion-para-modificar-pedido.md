...
Para evolucionar las modificaciones de pedidos en la plataforma VTEX, estamos lanzando [Modificar pedido](/es/docs/tutorials/como-funciona-modificar-pedido), una solución mucho más completa, versátil y que proporciona una [nueva experiencia en el Admin VTEX](/es/docs/tutorials/como-modificar-pedidos).
...
**Modificar pedido** utiliza nuevas plantillas para los [emails transaccionales](/es/docs/tutorials/plantillas-de-emails-transaccionales-del-pedido) (Message Center) que se ajustan a las funcionalidades innovadoras de la solución.

Para personalizar una plantilla de email en el Admin VTEX, copia y pega el siguiente link en tu navegador sustituyendo `{nombreDeCuenta}` por el [nombre de cuenta](/es/docs/tutorials/que-es-account-name) de tu tienda, y luego pulsa `Enter`:
...
En **Modificar pedido**, el endpoint [Create order modifications](https://developers.vtex.com/docs/api-reference/orders-api#patch-/api/order-system/orders/-changeOrderId-/changes) funciona de forma asíncrona y el [usuario](/es/docs/tutorials/gestionar-usuarios-administradores) o integración que realiza el request recibe un `requestId` de la plataforma, que se trata de un identificador único para dar seguimiento a la operación de modificación del pedido. Este identificador luego se utilizará en determinados endpoints. Todos los endpoints de **Modificar pedido** son:
