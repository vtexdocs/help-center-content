...
![Order Listing EN](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/todos-los-pedidos/todos-los-pedidos_1.gif)
...
Los datos del archivo reflejan el contenido de la página en el momento de la exportación, incluidos los filtros aplicados. Aprende más sobre cada campo del informe en [Informe de pedidos](/es/docs/tutorials/informe-de-pedidos).
...
Para saber más sobre todas las opciones de filtros, consulta el artículo [Filtrar pedidos en Todos los pedidos](/es/docs/tutorials/filtrar-todos-los-pedidos).
...
Al seleccionar un pedido de la lista, se te redirigirá a la página [Detalles del pedido](/es/docs/tutorials/pagina-de-detalles-del-pedido).

A continuación, encontrarás más detalles sobre cada columna:

* **Status:** identifica en que etapa del flujo se encuentra el pedido. Puedes ver más información en [Flujo y status de pedidos](/es/docs/tutorials/flujo-y-status-de-pedidos).  
...
![VTEX Do overview ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/todos-los-pedidos/todos-los-pedidos_2.gif)

[VTEX DO](/es/docs/tutorials/vtex-do-interface) es un gestor de tareas creadas por el Admin VTEX automáticamente y que requieren una acción manual por parte del equipo de _ecommerce_. 
