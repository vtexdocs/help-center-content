...
La baja en la reserva no ocurre automáticamente, esto debe ser controlado por su ERP. Para entender más detalles de cómo funciona la reserva, vea nuestra documentación [Cómo se maneja la reserva](/es/docs/tutorials/como-se-maneja-la-reserva).
