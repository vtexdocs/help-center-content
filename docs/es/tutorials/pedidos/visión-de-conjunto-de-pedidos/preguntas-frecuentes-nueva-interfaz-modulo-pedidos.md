...
Hemos transformado el módulo **Todos los pedidos** del Admin VTEX para ofrecer una experiencia más intuitiva y completa. Una de las últimas mejoras es que ahora puedes [buscar pedidos sin límite de fecha](/es/docs/tutorials/filtrar-todos-los-pedidos) sin la restricción de solamente en los últimos seis meses.
...
![board_comparativo_interface_pedido_v2_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_1.png)

## ¿Qué pasó con el filtro de búsqueda de seis meses?

El filtro de seis meses fue sustituido por la búsqueda sin límite de fecha que devuelve los pedidos relacionados con el criterio utilizado, independientemente de la fecha de creación del pedido. Por ejemplo, puedes acceder al historial de compras completo de un cliente utilizando su nombre, email o documento. Aprende más en el artículo [Filtrar pedidos en Todos los pedidos](/es/docs/tutorials/filtrar-todos-los-pedidos).
...
![busca_sem_limite_data_all_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_2.png)
...
![timeline_pedido_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_3.png)
...
![diagrama_pedido_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_4.png)
...
![faturar_referenciar_pedidos_final_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_5.png)
...
![enviar_email_es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pedidos/visión-de-conjunto-de-pedidos/preguntas-frecuentes-nueva-interfaz-modulo-pedidos_6.png)
