...
Las claves de API externas son credenciales generadas y administradas por otras cuentas VTEX. Al agregar [roles](/es/tutorial/roles) a las claves de API (el equivalente a nombres de usuario) proporcionadas por terceros, puedes permitirles acceso a recursos específicos de tu cuenta.
...
5. Selecciona los [roles](/es/tutorial/roles) que se asociarán a la clave. De manera predeterminada, no se preselecciona ningún rol.  
...
* [Claves generadas](/es/tutorial/claves-generadas)
