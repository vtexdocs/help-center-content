...
8. En el campo **Links**, haz clic en `Add`.
    ...
    ![cms-layout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/gesti%C3%B3n-de-la-cuenta/cuentas/gestionar-multitienda_1.png)
