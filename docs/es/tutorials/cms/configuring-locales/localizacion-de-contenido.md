...
Dentro de una entrada, puedes traducir un solo campo o toda la entrada. El contenido se traduce desde la \[configuración regional predeterminada\](/tbd) a una o más configuraciones regionales de destino seleccionadas.
