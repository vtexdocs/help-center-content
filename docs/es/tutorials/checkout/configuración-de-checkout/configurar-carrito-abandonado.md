...
![template xhtml](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-carrito-abandonado_1.PNG)
...
![CEM-Abandoned-Cart](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-carrito-abandonado_2.PNG)
...
![New template - message center](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-carrito-abandonado_3.PNG)
...
En esta etapa, es necesario configurar un [trigger en Master Data](/es/docs/tutorials/creando-trigger-en-el-master-data). El proceso consiste en rellenar algunos valores que determinarán la activación del trigger, algunos de los cuales son filtros:
...
- __¿Recibe newsletter?:__ garantiza el cumplimiento de los [derechos de titulares de datos](/es/docs/tutorials/derechos-de-los-titulares-de-datos-personales), ya que solo los clientes suscritos al newsletter recibirán emails de carrito abandonado. La suscripción al newsletter se puede gestionar desde el checkout o en la sección [Mi cuenta](/es/tutorial/como-funciona-a-minha-conta--2BQ3GiqhqGJTXsWVuio3Xh#perfil) de la tienda. El trigger se activa si el valor es verdadero.
...
![If positive tab IO](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-carrito-abandonado_5.PNG)
