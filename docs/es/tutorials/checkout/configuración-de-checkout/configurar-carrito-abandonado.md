...
- __¿Recibe newsletter?:__ garantiza el cumplimiento de los [derechos de titulares de datos](/es/docs/tutorials/derechos-de-los-titulares-de-datos-personales), ya que solo los clientes suscritos al newsletter recibirán emails de carrito abandonado. La suscripción al newsletter se puede gestionar desde el checkout o en la sección [Mi cuenta](/es/docs/tutorials/como-funciona-mi-cuenta#perfil) de la tienda. El trigger se activa si el valor es verdadero.
