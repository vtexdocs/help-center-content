...
![Minimum Order Value - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/como-configurar-el-valor-minimo-por-pedido-y-la-cantidad-maxima-de-items-por_1.png)
...
![Cantidad máxima de un mismo SKU en el carrito](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/como-configurar-el-valor-minimo-por-pedido-y-la-cantidad-maxima-de-items-por_2.png)
