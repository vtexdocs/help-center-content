...
![Colores](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuraci%C3%B3n-de-checkout/ajustes-en-la-interfaz-personalizada-del-checkout-en-el-admin_1.png)

## JavaScript

La pestaña JavaScript agrega un nivel adicional de personalización de la interfaz al posibilitar la inserción de scripts.

![Java - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuraci%C3%B3n-de-checkout/ajustes-en-la-interfaz-personalizada-del-checkout-en-el-admin_2.png)

## CSS

La pestaña CSS permite ajustar el aspecto visual de la tienda mediante la inclusión de código CSS.

![CSS - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuraci%C3%B3n-de-checkout/ajustes-en-la-interfaz-personalizada-del-checkout-en-el-admin_3.png)

## Historial

Permite ver y restaurar las personalizaciones creadas y publicadas anteriormente.

![Histórico - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuraci%C3%B3n-de-checkout/ajustes-en-la-interfaz-personalizada-del-checkout-en-el-admin_4.png)
