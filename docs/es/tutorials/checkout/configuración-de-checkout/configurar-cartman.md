...
3. En la esquina inferior derecha de la pantalla, haga clic en el botón <img src="https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_5.png" alt="cartman-icon" width="25"/> para acceder a Cartman.
...
Para más información sobre esta herramienta, consulta el artículo [Simulador de promociones](/es/docs/tutorials/simulador-de-promociones-beta).
...
![Detalles del ítem](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_1.PNG)
...
![Agregar ítems por ID de SKU](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_2.PNG)
...
![Agregar ítems al azar](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_3.PNG)
...
![Establecer datos de marketing](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_4.PNG)
...
1. Acceda a cualquier página de Checkout de su tienda   (`https://{accountname}.myvtex.com/checkout/`).
2. En la esquina inferior derecha de la pantalla, haga clic en el botón <img src="https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/checkout/configuración-de-checkout/configurar-cartman_6.png" alt="cartman-icon" width="25"/>.
