...
1. En el Admin VTEX, [agrega un nuevo](/es/docs/tutorials/registro-de-puntos-de-recogida) punto de recogida en la tienda, con stock para suministrar los ítems que abastecerán dicho punto de recogida.
2. [Crea una nueva política de envío](/es/docs/tutorials/politica-de-envio) cuya estrategia de envío coincida con la estrategia de envío previamente configurada en la política que utiliza la tienda física donde se recogerán los productos.
