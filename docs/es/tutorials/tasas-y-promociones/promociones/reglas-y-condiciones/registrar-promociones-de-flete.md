...
En la plataforma VTEX, usted puede crear diversas modalidades de [descuentos](/es/tutorial/como-criar-promocoes) para su tienda. Con las promociones de flete, el comprador recibe un descuento en el valor cobrado para la entrega de su pedido.

El paso a paso para crear una promoción de flete es el mismo de las [demás promociones regulares](/es/docs/tutorials/registro-promocion-regular). Sin embargo, hay algunas especificidades que se deben tener en cuenta al configurar este tipo de promociones.

Antes de configurar cualquier promoción de coste de envío, debe entender cuáles son las formas de ofrecer el descuento a los compradores. En VTEX, hay cuatro opciones de promoción de flete, que se pueden seleccionar en el campo **¿Qué tipo e importe de descuento?** [durante la creación de la Promoción regular](/es/docs/tutorials/registro-promocion-regular). Vea las opciones a continuación.
...
#### Configuración
![Aplicar el descuento solo para la opción de envío más barata - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_1.png)

#### Resultado
![saggincaso1.2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_2.png)
...
#### Configuración
![Nenhum frete selecionado - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_3.png)

#### Resultado
![saggincaso2.2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_4.png)
...
#### Configuración
![Tipo de carga - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_5.png)

#### Resultado
![saggincaso2.2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_6.png)
...
#### Configuración
![Tipo de Frete e Aplicar o desconto somente quando uma das transportadoras acima for selecionada pelo cliente - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_7.png)

#### Resultado
![saggincaso3.2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/registrar-promociones-de-flete_8.png)
