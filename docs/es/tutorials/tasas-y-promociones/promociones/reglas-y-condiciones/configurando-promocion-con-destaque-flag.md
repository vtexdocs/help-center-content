...
![ExemploPromocaoDestaque2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/configurando-promocion-con-destaque-flag_1.png)
...
5. En el menú lateral, haz clic en el layout marcado con una marca de verificación roja.
    ...
    ![template-pagina](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/configurando-promocion-con-destaque-flag_2.gif)

6. En el campo __Template__, marca el nombre de la plantilla utilizada:

    ![template-produto](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/configurando-promocion-con-destaque-flag_3.png)

7. En el menú lateral, haz clic en **HTML Templates > @Producto@**.

    ![save-template](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/configurando-promocion-con-destaque-flag_4.gif)
...
2.  Haz clic en **CMS > Shelves Templates**.
    ...
    ![shelves-templates](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/reglas-y-condiciones/configurando-promocion-con-destaque-flag_5.png)
