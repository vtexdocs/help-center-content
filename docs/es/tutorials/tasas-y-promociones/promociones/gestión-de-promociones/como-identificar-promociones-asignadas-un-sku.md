...
2. En Google Chrome, acceder a las **Herramientas de Desarolladores** (`Ctrl+Shift+I`).![ferramentas-do-desenvolvedor](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/gestión-de-promociones/como-identificar-promociones-asignadas-un-sku_1.png)
3. Seleccione **Network** y presione `F5` para registrar la carga de la página.![network-f5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/gestión-de-promociones/como-identificar-promociones-asignadas-un-sku_2.png)
4. Después de la carga, presione `Ctrl+F` para hacer búsqueda en la ventana de Herramientas de Desarolladores y busque por `orderForm`.![order-form](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/tasas-y-promociones/promociones/gestión-de-promociones/como-identificar-promociones-asignadas-un-sku_3.png)
