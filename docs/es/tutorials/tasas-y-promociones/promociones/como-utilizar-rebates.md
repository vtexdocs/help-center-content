...
El escenario B2B tiene diversas estrategias de incentivo, una de las más utilizadas es el rebate. Lea el artículo [Promociones más comunes para B2B](/es/docs/tutorials/promociones-mas-comunes-para-b2b) para conocer más estrategias de incentivo.
...
La forma más adecuada de utilizar el rebate recibido de los proveedores es a través de [Promociones regulares](/es/tracks/promociones--6asfF1vFYiZgTQtOzwJchR/7FjbeZdE2KMwk5L1t98pZI) con las restricciones de uso que se requieren. Para saber más sobre las opciones de Promoción Regular, lea nuestro artículo [Ejemplos de promoción](/es/docs/tutorials/ejemplos-de-promociones).
...
Para identificar los campos de la promoción que se deben completar, lea nuestro artículo [Campos de la promoción regular](/es/docs/tutorials/registro-promocion-regular). 
