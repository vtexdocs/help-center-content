...
La forma más adecuada de utilizar el rebate recibido de los proveedores es a través de [Promociones regulares](/es/docs/tracks/crear-promocion-regular) con las restricciones de uso que se requieren. Para saber más sobre las opciones de Promoción Regular, lea nuestro artículo [Ejemplos de promoción](/es/docs/tutorials/ejemplos-de-promociones).
