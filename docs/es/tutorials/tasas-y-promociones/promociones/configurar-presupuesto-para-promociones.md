...
> ℹ️ Esta funcionalidad está en fase de pruebas (beta cerrada). Si estás interesado en participar, abre un ticket con el equipo de [ Soporte de VTEX ](/es/support).
