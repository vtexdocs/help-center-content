...
* **[Tarifa de envío](/es/docs/tutorials/tarifas-de-envio)**: es la tarifa registrada con la política de envío, y corresponde a la tarifa de la transportadora o de un punto de recogida. No tiene en cuenta los costos de muelle y almacén. Esta tarifa considera:
    * Un costo fijo de flete.
    * [Adicionales de flete](/es/docs/tutorials/adicionales-de-flete): adicional de peso, adicional de precio, adicional de seguro y adicional de flete. 
