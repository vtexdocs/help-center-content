...
Los adicionales de flete son importes que se añaden al costo de envío mediante las [políticas de envío](/es/docs/tutorials/politica-de-envio). Así, al configurar un valor de costo para la entrega de los ítems de su tienda, puede establecer una tarifa fija e incluir valores adicionales. El costo de envío fijo más los adicionales constituyen el costo de la [tarifa de envío](/es/docs/tutorials/gestionar-las-tarifas-de-envio).

![Tarifa envio ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/tarifas-de-envío/adicionales-de-flete_1.svg)
...
> ❗ Es posible tener todos los adicionales configurados al mismo tiempo para una única tarifa de envío. El cálculo final de la [tarifa de envío](/es/docs/tutorials/tarifas-de-envio) es la suma de todos los adicionales registrados más la tarifa fija del flete. La tarifa de envío no es el costo final de envío.
...
![faixa-peso ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/tarifas-de-envío/adicionales-de-flete_3.png)

### Configuración 

Hay dos formas de configurar el adicional de peso. Para saber más, acceda a los tutoriales.

* Por [Plantilla de flete](/es/docs/tutorials/plantilla-de-flete), utilizando el campo de la columna _PriceByExtraWeight_.
* Y en la página de [Tarifas de Envío](/es/docs/tutorials/gestionar-las-tarifas-de-envio), en el campo _valor adicional por peso_.
...
* Por [Plantilla de flete](/es/docs/tutorials/plantilla-de-flete), utilizando el campo de la columna _PricePercent_.
* Y en la página de [Tarifas de Envío](/es/docs/tutorials/gestionar-las-tarifas-de-envio), en el campo _valor adicional_.
...
Durante el registro de los costos de la [política de envío](/es/docs/tutorials/politica-de-envio) mediante la [plantilla de flete](/es/docs/tutorials/plantilla-de-flete), para los códigos postales o polígonos seleccionados, si hay un **adicional de seguro** configurado de $3,00, se añadirá este valor para cada envío en esa ubicación.
...
El adicional de seguro se configura en la [plantilla de flete](/es/docs/tutorials/plantilla-de-flete), en el campo _MinimumValueInsurance_.
...
![adicional configuracoes ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/tarifas-de-envío/adicionales-de-flete_4.png)
