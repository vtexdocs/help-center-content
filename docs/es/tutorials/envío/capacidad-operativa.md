...
![operational_capacity_image_1_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/capacidad-operativa_1.png)
...
> ℹ️ Puede asociarse la búsqueda de sellers con el [filtro por status](/es/docs/tutorials/capacidad-operativa#filtrar-sellers). Si no se devuelve ningún resultado, comprueba que no haya ningún filtro activo.
...
![operational_capacity_image_2_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/capacidad-operativa_2.png)
...
![operational_capacity_image_3_ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/envío/capacidad-operativa_3.png)
...
> ⚠️ En cualquier momento puedes volver a [activar el módulo Capacidad operativa](/es/docs/tutorials/capacidad-operativa) para gestionar la capacidad de tus sellers.
