...
| `PricePercent`          | [Adicional de precio](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV), calculado según el precio de los productos en el carrito y expresado en número decimal. Para rellenar la tabla, utilice el valor en porcentaje. Por ejemplo, para un 10% adicional, complete la tabla con el número 10. | Utilice este campo en los casos en que haya un costo adicional en el precio de la entrega. Los [adicionales de flete](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV) se suman al valor fijo.                                                                                                                                               |
| `PriceByExtraWeight`    | [Adicional por peso](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV), calculado según el peso del carrito, expresado en número decimal. | Utilice este campo en los casos en que haya un costo adicional en el precio de la entrega. Los [adicionales de flete](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV) se suman al valor fijo.<br>Tenga en cuenta que la unidad de peso es la misma que se utiliza para rellenar los campos de [registro de SKU](/es/tutorial/campos-de-cadastro-de-sku--21DDItuEQc6mseiW8EakcY). |
...
| `MinimumValueInsurance` | [Valor adicional de seguro](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV), configurado con un valor absoluto, expresado en número decimal. | El valor registrado en el campo se añade al valor del flete. Sin embargo, solo se añadirá cuando el [Adicional de precio](/es/tutorial/adicionais-de-frete--2vqGwMn0LabkOHY6zSHYNV) sea menor que el campo **MinimumValueInsurance**.<br>Vea [¿Para qué sirve el campo Minimum Value Insurance?](/es/faq/para-que-serve-o-campo-na-tabela-de-frete-minimum-value-insurance). |
