...
En VTEX, es posible determinar los horarios de atención de las [transportadoras](/es/docs/tutorials/transportadoras-en-vtex) de tu tienda a través de configuraciones de la [política de envío](/es/docs/tutorials/politica-de-envio), en la que defines los períodos laborales para que la transportadora recolecte y envíe los pedidos.

Para configurar el horario laboral, an el Admin VTEX acceda a **Envío > Estrategia de envío** y cree una [nueva política de envío](/es/docs/tutorials/crear-una-politica-de-envio) o [edite](/es/docs/tutorials/gestionar-politicas-de-envio) una existente.
...
1. En la [política de envío](/es/docs/tutorials/politica-de-envio), en la seción **Horario laboral**, haga clic en `Ventana de envío`.
2. Si quieres activar la opción `Aceptar compras fuera del horario laboral`, activa el interruptor. De lo contrario, déjelo desactivado.
  ...
  > ℹ️ Cuando esta opción está habilitada, el [cálculo del envío](/es/docs/tutorials/como-funciona-el-calculo-del-envio) del pedido se ve influenciado y al tiempo total de envío se suma el tiempo desde que se realiza el pedido hasta la hora de apertura del transportista.
...
1. En la [política de envío](/es/docs/tutorials/politica-de-envio), en la seción **Horario laboral**, haga clic en la ventana `Hora de recogida`.
