...
> ℹ️ Para añadir ítems a su almacén, los productos deben estar previamente registrados en el [catálogo](/es/docs/tracks/arquitectura-del-catalogo). Con ello, es posible asociarlos al almacén mediante la [ gestión del stock](/es/docs/tutorials/gestionar-items-en-inventario). 
...
- Para saber cómo registrar, modificar y hacer un seguimiento de los almacenes, consulte el artículo [Gestión del almacén](/es/docs/tutorials/gestionar-almacenes).
- Para hacer un seguimiento y gestionar los ítems del almacén, consulte [Gestión del stock](/es/docs/tutorials/gestionar-items-en-inventario).
- Para configurar y gestionar la relación entre los almacenes y la retirada de pedidos, consulte [Gestión de muelles](/es/docs/tutorials/gestionar-el-muelle). 

> ⚠️ Como el almacén forma parte del sistema logístico de su tienda, le sugerimos que registre los módulos relacionados con la operación logística en el siguiente orden: <ul> <li>[Política de envío](/es/docs/tutorials/politica-de-envio)</li> <li>[Muelle](/es/docs/tutorials/muelles)</li> <li>Almacén</li> </ul>