...
| IsInRetry | Informa si se puede realizar un nuevo intento o si el ciclo de la suscripción terminó. <br> `TRUE`: la suscripción aún está en el ciclo de reintentos y hay intentos pendientes. <br> `FALSE`: el ciclo de la suscripción terminó. |
