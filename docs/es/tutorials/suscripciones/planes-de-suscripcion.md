...
La página de **Planes** del módulo de **Suscripciones** muestra la lista de todos los planes de suscripción configurados en su tienda, tanto los creados desde la [página de Nuevo plan](/es/docs/tutorials/como-crear-un-plan-de-suscripcion) como [los anexos de SKU](/es/docs/tutorials/como-crear-un-anexo-de-suscripcion-en-el-modulo-catalogo). 

Para que los planes de suscripción estén disponibles, primero debe instalar la aplicación Suscripciones y configurar todos los ajustes necesarios. Lea el artículo [Cómo configurar Suscripciones en su tienda](/es/docs/tutorials/como-configurar-suscripciones) para más información.
...
![planslist ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/suscripciones/planes-de-suscripcion_1.png)
...
Al hacer clic en el botón `Nuevo plan`, se le dirigirá a la página de registro de un nuevo plan de suscripción. Vea el artículo [Crear un plan de suscripción (Beta)](/es/docs/tutorials/como-crear-un-plan-de-suscripcion) para obtener más detalles sobre este proceso.
...
* **Id:** muestra el identificador del plan de suscripción, que sigue el formato `vtex.subscription.{nombre}`. El ID se genera automáticamente al rellenar el nombre del plan en la [página de creación de planes de suscripción](/es/docs/tutorials/como-crear-un-plan-de-suscripcion) y equivale al nombre del anexo de suscripción [cuando se configura manualmente](/es/docs/tutorials/como-crear-un-anexo-de-suscripcion-en-el-modulo-catalogo). Este campo no se puede modificar.
...
* [Cómo crear un plan de suscripción (Beta)](/es/docs/tutorials/como-crear-un-plan-de-suscripcion)
