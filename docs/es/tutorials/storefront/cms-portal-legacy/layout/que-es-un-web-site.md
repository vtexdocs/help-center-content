...
- [Templates](/es/docs/tutorials/que-son-templates): repositorios de código que estructuran el HTML y hacen referencia a los archivos JavaScript y CSS que se utilizan en las páginas.
- [Layouts](/es/docs/tutorials/que-son-layouts): elementos vinculados a los templates y que configuran los placeholders que se van a mostrar en la página.
- [Placeholders](/es/docs/tutorials/que-son-placeholders): elementos predefinidos que usted puede utilizar para mostrar archivos de contenido en las páginas de su web site.
...
Con todos estos elementos configurados, usted tendrá que enlazar su web site a un [account name](/es/docs/tutorials/que-es-account-name) y a una política comercial, en un proceso llamado [binding](/es/docs/tutorials/que-es-binding).
