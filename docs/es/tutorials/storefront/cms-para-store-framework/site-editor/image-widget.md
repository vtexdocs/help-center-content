...
Image Widget es un repositorio modal de bloques que permite subir imágenes al [Site Editor](/es/docs/tutorials/site-editor-subcategoria). Con este modal, puede subir, almacenar y gestionar las imágenes de su tienda y utilizarlas en diferentes páginas, como la de Inicio, Producto o Newsletter.
