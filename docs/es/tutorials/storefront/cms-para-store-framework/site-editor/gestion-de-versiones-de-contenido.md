...
![Activating Versions - Versiones](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/site-editor/gestion-de-versiones-de-contenido_1.png)
...
Consulta la documentación [Programación de actualizaciones de contenido](/es/docs/tutorials/programar-actualizaciones-de-contenido) y aprende a utilizar el recurso **Visibilidad**.
