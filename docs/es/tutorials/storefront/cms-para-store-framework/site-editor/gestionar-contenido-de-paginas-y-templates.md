...
![seta-interface-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/site-editor/gestionar-contenido-de-paginas-y-templates_1.png)

2. Haga clic en `Versiones` en la esquina superior derecha. 

> ℹ️ El contenido que ve cuando hace clic en un bloque es el que está activo en ese momento. Para más información sobre **Versiones**, acceda [Gestión de versiones de contenido](/es/docs/tutorials/gestion-de-versiones-de-contenido) y [Programar actualizaciones de contenido](/es/docs/tutorials/programar-actualizaciones-de-contenido)
...
![seta-interface-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/site-editor/gestionar-contenido-de-paginas-y-templates_2.png)
...
![seta-interface-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/site-editor/gestionar-contenido-de-paginas-y-templates_3.png)
