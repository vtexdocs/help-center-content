...
Después de [crear una nueva versión de contenido](/es/docs/tutorials/gestion-de-versiones-de-contenido), puedes programar su publicación en tu tienda a través del recurso **Visibilidad**.
