...
5. En el campo **Familia de fuentes**, crea un nombre para la fuente.
    ...
    ![familia-de-fontes-giff-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/estilos/personalizar-la-tipografia-de-tu-tienda_1.gif)
...
3. Haz clic en **Editar > Tipografía > Tokens de tipo**.
    ...
    ![tokens-tipo-giff-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/estilos/personalizar-la-tipografia-de-tu-tienda_2.gif)
