...
![es-redirect-tab](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/páginas/administrando-redireccionamientos-de-url-por-binding_1.png)
...
![es-novoredirect](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/páginas/administrando-redireccionamientos-de-url-por-binding_2.png)
...
![es-remover-redirect](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/páginas/administrando-redireccionamientos-de-url-por-binding_3.png)
...
5. Haga clic en el botón `Guardar` o `Eliminar` según sea el caso. 
  ...
  ![es-redirect-planilha](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-para-store-framework/páginas/administrando-redireccionamientos-de-url-por-binding_4.png)
