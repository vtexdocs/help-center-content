---
title: 'Gestión de Páginas en el Headless CMS (Legacy)'
...
En **Headless CMS (Legacy)**, puedes gestionar todas las rutas de URL y los modelos de página de tu tienda en línea, incluyendo las páginas `Global Alert Page` `Page`,`Product Page`. También puedes crear y asociar páginas personalizadas a plantillas predefinidas y gestionar páginas creadas directamente en el código fuente de tu proyecto de storefront.

## Visión general

![New pages - es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/headless-cms/gestion-de-paginas_1.png)
...
![Gif - Páginas](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/headless-cms/gestion-de-paginas_2.gif)
