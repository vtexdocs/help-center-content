...
Si la tienda utiliza el [buscador de VTEX](/es/docs/tutorials/como-funciona-la-busqueda-legada), pueden utilizarse los siguientes parámetros para implementar la ordenación por puntuación:
...
Los parámetros `OrderByScoreASC` y `OrderByScoreDESC` no son compatibles con [VTEX Intelligent Search](/es/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb), sino únicamente con el [buscador VTEX](/es/docs/tutorials/como-funciona-la-busqueda-legada).
