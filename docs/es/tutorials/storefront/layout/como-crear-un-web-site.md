...
5. Sigue el tutorial [Vincular una tienda a una estructura de carpetas en CMS (binding)](/es/tutorial/vincular-um-account-name-a-um-website-binding) para vincular tu sitio web a un nombre de cuenta.
