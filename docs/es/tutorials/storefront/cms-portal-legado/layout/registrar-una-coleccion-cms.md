...
![2019-06-06 16 22 46-Layout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_1.png)
...
![seleção-departamento ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_2.png)

Lo mismo aplica para los productos de una determinada Categoría o Subcategoría.

![seleção-categoria-subcategoria ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_3.png)

## Productos por Marca

Para crear un grupo con productos de una o más marcas, basta con seleccionar la marca deseada en la lista correspondiente. 

![seleção-marca-coleção ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_4.png)
...
![selecao-sku-manual en & es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_5.png)
...
> ℹ️ Obtenga el modelo de archivo para la inclusión y exclusión de SKUs de la colección [aquí](https://cdn.statically.io/gh/vtexdocs/help-center-content/files-migration-script/docs/es/tutorials/storefront/cms-portal-legado/layout/Colecao.xls).
...
![selecao-sku-planilha-insert en & es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_6.png)
...
![exemplo-planilha-seleção-sku-coleção](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_7.png)

Después de seleccionar la plantilla deseada, haga clic en la opción __import skus__ para enviar la información.

![Import SKUs](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_8.png)
...
![exclusao-skus-manualmente-planilha-coleção-cms en & es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_9.png)
...
![other-options-cms-coleções ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/registrar-una-coleccion-cms_10.png)
