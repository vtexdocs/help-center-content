...
![favicon-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/configurar-el-favicono-de-tu-tienda_1.png)
...
1. En el Admin VTEX, accede a **Storefront > Layout > CMS > Files Manager > imagens**.
    ...
    ![files-manager](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/configurar-el-favicono-de-tu-tienda_2.png)

2. En la segunda columna, haz clic en `Add`.

    ![add-image](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/storefront/cms-portal-legado/layout/configurar-el-favicono-de-tu-tienda_3.png)
