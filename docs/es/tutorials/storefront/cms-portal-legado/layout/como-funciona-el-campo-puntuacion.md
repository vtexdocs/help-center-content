...
Si la tienda utiliza la [VTEX Search (Legado)](/es/docs/tutorials/como-funciona-vtex-search-legado), pueden utilizarse los siguientes parámetros para implementar la ordenación por puntuación:
...
Los parámetros `OrderByScoreASC` y `OrderByScoreDESC` no son compatibles con [VTEX Intelligent Search](/es/tracks/vtex-intelligent-search--19wrbB7nEQcmwzDPl1l4Cb), sino únicamente con la [VTEX Search (Legado)](/es/docs/tutorials/como-funciona-vtex-search-legado).
