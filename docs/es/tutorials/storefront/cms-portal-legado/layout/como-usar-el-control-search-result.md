...
Cuando el usuario realiza una búsqueda en la tienda, el sistema de VTEX intenta traer resultados de acuerdo con un orden de prioridad de filtros. Entienda la búsqueda en el artículo [Cómo funciona la VTEX Search (Legado)](/es/docs/tutorials/como-funciona-vtex-search-legado).
