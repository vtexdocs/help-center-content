...
3. Escriba el nombre __BellunoDigitalBank__ en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En __Autorización del proveedor__, haga clic en __Autorizar com OAuth__. En este punto, serás redirigido a la página de Belluno Digital Bank, donde deberás acceder a tu cuenta y autorizar la conexión de VTEX a tu cuenta de Belluno Digital Bank. Luego del proceso de autorización, regresará automáticamente al VTEX Admin.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Belluno Digital Bank en la pantalla VTEX Admin, ingrese la información en el campo __Nombre__ en __Información general__.
