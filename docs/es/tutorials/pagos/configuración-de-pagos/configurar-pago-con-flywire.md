...
Si quieres utilizar Flywire con pagaré y no has configurado el pagaré como método de pago en otros conectores de tu tienda, accede a [Configurar pagos con Pagaré](/es/docs/tutorials/configurar-pagos-con-pagare).
