...
La liquidación por facturación es una de las etapas del [flujo de la transacción](/es/docs/tutorials/flujo-de-la-transaccion-en-pagos), el proceso interno de VTEX que ocurre después de que un cliente realiza el pago de un pedido.
