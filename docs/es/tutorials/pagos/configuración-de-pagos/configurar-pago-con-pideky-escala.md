---
title: 'Configurar pago con Pideky Escala'
id:
status: PUBLISHED
createdAt: 2026-06-19T00:00:00.000Z
updatedAt: 026-06-19T00:00:00.000Z
publishedAt: 026-06-19T00:00:00.000Z
firstPublishedAt: 026-06-19T00:00:00.000Z
contentType: tutorial
productTeam: Financial
author: 6DODK49lJPk3yvcoe6GB6g
slugEN: setting-up-payments-with-pideky-escala
legacySlug: configurar-pago-con-pideky-escala
locale: es
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

En VTEX es posible la integración con el proveedor de pagos Pideky Escala. Con este proveedor, su tienda puede realizar ventas a través de PidekyEscala e Promissories.

Para configurar Pideky Escala, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **PidekyEscalaConnector** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En **Autorización del proveedor**, rellene los campos de registro **Clave de aplicación** y **Token de aplicación** con los datos proporcionados por su cuenta Pideky Escala.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Pideky Escala en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
...
8. En **Campos del proveedor**, seleccione o complete los campos **API Key**, **API Token**, y **Production** con la información de su cuenta Pideky Escala.
9. Haga clic en `Guardar`.

Para configurar los métodos de pago a procesar por Pideky Escala, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/docs/tutorials/condiciones-de-pago).
...
Después de seguir los pasos indicados, Pideky Escala puede tardar hasta 10 minutos en aparecer en el checkout de tu tienda como una opción de pago.
