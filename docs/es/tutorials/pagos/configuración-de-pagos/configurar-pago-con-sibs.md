...
En VTEX es posible la integración con el proveedor de pagos SIBS. Con este proveedor, tu tienda puede realizar ventas a través de tarjeta de crédito SIBS, tarjetas de crédito y débito, pagarés, MBWay y MultiBanco.

Para configurar SIBS, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **SIBS** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. Rellene los campos de registro __Clave de aplicación__ y __Token de aplicación__ con los datos proporcionados por SIBS.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor SIBS en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
