---
title: 'Configurar pago con Braintree-Wallet'
id:
status: PUBLISHED
...
legacySlug: configurar-pago-con-braintree-wallet
locale: es
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

En VTEX es posible la integración con el proveedor de pagos Braintree-Wallet.
...
Para configurar Braintree-Wallet, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **Braintree-Wallet** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En **Autorización del proveedor**, rellene los campos de registro **Clave de aplicación** y **Token de aplicación** con los datos proporcionados por su cuenta Braintree-Wallet.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Braintree-Wallet en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
...
8. En **Campos del proveedor**, seleccione o complete los campos **PayPal Client ID (opcional)**, **Merchant Account Id (opcional)**, **Change Order Single Charge**, **PayPal Wallett Installments**, **PayPal Merchant ID (opcional)**, **Merchant Id (Braintree)**, **PayPal Payer ID (opcional)**, y **PayPal Secret (opcional)** con la información de su cuenta Braintree-Wallet.
9. Haga clic en `Guardar`.

Para configurar los métodos de pago a procesar por Braintree-Wallet, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/docs/tutorials/condiciones-de-pago).
...
Después de seguir los pasos indicados, Braintree-Wallet puede tardar hasta 10 minutos en aparecer en el checkout de tu tienda como una opción de pago.
