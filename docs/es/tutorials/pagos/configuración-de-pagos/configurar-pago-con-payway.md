...
3. Escriba el nombre **Payway** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En **Autorización del proveedor**, rellene los campos de registro **Clave de aplicación** y **Token de aplicación** con los datos proporcionados por su cuenta Payway.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Payway en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
...
8. En **Campos del proveedor**, seleccione o complete los campos **Site ID**, **Api Key Public**, **Api Key Private**, **Payment type**, **Do you use Cybersource?**, **Cuotas MiPyme**, **Plan Z**, **Límite Superior de Captura Permitido (%)** y **Límite Inferior de Captura Permitido (%)** según las instrucciones del proveedor.
...
> ⚠️ Conoce más detalles sobre la integración de Payway con VTEX en la [documentación oficial de Payway](https://payway-vtex-docs.vercel.app/docs/config).
