...
En VTEX es posible la integración con el proveedor de pagos PagarMeV3. Con este proveedor, tu tienda puede realizar ventas a través de tarjetas de crédito, débito, private labels, cobranded, boletos bancarios, PIX y Safetypay.
...
Para configurar los métodos de pago a procesar por PagarMeV3, acceda al [Configurar Condiciones de Pago](/es/tutorial/condiciones-de-pago--tutorials_455#).
