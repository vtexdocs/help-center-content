...
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Qhantuy en la pantalla VTEX Admin, ingrese la información en el campo __Nombre__ en __Información general__.
