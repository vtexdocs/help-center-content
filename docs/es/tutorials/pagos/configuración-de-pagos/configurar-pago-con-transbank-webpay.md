---
title: 'Configurar pago con Transbank Webpay'
...
legacySlug: configurar-pago-con-transbank-webpay
locale: es
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

En VTEX es posible la integración con el proveedor de pagos Transbank Webpay. A través de este proveedor, su tienda puede realizar ventas mediante  tarjetas de crédito y Webpay.

Para configurar Transbank Webpay, siga los pasos a continuación:

1. En el Admin VTEX, accede a __Configuración de la tienda > Pago > Proveedores__, o escribe __Proveedores__ en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre __Transbank Webpay__ en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En __Autorización del proveedor__, rellene los campos de registro __Clave de aplicación__ y __Token de aplicación__ con los datos proporcionados por Transbank Webpay.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Transbank Webpay en la pantalla VTEX Admin, ingrese la información en el campo __Nombre__ en __Información general__.
...
8. En __Campos del proveedor__, llena los campos __Codigo-de-Comercio__ y __Api-Key-Secret__ con los datos de tu cuenta Transbank Webpay.
9. En __MODE__ y __AMBIENTE__ seleccione las opciones deseadas.
