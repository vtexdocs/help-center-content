...
En VTEX es posible la integración con el proveedor de pagos Paguelofacil. Con este proveedor, su tienda puede realizar ventas a través de Visa, Mastercard e Paguelofacil.


Para configurar Paguelofacil, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **Paguelofacil** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En **Autorización del proveedor**, rellene los campos de registro **Clave de aplicación** y **Token de aplicación** con los datos proporcionados por su cuenta Paguelofacil.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Paguelofacil en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
...
8. En **Campos del Proveedor**, complete el campo **WEB_CODE** según las instrucciones del proveedor.
9. Haga clic en `Guardar`.

Para configurar los métodos de pago a procesar por Paguelofacil, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/docs/tutorials/condiciones-de-pago).
...
Después de seguir los pasos indicados, Paguelofacil puede tardar hasta 10 minutos en aparecer en el checkout de tu tienda como una opción de pago.
