...
Este antifraude depende de configuraciones diferentes a los [demás antifraudes que pueden configurarse en su plataforma](/es/docs/tutorials/como-configurar-antifraude/), pues recogen información de navegación y de dispositivo del visitante. Por esta razón, este artículo tiene como objetivo documentar la configuración del Konduto.

## Configure su GTM

GTM es el Google Tag Manager, una herramienta de Google que realiza administración de tags en el site. Ese GTM es entonces asociado en su cuenta e inserta todas las tags configuradas en él en su site. [Vea más detalles sobre cómo configurar el GTM en su tienda](/es/docs/tutorials/integracion-con-google-tag-manager/).
...
2. Haga clic en la condición deseada o [Configurar condiciones de pago](/es/docs/tutorials/condiciones-de-pago)
