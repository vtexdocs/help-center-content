...
Para comprobar el __status actual__ de una transacción, basta con buscar en la línea de tiempo por la *caja en la parte superior de la pantalla con un círculo verde del lado izquierdo*. [En este artículo](/es/tutorial/fluxo-da-transacao-no-pagamentos--Er2oWmqPIWWyeIy4IoEoQ), hay la explicación de cada uno de los status de una transacción exitosa. Si la transacción tiene algún problema, su status final será __Cancelled__.
