...
![Liquidacion de pagos](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/transacciones-y-operaciones/conciliación-y-liquidación/liquidacion-parcial-de-pagos-1.png)

4. En **Eventos de la transacción**, confirma la liquidación **Parcial** mediante los registros de este tipo de evento.

![Liquidacion de pagos 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/transacciones-y-operaciones/conciliación-y-liquidación/liquidacion-parcial-de-pagos-2.png)
