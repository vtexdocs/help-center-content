---
title: 'Configurar pago con Affirm'
id:
status: PUBLISHED
...
legacySlug: configurar-pago-con-affirm
locale: es
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

En VTEX es posible la integración con el proveedor de pagos Affirm. Con este proveedor, su tienda puede realizar ventas a través de Affirm y Promissories.

Para configurar Affirm, siga los pasos a continuación:

1. En el Admin VTEX, accede a **Configuración de la tienda > Pago > Proveedores**, o escribe **Proveedores** en la barra de búsqueda en la parte superior de la página.
2. En la pantalla de proveedores, haga clic en el botón `Nuevo proveedor`.
3. Escriba el nombre **Affirm** en la barra de búsqueda y haga clic en el nombre del proveedor.
4. En **Autorización del proveedor**, rellene los campos de registro **Clave de aplicación** y **Token de aplicación** con los datos proporcionados por su cuenta Affirm.
5. Si desea modificar el nombre de identificación que se mostrará para el proveedor Affirm en la pantalla VTEX Admin, ingrese la información en el campo **Nombre** en **Información general**.
...
Para configurar los métodos de pago a procesar por Affirm, acceda al [Configurar Condiciones de Pago](https://help.vtex.com/es/tutorial/condiciones-de-pago--tutorials_455).

Para establecer condiciones especiales en los métodos de pago, acceda al [Configurar condiciones especiales de Pago](https://help.vtex.com/es/tutorial/condiciones-especiales--tutorials_456).

Después de seguir los pasos indicados, Affirm puede tardar hasta 10 minutos en aparecer en el checkout de tu tienda como una opción de pago.
