...
Pagar.me es un [gateway](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#gateway) que ofrece diversas soluciones para procesar pagos en su tienda.
