...
17. En __Modo de procesamiento__, escoja cómo quiere usar MercadoPagoV2: como subadquirente o gateway. Para más información, visite [¿Qué es un subadquirente?](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#subadquirente) y [¿Qué es un gateway de pagos?](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#gateway). 
