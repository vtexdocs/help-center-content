...
![ES Flujo Tarjeta de Credito](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/medios-y-condiciones-de-pago/tarjetas-beneficios-y-tarjetas-de-regalo/tarjeta-de-credito-flujo-basico-de-un-pago_1.svg)

1. En la pantalla de Checkout, el cliente elige el __Medio de Pago__ tarjeta de crédito para realizar el pago de su compra.
2. La información de este pago se pasa al __Gateway de Pagos__. El [gateway](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#gateway) es el player responsable de garantizar que este pago se realice con éxito.
3. Con la información en mano, gateway de pagos repasa la información necesaria para el __Adquirente__. Los [adquirentes](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#adquirente) son responsables de liquidaciones de las transacciones financieras con los minoristas.
4. En posesión de la información, el adquirente envía los datos del pago a la __Bandera__. La [bandera de la tarjeta](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#bandera-de-tarjeta-de-credito) fija algunas reglas de negocio para los pagos, como el número de parcelas. Además, conecta el adquirente con los bancos emisores.
