...
![Frame 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/medios-y-condiciones-de-pago/boletos/boleto-bancario-registrado-flujo_1.png)
...
![Frame 2.1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/medios-y-condiciones-de-pago/boletos/boleto-bancario-registrado-flujo_2.png)

1. El __Cliente__ paga el boleto directamente al __Banco__.
2. El banco envía al __Gateway__ los archivos de [conciliación bancaria](/es/docs/tutorials/conciliaciones-bancarias) con la información sobre el estado de pago de los boletos.
