...
En el [flujo de pago por tarjeta de crédito](https://help.vtex.com/es/docs/tutorials/tarjeta-de-credito-flujo-basico-de-un-pago), la bandera recibe del adquirente la información de la compra realizada en su tienda. Entonces, valida las condiciones (como el número de parcelas) y envía los datos al [banco emisor](/es/tutorial/que-es-el-banco-emisor), que comprueba si el comprador tiene límite disponible.
