...
Siempre que un cliente agrega una nueva tarjeta de crédito a su página [Mi cuenta (My Account)](/es/docs/tutorials/como-funciona-mi-cuenta), la institución financiera o el emisor de la tarjeta crea una transacción de prueba para validar el uso de la tarjeta en esa tienda.
...
![Transação av es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/pagos/antifraude-y-seguridad/antifraude/como-funcionan-las-transacciones-de-verificacion-de-cuenta_1.png)
