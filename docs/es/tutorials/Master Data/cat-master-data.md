...
- [Master Data](https://help.vtex.com/es/docs/tutorials/master-data)
- [Entidad de datos](https://help.vtex.com/es/docs/tutorials/entidade-de-datos)

## Configuración de Master Data v1

- [Exportar la base de newsletter por Master Data](https://help.vtex.com/es/docs/tutorials/como-realizar-la-exportacion-de-la-base-de-newsletter-de-master-data)
- [Índices en Master Data](https://help.vtex.com/es/docs/tutorials/indices-en-master-data)
- [Crear formulario en Master Data](https://help.vtex.com/es/docs/tutorials/creando-formulario-en-master-data)
- [Dejar editable un campo del Master Data](https://help.vtex.com/es/docs/tutorials/dejar-editable-un-campo-del-master-data)
- [Crear un campo en Master Data](https://help.vtex.com/es/docs/tutorials/como-crear-un-campo-en-master-data)
- [Filtrar datos en el Master Data](https://help.vtex.com/es/docs/tutorials/filtrar-datos-en-el-master-data)
- [Definir campos obligatorios en los formularios de Master Data v1](https://help.vtex.com/es/docs/tutorials/definir-campos-obligatorios-en-los-formularios-de-master-data-v1)
- [Restringir el acceso público a los campos de Master Data](https://help.vtex.com/es/docs/tutorials/restringir-el-acceso-publico-a-los-campos-de-master-data)

## Triggers de Master Data v1

- [Crear trigger en Master Data v1](https://help.vtex.com/es/docs/tutorials/creando-trigger-en-el-master-data)
- [Configurar automatización de email de producto visitado](https://help.vtex.com/es/docs/tutorials/configurar-automatizacion-de-email-de-producto-visitado)
- [Captura de email](https://help.vtex.com/es/docs/tutorials/entendiendo-el-sistema-de-captura-de-email-de-vtex)
...
- [No recibí el email con el informe exportado de Master Data v1](https://help.vtex.com/es/docs/tutorials/no-recibi-el-email-con-el-informe-exportado-de-master-data-v1)
