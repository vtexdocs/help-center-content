...
![orders VTEX B2B](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/orders/b2b-orders/entendiendo-pedidos-b2b_1.png)
...
> ⚠️ Esta app solo está disponible para las tiendas desarrolladas con [VTEX IO](https://vtex.com/br-pt/store-framework/).Antes de continuar, necesita <a href = "https://developers.vtex.com/vtex-developer-docs/docs/querying-b2b-order-statuses">instalar y configurar Pedidos B2B</a> en su tienda.
