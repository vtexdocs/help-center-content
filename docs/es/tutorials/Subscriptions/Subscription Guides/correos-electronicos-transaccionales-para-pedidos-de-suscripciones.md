...
| New Subscription | `new-subscription` | <p>Suscripción creada con éxito.<br><br>>ℹ️ Hay un período de tiempo entre la creación de la suscripción y la activación de la notificación de plantilla `new-subscription`.</p> |
