...
El producto registrado en VTEX solo se podrá mapear con un anuncio en Mercado Libre. En el caso de los [anuncios Clásicos y Premium](/es/docs/tracks/tipos-de-anuncios-clasico-y-premium), el mismo producto podrá anunciarse en ambos tipos de anuncios, ya que tienen configuraciones separadas.
...
Para migrar los anuncios que se mapearon en la etapa anterior, es necesario abrir un ticket en el [Soporte VTEX](https://supporticket.vtex.com/support) con el asunto **"Mercado Libre - Migración de anuncios"** y adjuntar la [plantilla de migración rellenada](#2-descargar-la-plantilla-de-migracion).
...
Si hay más de un anuncio de un mismo producto en Mercado Libre, cada anuncio con una variación, y quieres unirlos, sugerimos que los mantengas separados. En caso de que quieras unirlos de todos modos, te recomendamos ponerte en contacto con el equipo de CX de VTEX a través del [Soporte VTEX](https://supporticket.vtex.com/support).
