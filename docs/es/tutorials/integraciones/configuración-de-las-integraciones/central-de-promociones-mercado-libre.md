...
En la página **Promociones** del menú de Mercado Libre en el Admin VTEX, los [sellers](/es/docs/tutorials/estrategias-de-marketplace-en-vtex#sendo-seller-vtex) tienen acceso a una lista con todas las campañas promocionales de Mercado Libre. En esta página puedes consultar el **nombre, tipo y ID de las campañas, el plazo para incluir anuncios, el periodo de vigencia** y el **status.**  
...
![Central de promociones Mercado Libre](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tutorials/integraciones/configuración-de-las-integraciones/central-de-promociones-mercado-libre_1.gif)
...
Al seleccionar una promoción de tipo **Tradicional,** se muestra una pantalla con las siguientes tres secciones:
