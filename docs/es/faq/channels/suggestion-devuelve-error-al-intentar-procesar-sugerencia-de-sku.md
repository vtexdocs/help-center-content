...
2. Haga clic en el SKU que el marketplace no aceptó.![erroSuggestion1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/channels/suggestion-devuelve-error-al-intentar-procesar-sugerencia-de-sku_1.png)
...
5. Todavía en developer tools, haga clic en la opción __All__.![erroSuggestion2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/channels/suggestion-devuelve-error-al-intentar-procesar-sugerencia-de-sku_2.png)
...
8. Si una de ellas está en rojo y con status `400`, como en la siguiente imagen, haga clic en esa llamada.![erroSuggestion3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/channels/suggestion-devuelve-error-al-intentar-procesar-sugerencia-de-sku_3.png)
9. Usted verá a continuación la descripción del error que ocasionó el problema en el procesamiento de la sugerencia de SKU.![erroSuggestion4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/channels/suggestion-devuelve-error-al-intentar-procesar-sugerencia-de-sku_4.png)
