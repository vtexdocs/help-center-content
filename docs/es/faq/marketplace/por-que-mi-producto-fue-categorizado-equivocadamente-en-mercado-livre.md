...
excerpt: "Mercado Libre categoriza automáticamente por nombre y precio, lo que puede fallar. Corrija la categoría en el panel de Mercado Libre o antes de integrar el SKU."
...
1. [Descargue esta hoja de trabajo](https://cdn.statically.io/gh/vtexdocs/help-center-content/files-migration-script/docs/es/faq/marketplace/Mercado_Libre_-__Recategorizacion.xlsx) y rellene sus respectivas columnas.
...
> ⚠️ Este proceso no tiene ninguna relación con la VTEX y debe ser intermediado directamente en el Mercado Libre.
