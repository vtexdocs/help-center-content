...
El artículo [Cómo funciona la búsqueda de VTEX?](/es/docs/tutorials/como-funciona-la-busqueda-de-vtex/) demuestra las principales reglas que el algoritmo del buscador utiliza para exhibir y priorizar los productos a partir de un término buscado.
