...
En la plataforma VTEX, existe la posibilidad de aplicar una [promoción](/es/tutorial/creando-promociones-cluster-clientes) a sólo un determinado [clúster](/es/tutorial/como-crear-un-cluster-de-cliente). Es decir, para sólo un grupo específico de clientes.
