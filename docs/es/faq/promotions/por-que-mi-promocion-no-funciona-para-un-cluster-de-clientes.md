...
excerpt: "Las promociones por cluster fallan cuando los valores del cluster faltan, no coinciden o están incompletos en las condiciones de la promoción."
...
En la plataforma VTEX, existe la posibilidad de aplicar una [promoción](/es/docs/tutorials/creando-promociones-cluster-clientes) a sólo un determinado [clúster](/es/docs/tutorials/como-crear-un-cluster-de-cliente). Es decir, para sólo un grupo específico de clientes.
...
![ES - 7GcSb6BuF6JKnmGAggO3uA](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/promotions/por-que-mi-promocion-no-funciona-para-un-cluster-de-clientes_1.png)
