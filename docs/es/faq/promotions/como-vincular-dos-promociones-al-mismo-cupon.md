...
excerpt: "Use el mismo cupón en dos promociones regulares: descuento nominal y envío gratis. Así cubre el total del producto y el flete."
...
3. Haga clic en la primera promoción regular que desea configurar.
...
5. Introduzca el código del cupón en __utm_source__.
    ...
    ![Sincronizar promoções no mesmo cupom - 1 - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/promotions/como-vincular-dos-promociones-al-mismo-cupon_1.png)

6. Haga clic en 'Crear cupón a partir de las UTMs arriba'.
7. Haga clic en 'Guardar'.
8. Vuelva al panel __Promociones__.
9. Repita el proceso con la segunda promoción regular.
10. Al final, ambas promociones deben presentar la misma UTM.

  ![Sincronizar promoções no mesmo cupom - 2 - ES](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/faq/promotions/como-vincular-dos-promociones-al-mismo-cupon_2.png)
