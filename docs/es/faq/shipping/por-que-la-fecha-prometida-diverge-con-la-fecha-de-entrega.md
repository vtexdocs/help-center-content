...
excerpt: "Un feriado registrado con un intervalo demasiado largo hace que VTEX aplique una ventana automática más corta, lo que cambia la fecha prometida de entrega."
...
Cuando hay un error asociado a la cantidad de días de un [feriado](/es/docs/tutorials/registrar-feriados), por cuestiones de seguridad, el sistema define un rango que puede estar afectando la fecha de entrega del pedido.
...
Para saper más, consulte el artículo [Registrar Feriados](/es/docs/tutorials/registrar-feriados).
