---
title: '¿Por qué un término buscado no retorna productos existentes?'
excerpt: "Si las reglas de Search Legacy no explican el resultado vacío, el término probablemente está en la lista de palabras bloqueadas del motor."
...
El artículo [Cómo funciona la VTEX Search (Legado)?](/es/docs/tutorials/como-funciona-vtex-search-legado) demuestra las principales reglas que el algoritmo del buscador utiliza para exhibir y priorizar los productos a partir de un término buscado.
...
- Utilizar especificación de producto, redireccionando el término buscado al filtro.
