...
excerpt: "La API del marketplace puede estar rechazando la actualización de la factura. Abra el pedido, haga clic en Intentar de nuevo y revise el error."
...
2. Seleccione el pedido deseado para acceder a la página de [detalles del pedido](/es/docs/tutorials/pagina-de-detalles-del-pedido).
