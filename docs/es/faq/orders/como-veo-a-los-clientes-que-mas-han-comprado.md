...
excerpt: "VTEX no tiene un reporte nativo de clientes que más compran. Exporte los pedidos del módulo Pedidos y arme el ranking en una hoja o en el ERP."
...
Pero usted puede acceder al módulo **Pedidos**, hacer una [exportación de pedidos](/es/docs/tutorials/exportacion-de-pedidos-en-el-modulo-pedidos) y con estos datos, puedes montar este informe en una planilla.
