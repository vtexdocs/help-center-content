...
excerpt: "La aprobación tardía del pago puede expirar la reserva. Otra venta puede llevarse las últimas unidades, y este pedido falla aunque el stock luego parezca disponible."
...
Cuando el pago de un pedido tarda muchos días para ser aprobado, algunas reservas terminan expirando, ocasionando posibles errores en el [flujo del pedido](/es/docs/tutorials/flujo-y-status-de-pedidos) en el módulo **Pedidos**, como productos con stock no disponible.
