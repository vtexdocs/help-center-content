...
excerpt: "Después de tres intentos de login fallidos, VTEX ID bloquea el correo durante una hora automáticamente. Los correos de contraseña también pueden estar en la lista de supresión de AWS SES."
