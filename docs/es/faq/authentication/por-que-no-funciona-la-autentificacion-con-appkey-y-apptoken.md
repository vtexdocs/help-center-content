...
excerpt: "Las llamadas de API fallan cuando appKey y appToken faltan, no coinciden o están ligados a un perfil sin los recursos necesarios. Revise el par de claves y el perfil."
...
Al acceder a __Perfiles de acceso__, dentro del módulo de __[Configuraciones de la cuenta](/es/docs/tutorials/vision-general-configuraciones-de-la-cuenta)__, es posible configurar [perfiles de acceso](/es/docs/tutorials/roles) con niveles de acceso diferentes a la plataforma.
...
> ℹ️ Apenas el [usuario Titular](/es/docs/tutorials/que-es-el-usuario-titular) tiene permiso para manipular las claves; es decir, crear la appKey y el appToken usados en integraciones con la tienda.
...
Puede verificar posibles errores de digitación en los campos en el módulo __Gestión de cuenta__, en __[Usuarios__](/es/docs/tutorials/gestionar-usuarios-administradores)__. 
