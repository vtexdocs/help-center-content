...
1. Ponte en contacto con el [Soporte Comercial de VTEX](https://help.vtex.com/es/tracks/support-at-vtex--4AXsGdGHqExp9ZkiNq9eMy/3KQWGgkPOwbFTPfBxL7YwZ) o directamente con el publicador con el que deseas anunciarte.  
2. Elige entre los formatos de anuncio disponibles, como productos patrocinados o banners. Aprende más sobre los formatos posibles en [Tipos de campaña](https://help.vtex.com/es/tracks/vtex-ads--4sZoGHUrBNlaPMrtPCqGvA#tipos-de-campana).  
...
1. Ponte en contacto con el [Soporte Comercial](https://help.vtex.com/es/tracks/support-at-vtex--4AXsGdGHqExp9ZkiNq9eMy/3KQWGgkPOwbFTPfBxL7YwZ) y solicita la activación de VTEX Ads en tu entorno.  
2. Define los espacios de medios publicitarios disponibles en tu sitio web, como estanterías de productos patrocinados o banners. Para más información sobre los formatos posibles, consulta [Tipos de campaña](https://help.vtex.com/es/tracks/vtex-ads--4sZoGHUrBNlaPMrtPCqGvA#tipos-de-campana).  
