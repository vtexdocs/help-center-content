...
La [configuración](/es/docs/tracks/vtex-sales-app-configuracion-basica) de VTEX Sales App permite a la tienda recibir pagos con tarjeta de crédito o débito.
