...
Los campos Cuenta-franquicia y Punto de Recogida, en el registro de la tienda, solo deben completarse si desea trabajar con la recogida de productos en tiendas físicas. Si este es su caso, lea también la guía [Configuración de Puntos de Recogida](/es/tutorial/configurar-seller-white-label-como-punto-de-retirada-pickup-point--6fSUE2O0taaoKieAaiuc4e).
