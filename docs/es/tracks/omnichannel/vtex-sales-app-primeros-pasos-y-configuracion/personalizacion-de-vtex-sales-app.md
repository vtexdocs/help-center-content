...
* [Habilitar transferencia y captura del carrito entre dispositivos:](https://developers.vtex.com/vtex-rest-api/docs/enable-cart-transfer-between-devices) permitir que una compra iniciada en un dispositivo se finalice en cualquier otro dispositivo presente en el flujo de compra, sin necesidad de volver a añadir productos al carrito. Para más información, consulte [este artículo](/es/docs/tracks/transferir-y-capturar-carrito).
