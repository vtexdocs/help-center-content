...
slug: ver-detalles-de-la-transaccion
locale: es
...
Lea el artículo __Visualizar detalles de la transacción en Pedidos__ para consultar [ejemplos de eventos registrados en esta línea de tiempo](https://help.vtex.com/es/tutorial/como-visualizar-detalhes-do-pedido--tutorials_452#exemplos).
