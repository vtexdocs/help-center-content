...
Hay diferentes formas de registrar un producto:
...
Para saber cómo registrar un nuevo producto al catálogo de la tienda, consulta el artículo [Agregar o editar productos](https://help.vtex.com/es/tutorial/adding-or-editing-products--29IkdEu6GofCFlltsZh2H8).
