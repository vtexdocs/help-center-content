...
Usted puede crear nuevos perfiles y definir permisos para estos. O bien puede utilizar los [perfiles predeterminados](/es/docs/tutorials/roles#descripcion-de-los-perfiles-predefinidos) que ya están configurados en la plataforma. Los perfiles predeterminados generalmente satisfacen la gran mayoría de necesidades de todas las tiendas.

> ❗ La mala gestión de perfiles de acceso de su tienda puede ocasionar graves consecuencias para su negocio. Vea las mejores prácticas en el artículo: [Métodos de seguridad para crear perfiles de usuarios en una tienda](/es/faq/metodos-de-seguridad-para-crear-perfiles-de-usuarios-en-una-tienda--15YDwC9jGgqWi3rvcDaiGM).
