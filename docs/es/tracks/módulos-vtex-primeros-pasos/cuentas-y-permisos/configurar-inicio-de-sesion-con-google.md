...
3.  Complete los campos ingresando el _Client Id_ y _Client Secret_ registrados en **Google**.
    ![Google OAuth](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tracks/m%C3%B3dulos-vtex-primeros-pasos/cuentas-y-permisos/configurar-inicio-de-sesion-con-google_1.png)
