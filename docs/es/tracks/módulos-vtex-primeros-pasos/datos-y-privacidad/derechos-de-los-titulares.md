...
Para más información, consulta la guía [Derechos de los titulares de datos personales](/es/docs/tutorials/derechos-de-los-titulares-de-datos-personales).
...
Si gestionas una tienda VTEX y necesitas ayuda para eliminar datos de usuarios, consulta [Eliminación de los datos de los clientes](/es/docs/tutorials/eliminacion-de-los-datos-de-clientes). 

## Rectificación de datos

Todos los datos personales de clientes de tu tienda pueden editarse en la página [Mi cuenta](/es/docs/tutorials/como-funciona-mi-cuenta), excepto el email. En este caso, se puede eliminar el perfil anterior y crear uno nuevo con un email diferente.
