...
<br/>
- **Gateway de Pagos**: El [gateway de pagos](/es/tutorial/o-que-e-um-gateway-de-pagamentos) es un sistema que transmite los datos de las compras realizadas en su tienda. El gateway envía datos y recibe respuestas para que usted sepa si debe confirmar o no una determinada compra.
