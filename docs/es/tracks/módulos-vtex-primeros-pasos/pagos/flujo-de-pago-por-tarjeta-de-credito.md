...
<br/>
- **Gateway de Pagos**: El [gateway de pagos](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#gateway) es un sistema que transmite los datos de las compras realizadas en su tienda. El gateway envía datos y recibe respuestas para que usted sepa si debe confirmar o no una determinada compra.

- **Adquirente**: El [adquirente](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#adquirente), también llamado acreditador, es una empresa que es especializada en procesar pagos; es decir, realizar la liquidación financiera de las transacciones de una tienda a través de tarjetas de crédito y débito.

- **Bandera**: Las [banderas](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#bandera-de-tarjeta-de-credito) son empresas responsables de definir las reglas de negocio para compras realizadas con tarjeta de crédito. Definen los estándares por los cuales los adquirentes deben procesar las transacciones realizadas mediante este medio de pago (cada bandera tiene sus propias reglas).
- **Banco Emisor**: El [banco emisor](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#banco-emisor) es la institución financiera responsable de los medios de pago, ya sean boletos bancarios, tarjetas de débito o crédito. Es este quien, al recibir los datos de una compra realizada en su tienda, autoriza o no la venta (dependiendo del límite de crédito o del dinero disponible en la cuenta del usuario).
<br/>
Para saber más sobre los agentes financieros involucrados en el flujo de pago, consulte [nuestro artículo](/es/docs/tutorials/agentes-financieros-en-el-flujo-de-pago#adquirente). <br/>
<br/>
