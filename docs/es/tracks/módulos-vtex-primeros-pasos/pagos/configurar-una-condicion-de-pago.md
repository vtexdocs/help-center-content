...
Para configurar una condición de pago, primero debe registrar un proveedor de pago, como se describe en [Registrar proveedores de pago y antifraude](/es/docs/tutorials/afiliaciones-de-gateway).
...
- Defina si utilizará o no [antifraude](/es/docs/tutorials/como-configurar-antifraude).

Además, para algunas condiciones de pago puede ser necesario definir si el pago se realizará en efectivo o a plazos, con o sin intereses y [condiciones especiales](/es/docs/tutorials/condiciones-especiales).

Como la **Tarjeta de Crédito** es un método de pago que te permite aplicar todas estas características, mira a continuación cómo configurarla:
...
Para habilitar esta opción, seleccione "Sí" en el campo **Utilizar pago en cuotas externo** durante el paso de [configuración de proveedor](/es/docs/tutorials/afiliaciones-de-gateway).

![cuotaautomatica](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tracks/módulos-vtex-primeros-pasos/pagos/configurar-una-condicion-de-pago_1.JPG)
