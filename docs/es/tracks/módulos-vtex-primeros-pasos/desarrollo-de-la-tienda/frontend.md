...
- **[Multiidiomas](/es/docs/tutorials/vtex-intelligent-search-configuracion-multidioma)**: es la posibilidad que VTEX IO proporciona para configurar la traducción automática de la tienda a otros idiomas.
