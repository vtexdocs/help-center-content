...
- **Tags de marketing:** campo utilizado para restringir la activación de la promoción si la compra se realiza a través del módulo [Suscripciones de VTEX](/pt/tutorial/como-funciona-a-assinatura--frequentlyAskedQuestions_4453).
- **Afiliados:** identificador de pedidos del marketplace. El descuento se aplicará a los afiliados seleccionados. Para más información, consulta el artículo [Qué es afiliado](/pt/tutorial/o-que-e-afiliado--4bN3e1YarSEammk2yOeMc0?locale=pt).
- **Clúster de clientes:** el descuento se concederá si el cliente está registrado en el clúster seleccionado. Es importante resaltar que el nombre del clúster debe coincidir exactamente con el nombre registrado. Cualquier error ortográfico impedirá que la configuración funcione correctamente. Para más información, consulta [Crear clúster de clientes](/pt/tutorial/como-criar-um-cluster-de-clientes).
...
- **¿Se debe aplicar el descuento incluso si el usuario no tiene sesión iniciada?:** este campo se muestra cuando se selecciona la opción Solo en la primera compra. Si se marca esta opción, la promoción se aplicará aun cuando el cliente no ingrese su email y contraseña. Por otro lado, si no se selecciona, la promoción solo se aplicará si el consumidor ingresó con su email y contraseña previamente registrados.
  ...
  - **Frecuencia:** permite seleccionar la frecuencia de los pedidos de suscripción: semanal, mensual y anual. Para más información, consulta [Configurar la frecuencia y la fecha del ciclo de suscripción](/pt/tutorial/como-criar-um-anexo-de-assinatura--2bUuKyPflA8cOGLv8OvaKK#configurar-frequencia-e-data-do-ciclo-de-assinatura).
