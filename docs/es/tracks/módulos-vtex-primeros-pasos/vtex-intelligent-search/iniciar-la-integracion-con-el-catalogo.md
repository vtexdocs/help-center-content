...
![integracoes-es](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tracks/módulos-vtex-primeros-pasos/vtex-intelligent-search/iniciar-la-integracion-con-el-catalogo_1.PNG)

No es necesario repetir este proceso. Después de que comience la integración, puedes seguir el status de indexación en la página [Historial de indexación](/es/docs/tutorials/historial-de-indexacion).
