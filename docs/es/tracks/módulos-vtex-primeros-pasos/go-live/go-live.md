...
Si la implementación es headless, es decir, si el front-end es externo, será necesario crear únicamente una entrada de tipo CNAME en el subdominio `secure` que apunte a secure.{dominio}.com.cdn.vtex.com. Consulta un ejemplo a continuación:

```
Dirección de da tienda: secure.mitienda.com
  - Entrada (subdominio): secure
  - Tipo: CNAME
  - Destino: secure.mitienda.com.cdn.vtex.com
```
