...
Si has [configurado el funcionamiento de tu tienda](/es/tracks) y [desarrollado tu storefront](/es/tracks/cms--2YcpgIljVaLVQYMzxQbc3z), ha llegado el momento de realizar el _go live_. Este proceso pone tu nueva tienda VTEX en producción, es decir, disponible para que los clientes puedan acceder a ella y realizar compras.

En este tutorial, encontrarás una guía detallada paso a paso sobre cómo realizar el _go live_ de tu tienda.

![Go live](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/es/tracks/módulos-vtex-primeros-pasos/go-live/processo-de-go-live_1.jpg)
...
> ℹ️ Si utilizas el CMS Portal (Legado) y quieres migrar a un storefront creado con [CMS IO](/es/docs/tracks/cms-vtex-io), sigue las instrucciones de la guía sobre cómo [migrar tu storefront de CMS Portal (Legado) a Store Framework](https://developers.vtex.com/vtex-developer-docs/docs/vtex-io-documentation-migrating-storefront-from-legacy-to-io).

En aras de la organización y la comodidad, esta guía divide los pasos del _go live_ en cuatro etapas:

1. [Configuración](/es/docs/tracks/configuracion)
2. [Antes del go live](/es/docs/tracks/antes-del-go-live)
3. [Go live](/es/tracks/go-live-your-store--4Ns5FxIiksmjsdX2yOTduM/12bQlMbJ68Ot0LIaO6Btkj#)
4. [Después del go live](/es/docs/tracks/despues-del-go-live)
