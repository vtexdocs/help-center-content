...
> ⚠️ Si no puedes remover el registro de dominio de tu tienda de la plataforma **Cloudfront**, ponte en contacto con el [equipo de soporte de VTEX](https://supporticket.vtex.com/support) y explícales la situación. Así, el equipo VTEX te ayudará a asegurar el buen funcionamiento de la tienda en el go-live.
