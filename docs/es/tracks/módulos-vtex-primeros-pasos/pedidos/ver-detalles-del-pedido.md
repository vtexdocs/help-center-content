...
Para comprender la lista de pedidos en detalle, consulte el artículo [Información general de la lista de pedidos](/es/tutorial/listado-de-pedidos--tutorials_200)
