...
2. En la pestaña **General**, cerca del campo **Sustitución de pedido**, marque la caja la caja <a class="far fa-check-square"></a> `Permitir que los clientes hagan cambios al pedido`.
