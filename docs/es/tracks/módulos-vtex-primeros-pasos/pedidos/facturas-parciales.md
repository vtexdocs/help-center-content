...
- Cuando se [cambian los ítems de un pedido](/es/docs/tutorials/cambiar-items-de-un-pedido-finalizado).    
...
* No es posible [cancelar](/es/docs/tutorials/como-cancelar-pedido) pedidos parcialmente facturados. Si el cliente desea sustituir o remover ítems del pedido, es posible [modificar el pedido](/es/docs/tutorials/cambiar-items-de-un-pedido-finalizado).
...
> Luego de emitir la factura, haz un [cambio en el pedido](/es/docs/tutorials/cambiar-items-de-un-pedido-finalizado).

Luego de realizar todos los cambios en el pedido, puedes seguir todos los eventos de la transacción haciendo clic en [Ver detalles de la transacción](/es/docs/tracks/ver-detalles-de-la-transaccion).
...
- [Página de detalles del pedido](/es/docs/tutorials/pagina-de-detalles-del-pedido)    
- [Cambiar ítems de un pedido finalizado](/es/docs/tutorials/cambiar-items-de-un-pedido-finalizado)
- [Cambiar el valor total del pedido](/es/docs/tutorials/cambiar-el-valor-total-del-pedido)
- [Como facturar un pedido](/es/docs/tutorials/como-facturar-manualmente-un-pedido)
