...
- **Amazon Auth Token*:** ingrese el **Token de autorización de MWS** proporcionado por Amazon en la etapa de [autorización de VTEX en el panel de Amazon](/es/docs/tracks/configuracion-de-la-cuenta-amazon). 
