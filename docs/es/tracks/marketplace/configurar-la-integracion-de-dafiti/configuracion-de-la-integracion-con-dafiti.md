...
Esta guía explica cómo realizar la integración con Dafiti utilizando el conector desarrollado por VTEX. La integración por medio de conectores nativos debe ser una opción predeterminada, ya que esto significa una mayor eficiencia y seguridad.
...
2. [Configurar el conector](/es/docs/tracks/configuracion-del-conector-dafiti).
3. [Enviar productos a Dafiti](/es/docs/tracks/envio-de-los-productos-a-dafiti).
