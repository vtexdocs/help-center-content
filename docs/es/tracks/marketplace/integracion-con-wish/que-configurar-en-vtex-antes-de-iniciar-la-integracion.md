...
Una vez creada la política comercial, será necesario asociar la nueva política con los productos de su catálogo para definir cuáles serán enviados a Wish. A continuación, un paso a paso de cómo definir el surtido **masivamente por plantilla** ([vea otros métodos aquí](/es/docs/tracks/registrar-sku)).

  1. Haga la exportación de los productos de su catálogo ([vea cómo en la sección "Plantilla" de este artículo](/es/docs/tracks/registrar-sku)).
...
Para garantizar que los pedidos se integren con éxito, deberá realizar toda la asociación logística entre stock, muelles y transportadoras en VTEX. Para comprender un poco más sobre el contexto general de logística en VTEX, consulte [este artículo](/es/docs/tracks/logistica-primeros-pasos). Realice el siguiente procedimiento para hacer las configuraciones:

  1. Verifique si sus [stocks](/es/docs/tracks/stock) están vinculados a los muelles correctos.
  2. Verifique si los [muelles](/es/docs/tutorials/almacen) escogidos están asociados con la política comercial de Wish.
...
Para vender sus productos en Wish, es importante definir una estrategia de precios. Para entender un poco más sobre el contexto general de precios en VTEX, consulte [este artículo](/es/docs/tracks/modulo-de-precios-vision-general). Realice el siguiente procedimiento para hacer las configuraciones:
