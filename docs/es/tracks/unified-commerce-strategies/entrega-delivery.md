...
* El cliente realiza una compra en un <i>ecommerce</i> y elige recibir el pedido en su domicilio.
* El cliente realiza una compra en una tienda física, a través del [Pasillo Infinito](https://help.vtex.com/es/tracks/estrategias-de-comercio-unificado--3WGDRRhc3vf1MJb9zGncnv/40KMlmGI5tN0r0KPCDWgGn) (sin que el ítem esté en el <i>*stock*</i> de esa tienda), y opta por recibir el pedido en su domicilio.

En este caso, es habitual que los ítems salgan del almacén de un Centro de Distribución, como se ilustra a continuación.

![ES Conceitos Logística](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_1.png)
