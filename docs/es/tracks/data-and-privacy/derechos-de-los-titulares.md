...
Para más información, consulta la guía [Derechos de los titulares de datos personales](/es/tutorial/derechos-de-los-titulares-de-datos-personales--6imchxTx09icupKMbzHVIM).
...
Si gestionas una tienda VTEX y necesitas ayuda para eliminar datos de usuarios, consulta [Eliminación de los datos de los clientes](/es/tutorial/eliminacion-de-los-datos-de-clientes--1R9Fn7A06Ifj4R9YD4JTKU). 

## Rectificación de datos

Todos los datos personales de clientes de tu tienda pueden editarse en la página [Mi cuenta](/es/tutorial/como-funciona-mi-cuenta--2BQ3GiqhqGJTXsWVuio3Xh), excepto el email. En este caso, se puede eliminar el perfil anterior y crear uno nuevo con un email diferente.
