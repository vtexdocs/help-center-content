...
A continuación, algunos ejemplos de carteras digitales que pueden configurarse para realizar pagos en tu tienda VTEX: [Google Pay](/es/docs/tracks/google-pay), [Apple Pay](/es/docs/tracks/apple-pay), [Samsung Pay](/es/docs/tutorials/configurar-samsung-pay-como-medio-de-pago), [Paypal](/es/docs/tutorials/configurar-pago-con-paypalv2), entre otros.
