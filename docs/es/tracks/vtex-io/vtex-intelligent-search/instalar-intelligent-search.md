...
| `vtex.edition-business@0.x` | No es compatible con Intelligent Search. Si deseas migrar a una versión compatible, ponte en contacto con nuestro [soporte](https://supporticket.vtex.com/support). |
