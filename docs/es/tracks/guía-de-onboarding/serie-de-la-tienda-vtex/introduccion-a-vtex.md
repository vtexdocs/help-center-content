...
Esta serie de artículos muestra la jornada de una tienda VTEX, desde la [configuración inicial](/es/docs/tracks/configuracion-inicial) hasta el [go live](/es/docs/tracks/planificacion-del-go-live). Antes de configurar los [módulos](/es/docs/tracks/modulos-de-vtex-i) de la plataforma, planificar las [integraciones de backend](/es/docs/tracks/integraciones-de-backend) y elegir una tecnología de [frontend](/es/docs/tracks/implementacion-del-frontend) para la construcción del storefront, hay un paso previo: definir el [tipo de cuenta y la arquitectura](/es/docs/tracks/cuentas-y-arquitectura) que mejor se ajuste a las necesidades específicas del negocio.
...
La **Serie de la tienda VTEX** es la primera de las que componen la **Guía de onboarding**. Tras el go live, existen otras [soluciones](/es/docs/tracks/products-add-on) y [configuraciones](/es/docs/tracks/otros-ajustes-de-los-modulos-de-vtex) en la plataforma cuyo objetivo es diversificar las estrategias de venta de la tienda y expandir sus operaciones comerciales. De eso trata la segunda serie, llamada [Próximos pasos tras el go live](/es/docs/tracks/proximos-pasos).

La tercera y última ruta de la **Guía de onboarding** se denomina [Soporte en VTEX](/es/docs/tracks/soporte-vtex) y tiene como objetivo proporcionar a nuestros clientes la mejor experiencia con la plataforma y nuestro soporte, abordando el [funcionamiento del Soporte VTEX](/es/docs/tracks/funcionamiento-del-soporte-vtex) y explicando cómo abrir tickets para obtener ayuda con problemas [técnicos](/es/docs/tracks/suporte-tecnico), [financieros](/es/docs/tracks/soporte-financiero) o [comerciales](/es/docs/tracks/soporte-comercial).
