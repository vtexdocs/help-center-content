...
* Link al [MSA (Master Services Agreement)](https://vtex.com/es-mx/trust/agreements).
...
Los clientes que hayan formalizado una asociación con VTEX mediante firma pueden encontrar el MSA en la parte superior del Anexo 1 - Order Form o en la [página de Contratos Anteriores](https://vtex.com/es-mx/trust/agreements-archive/), conforme a la región y fecha de firma del Anexo 1.
