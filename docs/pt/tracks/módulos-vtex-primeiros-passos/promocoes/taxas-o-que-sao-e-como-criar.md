...
Para criar uma taxa, siga os passos abaixo:
  ...
  4. Preencha os dados gerais da taxa, informe os itens aos quais ela será aplicada e escolha as condições de aplicação. Para saber em detalhes a função de cada campo da tela de configuração de taxas, leia o artigo [Criar taxa/imposto](/pt/docs/tutorials/como-criar-taxaimposto);
