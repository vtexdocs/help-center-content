...
Vale ressaltar que é imprescindível personalizar o remetente. Assim, seus clientes receberão as mensagens com o nome e o endereço de e-mail da sua empresa. Para saber mais sobre esse assunto, confira o [artigo sobre como editar o servidor de e-mails VTEX](/pt/docs/tutorials/personalizando-o-smtp-da-vtex).
