...
> ℹ️ A lista de templates está disponível no artigo [Templates de emails transacionais referentes ao pedido](/pt/docs/tutorials/templates-de-emails-transacionais).
