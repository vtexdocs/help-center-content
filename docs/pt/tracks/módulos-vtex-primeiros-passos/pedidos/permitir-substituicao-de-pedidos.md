...
> ℹ️ Para mais informações sobre a funcionalidade e casos que não permitem substituição, veja o artigo [Substituição de pedidos](/pt/docs/tutorials/substituicao-de-pedidos).
