...
A exportação de pedidos gera um relatório no formato .csv que contém uma série de detalhes sobre os pedidos da sua loja. Para saber quais são as informações apresentadas no relatório exportado, leia o tutorial sobre os [campos da planilha de pedidos](/pt/docs/tutorials/planilha-de-pedidos).
...
2. [Aplique o filtro de pedidos](/pt/docs/tutorials/filtrar-todos-pedidos) desejado, considerando o limite de até 50 mil pedidos.
3. Clique em `Exportar` e um link com arquivo no formato .csv será enviado para o seu email de [usuário](/pt/docs/tutorials/gerenciar-usuarios-administrativos).
