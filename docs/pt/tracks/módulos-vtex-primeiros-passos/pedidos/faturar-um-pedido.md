...
- __Manualmente:__ pelo *Admin VTEX > Pedidos > Todos os Pedidos*, clicando no pedido e em seguida no botão `Faturar`. Saiba mais em [Faturar um pedido manualmente](/pt/docs/tutorials/faturar-um-pedido-manualmente).
