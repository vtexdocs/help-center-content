...
Você pode criar novos perfis e definir as permissões para eles. Ou então pode usar os [perfis predefinidos](/pt/docs/tutorials/perfis-de-acesso#descricao-dos-perfis-predefinidos) que, por padrão, já estão configurados na plataforma. Os perfis predefinidos costumam atender à grande maioria das necessidades de todas as lojas.

> ❗ A má gestão dos perfis de acesso da sua loja pode trazer graves consequências para o seu negócio. Veja as melhores práticas no artigo: [Métodos de segurança para criação de perfis de usuários em uma loja](/pt/docs/tutorials/boas-praticas-de-gestao-de-acessos-para-lojas).
