---
title: 'Introdução ao Gerenciamento da Conta'
...
Ao contratar a VTEX, sua empresa recebe uma **conta** que dá acesso ao Admin, onde é possível gerenciar todos os aspectos do seu ecommerce. Esta conta é o ambiente central para configurar e operar sua loja virtual.
...
Após fazer login, você terá acesso ao painel administrativo exclusivo da sua loja, onde poderá gerenciar produtos, pedidos, clientes, configurações e muito mais.
...
Página onde você visualiza e gerencia os detalhes da sua conta VTEX, incluindo:
- Informações da empresa (nome, CNPJ, logotipo)
- Status da conta e da plataforma
...
Página para cadastrar e gerenciar os usuários administrativos que têm acesso ao Admin da sua loja. Aqui você pode:
...
Página para configurar os métodos de login disponíveis para clientes da loja e para usuários administrativos, incluindo:
- Código de acesso
- Senha (com opção de expiração)
