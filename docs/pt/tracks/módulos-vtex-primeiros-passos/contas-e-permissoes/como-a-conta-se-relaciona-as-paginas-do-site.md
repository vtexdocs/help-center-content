...
Para cada uma das lojas na opção **Multilojas**, é feito um **binding**. Confira nosso [artigo sobre multiloja e multidomínio](/pt/tutorial/como-criar-multiloja-multidominio) para configurar essa opção.
