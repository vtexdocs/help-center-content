...
![2FA - Select - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_1.png)
...
> ℹ️ Como algumas empresas restringem o uso de celular por operadores de televendas, usuários com o [perfil de acesso de televendas](/pt/docs/tutorials/perfis-de-acesso#call-center-operator) não são obrigados a habilitar 2FA quando fazem login usando e-mail e senha.
...
1. Baixe o aplicativo **Google Autenticator** ([App Store](https://itunes.apple.com/br/app/google-authenticator/id388497605?mt=8) / [Google Play](https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=pt_BR)). 
  ...
  ![2FA - App Download - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_2.png)

2. Use o aplicativo para ler o QR Code com a câmera do seu celular.

  ![2FA - App QR Code - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_3.png)
...
3. Sua conta da VTEX será adicionada ao aplicativo, com um código de 6 dígitos. Insira o código para concluir seu login.
  ...
  *O código do app é atualizado periodicamente. Não será necessário memorizá-lo, basta consultar o aplicativo sempre que precisar.*
  ...
  ![2FA - App Insert Code - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_4.png)
...
1. Insira seu número de celular para enviarmos o código por SMS - não se esqueça de colocar o código de país e área.
  ...
  ![2FA - SMS Insert Phone - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_5.png)

2. Você receberá uma mensagem de texto da VTEX no celular indicado. Insira a chave de 6 dígitos para concluir seu login.

   ![2FA - SMS Insert Code - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_6.png)
...
1. Acesse suas configurações de usuário, clicando no círculo com suas iniciais no canto superior-direito do Admin.
  ...
  ![2FA - User Initials - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_7.png)

2. Clique em **Verificação em 2 passos** para visualizar suas configurações.

  ![2FA - My User - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/contas-e-permissoes/habilitar-login-por-2-factor-authentication_8.png)
