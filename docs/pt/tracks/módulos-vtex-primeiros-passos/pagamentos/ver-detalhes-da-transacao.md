...
Leia o artigo __Visualizar detalhes da transação em Pedidos__ para consultar [exemplos de eventos registrados nessa timeline](/pt/docs/tutorials/como-visualizar-detalhes-do-pedido#exemplos).
