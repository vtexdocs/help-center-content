...
Se quiser aprofundar os conceitos de gateway, adquirente, subadquirente, bandeira, banco emissor e antifraude, confira nosso [artigo sobre agentes financeiros no fluxo de pagamento](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento).
