...
- **Gateway de Pagamentos**: O [gateway de pagamentos](/pt/docs/tutorials/o-que-e-um-gateway-de-pagamentos) é um sistema que efetua a transmissão dos dados das compras realizadas na sua loja. O gateway envia dados e recebe respostas para que você saiba se uma determinada compra deve ou não ser confirmada. 
- **Adquirente**: O [adquirente](/pt/docs/tutorials/diferenca-entre-adquirentes-subadquirentes-e-gateways-no-brasil#adquirente), também chamado de credenciador, é uma empresa especializada em processar pagamentos, isso é, fazer a liquidação financeira das transações de uma loja por meio de cartões de crédito e débito.
- **Bandeira**: As [bandeiras](/pt/docs/tutorials/o-que-e-uma-bandeira-de-cartao-de-credito) são empresas responsáveis por definir as regras de negócio para compras realizadas com cartão de crédito. São elas que definem os padrões pelos quais os adquirentes devem processar as transações realizadas por esse meio de pagamento (cada bandeira tem suas próprias regras).
...
<br/>
Para saber mais sobre os agentes financeiros envolvidos no fluxo de pagamento de um pedido no Brasil, confira [nosso artigo](/pt/docs/tutorials/diferenca-entre-adquirentes-subadquirentes-e-gateways-no-brasil#adquirente). <br/>
<br/>
