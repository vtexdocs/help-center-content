...
![CMS Capa overview](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/módulos-vtex-primeiros-passos/cms/o-que-e-o-cms_1.png)
...
O CMS oferece um conjunto de ferramentas que variam de acordo com a tecnologia que você utiliza em sua loja: **FastStore - VTEX Headless CMS (Legacy)**, **Store Framework - Site Editor** ou **Legacy Portal - Layout**.

Confira nossos artigos sobre as funcionalidades relacionadas ao CMS para cada tecnologia:

- [FastStore CMS](/pt/docs/tutorials/gerenciando-paginas)
- [Store Framework CMS](/pt/docs/tracks/cms-vtex-io)
- [CMS Portal (Legado)](/pt/docs/tutorials/o-que-e-o-cms-layout)
