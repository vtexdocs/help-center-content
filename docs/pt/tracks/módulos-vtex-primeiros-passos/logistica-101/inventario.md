...
* Itens [reservados](/pt/docs/tutorials/como-a-reserva-funciona)

Para inserir itens em massa no inventário, utilize a planilha de importação do estoque. Leia o artigo [Importar e exportar planilha de estoque](/pt/docs/tutorials/importando-e-exportando-planilha-de-estoque) e saiba mais.

Utilize o [alerta de estoque crítico](/pt/docs/tutorials/configurar-o-alerta-de-estoque-critico) para receber notificações de itens que estão próximos de serem esgotados.
