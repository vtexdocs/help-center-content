...
Só será necessário [configurar uma nova política comercial](https://help.vtex.com/pt/tutorial/configurando-a-politica-comercial-para-marketplace--tutorials_404) para um marketplace específico, se você tiver algum dos seguintes objetivos:
...
Na integração com a Shopee, o envio dos produtos é de responsabilidade do próprio marketplace. Todos os pedidos provenientes da Shopee seguem a modalidade [FOB](https://help.vtex.com/pt/tutorial/como-funciona-o-frete-quando-o-marketplace-faz-a-entrega--EY1l6tYW3IUquwwwcQqwQ) (Free on Board), ou via logística do vendedor.  
