...
|---|---|---|
| **Integração*** | Marque como *Ativada* para que a integração comece a operar. Se optar por desativar a integração, toda a configuração, incluindo afiliado, serão excluídos. | ![Integração Magalu](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/_1.png) |
