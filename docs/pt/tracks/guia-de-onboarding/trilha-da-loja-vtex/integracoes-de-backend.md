...
A importação de dados de clientes permite integrar informações de clientes de outros sistemas, como aplicações de CRM (Customer Relationship Management), com a VTEX. Por padrão, a VTEX armazena os dados dos clientes no [Master Data V1](/pt/tutorial/master-data--4otjBnR27u4WUIciQsmkAw). 
