...
| -------------- | ------------------------- |
| Global         | **Artigo:** [Como funciona o suporte da VTEX?](/pt/faq/como-funciona-o-suporte-da-vtex--3kACEfni4m8Yxa1vnf2ebe)<br><br>Apresenta como funciona o suporte em nível global, abordando tickets, planos regionais, pesquisa de satisfação e serviços, como monitoramento e recursos como [Help Center](/), [Developer Portal](https://developers.vtex.com/) e comunicados de atualizações na plataforma. |
