...
Entre as informações inseridas no cadastro de um produto no Catálogo, está o **EAN**. O EAN corresponde ao código de barras do SKU. É ele que permite ao vendedor adicionar facilmente o produto ao carrinho do **VTEX Sales App**, bastando passar o código de barras do produto na máquina leitora. O **VTEX Sales App** também permite que o código de barras seja digitado no campo de busca.
