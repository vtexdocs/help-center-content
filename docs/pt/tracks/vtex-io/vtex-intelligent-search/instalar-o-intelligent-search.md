...
| Versões anteriores da `vtex.edition-store` | Não são compatíveis com o Intelligent Search. Se você deseja migrar para uma versão compatível, entre em contato com o [Suporte](https://supporticket.vtex.com/support). |
| `vtex.edition-business@0.x` | Não é compatível com o Intelligent Search. Se você deseja migrar para uma versão compatível, entre em contato com o [Suporte](https://supporticket.vtex.com/support). |
