...
Sua loja está disponível no [domínio cadastrado](https://help.vtex.com/pt/tracks/como-realizar-el-go-live-de-tu-tienda--4Ns5FxIiksmjsdX2yOTduM/7sM5IMx02zaHvAFTm0OxiJ#cadastrar-dominio-na-vtex) para que clientes a acessem e realizem compras.

Caso queira, você pode disponibilizar sua loja em outros endereços por meio de [redirecionamentos](#realizar-redirecionamentos). 
