...
> ⚠️ Antes de iniciar a configuração do provedor é necessário [registrar o Merchant ID no Apple Pay](https://developer.apple.com/help/account/capabilities/configure-apple-pay#create-a-merchant-identifier).
...
8. Se desejar, você também pode optar por uma [condição especial de pagamento](/pt/docs/tutorials/condicoes-especiais).
9. Clique em `Salvar`.
