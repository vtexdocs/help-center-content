...
Você será direcionado para a página de configuração da nova condição de pagamento. Explicamos como preencher os campos no artigo de [como configurar uma condição de pagamento](/pt/tracks/customer-credit-como-comecar--1hCRg21lXYy2seOKgqQ2CC/21ok0GBwmcIeaY2IukYMOg#condicoes-de-pagamento) da track do Customer Credit.
