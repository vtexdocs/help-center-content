...
updatedAt: 2025-11-12T15:17:32.149Z
...
![15. Configurar impressão de resumo do pedido - 1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/canais-de-venda/omnichannel/vtex-sales-app-usando-o-app/impressao-de-resumo-do-pedido_1.png)
...
* Caso não tenha o VTEX Sales App em seu computador, instalar o aplicativo a partir do nosso guia de [Instalação](/pt/docs/tracks/instalacao).
* Obter um par de credenciais (AppKey e AppToken) com as devidas permissões de acesso. Leia o artigo [Chaves de aplicação](/pt/docs/tutorials/chaves-de-api) para mais informações.
...
![15. Configurar impressão de resumo do pedido - 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/canais-de-venda/omnichannel/vtex-sales-app-usando-o-app/impressao-de-resumo-do-pedido_2.png)
...
![15. Configurar impressão de resumo do pedido - 4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/canais-de-venda/omnichannel/vtex-sales-app-usando-o-app/impressao-de-resumo-do-pedido_3.png)
