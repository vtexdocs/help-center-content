...
![Levar os visitantes do meu site e redes sociais para o WhatsApp 1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tracks/canais-de-venda/conversational-commerce/suiteshare/levar-os-visitantes-do-meu-site-e-redes-sociais-para-o-whatsapp_1.png)
...
VTEX Assisted Sales (SuiteShare) traz a solução completa para a sua empresa crescer, vender e atender. Agora que aprendemos a como levar os visitantes das redes sociais para o WhatsApp, que tal [distribuir o atendimento no WhatsApp para mais de um número?](/pt/docs/tracks/como-distribuir-o-atendimento-no-whatsapp-para-mais-de-um-numero)
