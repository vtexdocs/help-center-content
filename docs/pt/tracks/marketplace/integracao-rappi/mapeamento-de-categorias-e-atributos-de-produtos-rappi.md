...
Após fazer as conﬁgurações de conta na Rappi na VTEX e integrar o conector, é necessário categorizar e enviar as variações e [especiﬁcações de produto](/pt/docs/tracks/especificacoes-definicao-de-conceito) para o marketplace. O envio dessas informações é feito por meio do menu **Mapeamento de categorias**.  
