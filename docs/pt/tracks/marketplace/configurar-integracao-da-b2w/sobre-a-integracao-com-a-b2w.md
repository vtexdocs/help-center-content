...
Neste artigo, serão abordados pontos referentes à integração de pedidos e apresentação dos serviços de entrega da B2W. Para mais informações sobre o fluxo da integração, veja [Como funciona a integração da SkyHub/B2W](/pt/tutorial/como-funciona-a-integracao-da-skyhu).
...
A SkyHub oferece o serviço [B2W Entrega](https://blog.americanasmarketplace.com.br/2018/01/08/logistica-no-b2w-marketplace/), uma modalidade na qual a própria B2W é responsável pelo envio dos produtos aos consumidores. Quando a entrega é realizada pelo marketplace, isso é chamado de [frete tipo FOB](/pt/docs/tutorials/como-funciona-o-frete-quando-o-marketplace-faz-a-entrega). Neste cenário, o _Service Level Agreement_ (SLA), ou seja, o nível de acordo de entrega é responsabilidade do marketplace.
