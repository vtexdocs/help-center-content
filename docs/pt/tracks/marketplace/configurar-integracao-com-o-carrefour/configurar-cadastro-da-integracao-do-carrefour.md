...
- **Mapeamento de Certificados de Homologação (Opções aceitas pelo marketplace: ANATEL, INMETRO, ANVISA, MAPA e Não Se Aplica):** devido a uma definição do Carrefour, produtos de determinadas categorias deverão possuir obrigatoriamente uma [especificação de produto](/pt/tracks/catalogo-101--5AF0XfnjfWeopIFBgs3LIQ/4fcdmJzQ6QYA9zWf3bLWin) cadastrada com o código de homologação de cada agência reguladora para serem comercializados no marketplace. Por isso, para as [categorias elegíveis](#categorias-elegiveis), é necessário preencher este campo com o nome da especificação de produto criada e o código de homologação do produto disponibilizado pelas agências reguladoras.
...
- __Política comercial*__: ID da [política comercial](/pt/docs/tutorials/como-funciona-uma-politica-comercial) que será utilizada para a integração com o Carrefour. São os produtos dessa política comercial que serão enviados para o marketplace.
...
- __Mapeamento de SLA de tipo Normal*:__ preencha com o nome do [Método de Envio](/pt/docs/tutorials/como-funciona-o-tipo-de-envio) cadastrado na [Política de Envio](/pt/tutorial/politica-de-envio--tutorials_1400). Por exemplo, se você cadastrou como `Normal`, então, deve preencher esse campo o nome exatamente igual.
- __Mapeamento de SLA de tipo Expressa*:__ preencha com o nome do [Método de Envio](/pt/docs/tutorials/como-funciona-o-tipo-de-envio) cadastrado na [Política de Envio](/pt/tutorial/politica-de-envio--tutorials_1400). Por exemplo, se você cadastrou como `Expressa`, então, deve preencher esse campo o nome exatamente igual.
- __Mapeamento de SLA de tipo Econômica*:__ preencha com o nome do [Método de Envio](/pt/docs/tutorials/como-funciona-o-tipo-de-envio) cadastrado na [Política de Envio](/pt/tutorial/politica-de-envio--tutorials_1400). Por exemplo, se você cadastrou como `Entrega econômica`, então, deve preencher esse campo o nome exatamente igual.
- __Mapeamento de SLA de tipo Agendada*:__ preencha com o nome do [Método de Envio](/pt/docs/tutorials/como-funciona-o-tipo-de-envio) cadastrado na [Política de Envio](/pt/tutorial/politica-de-envio--tutorials_1400). Por exemplo, se você cadastrou como `Agendada`, então, deve preencher esse campo o nome exatamente igual.
