...
7. Revise todos os campos na lista e identifique aquele em que a opção **�? anulável** não está marcada, e marque-a.

   > �s�️ Apenas o campo de email deve permanecer com a opção **�? anulável** desmarcada.
8. Clique em **Salvar**.  
...
![B2B Suite - troubleshootingv2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/b2b/nao-consigo-corrigir-o-erro-de-schema-em-aplicativos-b2b_1.gif)
