...
Na VTEX é possível utilizar o servidor nativo de emails ou [configurar um servidor SMTP externo](/pt/docs/tutorials/personalizando-o-smtp-da-vtex). Caso você esteja utilizando um servidor SMTP externo, verifique os cenários abaixo.
