...
> ⚠️ Caso o pedido ainda permaneça no status `Pronto para manuseio`, solicite mais informações por meio de um ticket no [Suporte VTEX](/pt/support).
...
> ⚠️ Caso o pedido ainda permaneça no status `Pronto para manuseio` após a tentativa de atualização manual, solicite mais informações por meio de um ticket no [Suporte VTEX](/pt/support).
