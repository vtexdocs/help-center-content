...
|:---:|:---:|:---:|
| **Dados de entrega incompletos** | Os dados para entrega estão incompletos ou preenchidos incorretamente. | Corrigir ou preencher os dados solicitados seguindo a documentação [Fluxo e status de pedidos.](/pt/docs/tutorials/fluxo-e-status-de-pedidos) |
| **Divergência de valores** | O valor total do pedido pago no marketplace difere do valor esperado pela loja VTEX, e essa diferença de valor supera o percentual aceito pela loja VTEX ou a Taxa de divergência de preço não está configurada.<br>**Exemplo**<br>O total pago pelo pedido no marketplace é igual R$ 311,77, o valor esperado pela loja é igual R$ 313,61. Ou seja, pedido tem uma diferença de R$ 1,84. | [Reprocessar o pedido](/pt/docs/tutorials/verificando-integracao-no-bridge#pedidos) ou Configurar a [Regra de divergência de valores.](/pt/docs/tutorials/regra-de-divergencia-de-valores) |
