...
![ascii_1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/acesso-a-dados-e-seguranca/removendo-mensagem-de-erro-request-headers-must-contain-only-ascii_1.png)
...
![ascii 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/acesso-a-dados-e-seguranca/removendo-mensagem-de-erro-request-headers-must-contain-only-ascii_2.png)    
...
![ascii 3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/acesso-a-dados-e-seguranca/removendo-mensagem-de-erro-request-headers-must-contain-only-ascii_3.png)

4. Clique na aba **Cabeçalhos** e copie os dados do cookie.  

![ascii 4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/acesso-a-dados-e-seguranca/removendo-mensagem-de-erro-request-headers-must-contain-only-ascii_4.png)    
...
![ascii 5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/acesso-a-dados-e-seguranca/removendo-mensagem-de-erro-request-headers-must-contain-only-ascii_5.png)  
...
> �s�️ A remoção dos cookies via script não é uma solução definitiva. Conforme descrito na seção **Desabilitando cookies com caracteres especiais**, é necessário identificar a origem e interromper o processo de envio de cookies com caracteres especiais.  
