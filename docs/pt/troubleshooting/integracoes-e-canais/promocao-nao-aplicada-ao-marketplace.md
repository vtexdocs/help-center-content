...
A [política comercial](/pt/docs/tutorials/criar-uma-politica-comercial) define regras e condições para a aplicação de promoções nos marketplaces. �? importante selecionar a política comercial correta para assegurar que a promoção seja aplicada conforme esperado. Abaixo estão os passos para configurar uma promoção de política comercial.

1. Crie uma [promoção regular](/pt/docs/tracks/criar-promocao-regular).
...
![Dados gerais da promoção - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/integracoes-e-canais/promocao-nao-aplicada-ao-marketplace_1.png)
...
2. Preencha o campo **Afiliados** com o nome do afiliado relacionado ao marketplace desejado.  
   ...
   ![condições para promoção - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/troubleshooting/integracoes-e-canais/promocao-nao-aplicada-ao-marketplace_2.png)

3. Na seção **Política Comercial**, selecione as opções `Iguais` a e **Entregue por mim (Outras lojas)**.  
4. Clique em `Salvar`.

> �"�️ Verifique se não foi criado nenhum filtro adicional de promoção, como forma de pagamento, filtros de cluster ou limitações no carrinho.
