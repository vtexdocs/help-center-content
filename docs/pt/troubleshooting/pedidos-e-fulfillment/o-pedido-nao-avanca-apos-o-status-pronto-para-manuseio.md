...
> �s�️ Caso o pedido ainda permaneça no status `Pronto para manuseio`, solicite mais informações por meio de um ticket no [Suporte VTEX](https://supporticket.vtex.com/support).
...
> �s�️ Caso o pedido ainda permaneça no status `Pronto para manuseio` após a tentativa de atualização manual, solicite mais informações por meio de um ticket no [Suporte VTEX](https://supporticket.vtex.com/support).
