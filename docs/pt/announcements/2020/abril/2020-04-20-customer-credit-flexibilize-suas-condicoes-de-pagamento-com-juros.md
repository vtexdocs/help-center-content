...
## Como funciona
Para definir juros no Customer Credit, você precisa seguir o fluxo padrão para [configurar uma condição de pagamento](/pt/docs/tutorials/condicoes-de-pagamento).
...
Para saber mais detalhes sobre o Customer Credit, confira nossa [trilha introdutória sobre essa app](/pt/docs/tutorials/customer-credit-visao-geral).
