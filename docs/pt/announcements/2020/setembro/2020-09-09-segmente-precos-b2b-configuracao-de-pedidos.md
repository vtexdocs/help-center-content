...
### Como funciona?
De agora em diante, você poderá combinar as regras e [tabelas de preços](/pt/docs/tutorials/criar-tabelas-de-precos) já criadas no nosso sistema com novos critérios de segmentação baseados no tipo de pedido, para refletir instantaneamente novos preços para o comprador durante a experiência de compra. 
...
Independentemente da versão da sua loja, acesse agora a [nossa documentação](/pt/docs/tutorials/o-que-e-order-configuration) e veja como começar a utilizar a Configuração de Pedidos B2B na sua loja.
