...
Existem múltiplas possibilidades de [aprovação de SKUs recebidos](/pt/tutorial/manual-sku-cataloging--tutorials_396). Além dos endpoints que [ativam e desativam](/pt/announcements/marketplace-improvements-on-received-skus--5AY73ocF0evsh3yzY6AMX6)  a aprovação automática de SKUs em seu marketplace, acrescentamos novos endpoints à nossa API para configurar regras de aprovação. As configurações podem ser aplicadas a sellers específicos, ou a toda a conta do marketplace. A API permite configurar os seguintes campos:
