...
Nenhuma ação é necessária. A funcionalidade já está disponível automaticamente em todas as lojas. Para mais informações acesse [Admin VTEX: Comece Aqui](/pt/docs/tutorials/admin-vtex-comece-aqui).
