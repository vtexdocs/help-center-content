...
O [reCAPTCHA](/pt/tutorial/recaptcha-no-checkout--18Te3oDd7f4qcjKu9jhNzP) é uma solução utilizada para validação de usuário real disponibilizada pela VTEX para todas as lojas. Ele prevê cenários em que programas maliciosos são utilizados para fraudes, evitando acesso de falsos usuários.
...
A VTEX está integrada com o reCAPTCHA enterprise, que oferece duas abordagens de validação: checkbox (equivalente ao reCAPTCHA v2) e baseada em pontuação (equivalente ao reCAPTCHA v3). Confira este artigo sobre o <a href="https://help.vtex.com/pt/tutorial/recaptcha-no-checkout--18Te3oDd7f4qcjKu9jhNzP#versoes-do-recaptcha">reCAPTCHA no Checkout da VTEX</a> para aprender qual versão você deve usar dependendo das características da sua loja. Você também pode aprender mais sobre cada método: <a href="https://developers.google.com/recaptcha/docs/display">reCAPTCHA v2</a> ou <a href="https://developers.google.com/recaptcha/docs/v3">reCAPTCHA v3</a> com a documentação fornecida pelo Google.
</div>
