...
* Conectar e integrar sellers com menos atrito e mais rapidez.
* Gerenciar sellers com mais precisão.
* Oferecer ferramentas simples para sellers integrarem catálogo, importarem produtos e acompanharem anúncios enviados ao marketplace.
...
![capa de blog marketplace 2022](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2022-10-17-lancamentos-de-marketplace-vtex-em-2022_1.png)

## O que estamos lançando?

A tabela a seguir apresenta as funcionalidades novas, voltadas para lojas que atuam como marketplaces e sellers no ambiente VTEX.
...
<tbody>
  <tr>
    ...
    <td>Gestão de Sellers</td>
  </tr>
  <tr>
    <td>Convite de Sellers para o Seller Portal</td>
  </tr>
  <tr>
...
Saiba mais sobre cada funcionalidade a seguir. 

### Seller Portal 

![Seller Portal gif 2022 launch](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2022-10-17-lancamentos-de-marketplace-vtex-em-2022_2.gif)
...
<thead>
  <tr>
    <th>Por meio do Seller Portal, sellers conseguem:</th>
    <th>Providenciando o Seller Portal, marketplaces conseguem:</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td><ul> <li>Conectar-se de forma rápida e sem atrito ao marketplace que os convidou.</li>Acessar a interface renovada do <a href="https://help.vtex.com/pt/tutorial/seller-portal-como-funciona-o-catalogo--7pMB6YOt6YQDQQbzFB4Pxp"><span style="font-weight:400;color:#F71963;background-color:transparent">Catálogo Seller Portal</span></a>, para ativar e vender produtos imediatamente.</li> <li>Cadastrar, consultar e editar informações do Catálogo utilizando a <a href="https://developers.vtex.com/docs/api-reference/catalog-api-seller-portal"><span style="font-weight:400;color:#F71963;background-color:transparent">Catalog API - Seller Portal</span></a>.</li> <li>Gerenciar <a href="https://help.vtex.com/pt/tutorial/seller-portal-produtos-compartilhados--6vUGj2UmOuLzQTK9pj04lu"><span style="font-weight:400;color:#F71963;background-color:transparent">produtos compartilhados</span></a>, que já existem no catálogo do marketplace, diminuindo a complexidade de vender produtos que o marketplace tem disponível.</li> <li>Atualizar estoque e preço de produtos.</li> <li>Gerenciar e faturar todos os seus pedidos no marketplace, podendo processar pagamentos.</li> <li>Construir sua estratégia de envio de pedidos para seus clientes, adicionando opções de entrega e pontos de retirada.</li> </ul></td>
    <td><ul><li>Expandir com facilidade a base de sellers.</li> <li>Diminuir o tempo de conversão das vendas, com o onboarding self-service de novos sellers, agora mais rápido.</li> <li>Compartilhar o sortimento de produtos com o seller de forma simples e gerenciar com agilidade anúncios de produtos compartilhados.</li> <li>Ter a flexibilidade de construir e providenciar funcionalidades específicas, de acordo com seus diferentes casos de uso.</li> <li><a href="https://developers.vtex.com/vtex-developer-docs/docs/seller-portal-edition-app"><span style="font-weight:400;color:#F71963;background-color:transparent">Adicionar apps VTEX de forma massiva</span></a>, que atendem as particularidades de sua operação para todos os seus sellers.</li> <li>Avaliar métricas de sellers filtrando por "Sellers 3P" na página <a href="https://help.vtex.com/pt/tutorial/performance-de-vendas--3DMube0sEsK9vPcRYGas72"><span style="font-weight:400;color:#F71963;background-color:transparent">Performance de Vendas</span></a> </li> </ul>.</td>
  </tr>
</tbody>
</table>
...
Disponibilizamos a [Catalog API - Seller Portal](https://developers.vtex.com/docs/api-reference/catalog-api-seller-portal) para que sellers possam cadastrar, consultar e editar dados de produtos, SKUs, marcas e categorias de forma massiva. A novidade facilita a importação automática de informações do Catálogo por meio da integração com sistemas externos como ERP, incluindo:
...
![Seller management gif 2022 launch](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2022-10-17-lancamentos-de-marketplace-vtex-em-2022_3.gif)
...
* Novas opções aprimoradas de filtro e busca.
* Um formulário de criação e edição de sellers mais completo.
...
![Offer Management gif](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2022-10-17-lancamentos-de-marketplace-vtex-em-2022_4.gif)
...
Confira nas tabelas abaixo o que deve ser feito para marketplaces e sellers começarem a usar as novas funcionalidades. 
...
<thead>
  <tr>
    <th>Funcionalidade</th>
    <th>Como começar a usar</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td>Convite de Sellers</td>
    <td>A funcionalidade já está disponível no seu Admin em <i>Marketplace > Sellers > Gerenciamento de Sellers</i>. Está presente em todas as contas, com exceção de contas franquia e seller white label. </td>
  </tr>
  <tr>
    <td>Seller Portal</td>
    <td>Para possibilitar que sellers acessem o portal, siga o passo a passo: <br> <ol> <li>Envie um convite para cada seller que deseja adicionar ao Seller Portal por meio da página <a href="https://help.vtex.com/pt/tutorial/marketplace-convite-de-sellers-beta--6rb2FkcslmDueJ689Ulb9A"><span style="font-weight:400;color:#F71963;background-color:transparent">Convite de Sellers</span></a>.</li> <li>Compartilhe o artigo de ajuda <a href="https://help.vtex.com/pt/tutorial/seller-criar-conta-no-seller-portal-beta--3gn2Q5rMhgu0jjX7AiiHcs"><span style="font-weight:400;color:#F71963;background-color:transparent">Seller: criar conta no Seller Portal</span></a> com seus sellers, para aprenderem a configurar sua conta.</li> <li> <a href="https://help.vtex.com/pt/tutorial/seller-portal-primeiros-passos-para-o-marketplace--6ccErY3mCcfoW0qGXf167#ativar-seller"><span style="font-weight:400;color:#F71963;background-color:transparent">Ative o seller</span></a> para que ele possa enviar produtos ao seu marketplace.</li> </ol> Saiba mais sobre o processo completo conferindo o artigo <a href="https://help.vtex.com/pt/tutorial/seller-portal-primeiros-passos-para-o-marketplace--6ccErY3mCcfoW0qGXf167"><span style="font-weight:400;color:#F71963;background-color:transparent">Seller Portal: primeiros passos para o marketplace</span></a>.</td>
  </tr>
  <tr>
    <td>Gerenciamento de sellers</td>
    <td>A página já está disponível em seu Admin em Marketplace > Sellers > Gerenciamento de Sellers no menu lateral. Com o lançamento, a página anterior será substituída pela experiência nova, e não haverá a opção de voltar para a anterior. <br> Saiba como operar a página e aprimorar seu acompanhamento de sellers conferindo o artigo <a href="https://help.vtex.com/pt/tutorial/gerenciamento-de-sellers-beta--6eEiOISwxuAWJ8w6MtK7iv"><span style="font-weight:400;color:#F71963;background-color:transparent">Gerenciamento de Sellers</span></a>.</td>
  </tr>
</tbody>
</table>
...
<thead>
  <tr>
    <th>Funcionalidade</th>
    <th>Para começar a usar</th>
  </tr>
</thead>
<tbody>
  <tr>
    <td>Gestão de anúncios</td>
    <td>A página já está disponível no Admin de sellers que vendem produtos no <a href="https://help.vtex.com/pt/tracks/configurar-integracao-do-mercado-livre--2YfvI3Jxe0CGIKoWIGQEIq"><span style="font-weight:400;color:#F71963;background-color:transparent">Mercado Livre</span></a> (Classic e Premium), <a href="https://help.vtex.com/pt/tracks/configurar-integracao-da-netshoes--5Ua87lhFg4m0kEcuyqmcCm"><span style="font-weight:400;color:#F71963;background-color:transparent">Netshoes</span></a> e em qualquer marketplace VTEX. Para os outros marketplaces, ainda será preciso utilizar as páginas de Produto, Preço e Estoque em Marketplace &gt; Integrações.<br>Para acessar a página no Admin VTEX, vá em Marketplace &gt; Integrações &gt; Gestão de anúncios. Se sua loja usa o <a href="https://content.vtex.com/join-new-admin-beta-program-pt/"><span style="font-weight:400;color:#F71963;background-color:transparent">Novo Admin VTEX</span></a>, acesse Marketplace > Conexões > Gestão de anúncios.<br>Saiba como operar a página conferindo o artigo <a href="https://help.vtex.com/pt/tutorial/gestao-de-anuncios--7MRb9S78aBdZjFGpbuffpE"><span style="font-weight:400;color:#F71963;background-color:transparent">Módulo Gestão de anúncios</span></a>.</td>
  </tr>
  <tr>
    <td>Seller Portal</td>
    <td>Após o marketplace enviar um convite, o seller convidado receberá por e-mail o link para a criação de sua conta no Seller Portal.<br> <ol> <li><a href="https://help.vtex.com/pt/tutorial/seller-criar-conta-no-seller-portal-beta--3gn2Q5rMhgu0jjX7AiiHcs"><span style="font-weight:400;color:#F71963;background-color:transparent">Crie uma conta no Seller Portal</span></a>. </li> <li>Configure sua loja seguindo as instruções do artigo <a href="https://help.vtex.com/pt/tutorial/seller-portal-primeiros-passos--6w1vBdRH2uuBGmUqgNQjwK"><span style="font-weight:400;color:#F71963;background-color:transparent">Seller Portal: Primeiros Passos do seller</span></a>. </li> </ol></td>
  </tr>
  <tr>
    <td>Catalog API</td>
    <td>A Catalog API é usada para importar seu catálogo para o Seller Portal. Saiba mais sobre cada chamada de API REST conferindo <a href="https://developers.vtex.com/vtex-rest-api/reference/catalog-api-seller-portal"><span style="font-weight:400;color:#F71963;background-color:transparent">Catalog API - Seller Portal</span></a>.  </td>
  </tr>
</tbody>
</table>
