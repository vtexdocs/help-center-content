...
Nenhuma ação é necessária para acessar o novo formulário. A atualização será aplicada automaticamente em todas as lojas VTEX. Para mais informações, acesse [Criar promoção Leve Mais por Menos](/pt/docs/tutorials/leve-mais-por-menos).
