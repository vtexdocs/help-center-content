...
Se sua operação utiliza apps customizados do VTEX IO que interagem com dados de sellers, atualize o arquivo `manifest.json` adicionando as políticas necessárias:
