...
slugEN: announcements-hit-the-spotlight-in-the-new-admin
locale: pt
...
Além disso, os announcements agora têm um módulo próprio na home do __Novo Admin__. Uma forma de dar destaque para as últimas notícias e você ficar logo sabendo se uma mudança pode ou não impactar as operações da sua loja. Assim, você tem o tempo necessário para realizar as ações que precisa para continuar oferecendo a melhor experiência de compra aos seus clientes.
