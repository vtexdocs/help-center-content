...
Já está disponível em stable uma API que vai trazer ainda mais autonomia para os marketplaces que usam VTEX. É o Change Seller, que inaugura um novo status no workflow, chamado de __Window to change Seller__.
...
> ⚠️ **Atenção:**<br> O novo status só estará disponível quando **Marketplace** e **Seller** forem VTEX. E, se não houver seller VTEX com estoque disponível, a compra do cliente não passa pelo novo status e é cancelada automaticamente.
...
Para saber mais sobre a API, acesse [este artigo do VTEX Help](/pt/tutorial/veja-como-utilizar-o-change-seller). 
