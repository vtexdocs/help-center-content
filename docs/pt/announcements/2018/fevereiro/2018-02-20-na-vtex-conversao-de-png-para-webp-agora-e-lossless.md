...
> ⚠️ A compressão **lossless** é aplicável apenas para arquivos **PNG**. Os arquivos **JPG** continuam a ser comprimidos pelo processo **lossy** (que diminui o tamanho da imagem para aumentar velocidade de carregamento da página).
