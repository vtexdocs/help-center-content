...
<div class="alert alert-warning" role="alert"> 
  Conforme <a href="https://help.vtex.com/pt/announcements/store-framework-cms-nova-permissao-para-gerenciar-redirecionamentos--1GcT48ML2w6TZQxQyGbD6W">anunciado anteriormente</a>, o recurso <code>CMS Settings</code> já era necessário para gerenciar redirecionamentos no Store Framework CMS.
</div>
