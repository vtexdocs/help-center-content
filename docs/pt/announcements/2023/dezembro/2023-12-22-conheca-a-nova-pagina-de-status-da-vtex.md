...
Confira o artigo [Página de status da VTEX](/pt/docs/tutorials/pagina-de-status-da-vtex) para mais informações sobre cada componente.
...
Acesse a nova página em [status.vtex.com](https://status.vtex.com/) e leia o guia [Página de status da VTEX](/pt/docs/tutorials/pagina-de-status-da-vtex) para mais detalhes.
