...
Para mais informações sobre como criar uma nova atribuição de seller, acesse [Configurando atribuição de sellers a organizações compradoras (B2B)](/pt/docs/tutorials/configurando-atribuicao-de-sellers-a-organizacoes-compradoras-b2b-xky).
