...
Nas lojas que já utilizam [o novo design da página de Produtos & SKUs (Beta)](/pt/docs/tutorials/produtos-e-skus), esse status não existe, pois o produto permanece **Publicado** mesmo após alterações.
...
Essa melhoria permite que lojas VTEX construam e expandam operações omnichannel complexas em grande escala, incluindo modelos de [franquia](/pt/docs/tutorials/o-que-e-conta-franquia), [marketplaces](/pt/docs/tutorials/estrategias-de-marketplace-na-vtex) com um grande número de sellers e experiências regionalizadas.
