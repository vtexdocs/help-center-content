...
Ao abrir um [chamado de atendimento](https://supporticket.vtex.com/support) do tipo Técnico, você terá acesso a uma nova tela de conversação em tempo real com o bot VTEX, onde poderá tirar as suas dúvidas sobre a plataforma. O bot oferece **suporte para múltiplos idiomas**, e foi treinado com a base de conhecimento disponível pela VTEX, como nosso [Help Center](https://help.vtex.com/).

Mesmo com essa novidade, ainda é possível **continuar o atendimento com nosso time de especialistas do Suporte**, seguindo os SLAs definidos na [política de atendimento de sua região](/pt/docs/tutorials/como-funciona-o-suporte-da-vtex#planos-de-suporte).
