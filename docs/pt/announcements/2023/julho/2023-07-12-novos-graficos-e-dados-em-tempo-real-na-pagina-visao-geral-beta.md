...
A versão atualizada da página [Visão Geral (Beta)](/pt/docs/tutorials/visao-geral-da-loja-beta) já está disponível no Admin VTEX a partir do dia 17 de agosto. Para acessar a página, no Admin VTEX, vá para **Dashboards > Visão Geral (Beta)**, ou digite _Visão Geral (Beta)_ na barra de busca no topo da página.
...
A página Visão Geral atualmente presente no Admin VTEX continuará disponível para uso. Ambas as páginas poderão ser acessadas pelo menu [Dashboards](/pt/docs/tutorials/visao-geral-dashboards) do seu Admin. 
