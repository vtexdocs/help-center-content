...
Na VTEX, é possível alterar o preço várias vezes ao dia de acordo com a estratégia da sua loja. No módulo de Preços, é possível cadastrar ou alterar [preços base](/pt/docs/tracks/preco-base-definicao-de-conceito) ou [preços fixos](/pt/docs/tracks/preco-fixo-definicao-de-conceito) utilizando:
...
![exportacao pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2023/janeiro/2023-01-13-melhorias-na-exportacao-de-precos-via-planilha_1.gif)
...
Para mais informações, leia o artigo [Exportação e importação via planilha de preços](/pt/docs/tracks/exportacao-e-importacao-via-planilha-de-precos).
