...
- A coluna **ROAS click** fica disponível como métrica opcional para usuários com permissão de administrador (superAdmin), permitindo entender a origem do resultado e comparar com períodos anteriores. Essa coluna não exibe dados anteriores a 25 de março de 2026.
...
## Ajuste na taxa de conversão

Também a partir de 1º de julho de 2026, os dashboards passam a exibir a **taxa de conversão** consolidada por padrão para todos os formatos, usando visualizações como denominador para manter a consistência entre os tipos de anúncio. A **taxa de conversão por clique** fica disponível como métrica complementar, com tooltips que explicam o cálculo de cada uma.
...
- Utilizem a coluna **ROAS click** (disponível para usuários com permissão de administrador) ao analisar a origem dos resultados e ao comparar campanhas com períodos anteriores à mudança.
