...
Para saber mais sobre Multilevel Omnichannel Inventory e as mudanças nas APIs do Checkout, acesse [este artigo do Help](/pt/business-guides/ofereca-os-produtos-da-sua-rede-de-lojas-fisicas-em-marketplaces-externos--6s64bV8Dqb5QN6sqIfPzcA). 

> ❗ <body> <li>O termo Marketplace Recursivo foi substituído por**Multilevel Omnichannel Inventory.**</li> <li>A funcionalidade não permite [change seller](/pt/tutorial/veja-como-utilizar-o-change-seller--5TBAwO2kOAMw44uyaaQMQO?). <li>Essa solução é destinada à integração com Marketplaces externos, e não marketplaces que já possuem uma [integração nativa VTEX](/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrado-a-conector-nativo-vtex).</li> <li>Leia o artigo [Multilevel Omnichannel Inventory](/pt/docs/tutorials/multilevel-omnichannel-inventory) e confira as restrições de uso detalhadamente.</li> </body>
