...
O resumo da promoção já está disponível no Admin VTEX automaticamente. Para saber mais sobre a etapa e a descrição dos seus campos, leia nosso artigo [Resumo da promoção](/pt/docs/tutorials/resumo-da-promocao).
