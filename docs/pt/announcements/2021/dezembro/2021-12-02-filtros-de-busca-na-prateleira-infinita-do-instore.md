...
Agora, os vendedores da sua loja física podem utilizar filtros durante a busca por produtos no inStore, caso tenham o [VTEX Intelligent Search](/pt/docs/tracks/visao-geral-intelligent-search) habilitado. Com esse recurso, a busca na Prateleira Infinita do inStore se torna mais dinâmica e precisa, agilizando as vendas.
...
Para mais informações sobre a busca no inStore, leia o artigo [Busca unificada](/pt/docs/tracks/busca-unificada-no-vtex-sales-app).
