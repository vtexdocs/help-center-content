...
- **Segurança:** Stripe é um serviço compatível com [PCI](/pt/docs/tutorials/o-que-e-o-pci-ssc) Nível 1, que é o mais alto nível de certificação de segurança.
...
Confira o passo a passo completo na documentação [Configurar a afiliação de gateway Stripe](/pt/docs/tutorials/configurar-a-afiliacao-de-gateway-stripe).
