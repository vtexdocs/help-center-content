...
- Realize a instalação e configuração do aplicativo Banks for PSE, e a configuração do PSE em sua loja. Saiba mais em [Configurando o meio de pagamento PSE](/pt/docs/tutorials/configurar-pagamento-com-pse).
