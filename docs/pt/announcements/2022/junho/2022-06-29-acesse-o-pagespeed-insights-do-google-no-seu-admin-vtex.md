...
A página “Performance das páginas web” está disponível automaticamente apenas para lojas que usam o [novo Admin VTEX](/pt/announcements/2022-06-13-bem-vindo-ao-novo-admin-vtex). Para acessá-la, no menu lateral de seu Admin, clique em **Dashboards > Performance das páginas web**. 
...
Descubra como aproveitar ao máximo esse dashboard em nosso artigo sobre a [Performance das páginas web](/pt/tutorial/performance-de-paginas-web--4cRiiTByzNMulixZec5YaG).
