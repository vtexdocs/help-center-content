...
![Store overview gif PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/announcements/2022/junho/2022-06-13-bem-vindo-ao-novo-admin-vtex_1.gif)
...
Nenhuma página foi removida do Admin VTEX, mas reorganizamos o menu de navegação para estar alinhado às páginas mais acessadas e refletir as prioridades da sua operação. Saiba mais sobre a nossa [navegação aprimorada](/pt/docs/tutorials/admin-vtex-comece-aqui#Enhanced%20Navigation).
...
Para ajudar você a navegar na nova experiência, criamos um [novo Help Center](/pt/v4) dedicado à experiência redesenhada, onde você poderá acessar [artigos de ajuda sobre as novas páginas](/pt/docs/tutorials/admin-vtex-comece-aqui) e acompanhar os lançamentos enquanto redesenhamos toda a plataforma.
