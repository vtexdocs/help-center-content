...
Promoções para públicos segmentados são ações estratégicas para atrair e reter clientes. Na VTEX, a [promoção de campanha](/pt/docs/tutorials/promocao-de-campanha) possibilita atingir públicos-alvo específicos definidos em uma [audiência de campanha](/pt/docs/tutorials/audiencias-de-campanhas).
