...
A página [Performance de Vendas](/pt/docs/tutorials/performance-de-vendas) está em constante evolução para que lojistas extraiam cada vez mais inteligência de negócio com a VTEX. 
...
Até então, a página só permitia selecionar períodos fixos como "Semana passada", por exemplo. Agora é possível [selecionar período](/pt/docs/tutorials/performance-de-vendas#periodo) marcando no calendário as datas de início e fim desejadas, ocorridas durante os últimos 90 dias. 

### Novas dimensões para filtros

Incluímos as seguintes [dimensões de filtros](/pt/docs/tutorials/performance-de-vendas#dimensoes-de-filtro-e-agrupamento-de-dados), relacionando mais sistemas da VTEX à sua Performance de Vendas:
