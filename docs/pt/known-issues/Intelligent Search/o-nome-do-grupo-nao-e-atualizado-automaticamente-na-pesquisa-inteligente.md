...
O módulo legado tem dois clusters de dados distintos, a coleção (A) e o nome do grupo (B)
 ...
 ![](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/known-issues/Intelligent Search/o-nome-do-grupo-nao-e-atualizado-automaticamente-na-pesquisa-inteligente_1.png)

No entanto, o novo módulo de coleções exibe apenas o nome da coleção, não seu GroupName:

 ![](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/known-issues/Intelligent Search/o-nome-do-grupo-nao-e-atualizado-automaticamente-na-pesquisa-inteligente_2.png)
