...
Para verificar os provedores que realizam transações com a Ficha Depósito e configurá-los em sua loja, siga os passos abaixo:

1. No Admin VTEX, acesse __Configurações da loja > Pagamentos > Configurações__, ou digite __Configurações__ na barra de busca no topo da página.
2. Na aba __Condições de Pagamentos__, clique no botão `+`.
3. Clique sobre __FichaDeposito__.
4. Ative a condição no campo __Status__.
5. Selecione as opções disponíveis de provedores e realize as configurações necessárias para cada um deles.
6. Clique em `Salvar`.
