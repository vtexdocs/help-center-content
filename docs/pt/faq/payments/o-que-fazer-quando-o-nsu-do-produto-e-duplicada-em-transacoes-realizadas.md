...
excerpt: "Quem emite o NSU é a Rede, não a VTEX. Se duas transações compartilham o NSU, concilie pelo TID e fale com a Rede para corrigir a duplicidade."
...
Eventualmente, o [NSU](/pt/docs/tutorials/como-achar-nsu-e-tid-do-pedido) ou número sequencial único, pode ser duplicado na adquirente Rede. Erros como esse podem atrapalhar o processo de conciliação.

Porém, em circunstâncias que o NSU é a mesma para dois clientes diferentes, uma alternativa para verificar a transação é dar baixa no pagamento pelos números da [TID](/pt/docs/tutorials/como-visualizar-detalhes-do-pedido), que são distintos entre si. 
