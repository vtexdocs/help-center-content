...
Lembre-se! É possível acompanhar o status de indexação e o status de integração dos estoques. Para isso, acesse o [relatório de indexação](/pt/tutorial/utilizar-o-relatorio-de-indexação) e o modulo [Integrações](/pt//tutorial/bridge/).
