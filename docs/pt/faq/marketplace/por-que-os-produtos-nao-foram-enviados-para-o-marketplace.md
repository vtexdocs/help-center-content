...
excerpt: "O envio de produtos depende das Integrações e da catalogação no marketplace. Confira o status no Bridge e a configuração antes de tentar de novo."
