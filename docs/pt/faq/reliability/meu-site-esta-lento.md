...
excerpt: "Lojas lentas em geral sofrem com scripts pesados, imagens grandes, requisições síncronas ou cache fraco. Revise esses pontos antes de culpar a plataforma."
...
Entenda este assunto a fundo no artigo [Melhorar a performance de imagens de produtos](/pt/docs/tutorials/melhorando-a-performance-de-imagens-do-site).
