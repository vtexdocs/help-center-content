...
excerpt: "Chamadas de API falham quando appKey e appToken estão ausentes, trocados ou ligados a um perfil sem os recursos necessários. Revise o par de chaves e o perfil."
...
Ao acessar __Perfis de acesso__, dentro do menu de [Configurações da conta](/pt/docs/tutorials/visao-geral-configuracoes-da-conta), é possível configurar [perfis de acesso](/pt/docs/tutorials/perfis-de-acesso) com níveis de acesso diferentes à plataforma.
...
> ℹ️ Apenas o [usuário Titular](/pt/docs/tutorials/o-que-e-o-usuario-titular) tem permissão para manipular as chaves, isso é, criar a appKey e o appToken usados em integrações com a loja.
