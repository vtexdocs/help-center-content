...
excerpt: "Depois de três tentativas de login erradas, o VTEX ID bloqueia o e-mail por uma hora automaticamente. E-mails de senha também podem estar na lista de supressão da AWS SES."
