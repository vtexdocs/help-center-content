...
excerpt: "Authorize-fulfillment falha quando a reserva do SKU foi liberada e o estoque acabou. Confirme o inventário em Ver interações antes de aprovar de novo."
...
![error authorize fulfillment](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/faq/orders/ao-tentar-aprovar-pagamento-gerenciamento-de-pedidos-retorna-erro_1.png)

Para confirmar se o problema é este, na página de [detalhes do pedido](/pt/docs/tutorials/pagina-de-detalhes-do-pedido), clique em `Ver interações` para ver os detalhes do pedido.
