...
excerpt: "Aprovação tardia do pagamento pode expirar a reserva. Outra venda pode levar as últimas unidades, e este pedido falha mesmo se o estoque parecer disponível depois."
...
Quando o pagamento de um pedido demora muitos dias para ser aprovado, algumas reservas acabam expirando, ocasionando possíveis erros no [fluxo do pedido](/pt/docs/tutorials/fluxo-e-status-de-pedidos) no módulo **Pedidos**, como produtos com estoque indisponível.
