...
excerpt: "Um 404 no cancelamento em geral significa falha na API de um parceiro. Abra Ver interações no pedido para ver qual chamada retornou o erro."
...
Como explicado no artigo [Verificar detalhes de erros nos pedidos](/pt/docs/tutorials/como-verificar-detalhes-de-erros-nos-pedidos), acesse o pedido em que houve o problema, conforme o passo a passo abaixo:
