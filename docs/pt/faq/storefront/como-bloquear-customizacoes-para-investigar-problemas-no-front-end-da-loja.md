...
excerpt: "Em lojas do CMS Portal (Legacy), bloqueie customizações de frontend no Chrome DevTools para ver se o bug vem da VTEX ou do código customizado."
...
4. Selecione **Mais ferramentas** e, em seguida, **Condições de solicitação** para bloquear todas as customizações feitas por meio de CSS, JavaScript e Google Tag Manager. 
  ...
  ![legado-02](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/faq/storefront/legado-02.png)
 ...
 * `*://www.googletagmanager.com/gtm.js*`
  ...
  ![request-conditions-02](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/faq/storefront/request-conditions-02.png)
