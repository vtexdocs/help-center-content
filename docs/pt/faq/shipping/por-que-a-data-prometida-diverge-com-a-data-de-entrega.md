...
excerpt: "Um feriado cadastrado com intervalo longo demais faz a VTEX aplicar uma janela automática menor, o que altera a data prometida de entrega."
...
Quando existe um erro associado à quantidade de dias de um [feriado](/pt/docs/tutorials/cadastrar-feriados), por questões de segurança, o sistema automaticamente define um período, o pode afetar a data de entrega do pedido.
