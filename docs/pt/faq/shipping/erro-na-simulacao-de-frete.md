...
excerpt: "A simulação de frete devolve o resultado da API de cálculo logístico. Percorra docas, estoque, transportadoras e cobertura de CEP para achar a falha."
