...
![Configuração do proxy da Cloudflare](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/Untitled category/Untitled subcategory/desabilitar-proxy-cloudflare_1.png)
