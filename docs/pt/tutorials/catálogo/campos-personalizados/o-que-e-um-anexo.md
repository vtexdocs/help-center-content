...
Um anexo é a customização, opcional e sem custo, de um produto. Ele é utilizado para adicionar uma informação a um SKU. Essa informação pode ser relacionada a um [serviço](/pt/docs/tutorials/o-que-e-um-servico) ou ao próprio item comprado.
...
- [Cadastrar um Serviço](/pt/docs/tutorials/criando-servico-para-um-sku)
