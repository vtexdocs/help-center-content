...
Entenda melhor a funcionalidade do XML na VTEX no artigo [Como funciona a atualização do XML](/pt/docs/tutorials/entendendo-a-atualizacao-do-xml).
Com o fim de aplicar um preço diferenciado a produtos pelo XML, é preciso associar uma tabela de preços de SKU. Para isso siga os passos a seguir:
  ...
  2. Clique em `Alterar` no arquivo XML que deseja editar. Caso deseje criar um novo, leia nosso artigo [Configurar XML](/pt/docs/tutorials/configurando-xml).
...
![PT-tabela de precos](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/preços/lista-de-preços/criando-um-xml-com-preco-promocional-por-tabela-de-preco_1.png)
...
![XML-exemplo](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/preços/lista-de-preços/criando-um-xml-com-preco-promocional-por-tabela-de-preco_2.png)
