...
> ⚠️ A funcionalidade [Lista](/pt/docs/tutorials/o-que-e-uma-lista) é exclusiva para lojas que usam CMS Portal (Legado).

Será abordado neste artigo as particularidades da criação de um tipo de Lista Vale, que é um tipo especial de Lista. [Veja nossa documentação completa de Tipo de Lista clicando aqui.](/pt/docs/tutorials/criando-tipo-de-lista/)
...
![sku-opção-credito-vale pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/tipos-de-lista/configurando-lista-vale_1.png)
...
![entrega-tipos-lista pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/tipos-de-lista/configurando-lista-vale_2.png)
