...
Na VTEX, o SKU (Stock Keeping Unit) corresponde tanto à unidade física de estoque do produto quanto ao nível mais específico para lidar com a variação desse produto. Por exemplo, se o produto é uma camiseta, o SKU poderia ser uma camiseta branca P. A partir do ID do SKU, você pode [editar o SKU](/pt/docs/tutorials/adicionar-ou-editar-sku) ou realizar outras ações.
...
2. Para exibir os [SKUs adicionados ao produto](/pt/docs/tutorials/adicionar-ou-editar-sku), clique na seta para baixo ao lado do nome do produto.
...
Quando você clica em um SKU e acessa sua [página de edição](/pt/docs/tutorials/adicionar-ou-editar-sku), a URL no seu navegador apresenta o seguinte formato: 
