...
> ⚠️ SKUs cadastrados com dados inválidos não terão a opção de *Ativar o SKU se possível* ativada. Caso nem todos os SKUs tenham sido marcados com a opção de *Ativar o SKU se possível*, repita o processo descrito acima.
...
](/pt/tutorial/como-exportar-planilha-de-produtos--2sIroGeqZqaN3NAvaSGwWV).
