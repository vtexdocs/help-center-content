...
> ❗ Uma vez que o produto seja criado, ele pode ser inativado, mas não é possível excluir um único produto. A plataforma só permite excluir produtos e SKUs em massa por meio da [Manutenção de Base (Full Cleanup)](https://help.vtex.com/pt/tutorial/manutencao-de-base-full-cleanup--34P9LGs7BCIQK6acQom802).

> ℹ️ Se após criar o produto ele não aparecer na vitrine da loja, confira o artigo [Por que o produto não aparece no site?](https://help.vtex.com/pt/faq/por-que-o-produto-nao-aparece-no-site--frequentlyAskedQuestions_382) e saiba como resolver o problema.
...
- **Nome do produto*:** insira o nome do produto, que será apresentado para os clientes na experiência de navegação. O limite são 150 caracteres. Este campo é muito importante para [SEO](https://help.vtex.com/pt/tutorial/melhorando-o-seo-das-paginas-de-lista-de-produtos--UrQtlKAMuSaLBP5wG9ftG), por isso temos algumas recomendações:
