...
3. Clique na aba __Especificações de produto__ ou __Especificações de SKU__, dependendo da sua necessidade.
    ![skuexport.pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/importação-e-exportação/exportar-e-importar-especificacoes-de-produto-e-de-sku_1.png)
...
![skuexport2.pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/catálogo/importação-e-exportação/exportar-e-importar-especificacoes-de-produto-e-de-sku_2.png)
