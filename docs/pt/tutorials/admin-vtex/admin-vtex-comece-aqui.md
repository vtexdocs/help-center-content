...
![Store overview gif PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/admin-vtex-comece-aqui_1.gif)

A página inicial oferece uma visão geral de alto nível da sua loja, como uma cabine de comando para as suas operações de comércio digital. Por isso, ela se chama [Visão Geral](/pt/docs/tutorials/visao-geral-da-loja).
...
![menu de navegação admin SEP2023](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/admin-vtex-comece-aqui_2.png)
...
![central de informações admin SEP2023](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/admin-vtex-comece-aqui_3.gif)
...
![Botão feedback - PT -](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/admin-vtex-comece-aqui_4.gif)
...
![configurações de avatar admin SEP2023](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/admin-vtex-comece-aqui_5.gif)
