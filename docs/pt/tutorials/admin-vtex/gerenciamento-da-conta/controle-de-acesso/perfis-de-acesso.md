...
Para gerenciar os perfis de acesso cadastrados na sua loja e os usuários associados a eles, acesse a [lista de perfis de acesso](/pt/docs/tutorials/perfis-de-acesso).

Confira a seguir os diferentes tipos de perfis de acesso que você pode cadastrar na loja.

### Tipos de perfis de acesso

Ao [criar um novo perfil de acesso](/pt/docs/tutorials/criar-perfil-de-acesso), você tem a opção de utilizar um dos perfis predefinidos disponibilizados pela VTEX ou de criar um perfil customizado, selecionando cada recurso necessário.

O administrador precisa ter um perfil de acesso com o [recurso](/pt/docs/tutorials/recursos-do-license-manager) _Save access profile_ para criar perfis de acesso no License Manager.

#### Predefinidos

Perfis de acesso predefinidos são conjuntos de recursos pré-determinados pela VTEX que cobrem os casos de uso mais comuns. Confira a lista completa de [perfis predefinidos](/pt/docs/tutorials/perfis-de-acesso-predefinidos) e as respectivas permissões associadas.
...
Confira a lista completa de [recursos do License Manager](/pt/docs/tutorials/recursos-do-license-manager) que podem ser utilizados.
...
![Lista perfis de acesso](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/gerenciamento-da-conta/controle-de-acesso/perfis-de-acesso_1.png)
...
Para os usuários que não devem ter acesso irrestrito à plataforma, é importante criar perfis de acesso que limitem os recursos disponíveis a apenas os estritamente necessários para aquele tipo de usuário. Para isso, confira o guia [Criar perfil de acesso](/pt/docs/tutorials/criar-perfil-de-acesso).

Você pode criar um novo perfil com base nos [perfis predefinidos](/pt/docs/tutorials/perfis-de-acesso-predefinidos) ou de forma customizada, selecionando os [recursos do License Manager](/pt/docs/tutorials/recursos-do-license-manager) necessários.
