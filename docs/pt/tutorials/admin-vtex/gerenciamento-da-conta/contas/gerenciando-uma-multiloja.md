...
- Para lojas desenvolvidas com Store Framework, veja [Gerenciando conteúdo de página e template](/pt/docs/tutorials/gerenciando-conteudo-de-pagina-e-template).

### Definir politícias comerciais

Para diferenciar produtos e/ou preços em cada loja, é necessária a utilização de políticas comerciais. Para saber mais, veja [Como funciona uma Política Comercial](/pt/docs/tutorials/como-funciona-uma-politica-comercial) e [Criar uma política comercial](/pt/docs/tutorials/criar-uma-politica-comercial).
...
8. No campo **Links**, clique em `Add`.
    ...
    ![cms-layout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/admin-vtex/gerenciamento-da-conta/contas/gerenciando-uma-multiloja_1.png)
...
10. Preencha o campo **Available sales channel** selecionando as políticas comerciais que serão associadas a esta loja.
    ...
    > ⚠️ Caso a loja utilize mais de uma 1 política comercial, atente-se para a ordenação dessas políticas em **Configurações da loja > Canais > Políticas comerciais**. Para saber mais, veja [Como funciona a relação entre websites e políticas comerciais](/pt/docs/tutorials/como-funciona-a-relacao-entre-websites-e-politicas-comerciais).

11. Clique em `Save Binding` e depois em `Save Website`.

### Configurar domínio do XML

Para gerar o arquivo XML da nova loja automaticamente, siga as instruções do guia [Configurar domínio do XML](/pt/docs/tutorials/configurar-dominio-do-xml).
...
- [Escolhendo entre arquitetura multiloja ou ambiente adicional](/pt/docs/tutorials/escolher-entre-arquitetura-multiloja-ou-ambiente-adicional)
