...
Ao finalizar a [configuração da funcionalidade Assinatura](/pt/docs/tutorials/como-configurar-assinaturas), ela já estará habilitada para que o cliente da sua loja gere um pedido com assinatura. Existem duas formas do seu cliente criar uma assinatura:
...
O seu cliente deverá selecionar a opção de _Assinatura_ e selecionar qual a frequência da assinatura. Vale notar que esse fluxo pode ser customizado em alguns casos, dependendo da necessidade de negócio.

Após selecionar os detalhes da assinatura, o cliente seguirá com o fluxo normal de compra. Deverá inserir o endereço de entrega e utilizar um dos [**meios de pagamento habilitados para o Sistema de Assinatura**](/pt/docs/tutorials/como-configurar-assinaturas). Após a aprovação do pagamento, a assinatura será ativada.
...
A comunicação com seu cliente sobre a assinatura será feita pelo módulo **Central de Mensagens**. Confira nosso artigo sobre [Emails Transacionais para Assinaturas](/pt/docs/tutorials/emails-transacionais-para-pedidos-de-assinaturas).
