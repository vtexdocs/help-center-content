...
Este artigo explica como cadastrar um usuário com um perfil de acesso de televendas. Para mais informações sobre perfis de acesso e como configurá-los, veja o artigo [Perfis de acesso](https://help.vtex.com/pt/tutorial/perfis-de-acesso).
