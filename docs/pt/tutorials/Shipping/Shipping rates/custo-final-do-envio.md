...
![Custo-final-envio-PT](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/Shipping/Shipping%20rates/custo-final-do-envio_1.svg)

>❗ Se o **adicional por preço** for menor que o **adicional de seguro**, a tarifa que é considerada é a do adicional de seguro e o adicional por preço é desconsiderado no cálculo da tarifa final.<p>
> A escolha da transportadora para o envio dos itens considera apenas o preço da Tarifa de envio, desconsiderando os custos da doca e estoque (caso existam). Para simular o cenário de entrega para o cliente, use o [Simulador de envio](https://help.vtex.com/pt/tutorial/simulacao-de-frete--tutorials_144).
