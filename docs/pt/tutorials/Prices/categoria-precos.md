...
- [Configurar regra de preço para política comercial](https://help.vtex.com/pt/docs/tutorials/configurar-regra-de-preco-para-politica-comercial)

## Arredondamento de Preços

- [Arredondamento de Preços](https://help.vtex.com/pt/docs/tutorials/arredondamento-de-precos)

## Configurações de preços

- [Configurações de preços](https://help.vtex.com/pt/docs/tutorials/configuracoes-de-precos)
