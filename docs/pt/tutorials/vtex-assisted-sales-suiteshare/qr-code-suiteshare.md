...
![QR Code_1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/qr-code-suiteshare_1.png)
...
> ⚠️ Antes de começar, você já deverá ter criado um link para cada número de WhatsApp. Se ainda não fez isso, é só [acessar esse link](/pt/docs/tutorials/links-suiteshare).

No painel do VTEX Assisted Sales (SuiteShare), acesse a opção _**Atrair > Links**_.

![QR Code_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/qr-code-suiteshare_2.png)

Clique no ícone do QRCODE, localizado no lado direito do link que você deseja criar um código.

![QR Code_3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/qr-code-suiteshare_3.png)

Escolha um logotipo (Opcional):

![QR Code_4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/qr-code-suiteshare_4.png)
...
![QR Code_5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/qr-code-suiteshare_5.png)
