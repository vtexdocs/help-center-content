...
![Funil de vendas_1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/funil-de-vendas-suiteshare_1.png)
...
1. No dashboard, clique em **Ver todas integrações** e em **Funil de Vendas**.
   ...
   ![Funil de vendas_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/funil-de-vendas-suiteshare_2.png)

2. Acesse **Configurações > Integrações > Funil de Vendas > Integrar**.

   ![Funil de vendas_3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/funil-de-vendas-suiteshare_3.png)

Clique em **Conectar**.

Pronto! Esse deve ser o resultado da integração dentro do Funil de Vendas CRM:

![Funil de vendas_4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-assisted-sales-suiteshare/funil-de-vendas-suiteshare_4.png)
