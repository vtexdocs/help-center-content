...
> ⚠️ Ao editar um conteúdo de bloco, você não poderá alterar os dados de *binding* e localidade - os campos serão bloqueados. Se você deseja alterá-los durante o processo, salve ou descarte suas alterações primeiramente e retorne à página inicial do Site Editor.
