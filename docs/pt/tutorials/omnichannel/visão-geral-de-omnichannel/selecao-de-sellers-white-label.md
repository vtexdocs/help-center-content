...
A arquitetura de uma loja VTEX permite que ela atue tanto como [marketplace](/pt/docs/tutorials/estrategias-de-marketplace-na-vtex), quanto como seller. O marketplace é o ambiente onde o produto é vendido, também chamado de vitrine, e o seller é o dono do estoque e o responsável pelo envio do pedido.
...
- **[Seller white label](/pt/docs/tutorials/seller-white-label):** o seller permanece oculto na experiência de compra do consumidor e é selecionado de forma automática pela plataforma VTEX para realizar o envio do pedido.

> ℹ️ Na VTEX, a conta franquia é um tipo de conta criada associada a uma conta principal e tem a característica de ser um seller white label da conta principal. Esse modelo de negócio é estratégico para lojistas que desejam conectar lojas físicas ao seu canal digital de venda, saiba mais em [O que é conta franquia](/pt/docs/tutorials/o-que-e-conta-franquia).
...
- [Retirada](#tipo-de-envio-retirada): o cliente retira o pedido em um [ponto de retirada](/pt/docs/tutorials/pontos-de-retirada).
...
2. É feita uma seleção de sellers que entregam na região do cliente pelo menos um SKU da lista. Sellers que não possuem no seu [inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque) todas as unidades de pelo menos um SKU são desconsiderados.
...
Um cliente adicionou ao carrinho cinco SKUs. Dentre os sellers que entregam na sua região, os sellers A, B, C e D, cada um possui no [inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque) apenas parte dos itens, conforme a imagem a seguir:

![print_selecao_seller_white_label_1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/omnichannel/visão-geral-de-omnichannel/selecao-de-sellers-white-label_1.png)
...
![print_selecao_seller_white_label_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/omnichannel/visão-geral-de-omnichannel/selecao-de-sellers-white-label_2.png)
...
Um cliente adicionou cinco SKUs ao carrinho e existem quatro sellers que entregam na sua região, os sellers A, B, C e D. Nenhum deles tem no [inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque) todos os itens, conforme imagem a seguir:

![print_selecao_seller_white_label_3](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/omnichannel/visão-geral-de-omnichannel/selecao-de-sellers-white-label_3.png)
...
![print_selecao_seller_white_label_4](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/omnichannel/visão-geral-de-omnichannel/selecao-de-sellers-white-label_4.png)
...
![print_selecao_seller_white_label_5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/omnichannel/visão-geral-de-omnichannel/selecao-de-sellers-white-label_5.png)
...
A seleção de até seis sellers para envio do tipo retirada é planejada para o cliente obter todos os itens do carrinho em um único [ponto de retirada](/pt/docs/tutorials/pontos-de-retirada), e ocorre da seguinte forma:
...
- Escolher um [ponto de retirada](/pt/docs/tutorials/pontos-de-retirada), se optar por retirar o pedido.
