...
4. Clique em <i class="fas fa-pencil"/> `Editar`.
...
* **Ativar códigos de barras dinâmicos:** opção que, se ativada <i class="fas fa-toggle-on"></i>, permite gerar EANs baseados em:
  | Preço                                                                                                                                                                                    | Peso                                                                                                                                                                                             |
  | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
  | Formato:`Dígito-Item-Preço-Verificador` Os dígitos para o preço são convertidos da seguinte forma: o preço R$12,90 equivale aos dígitos `01290`. Exemplo: `20-01234-01290-1` | Formato:`Dígito-Item-Peso-Verificador` <b></b>Os dígitos para o peso são convertidos da seguinte forma: o peso de 200 gramas equivale aos dígitos `00200`. Exemplo: `20-01234-00200-1` |
...
### Acessar o VTEX Pick and Pack no VTEX Admin

Pickers criados nesta aba só podem acessar o app mobile. Usuários que precisam acompanhar a operação no **VTEX Admin** requerem [perfis de acesso](/pt/docs/tutorials/roles) e [recursos do License Manager](/pt/docs/tutorials/license-manager-resources), e não são gerenciados nesta aba.
