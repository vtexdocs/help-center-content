...
- [Tarifas de envio](/pt/docs/tutorials/tarifas-de-envio): como as tarifas de envio são calculadas e como cadastrá-las.  
- [Gerenciar tarifas de envio](/pt/docs/tutorials/gerenciar-tarifas-de-envio): como gerenciar uma tarifa de envio específica utilizando o código postal.  
- [Planilha de frete](/pt/docs/tutorials/planilha-de-frete): como cadastrar tarifas de envio em massa, em vez de usar o cadastro individual.  

## Simulador de envio

O simulador de envio é a ferramenta utilizada para validar as [tarifas de envio](/pt/docs/tutorials/tarifas-de-envio). A simulação verifica as condições de entrega, dando ao lojista a capacidade de averiguar a disponibilidade de itens, as formas de entrega, os custos e os prazos.
...
Confira o artigo [Simulador de envio](/pt/docs/tutorials/simulador-de-envio) para entender o funcionamento do simulador e ver como são apresentados os detalhes da simulação.
...
Para entender o funcionamento desse tipo de entrega, leia o artigo [Como funcionam pontos de retirada](/pt/docs/tutorials/pontos-de-retirada). Para saber como utilizar um ponto de retirada, leia o artigo [Configurar Pontos de Retirada (Pickup Points)](/pt/docs/tutorials/cadastro-de-pontos-de-retirada).

## Estratégia de envio

[Estratégia de envio](/pt/docs/tutorials/estrategia-de-envio) é a relação que a loja tem com os estoques, docas e políticas de envio. Na VTEX, o estoque é onde os itens da loja estão armazenados; as docas são os intermediadores entre o armazenamento e o transporte dos pedidos; e as políticas de envio são as regras de entrega acordadas entre a transportadora e a loja.
