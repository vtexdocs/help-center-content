...
Lead time é a configuração opcional do tempo de envio a nível de SKU. Isso significa que você pode definir um período de envio para o SKU de um [estoque](/pt/docs/tutorials/estoque) e este tempo será adicionado ao prazo total de envio do pedido.

A configuração do lead time é feita no contexto da [gestão do seu inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque), pois se relaciona a itens em estoque e disponíveis para venda.
...
![lead_time_image_total_time_PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/envio/inventário/lead-time-tempo-de-envio-a-nivel-de-sku_1.png)
...
* [Tempo de estoque:](/pt/docs/tutorials/gerenciar-estoque) tempo que o SKU leva para sair de um estoque para uma [doca](/pt/docs/tutorials/doca). Essa configuração é obrigatória, mas você pode definir o tempo igual a zero.
* [Tempo de doca:](/pt/docs/tutorials/gerenciar-doca) tempo que o SKU leva para sair da doca, ponto intermediário entre o estoque e a [transportadora](/pt/docs/tutorials/transportadoras-na-vtex), para ser enviado para o cliente. Essa configuração é obrigatória, mas você pode definir o tempo igual a zero.
* [Política de envio:](/pt/docs/tutorials/politica-de-envio) agrupa as regras e condições apresentadas aos clientes no checkout, incluindo:
    * [Taxas de envio](/pt/docs/tutorials/planilha-de-frete)
...
O lead time vem configurado como zero dias, e o seu limite máximo é de 365 dias. Por padrão, a contagem é feita em dias úteis, considerando feriados e demais condições da sua [política de envio](/pt/docs/tutorials/politica-de-envio), mas você pode [configurar a contagem para ser em dias corridos](#configurar-a-contagem-do-lead-time-em-dias-do-calendario-opcional).
...
3. Na linha do SKU e na coluna **Lead time (dias)**, digite o número de dias desejado.
  ![lead_time_inventory_management_PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/envio/inventário/lead-time-tempo-de-envio-a-nivel-de-sku_2.png)
...
2. Encontre a política de envio desejada. Você pode utilizar a barra de pesquisa e os filtros.
    > Para criar uma nova política de envio, veja o artigo [Política de Envio](/pt/docs/tutorials/politica-de-envio).
