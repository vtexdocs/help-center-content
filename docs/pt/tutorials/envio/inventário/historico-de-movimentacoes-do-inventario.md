...
2. Selecione o SKU de que deseja conferir o histórico. Para saber como utilizar os filtros e realizar a busca, confira o artigo [Gerenciar inventário](/pt/tutorial/gerenciar-itens-em-estoque--tutorials_139).
...
A quantidade total de itens na página [Gerenciamento de inventário](/pt/tutorial/gerenciar-itens-em-estoque--tutorials_139) é atualizada em tempo real, mas pode haver um atraso de até 1 hora para a informação aparecer no registro de atualizações.
