...
O inventário contém as informações dos produtos que a loja possui para venda e em qual [estoque](/pt/docs/tutorials/estoque) eles estão armazenados. Nele, a loja pode conferir os registros de atualizações da quantidade de cada SKU: as unidades disponíveis, os usuários que realizaram alterações, as datas em que foram feitas as mudanças, e quantas eram as unidades de SKUs antes da atualização.

Esse artigo contém as instruções para acessar o histórico de movimentações do inventário pelo Admin VTEX. 

> ℹ️ Não esqueça da diferença entre estoque e inventário:  **[Estoque:](/pt/docs/tutorials/estoque)** nome dado para os locais de armazenamento da loja.   **Inventário:** relação dos SKUs e os estoques em que estão armazenados.
...
2. Selecione o SKU de que deseja conferir o histórico. Para saber como utilizar os filtros e realizar a busca, confira o artigo [Gerenciar inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque).
