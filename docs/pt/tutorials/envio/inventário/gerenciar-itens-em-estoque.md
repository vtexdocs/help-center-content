...
> ❗ Para garantir que os itens adicionados ao estoque fiquem disponíveis para venda na loja, o [ID dos SKUs](/pt/docs/tutorials/descobrir-o-id-de-um-sku) não deve conter o número zero à esquerda. O sistema não reconhece, por exemplo, IDs no formato `01`, `02`, `021` pois é esperado o formato`1`, `2`, `21`.
