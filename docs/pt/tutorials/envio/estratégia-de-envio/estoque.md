...
![EstrategiaEnvio](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/envio/estrat%C3%A9gia-de-envio/estoque_1.svg)
...
> ℹ️ Para adicionar itens ao seu estoque, os produtos precisam ser previamente cadastrados no [catálogo](/pt/tracks/catalogo-101--5AF0XfnjfWeopIFBgs3LIQ/7kz4uWVq6NoaOdUpiJv4PR). Com isso, é possível associá-los ao estoque pelo [gerenciamento de inventário](/pt/tutorial/gerenciar-itens-em-estoque--tutorials_139).

A disponibilidade dos produtos da sua loja é dada por produtos cadastrados em diferentes estoques. O que significa que para o cliente final os itens que ficam disponíveis durante a navegação na loja são itens referentes a todos os estoques. Assim, existe a possibilidade de em uma única compra ter produtos de diferentes estoques da sua loja. Para o controle de movimentações dos estoques e  disponibilidade de itens da sua loja acesse o [Gerenciamento de Inventário](/pt/tutorial/gerenciar-itens-em-estoque--tutorials_139).

Saiba mais sobre como gerenciar componentes logísticos na plataforma VTEX: 

*  Para saber como realizar cadastro, mudança e acompanhamento dos estoques consulte o  [Gerenciamento de Estoque](/pt/tutorial/gerenciar-estoque--tutorials_137).
* Para acompanhar e gerenciar os itens do estoque consulte o [Gerenciamento de inventário](/pt/tutorial/gerenciar-itens-em-estoque--tutorials_139).
* Para configurar e gerenciar a relação entre os estoques e as retiradas dos pedidos consulte [Gerenciamento de docas.](/pt/tutorial/como-cadastrar-doca--7K3FultD8I2cuuA6iyGEiW)

> ⚠️ A ordem de cadastro sugerida na plataforma VTEX para o funcionamento esperado do sistema logístico é: <body> <ol> <li>[Política de Envio](/pt/tutorial/politica-de-envio--tutorials_140)</li> <li>[Doca](/pt/tutorial/doca--5DY8xHEjOLYDVL41Urd5qj)</li> <li>Estoque</li> </ol> </body>
