...
Na VTEX, é possível determinar o horário de funcionamento das [transportadoras](/pt/docs/tutorials/transportadoras-na-vtex) da sua loja através de configurações na [política de envio](/pt/docs/tutorials/politica-de-envio), na qual você define os períodos válidos para a transportadora coletar e enviar pedidos.

Para configurar o horário de funcionamento, no seu Admin VTEX, acesse **Envio > Estratégia de envio** e crie uma [nova política de envio](/pt/docs/tutorials/criar-uma-politica-de-envio) ou [edite](/pt/docs/tutorials/gerenciar-politicas-de-envio) uma existente. 
...
1. Na [política de envio](/pt/docs/tutorials/politica-de-envio), na seção **Horário de funcionamento**, clique em `Janela de envio`.
2. Se você deseja ativar a opção `Aceitar compras fora do horário de funcionamento`, ative o toggle. Caso contrário, deixe-o desativado.
  ...
  > ℹ️ Quando esta opção está habilitada, o [cálculo de envio](/pt/docs/tutorials/como-funciona-o-calculo-de-envio) do pedido é influenciado, e o tempo desde a realização do pedido até o horário de início de funcionamento da transportadora é somado ao tempo de envio total de envio.
...
1. Na [política de envio](/pt/docs/tutorials/politica-de-envio), na seção **Horário de funcionamento**, clique na janela `Horário de coleta`.
