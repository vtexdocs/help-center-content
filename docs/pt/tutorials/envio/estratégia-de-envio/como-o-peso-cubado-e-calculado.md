...
Ao realizar o cadastro da sua transportadora, esse é o valor que você deve preencher no campo **Fator de peso cúbico** na sua [política de envio](/pt/docs/tutorials/politica-de-envio).
