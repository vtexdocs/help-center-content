...
A página [Chaves de API](https://help.vtex.com/pt/tutorial/chaves-de-api--4bFEmcHXgpNksoePchZyy6) permite exportar informações de todas as chaves geradas e as chaves externas relacionadas à conta para um arquivo `XLSX`.
...
* [Configurações de chaves de API](https://help.vtex.com/pt/tutorial/configurar-a-duracao-de-chaves-de-api--kcGIFysFt02FDuhsfjQwZ)  
