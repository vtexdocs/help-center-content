...
![one-time-link-pt](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/account-management/api-keys/renovar-token-de-api_1.png)
...
3. Na linha de uma chave de API com o alerta `Exclusão pendente - Token antigo`, clique no menu ⋮ e depois em <i class="far fa-trash-alt"></i> `Excluir token antigo`.
   ...
   ![delete-pending-pt](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/account-management/api-keys/renovar-token-de-api_2.png)
