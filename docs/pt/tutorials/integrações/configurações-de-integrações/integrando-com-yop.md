...
2. Configure a [logística](/pt/docs/tutorials/configurando-logistica-para-marketplace/) para essa política comercial;  
...
[Siga as instruções de nosso manual e preencha os campos conforme indicação abaixo](/pt/docs/tutorials/como-configurar-afiliado/).
...
[Siga nosso manual de como criar promoção para o marketplace](/pt/docs/tutorials/configurar-promocao-para-marketplace).
