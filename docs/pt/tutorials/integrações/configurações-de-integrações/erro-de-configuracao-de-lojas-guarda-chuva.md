...
Chamamos de lojas guarda chuva as contas no [Mercado Livre](/pt/docs/tracks/mercado-livre-marketplace) que possuem múltiplas [lojas oficiais](https://www.mercadolivre.com.br/lojas-oficiais/catalogo) vinculadas ao mesmo usuário no Mercado Livre. A arquitetura funciona da seguinte forma: o [seller](/pt/docs/tutorials/o-que-e-um-seller) integra suas [subaccounts](/pt/tutorial/o-que-e-store-name--3gh9mTNeMgs6Qe44e8IqQK?&utm_source=autocomplete) com o Mercado Livre de forma que as lojas oficiais do usuário do Mercado Livre ficam vinculadas às subaccounts do seller.
...
![cenario problema](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/integrações/configurações-de-integrações/erro-de-configuracao-de-lojas-guarda-chuva_1.JPG)
...
![cenario ideal](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/integrações/configurações-de-integrações/erro-de-configuracao-de-lojas-guarda-chuva_2.JPG)
...
![cenario atual](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/integrações/configurações-de-integrações/erro-de-configuracao-de-lojas-guarda-chuva_3.JPG)
