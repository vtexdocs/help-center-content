...
O primeiro passo para configurar seus produtos FBA Onsite é [cadastrar uma especificação de produto](/pt/docs/tutorials/cadastrar-especificacoes-ou-campos-de-produto) chamada **AMAZON_CHANNEL**. Dessa forma, você sinaliza à Amazon o tipo de envio do produto.
...
> ℹ️ É importante assegurar que a [política comercial](/pt/docs/tutorials/como-funciona-uma-politica-comercial) utilizada é específica para a Amazon. Dessa forma, você garante que o estoque criado não será utilizado por outra integração.  

Para dar continuidade à configuração, é preciso determinar uma [Estratégia de Envio](/pt/docs/tutorials/estrategia-de-envio) exclusiva para o FBA Onsite, ou seja, informar qual será a operação de entrega de seus produtos.  
