...
Toda vez que um [SKU](/pt/docs/tracks/sku-definicao-de-conceito) com [EAN](https://sellercentral.amazon.com.br/learn/courses?ref_=su_course_accordion&moduleId=71d0b122-4e43-4547-a05a-04517e8f41a2&courseId=959bc7cb-2866-499c-b24a-8d3f6def1306&modLanguage=Portuguese&videoPlayer=youtube) cadastrado na VTEX é enviado para a Amazon, o marketplace realiza um processo chamado *matching*, que consiste em unificar anúncios de um mesmo produto através do seu EAN.  
...
Após o [envio](/pt/docs/tracks/envio-de-produtos-para-amazon), os produtos estarão disponíveis na página __Match de anúncios Amazon__. Para visualizar os anúncios não aprovados, acesse o Admin VTEX, clique em *Marketplace >*__Match de anúncios Amazon__ ou use a barra de busca no topo da página.  
...
- **Botão `Rejeitar`:** esse botão irá excluir a sugestão de match e o seller deverá enviar novamente o seu produto caso queira, seguindo o [tutorial de envio de produtos](/pt/docs/tracks/envio-de-produtos-para-amazon).  
...
Os anúncios que não possuem correspondências, deverão ser enviados novamente. Para isso, siga o [tutorial de envio de produtos](/pt/docs/tracks/envio-de-produtos-para-amazon).  
