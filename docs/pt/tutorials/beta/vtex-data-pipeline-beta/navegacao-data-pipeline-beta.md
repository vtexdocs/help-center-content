...
> ⚠️ O conjunto de dados de navegação não captura todos os tipos de eventos que ocorrem durante a navegação.</br> Ex: cliques específicos, eventos especiais e interações com o mini carrinho.</br>
