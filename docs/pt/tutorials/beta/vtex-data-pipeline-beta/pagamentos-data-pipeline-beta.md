...
|:---:|:---:|
| **Origem do dado** | Os dados desse conjunto se origina do [módulo de Pagamentos da VTEX](/pt/docs/tracks/como-funciona-o-modulo-de-pagamentos). Eles são coletados e organizados de modo a refletir as transações e os pagamentos realizados na plataforma. |
...
**- Interação com dados de [pedidos](/pt/docs/tutorials/pedidos-data-pipeline-beta):** análise dos dados de pagamento em conjunto com os pedidos oferece insights sobre como os métodos de pagamento influenciam nas conversões de pedidos, revelando tendências no comportamento de compra dos clientes.  
