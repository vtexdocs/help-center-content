...
Para minimizar efeitos indesejados em promoções, a página **Alerta de promoções** possibilita que você [crie alertas](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta) com [condições](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta#condicoes) de verificar se os preços e promoções estão corretos e defina [ações preventivas](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta#acoes-preventivas) para evitar vendas com preços inesperados. Entretanto, é necessário que um pedido seja realizado para ativar o primeiro alerta.

Caso as [condições](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta#condicoes) definidas no alerta sejam identificadas, o sistema gera um alerta com informações sobre o produto vendido a preços inesperados e aplica as [ações preventivas](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta#acoes-preventivas) configuradas. Se a ação de [desativar as promoções](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta#acoes-preventivas) for configurada, o cenário indesejado não ocorrerá novamente, pois a promoção terá sido desativada.
...
![simuladordepromocoes gerenciar](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/beta/promoções-beta/alerta-de-promocoes-beta_1.gif)
...
Para criar um alerta de promoção, clique no botão `Criar Alerta`. Para mais detalhes, leia o artigo [Alertas de promoção: como criar um alerta de promoção](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta).
...
- [Alerta de promoção: Como criar um alerta de promoção](/pt/docs/tutorials/alerta-de-promocoes-como-criar-um-alerta-beta)
