...
> ℹ️  O uso das aspas duplas varia [de acordo com o tipo de campo](/pt/docs/tutorials/entidade-de-dados#entendendo-os-tipos) criado no Master Data. 
...
Na configuração abaixo, por exemplo, apenas registros `funcionario` com o valor `true` (utilizado em um campo do tipo **[Boolean](/pt/docs/tutorials/entidade-de-dados#entendendo-os-tipos)**, em que os valores são sempre verdadeiro ou falso) receberão a promoção. 
...
![Campo funcionário Master Data PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/criar-promoções/criando-promocao-para-um-cluster-de-clientes_1.png)

![Cluster de clientes PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/criar-promoções/criando-promocao-para-um-cluster-de-clientes_2.png)
...
![Campo Email Master Data](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/criar-promoções/criando-promocao-para-um-cluster-de-clientes_3.png)

![cluster email PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/criar-promoções/criando-promocao-para-um-cluster-de-clientes_4.PNG)
