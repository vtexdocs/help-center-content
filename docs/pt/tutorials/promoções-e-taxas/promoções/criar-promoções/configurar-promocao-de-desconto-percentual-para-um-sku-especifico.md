---
title: 'Configurar uma promoção de desconto percentual para um SKU específico'
...
4. Preencha os campos conforme [documentação da promoção](/pt/docs/tutorials/leve-mais-por-menos).
