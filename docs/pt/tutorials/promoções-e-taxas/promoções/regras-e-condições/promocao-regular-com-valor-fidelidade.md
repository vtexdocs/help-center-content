...
É possível criar uma [promoção regular](/pt/docs/tutorials/promocao-regular-pt) em **Promoções e Taxas > Promoções > Nova Promoção > Promoção Regular**. No momento de escolher o tipo e o valor do desconto, existem duas opções disponíveis para oferecer um valor fidelidade:
...
![vf-nominal-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/regras-e-condições/promocao-regular-com-valor-fidelidade_1.png)
...
![vf-percentual-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/regras-e-condições/promocao-regular-com-valor-fidelidade_2.png)
...
Você pode fazer essas configurações em **Promoções e Taxas > Promoções > Nova Promoção > Promoção Regular**. Para isso, siga as instruções do artigo [Promoção Regular](/pt/docs/tutorials/promocao-regular-pt).
...
![fluxo-oms-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/regras-e-condições/promocao-regular-com-valor-fidelidade_3.png)

Se você utiliza a nova interface de [Detalhes do pedido (Beta)](/pt/docs/tutorials/pagina-de-detalhes-do-pedido), acesse `Ver interações` para verificar o valor concedido:

![interacoes-neworders-pt (1)](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/regras-e-condições/promocao-regular-com-valor-fidelidade_4.png)
...
![checkout-pt (1)](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/regras-e-condições/promocao-regular-com-valor-fidelidade_5.png)
