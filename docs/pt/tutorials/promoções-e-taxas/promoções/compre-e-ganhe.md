...
- **Cluster de clientes:** selecione um [cluster de clientes](https://help.vtex.com/pt/tutorial/como-criar-um-cluster-de-clientes) já criado no Master Data, seguindo o formato `field=value` ou `field contains value`.
...
- **Permitir acumular com outras promoções:** a promoção poderá ser combinada com outras promoções ativas no momento. Note que, por padrão, a promoção já acumula descontos de frete ou brindes. Para mais informações acesse o artigo [Como funciona a concorrência de promoções](https://help.vtex.com/pt/tutorial/entendendo-a-concorrencia-de-promocoes--tutorials_2270).
