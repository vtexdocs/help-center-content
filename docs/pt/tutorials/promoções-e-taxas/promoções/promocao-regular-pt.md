...
* [Criar a promoção](#criar-promocao)  
...
* **Utm\_source:** permite o desconto quando a navegação for realizada com a utm\_source configurada.  
* **Utm\_campaign:** permite o desconto quando a navegação for realizada com o parâmetro utm\_campaign configurado.  
...
* **Utmi\_cp:** o desconto será aplicado apenas se a navegação incluir o parâmetro `utmi_cp` com o valor cadastrado. Para mais detalhes, consulte o artigo [O que são as UTMs internas utmi\_cp, utmi\_pc e utmi\_p](https://help.vtex.com/pt/tutorial/what-are-the-internal-utms).  
