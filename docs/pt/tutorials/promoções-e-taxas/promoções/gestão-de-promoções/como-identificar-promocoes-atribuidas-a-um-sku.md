...
2. No Google Chrome, acesse **Ferramentas de Desenvolvedor** (`Ctrl+Shift+I`).![ferramentas-do-desenvolvedor](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/gestão-de-promoções/como-identificar-promocoes-atribuidas-a-um-sku_1.png)
3. Selecione a aba **Network** e pressione `F5` para gravar o carregamento da página.![network-f5](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/gestão-de-promoções/como-identificar-promocoes-atribuidas-a-um-sku_2.png)
4. Após o carregamento, pressione `Ctrl+F` para fazer uma busca na janela das __Ferramentas de Desenvolvedor__ e busque por `orderForm`.![order-form](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/gestão-de-promoções/como-identificar-promocoes-atribuidas-a-um-sku_3.png)
