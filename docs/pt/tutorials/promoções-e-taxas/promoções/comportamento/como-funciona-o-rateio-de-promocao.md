...
Existem dois tipos principais de descontos: __percentual__ e __nominal__. 

O tipo __percentual__ é dinâmico, varia de acordo com o valor dos itens. Assim, ele é aplicado a cada produto separadamente.

O tipo __nominal__ exige uma inteligência de cálculo mais apurada. Há diversas situações em que __existe mais de um produto associado a uma mesma promoção__ num carrinho. Nestes casos, __a promoção é aplicada à soma total dos produtos no carrinho__.
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/comportamento/como-funciona-o-rateio-de-promocao_1.JPG)
...
[Entenda como funciona a concorrência de promoções](/pt/tutorial/entendendo-a-concorrencia-de-promocoes/)
