---
title: 'Concorrência de promoções'
id: tutorials_2270
status: PUBLISHED
...
O módulo de Promoções define qual promoção será aplicada em uma compra. Da mesma forma, o [Checkout](/pt/docs/tutorials/checkout-vtex-visao-geral) seleciona qual seller irá realizar o fulfillment do pedido. Essa lógica é chamada de concorrência de promoções.
...
![promocao3 PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/promoções-e-taxas/promoções/comportamento/como-funciona-a-concorrencia-de-promocoes_1.png)
