...
* **Valor do item entre __e__:** preço mínimo e máximo que cada item no carrinho pode ter. A audiência de campanha será ativada se o valor do item atender ao intervalo de valores preenchidos.
...
* **O CEP de entrega deve Incluir / Excluir de __até__:** permite incluir ou excluir intervalos de CEPs para envio de pedidos. A audiência de campanha será ativada caso o CEP atenda à regra configurada no público-alvo.
