...
> ℹ️ Para mais informações sobre como adicionar ou configurar campos contábeis, acesse [Adicionar ou editar campos contábeis](https://help.vtex.com/pt/docs/tutorials/adding-or-editing-accounting-fields).
