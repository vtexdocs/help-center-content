...
| [VTEX Intelligent Search](https://developers.vtex.com/vtex-developer-docs/docs/search) | Habilita buscas de produtos (apenas disponível para lojas desenvolvidas com VTEX IO).                                                                                                                                                          |
