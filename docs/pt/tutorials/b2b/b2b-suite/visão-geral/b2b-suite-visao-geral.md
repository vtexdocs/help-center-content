...
![Instalação B2B Suite - PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/b2b/b2b-suite/visão-geral/b2b-suite-visao-geral_1.gif)
...
Fornece uma nova página de Pedidos no [Minha Conta](/pt/docs/tutorials/como-funciona-a-minha-conta) para que os usuários B2B possam visualizar todos os pedidos anteriores feitos por usuários em sua organização ou centro de custos, dependendo de sua função.
