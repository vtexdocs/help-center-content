...
## Funcionalidade
O aplicativo Histórico de Pedidos B2B substitui a página de Pedidos padrão em [Minha Conta](/pt/docs/tutorials/como-funciona-a-minha-conta) por uma versão adaptada para o cenário B2B. Essa personalização permite que os [usuários](/pt/docs/tutorials/gerenciamento-de-permissoes-no-b2b-suite) logados de uma organização não apenas vejam seus próprios pedidos, mas também acessem pedidos feitos por outros membros da mesma organização ou centro de custo, desde que possuam as permissões adequadas.
