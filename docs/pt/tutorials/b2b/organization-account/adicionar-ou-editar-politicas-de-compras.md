...
* Adicionar política de compra
* Ver página de detalhes
* Editar política de compra
* Remover política de compra

> ⚠️ Para configurar políticas de compras, o perfil de [Storefront Roles](https://developers.vtex.com/docs/guides/storefront-roles) do usuário deve ter o recurso `ManageBuyingPolicies`. Para autorizar pedidos, é necessário o recurso `ApproveOrders`.
...
3. No modal **Add new buying policy**, preencha os campos, que são todos obrigatórios:
    * Em **Basic information**, defina o nome e a descrição da política de compra que aparecerá no checkout para os compradores:
        * **Name:** nome da política de compra.
        * **Description:** explicação breve do funcionamento da política de compra. Ao criar uma boa descrição, os usuários que interagirem com essa política de compra têm maiores chances de entender os motivos pelos quais um pedido foi negado ou precisou de aprovação manual.
    * Em **Criteria**, defina os critérios que resultam na aplicação da política de compra. Para isso, preencha o campo com uma expressão no formato [JSONata](https://jsonata.org/), tal como `value > 10000` (pedidos acima de R$ 100,00). É possível selecionar o critério desejado e apenas editar os valores desejados (destacados em roxo):
...
1. Na [tela inicial da Conta da Organização](https://help.vtex.com/pt/docs/tutorials/conta-da-organizacao#acessando-a-conta-da-organizacao), na seção **Finance and Compliance**, clique em `Buying Policies`.
2. Na tela **Buying Policies**, na linha correspondente à opção desejada, clique no ícone menu > `Edit` (editar). Ou então, na [página de detalhes](#ver-pagina-de-detalhes) da política de compra, clique em `Edit` (editar).
3. Faça as modificações desejadas.
4. Para salvar as alterações, clique em `Save` (salvar).

## Remover política de compra

> ❗ A remoção de uma política de compra é permanente e não pode ser desfeita. As configurações são excluídas, mas o histórico de aplicação da política de compra fica armazenado para consultas futuras.

1. Na [tela inicial da Conta da Organização](https://help.vtex.com/pt/docs/tutorials/conta-da-organizacao#acessando-a-conta-da-organizacao), na seção **Finance and Compliance**, clique em `Buying Policies`.
2. Na página **Buying Policies**, na linha correspondente à opção desejada, clique no ícone menu > `Delete` (deletar). Ou então, na [página de detalhes](#ver-pagina-de-detalhes) da política de compra, clique em menu > `Delete`.
3. No modal aberto, preencha o nome da política de compra a ser removida.
