...
Os campos são atributos de um documento. Para criá-los, é necessário acessar uma [entidade de dados](/pt/docs/tutorials/entidade-de-dados) específica e editá-la.
...
![criar campo master data ds](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/master-data/configurações-do-master-data-v1/como-crio-um-campo-no-master-data_1.gif)
...
![criar campo master data CRM](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/master-data/configurações-do-master-data-v1/como-crio-um-campo-no-master-data_2.gif)
