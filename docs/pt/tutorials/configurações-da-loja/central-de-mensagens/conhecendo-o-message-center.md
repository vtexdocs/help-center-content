...
> ⚠️ Por questões de segurança, nem todos templates podem ser enviados com “CC” e “CCO”.

Entenda as informações que cada _card_ do template traz:

![message center - card templates](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/central-de-mensagens/conhecendo-o-message-center_1.png)
...
![busca-templates-central-mensagens pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/central-de-mensagens/conhecendo-o-message-center_2.png)
...
![message center - card remetentes](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/configurações-da-loja/central-de-mensagens/conhecendo-o-message-center_3.png)
...
É importante que você personalize seu remetente para que o cliente receba as mensagens com o nome e e-mail da sua empresa, caso contrário os e-mails recebidos serão em nome de “noreply@vtexcommerce.com.br”. Para tal, veja [como alterar o servidor SMTP](/pt/docs/tutorials/personalizando-o-smtp-da-vtex) de sua loja.
