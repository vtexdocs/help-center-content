...
- [Visão geral](/pt/docs/tutorials/visao-geral-da-loja): onde lojistas têm acesso às principais métricas que impactam a receita de suas lojas. Nesse painel, você pode acompanhar a evolução das suas vendas através dos recursos de análise de tendências de pedidos, taxa de conversão e gráficos de funil de vendas.  
- [Performance de Vendas](/pt/docs/tutorials/performance-de-vendas): um painel de controle para comércio unificado, ajudando lojas a ampliarem seu negócio e tomarem decisões com mais precisão.  
