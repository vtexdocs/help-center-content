...
![Store overview gif PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_1.gif)

A página de Visão Geral traz um resumo do seu negócio com a VTEX. Para consultar análises mais profundas das métricas da sua loja, acesse [Performance de Vendas](/pt/docs/tutorials/performance-de-vendas).
...
## Métricas
![Store overview Métricas PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_2.png)
...
| Pedidos na última hora                | Pedidos feitos na sua loja na última hora. Ao clicar nessa métrica, você será redirecionado para a página [Todos os pedidos](/pt/docs/tutorials/todos-os-pedidos).                                                                                                                                                                   |

## Produtos com maior receita / Produtos com mais unidades vendidas
![Store overview Growing products PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_3.jpg)
...
## Pedidos realizados
![Store overview Pedidos realizados PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_4.png)
...
## Pedidos cancelados
![Store overview Pedidos cancelados PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_5.png)
...
![Store overview Order trend PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_6.jpg)
...
## Taxa de conversão
![Store overview Conversion rate PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_7.jpg)  
...
## Funil de vendas
![Store overview sales funnel PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_8.jpg)
...
![Categorias PT](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/dashboards/dashboards-no-admin-vtex/visao-geral-da-loja_9.png)
