...
As três primeiras prateleiras são montadas automaticamente pelo sistema e as três últimas são configuradas [manualmente no cadastro de produtos](/pt/docs/tutorials/configurando-produto-similar-sugestoes-acessorios-e-genericos/).
