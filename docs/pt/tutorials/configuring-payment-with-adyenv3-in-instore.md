---
title: Configurar pagamento com AdyenV3 no inStore
...
slug: configurar-pagamento-com-adyenv3-no-instore
legacySlug: configurar-pagamento-com-adyenv3-no-instore
subcategory: 3tDGibM2tqMyqIyukqmmMw
---

Na VTEX, é possível realizar a integração com o provedor de pagamento Adyen. Por meio deste conector, sua loja pode oferecer transações de pagamento em lojas físicas (inStore), utilizando pontos de vendas (POS). Para mais informações, acesse [O que é o inStore?](https://help.vtex.com/pt/tracks/instore-getting-started-and-setting-up--zav76TFEZlAjnyBVL5tRc/7fnnVlG3Kv1Tay9iagc5yf).

<div class="alert alert-info">
Para utilizar a afiliação AdyenV3 em sua loja por outros canais de venda online (exceto inStore), acesse <a href="https://docs.google.com/document/d/1mpjo4VMG8v__YT4dvaKHyvDeWA3NY6O9wnYEIRgkQYM/edit#">Configurar pagamento com AdyenV3</a>.
</div>

Para utilizar a afiliação AdyenV3 no inStore, é necessário:

- [Configurar ponto de venda (POS)](#configurar-ponto-de-venda-(pos))
- [Configurar ambiente Adyen](#configurar-ambiente-adyen)
- [Configurar conector AdyenV3 (inStore) na VTEX](#configurar-conector-adyenv3-(instore)-na-vtex)
- [Configurar condição de pagamento](configurar-condição-de-pagamento)
...
- [VTEX - inStore Basic settings](https://help.vtex.com/en/tracks/instore-primeiros-passos-e-configuracoes--zav76TFEZlAjnyBVL5tRc/4L5SoLxE8O3YkxF7FKymrO)
...
<div class="alert alert-warning">
As informações abaixo consideram que a API Key já foi previamente gerada no ambiente da Adyen. Caso seja necessário criá-la, consulte a documentação da <a href="https://docs.adyen.com/">Adyen</a>.
</div>
...
## Configurar conector AdyenV3 (inStore) na VTEX
...
Depois de seguir os passos indicados, o conector AdyenV3 pode demorar até 10 minutos para aparecer como opção de pagamento no inStore de sua loja.
