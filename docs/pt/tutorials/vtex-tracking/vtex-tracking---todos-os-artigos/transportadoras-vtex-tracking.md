...
Após o cadastro da transportadora, cadastre seu usuário correspondente, para que tenha um login e senha de acesso ao sistema. Confira nossa documentação sobre criação de [usuários VTEX Tracking](/pt/docs/tutorials/usuarios-vtex-tracking#consultar-usuario) para saber mais. 
