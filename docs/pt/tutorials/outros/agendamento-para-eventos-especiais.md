...
> ⚠️ O agendamento de conteúdo está disponível apenas para lojas desenvolvidas usando [VTEX IO](https://developers.vtex.com/docs/guides/store-framework).
...
![seta-interface](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/outros/agendamento-para-eventos-especiais_1.png)
