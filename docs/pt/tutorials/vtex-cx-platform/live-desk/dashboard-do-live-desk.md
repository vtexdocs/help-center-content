...
Para acessá-la, basta ir em **Live Desk** (em **Operações**) no VTEX CX Platform e dentro do menu de Opções clicar no botão `Dashboard`. Por enquanto esta ferramenta está disponível somente para gestores e administradores.
