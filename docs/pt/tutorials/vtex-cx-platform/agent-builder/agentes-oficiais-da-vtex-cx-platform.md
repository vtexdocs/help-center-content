...
| [Cadê Meu Pedido](https://www.cademeupedido.com.br/login) | Cadê Meu Pedido | Consulta o Cadê Meu Pedido para informar detalhes do pedido, como faturamento e rastreamento. | `CadeMeuPedido Base URL`: URL da sua conta no Cadê Meu Pedido. <br> `CadeMeuPedido Subdomain`: subdomínio da sua conta no Cadê Meu Pedido. |
