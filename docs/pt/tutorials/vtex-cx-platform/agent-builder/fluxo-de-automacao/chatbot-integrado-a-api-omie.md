...
É um chatbot pronto para envio de **Segunda via em PDF** e **Captura de Leads** (possíveis clientes para o seu negócio). O VTEX CX Platform fornece soluções digitais para automatização da comunicação consciente, aberta e acessível. Este chatbot é um projeto template desenvolvido pelo VTEX CX Platform, utilizando a API da [Omie](https://www.omie.com.br/).
