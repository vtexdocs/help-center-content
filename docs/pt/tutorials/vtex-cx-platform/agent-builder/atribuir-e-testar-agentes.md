...
> ℹ️ Para criar agentes customizados, use o CLI do VTEX CX Platform (Weni). Confira a [documentação](https://developers.vtex.com/docs/guides/using-the-weni-by-vtex-cli) para criar seu próprio agente.
