...
![Imagem Supervisor](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/agent-builder/visao-geral-agent-builder_1.png)
...
Para entender como fazer isso, leia o artigo [Como atribuir e testar um agente](/pt/docs/tutorials/atribuir-e-testar-agentes).
...
![GIF Feedback progressivo dos agentes](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/agent-builder/visao-geral-agent-builder_2.gif)
...
![Formato de mensagem múltipla](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/agent-builder/visao-geral-agent-builder_3.png)
...
> ℹ️ Leia mais sobre o assunto no artigo [Agentes oficiais da Weni by VTEX](/pt/docs/tutorials/agentes-oficiais-da-weni-by-vtex).
