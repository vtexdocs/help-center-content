...
1. Comunicação com o VTEX CX Platform
2. Registro do aplicativo no Portal da Azure;
3. Criação do Bot no Portal do Azure;
4. Habilitar o Canal de Atendimento do Teams no VTEX CX Platform
5. Criação da Aplicação na AppStudio;
6. Publicar a Aplicação no Teams.

### 1. Comunicação com o VTEX CX Platform

No Microsoft Teams, a comunicação do Chatbot com o VTEX CX Platformpela URL de callback. Essa URL deve ser pega assim que a integração do canal do Teams no VTEX CX VTEX CX Platform
