...
legacySlug: como-criar-um-canal-no-instagram
locale: pt
subcategoryId: 7e9LaCixVcvflzgWkxlftd
---

O Instagram já atingiu o marco de 1.4 bilhão de usuários ativos, sendo que mais de 500 milhões navegam assiduamente todos os dias, buscando não somente a interação, mas procurando por serviços e produtos.
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_1.png)

![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_2.png)
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_3.png)
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_4.png)

4. Toque em **Sim, concluir a configuração**.
5. Selecione se deseja sincronizar a sua foto de perfil. Depois, toque em **Continuar**.

Caso queira remover uma conta do Facebook da Central de Contas realize os passos abaixo:

1. Acesse o seu perfil, ou na sua foto do perfil, no canto inferior direito.
2. Toque em menu, no canto superior direito e em **configurações**.
3. Toque em **Central de Contas** na parte inferior e toque no seu nome na parte superior.
4. Toque na sua conta conectada e em **Remover da Central de Contas**.
...
1. Acesse o seu perfil, ou na sua foto do perfil, no canto inferior direito,
2. Toque em menu, no canto superior direito e em **configurações**.
3. Toque em **Privacidade**. Em Interações toque em **Mensagens**.
4. Abaixo de Ferramentas Conectadas habilite o **Permitir acesso às mensagens**.
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_5.png)

2. Vá em Descoberta. Agora escolha entre a lista de canais disponíveis a opção de Instagram.

![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_6.png)

3. Se já tiver realizado os passos de configuração apresentados anteriormente, clique em Conectar.

![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_7.png)
...
6. Agora você verá as páginas da sua conta do Facebook, selecione a página que você vinculou à conta do Instagram escolhida no passo anterior e clique em Avançar.
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/vtex-cx-platform/integrações/como-criar-um-canal-no-instagram_8.gif)
