...
1. No seu projeto, clique em **Aplicações > Descobrimentos > Adicione o canal VTEX CX Platformt**.

2. Em seguida, clique em **Minhas Aplicações** e acesse o canal Web Chat que você criou.

3. Ao clicar na aplicação, abrirá uma janela de configuração do seu VTEX CX Platformt com opções de personalização.
