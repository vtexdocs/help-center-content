...
> ⚠️ Se sua loja é desenvolvida com base no [Store framework](/pt/docs/tracks/cms-vtex-io), para fazer a integração funcionar em todas as páginas é necessário também instalar o aplicativo do pixel do Google Tag Manager. Veja como fazer isso na [documentação sobre a app](https://developers.vtex.com/vtex-developer-docs/docs/google-tag-manager).
...
- Configurar Google Analytics 4, ou seja, realizar a primeira etapa descrita no guia [Configurar Google Analytics 4 em loja VTEX](/pt/docs/tutorials/como-configurar-google-analytics-em-loja-vtex).
...
![Google Tag Manager](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/integracao-com-o-google-tag-manager_1.PNG)
...
Se a sua loja utiliza [VTEX IO - Store Framework](/pt/docs/tracks/cms-vtex-io), além da configuração, será necessário instalar uma nova versão do app Google Tag Manager. Para mais informações, acesse [Installing Google Tag Manager](https://developers.vtex.com/docs/guides/vtex-io-documentation-installing-google-tag-manager).

Esta etapa não é necessária para lojas que utilizam [CMS - Portal Legado](/pt/docs/tracks/cms-portal-legado).
