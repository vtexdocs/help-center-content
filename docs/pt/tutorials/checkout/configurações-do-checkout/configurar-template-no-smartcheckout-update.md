...
![Novo Site](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_1.png)

Acesso ao __Nome da Conta__: 

![PT Configuração da Conta Nome Loja](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_2.png)
...
![PT Cards Portal](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_3.png)

Exemplo de páginas disponíveis para um site:
![PT Paginas Cropped (2)](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_4.png)

Caso deseje __excluir__ um site, clique no botão de exclusão do site desejado, como no exemplo indicado abaixo:
![PT Card Croppped Delete](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_5.png)
...
![PT Editar Checkout](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_6.png)
...
![PT Lista Código Templates](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_7.PNG)
...
![checkout-header-codigo-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_8.png)

![checkout-header-page-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_9.png)

- Template __checkout-footer__ e rodapé da página do site:

![checkout-footer-codigo-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_10.png)

![checkout-footer-page-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_11.png)

- Template __vtex-checkout__ e página do carrinho no Checkout:

![smartcheckout16.pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_12.png) 

![vtex-checkout-page-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_13.png)

- Template __vtex-orderPlaced__ e página do pedido confirmado:

![smartcheckout18.pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_14.png) 

![vtex-orderplaced-page-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_15.png)
...
![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configura%C3%A7%C3%B5es-do-checkout/configurar-template-no-smartcheckout-update_16.jpg)
