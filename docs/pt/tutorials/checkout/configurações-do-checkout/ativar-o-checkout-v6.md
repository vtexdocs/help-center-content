...
6. [Acesse sua loja em ambiente beta](/pt/docs/tutorials/acessar-o-ambiente-beta-pelo-dominio-myvtex-com) e realize os ajustes de estilo necessários. O Checkout v6 possui novas classes _CSS_ que devem ser levadas em consideração para customização do estilo.
