...
3. No canto inferior direito da tela, clique no botão <img src="https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_5.png" alt="cartman-icon" width="25"/> para acessar o Cartman.
...
![Detalhes do item](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_1.PNG)
...
![Adicionar itens pelo ID do SKU](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_2.PNG)
...
![Adicionar itens aleatórios](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_3.PNG)
...
![Definir dados de marketing](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_4.PNG)
...
1. Acesse uma página de Checkout da sua loja (`https://{accountname}.myvtex.com/checkout/`).
2. No canto inferior direito da tela, clique no botão <img src="https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/configurações-do-checkout/configurar-o-cartman_6.png" alt="cartman-icon" width="25"/>.
