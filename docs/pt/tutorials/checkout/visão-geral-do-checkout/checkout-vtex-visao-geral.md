...
![Checkout overview](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/checkout/vis%C3%A3o-geral-do-checkout/checkout-vtex-visao-geral_1.png)
...
- [reCAPTCHA](/pt/tutorial/recaptcha-no-checkout--18Te3oDd7f4qcjKu9jhNzP): ferramenta para validação de usuário real em pedidos que serão pagos com cartão de crédito ou débito, afim de evitar acessos de falsos usuários que possam ser simulados por meio de programas maliciosos.
