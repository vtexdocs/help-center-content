...
> ℹ️ O Live Shopping é um aplicativo pago com diferentes planos de assinatura: **Lite**, **Standard** e **Pro**. O custo da assinatura depende do plano escolhido, cada um com um número específico de minutos mensais de transmissão ao vivo. Para mais informações sobre os planos e preços, consulte a página do [Live Shopping App Store](https://apps.vtex.com/liveshopping/p).

![live-shopping-web](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/live-shopping/live-shopping_1.png)

![live-shopping-mobile](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/live-shopping/live-shopping_2.png)
...
![ls-usage](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/live-shopping/live-shopping_4.png)
