...
> ℹ️ O **Affiliates Program** é um aplicativo compatível apenas com lojas [VTEX IO](/pt/docs/tracks/cms-vtex-io), e não está disponível para lojas que utilizam [CMS Portal (Legado)](/pt/docs/tracks/cms-portal-legado) ou [Headless CMS (Legacy)](https://faststore.dev/tutorials/cms/0#vtex-headless-cms). Para instalar e configurar o aplicativo na sua loja VTEX, acesse o guia para desenvolvedores Affiliates Program app.
...
![print_affiliates_url_pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/aplicativo-affiliates-program_1.png)
...
![affiliate_profile_page_pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/aplicativo-affiliates-program_2.png)
...
![affiliates_management_page_pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/aplicativo-affiliates-program_3.jpg)
...
![orders_management_page_pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/aplicativo-affiliates-program_4.jpg)
...
![commissions_ management_page_pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/apps/aplicativo-affiliates-program_5.jpg)
