---
title: 'Alterar os dados cadastrais da loja'
...
> ℹ️ O documento fiscal identifica, legal e tributariamente, a empresa e varia conforme o país de operação.

O documento fiscal da sua loja não pode ser alterado diretamente no Admin VTEX. Para solicitar essa alteração, [abra um ticket para o suporte financeiro](https://supporticket.vtex.com/support).

> ℹ️ Se a sua loja opera no Brasil, consulte o artigo [Alterar o CNPJ da loja](/pt/docs/tutorials/alterar-o-cnpj-da-loja).
