...
- Credenciais SMSC: O VTEX Agentic CX Platform precisa de nome de usuário, senha, porta e qualquer outra informação necessária para enviar e receber mensagens para o agregador.
