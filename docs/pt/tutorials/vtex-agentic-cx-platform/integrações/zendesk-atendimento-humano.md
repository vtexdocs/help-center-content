...
Dentro do seu projeto no VTEX Agentic CX Platform, vá até o módulo **Aplicações > Outros Apps**.
...
1. Verifique a Conexão no VTEX Agentic CX Platform
Se todos os passos foram seguidos corretamente, em **Aplicações > Outros Apps** no VTEX Agentic CX Platform, o serviço com o Zendesk deverá aparecer como conectado.

1. Use o Card ""**Abrir um Ticket**"" no Fluxo
Agora você pode usar o card **Abrir um Ticket** no seu fluxo no VTEX Agentic CX Platform.
