...
O VTEX Agentic CX Platform tem vários canais SMS para serem configurados para receber e enviar mensagens e, de acordo com o aplicativo escolhido, terá configurações diferenciadas a serem feitas. Para ativar um canal vá a **Configurações > Canais > Outras Aplicações > Adicionar Canal**
