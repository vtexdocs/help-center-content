...
Através do chatbot, você também terá um período de 24 horas a partir da última interação do usuário com o bot para enviar mensagens gratuitas pelo VTEX Agentic CX Platform, onde os usuários podem não só consultar e obter informações, mas também optar por comprar produtos, por exemplo. Você também pode enviar mensagens de saída, mas elas são pagas.
