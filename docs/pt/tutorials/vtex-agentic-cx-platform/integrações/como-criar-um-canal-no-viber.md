...
Levará alguns segundos para processar e uma nova janela será exibida com o token necessário. copie e guarde este token para o próximo passo de integração do canal com o VTEX Agentic CX Platform.
