---
title: 'Visão geral VTEX Agentic CX Platform'
...
2) Se você nunca se cadastrou na Weni Plataforma, clique no botão Cadastre-se grátis ou escolha o provedor do seu email, você será redirecionado para a seguinte página:
