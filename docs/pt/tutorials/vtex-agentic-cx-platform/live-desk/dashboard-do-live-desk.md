...
Para acessá-la, basta ir em **Live Desk** (em **Operações**) no VTEX Agentic CX Platform e dentro do menu de Opções clicar no botão `Dashboard`. Por enquanto esta ferramenta está disponível somente para gestores e administradores.

### Tela principal

Ao acessar Dashboards, são apresentados os dados do projeto. Dessa forma, se existe mais de um setor, as métricas representam os dados de todos os setores
contidos no projeto.
...
Ao selecionar um setor, os dados principais serão mostrados de acordo com aquele setor exclusivamente. Dessa forma, serão listadas as filas contidas naquele setor e os agentes online listados serão apenas os que estão naquele setor.
