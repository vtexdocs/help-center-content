...
Existem duas formas de se criar uma IA de classificação no VTEX Agentic CX Platform: através dos cards de fluxo **Classificar automaticamente** e **Aguarde por resposta inteligente**.
