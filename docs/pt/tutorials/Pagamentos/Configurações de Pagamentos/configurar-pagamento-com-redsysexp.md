...
8. Em __Campos do provedor__, preencha os campos __Merchant code__, __Signature key__ e __Merchant URL__ com as informações da sua conta RedsysEXP.
9. Em __Terminal__, __Currency__, __Language__, __3DS Enabled__, __Sanbox__ e __Permite Tokenizar__ selecione as opções desejadas.
10. Clique em `Salvar`.
