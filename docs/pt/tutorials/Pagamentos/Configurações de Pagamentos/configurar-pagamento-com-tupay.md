...
Para configurar os métodos de pagamento a serem processados pela Tupay, acesse [Condições de Pagamento](https://help.vtex.com/pt/tutorial/condicoes-de-pagamento).
