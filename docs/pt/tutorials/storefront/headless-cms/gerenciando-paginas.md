...
No **Headless CMS (Legacy)**, você pode gerenciar todas as rotas de URL e modelos de página do site da sua loja, incluindo as páginas `Global Alert Page`, `Page` and `Product Page`. Você também pode criar e associar páginas personalizadas a modelos pré-definidos e gerenciar páginas criadas diretamente no código-fonte do seu projeto de storefront.
