...
![erroDeletarPasta2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-portal-legado/layout/apagar-uma-pasta-do-cms_1.png)

> ❗ Algumas pastas são obrigatórias. Sua loja não funcionará corretamente sem elas. Outras são importantes, portanto não é uma boa ideia apagá-las.<br><br>Entenda melhor este assunto no artigo [Estrutura de pastas do CMS](/pt/docs/tutorials/estrutura-de-pastas-do-cms).
...
![erroDeletarPasta](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-portal-legado/layout/apagar-uma-pasta-do-cms_2.png)
