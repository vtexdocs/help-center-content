...
![pastasObrigatorias](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-portal-legado/layout/estrutura-de-pastas-do-cms_1.png)
...
> ⚠️ Como são pastas privadas, `/account` e `/account/orders` **precisam requerer autenticação**. Veja [neste artigo](/pt/docs/tutorials/como-criar-uma-pagina-customizada-em-lojas-cms-legado) como garantir que elas estejam configuradas para pedir autenticação do usuário.
