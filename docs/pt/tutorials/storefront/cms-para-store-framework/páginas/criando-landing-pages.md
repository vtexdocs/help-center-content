...
> ⚠️  Se sua loja tem múltiplas políticas comerciais ou é uma loja internacional, selecione o [binding](/pt/docs/tutorials/o-que-e-binding) correspondente à loja à qual você deseja adicionar uma nova landing page usando o menu suspenso no canto superior direito. 

2.Clique em **CRIAR PÁGINA**.

![Criando Landing pages](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-para-store-framework/páginas/criando-landing-pages_1.png)
