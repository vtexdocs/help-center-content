...
> ⚠️ Tutorial válido apenas para lojas Store Framework. Para lojas desenvolvidas com CMS Portal (Legado), siga as instruções do guia [Configurar o favicon em sua loja](/pt/docs/tutorials/configurar-o-favicon-em-sua-loja)
...
Em todas as lojas desenvolvidas com Store Framework, é possível configurar esses parâmetros nativamente, seguindo as etapas abaixo.
...
3. Preencha os campos conforme as orientações a seguir:
  ...
  ![seo-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-para-store-framework/configurações-da-loja---storefront/configurando-seo-em-sua-loja_1.png)
...
3. Clique em **Adicionar**.
  ...
  ![favicon-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-para-store-framework/configurações-da-loja---storefront/configurando-seo-em-sua-loja_2.png)

4. Abrirá uma nova tela, que deve ser preenchida conforme as orientações a seguir:
    - **Relação do favicon:** defina a relação entre o favicon e a URL configurada no campo **href do favicon**. Atribuir o valor `icon`, por exemplo, indica que a URL configurada está associada ao ícone do site.
    - **Tipo de mídia do favicon (Opcional):** especifique o tipo do favicon, conforme os padrões do HTML e da W3C. Consulte a documentação [HTML Favicon](https://www.w3schools.com/html/html_favicon.asp) para saber mais.
    - **Tamanho do favicon (Opcional):** indique as dimensões do favicon no formato `{largura}x{altura}`, por exemplo, `180x180`.
    - **href do favicon:** insira a URL completa que aponta para o local onde o arquivo do favicon está armazenado.

    Veja o exemplo a seguir:

    ![relacao-favicon-pt](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/storefront/cms-para-store-framework/configurações-da-loja---storefront/configurando-seo-em-sua-loja_3.png)

5. Clique em **Aplicar** para que as configurações reflitam na sua loja, o que pode levar alguns minutos.

> ℹ️ O campo **Caminho do termo de busca** é uma configuração legada que era compatível com o `vtex.search-resolver@0.x`.
