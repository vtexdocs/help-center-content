...
Image Widget é um repositório modal para blocos que permitem o envio de imagens no [Site Editor](/pt/docs/tutorials/site-editor-subcategoria). Com esse modal, você pode enviar, armazenar e gerenciar as imagens de sua loja e usá-las em diferentes páginas, como Home, Product ou Newsletter.
