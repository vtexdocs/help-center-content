...
* Scripts suportados: latim, cirílico

A seguir, apresentamos a lista completa de idiomas e regiões suportados.

## Idiomas suportados

Você pode configurar localidades usando os idiomas abaixo:
