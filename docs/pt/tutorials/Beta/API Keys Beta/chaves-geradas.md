...
![apikeys-pt](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/Beta/API%20Keys%20Beta/chaves-geradas_1.png)
...
O token correspondente a uma chave de API é válido apenas durante o período definido ao [configurar a duração de chaves de API](/pt/tutorial/configurar-a-duracao-de-chaves-de-api--kcGIFysFt02FDuhsfjQwZ). É necessário renovar o token de API antes da duração expirar para manter o acesso contínuo aos recursos e garantir a segurança.

Para isso, siga as instruções descritas em [Renovar token de API](/pt/tutorial/renovar-token-de-api--7r4AzptYjXErGHadg9LnJ3).
...
* [Configurações de chaves de API (Beta)](/pt/tutorial/configurar-a-duracao-de-chaves-de-api--kcGIFysFt02FDuhsfjQwZ)  
* [Chaves terceiras (Beta)](/pt/tutorial/chaves-terceiras--1isU0HfKkeg0atlxRha14Q)
