...
![Credit Card Flow](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/meios-e-condições-de-pagamento/cartões-benefícios-e-vale-presente/cartao-de-credito-fluxo-basico-de-um-pagamento_1.jpg)
...
2. As informações deste pagamento são passadas para o __Gateway de Pagamentos__. O [gateway](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#gateway) é o player responsável por garantir que este pagamento seja realizado com sucesso.
3. Com as informações em mãos, o gateway de pagamentos repassa as informações necessárias para o __Adquirente__. Os [adquirentes](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#adquirente) são responsáveis por liquidações das transações financeiras com os varejistas.
4. Em posse das informações, o adquirente envia os dados do pagamento para a __Bandeira__. A [bandeira](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#bandeira-de-cartao) determina algumas regras de negócio para os pagamentos, como a quantidade de parcelas. Além disso, ela conecta o sistema de adquirentes com os bancos emissores.
