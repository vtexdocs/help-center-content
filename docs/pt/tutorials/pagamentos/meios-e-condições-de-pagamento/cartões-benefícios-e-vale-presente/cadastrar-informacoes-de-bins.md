...
![BIN_image_digits_PT_2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/meios-e-condições-de-pagamento/cartões-benefícios-e-vale-presente/cadastrar-informacoes-de-bins_1.png)

Quando a instituição bancária deseja criar novos perfis de cartões ou emitir novos cartões para um modelo já existente, é necessário criar novos BINs. Isso também se aplica quando uma [bandeira](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#bandeira-de-cartao) é comprada por outra.
...
![Bin_spreadsheet](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/meios-e-condições-de-pagamento/cartões-benefícios-e-vale-presente/cadastrar-informacoes-de-bins_2.PNG)
