...
3. Digite o nome **BellunoDigitalBank** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, clique em **Autorizar via OAuth**. Neste momento, você será redirecionado para a página do Belluno Digital Bank, onde deverá acessar a sua conta, e autorizar a conexão da VTEX na sua conta do Belluno Digital Bank. Após o processo de autorização, você retornará automaticamente para o Admin VTEX.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Belluno Digital Bank na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
...
Para configurar os métodos de pagamento a serem processados pela Belluno Digital Bank, acesse [Condições de Pagamento](/pt/docs/tutorials/condicoes-de-pagamento).
