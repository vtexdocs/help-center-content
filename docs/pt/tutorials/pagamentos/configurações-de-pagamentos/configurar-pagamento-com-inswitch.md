...
4. Em __Autorização do provedor__, preencha os campos __Chave de aplicação__ e __Token de aplicação__ com as informações da sua conta Inswitch.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Inswitch na tela do Admin VTEX, insira a informação no campo __Nome__ em __Informações básicas__.
