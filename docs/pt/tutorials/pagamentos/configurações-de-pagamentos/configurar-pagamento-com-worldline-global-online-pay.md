...
Para configurar os métodos de pagamento a serem processados pela Worldline Global Online Pay, acesse [Configurar condições de Pagamento](/pt/docs/tutorials/condicoes-de-pagamento).
