...
3. Digite o nome **Bamboo-Payments** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, preencha os campos **Chave de aplicação** e **Token de aplicação** com as informações da sua conta Bamboo-Payments.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Bamboo-Payments na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
...
8. Em **Campos do provedor**, preencha o campo **Ingrese su llave privada** com as informações da sua conta Bamboo-Payments.
