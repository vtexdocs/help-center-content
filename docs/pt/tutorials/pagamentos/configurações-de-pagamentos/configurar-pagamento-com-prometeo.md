...
3. Digite o nome **PrometeoA2A** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, preencha os campos **Chave de aplicação** e **Token de aplicação** com as informações da sua conta Prometeo.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Prometeo na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
