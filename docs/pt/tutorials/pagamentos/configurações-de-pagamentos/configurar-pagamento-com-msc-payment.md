...
legacySlug: configurar-pagamento-msc-payment
locale: pt
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

Na VTEX, é possível realizar a integração com o provedor de pagamento MSC-Payment. Por meio deste provedor, sua loja pode oferecer diversos meios de pagamento, como MSC Payment, Credito, C2P, P2C, Credito Inmediato, Zelle e Crypto.

Para configurar MSC-Payment, siga os passos abaixo:

1. No Admin VTEX, acesse **Configurações da loja > Pagamentos > Provedores**, ou digite **Provedores** na barra de busca no topo da página.
2. Na tela de provedores, clique no botão `Novo provedor`.
3. Digite o nome **MSC-Payment** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, preencha os campos **Chave de aplicação** e **Token de aplicação** com as informações da sua conta MSC-Payment.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor MSC-Payment na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
...
8. Em **Campos do provedor**, preencha o  **tasaCambio** conforme orientações do provedor.
9. Clique em `Salvar`.

Para configurar os meios de pagamento a serem processados pela MSC-Payment, acesse [Condições de Pagamento](https://help.vtex.com/pt/docs/tutorials/condicoes-de-pagamento).
