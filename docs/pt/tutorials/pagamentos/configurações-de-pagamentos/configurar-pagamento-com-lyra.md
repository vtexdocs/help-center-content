...
8. Em **Campos do provedor**, selecione ou preencha os campos **Clave pública, Clave HMAC-SHA-256, Pago por token, Modo de ingreso de datos de pago, Número de intentos de pago con tarjeta, Tema, Modo compacto** conforme orientações do provedor.
9. Clique em `Salvar`.
