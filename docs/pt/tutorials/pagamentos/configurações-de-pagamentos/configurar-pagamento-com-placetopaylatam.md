...
Para configurar os métodos de pagamento a serem processados pela PlaceToPayLatam, acesse [Configurar condições de Pagamento](/pt/docs/tutorials/condicoes-de-pagamento).
