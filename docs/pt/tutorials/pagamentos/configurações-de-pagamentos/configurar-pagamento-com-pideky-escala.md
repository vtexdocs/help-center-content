---
title: 'Configurar pagamento com Pideky Escala'
id:
status: PUBLISHED
...
legacySlug: configurar-pagamento-pideky-escala
locale: pt
subcategoryId: 3tDGibM2tqMyqIyukqmmMw
---

Na VTEX, é possível realizar a integração com o provedor de pagamento Pideky Escala. Por meio deste provedor, sua loja pode oferecer diversos meios de pagamento, como PidekyEscala e Promissories.

Para configurar Pideky Escala, siga os passos abaixo:

1. No Admin VTEX, acesse **Configurações da loja > Pagamentos > Provedores**, ou digite **Provedores** na barra de busca no topo da página.
2. Na tela de provedores, clique no botão `Novo provedor`.
3. Digite o nome **PidekyEscalaConnector** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, preencha os campos **Chave de aplicação** e **Token de aplicação** com as informações da sua conta Pideky Escala.
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Pideky Escala na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
...
8. Em **Campos do provedor**, selecione ou preencha os campos **API Key**, **API Token** e **Production** conforme orientações do provedor.
9. Clique em `Salvar`.

Para configurar os meios de pagamento a serem processados pela Pideky Escala, acesse [Condições de Pagamento](https://help.vtex.com/pt/docs/tutorials/condicoes-de-pagamento).
...
Depois de seguir os passos indicados, o conector Pideky Escala pode demorar até 10 minutos para aparecer no Checkout da sua loja como uma opção de pagamento.
