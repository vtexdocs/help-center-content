...
A liquidação por faturamento é uma das etapas do [fluxo da transação](/pt/docs/tutorials/fluxo-da-transacao-no-pagamentos), sendo o processo interno da VTEX que ocorre depois que um cliente realiza o pagamento de um pedido.
