...
Para configurar os métodos de pagamento a serem processados por Cielo Orquestrador, acesse [Condições de Pagamento](/pt/docs/tutorials/condicoes-de-pagamento).
