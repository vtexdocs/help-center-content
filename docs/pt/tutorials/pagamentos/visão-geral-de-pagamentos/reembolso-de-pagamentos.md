...
> ℹ️ As lojas VTEX são configuradas por padrão com a regra de **Menor valor liquidado**. Caso deseje alterar a sua operação para a regra de **Cartão de Crédito primeiro**, solicite a modificação por meio de um ticket no [Suporte VTEX](/pt/support).
