...
[Neste artigo](/pt/docs/tutorials/fluxo-da-transacao-no-pagamentos), há a explicação de cada um dos status de uma transação bem-sucedida. Caso a transação tenha algum problema, seu status final será __Cancelled__.
