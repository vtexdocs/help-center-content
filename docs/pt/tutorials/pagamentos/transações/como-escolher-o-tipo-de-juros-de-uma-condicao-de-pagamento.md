...
Na hora de configurar uma [condição de pagamento parcelado com juros](/pt/docs/tutorials/condicoes-de-pagamento#parcelado-com-juros), você pode escolher se deseja usar juros simples ou composto.
...
3. Escolha uma condição de pagamento para ser editada ou [crie uma nova](/pt/docs/tutorials/condicoes-de-pagamento).
...
8. Depois de realizar todas as configurações (como [condições especiais de pagamento](/pt/docs/tutorials/condicoes-especiais/), por exemplo), clique em __Salvar__.
