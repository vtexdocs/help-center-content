...
Para configurar os métodos de pagamento a serem processados pela Cybersource LAC, acesse [Condições de Pagamento](/pt/docs/tutorials/condicoes-de-pagamento). 
