...
17. Em __Modo de processamento__, escolha como você deseja utilizar MercadoPagoV2: subadquirente (agreggator) ou gateway. Para maiores informações, acesse [O que é um subadquirente?](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#subadquirente) e [O que é um gateway de pagamentos?](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#gateway). 
