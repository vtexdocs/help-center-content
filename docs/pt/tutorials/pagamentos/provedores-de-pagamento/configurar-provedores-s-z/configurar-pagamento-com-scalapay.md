...
3. Digite o nome *Scalapay Connector** na barra de busca e clique sobre o nome do provedor.
4. Em **Autorização do provedor**, preencha os campos **Chave de aplicação** e **Token de aplicação** com as informações da sua conta Scalapay
5. Caso deseje modificar o nome de identificação a ser exibido para o provedor Scalapay na tela do Admin VTEX, insira a informação no campo **Nome** em **Informações básicas**.
...
8. Em **Campos do provedor**, selecione **Pay in 3** ou **Pay in 4** em **Product Type**.
9. Clique em `Salvar`.
