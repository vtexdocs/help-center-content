...
Essas informações são informadas à VTEX durante as transações e são organizadas para uma simples visualização em **+ informações**, no [detalhe do pedido](/pt/docs/tutorials/como-visualizar-detalhes-do-pedido).
