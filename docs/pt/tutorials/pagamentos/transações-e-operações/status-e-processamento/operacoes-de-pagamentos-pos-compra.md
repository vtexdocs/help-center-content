...
![Modo total liquidação](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-total-liquidacao.png)
...
![Modo total cancelamento](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-total-cancelamento.png)
...
![Modo total reembolso](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-total-reembolso.png)
...
![Modo hold liquidação](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-hold-liquidacao.png)
...
![Modo hold cancelamento 1](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-hold-cancelamento-1.png)
...
![Modo hold cancelamento 2](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-hold-cancelamento-2.png)
...
![Modo hold reembolso](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-hold-reembolso.png)
...
![Modo parcial liquidação](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-parcial-liquidacao.png)
...
![Modo parcial cancelamento](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-parcial-cancelamento.png)
...
![Modo parcial reembolso](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pagamentos/transações-e-operações/status-e-processamento/modo-parcial-reembolso.png)
