...
Você pode usar a [API do Master Data v1](https://developers.vtex.com/docs/api-reference/masterdata-api#get-/api/dataentities/-acronym-/search) ou o Admin VTEX para acessar e exportar dados de clientes armazenados no [Master Data v1](/pt/docs/tutorials/master-data).
...
> ℹ️ Saiba mais sobre como [filtrar dados](/pt/tutorial/filtering-data-on-master-data--tutorials_778#how-to-use-filters) e [exportar dados](/pt/docs/tutorials/exportando-dados). na interface do Master Data v1.
...
> ℹ️ Saiba mais sobre a página [Minha Conta](/pt/docs/tutorials/como-funciona-a-minha-conta).
...
A função [Avise-me](/pt/docs/tutorials/configurar-a-opcao-avise-me) permite que pessoas se inscrevam para receber notificação por email quando haja reposição de inventário de algum item de seu interesse.

Qualquer pessoa pode gerenciar o consentimento relativo ao [Avise-me](/pt/docs/tutorials/configurar-a-opcao-avise-me) na própria página do produto de interesse.
...
> ℹ️ Saiba mais sobre [automação de carrinho abandonado](/pt/docs/tutorials/configurar-carrinho-abandonado).

## Exclusão

O direito de exclusão permite que os clientes solicitem que suas informações pessoais sejam excluídas da plataforma.

Caso algum cliente solicite a exclusão de seus dados da sua loja, você pode cumprir esse direito seguindo o guia [Exclusão de dados de clientes](/pt/docs/tutorials/exclusao-de-dados-de-clientes).
