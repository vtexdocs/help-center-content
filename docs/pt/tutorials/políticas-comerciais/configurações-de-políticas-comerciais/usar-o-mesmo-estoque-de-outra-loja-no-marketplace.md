...
Por não precisar de prazos ou preços especiais, o Marketplace também não precisa de uma nova configuração de logística. Logo, basta [associar a política comercial já em uso ao novo marketplace](/pt/docs/tutorials/configurando-a-politica-comercial-para-marketplace/).
