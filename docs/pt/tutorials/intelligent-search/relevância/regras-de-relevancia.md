...
- **Promoção:** critério que verifica se há [Audiências de campanhas](/pt/tutorial/overview-2--tutorials_326#audiencia-de-campanhas) ou [Promoções](/pt/docs/tracks/como-funcionam-as-promocoes) vinculadas ao item para determinar se o produto será classificado como promoção.
