...
Os dados que compõem o relatório são atualizados a cada doze horas e contêm as seguintes informações:
...
> ℹ️ Os dados exibidos no relatório são limitados aos 10 mil termos mais pesquisados. Caso deseje os dados completos da busca da sua loja, é necessário [exportar o relatório](/pt/docs/tutorials/intelligent-search-analytics#exportacao).
