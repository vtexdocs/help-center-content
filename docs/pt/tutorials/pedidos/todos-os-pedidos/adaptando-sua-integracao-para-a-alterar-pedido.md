...
Para evoluir a plataforma VTEX com relação a mudanças em pedidos, estamos lançando a [Alterar pedido](/pt/docs/tutorials/como-funciona-a-alterar-pedido), uma solução muito mais completa, versátil e que proporciona uma [nova experiência no Admin VTEX](/pt/docs/tutorials/como-alterar-pedidos).
...
A **Alterar pedido** utiliza novos templates para [emails transacionais](/pt/docs/tutorials/templates-de-emails-transacionais) (Message Center), de forma a contemplar as funcionalidades inovadoras da solução. 

Para customizar um template de email no Admin VTEX, copie e cole o link abaixo no seu navegador, substituindo o `{accountName}` pelo [nome de conta](/pt/docs/tutorials/o-que-e-account-name) da sua loja, e depois clique em `enter`:
...
A **Alterar pedido** mantém alguns atributos da solução anterior, mas há outros que foram criados ou transformados, tanto em nomenclatura quanto em funcionamento. As principais mudanças foram organizadas da seguinte forma:
