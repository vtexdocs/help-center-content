...
Para ver o passo a passo completo de como realizar cada ação, veja a documentação [Como alterar pedidos](/pt/docs/tutorials/como-alterar-pedidos). O artigo atual aborda outros aspectos da **Alterar pedido** e está organizado da seguinte forma:
...
| Marketplace VTEX, certificado, parceiro e externo | A funcionalidade Alterar pedidos se comporta da mesma forma nos vários cenários de marketplace na VTEX:<ul><li>É possível alterar pedidos de lojas que atuam tanto como seller VTEX quanto como [marketplace VTEX](/pt/docs/tutorials/estrategias-de-marketplace-na-vtex#ser-um-marketplace-vtex).</li><li>É possível alterar pedidos de [Multilevel Omnichannel Inventory (MOI)](/pt/docs/tutorials/multilevel-omnichannel-inventory) quando são realizados em [marketplaces externos](https://developers.vtex.com/docs/guides/change-orders-multilevel-omnichannel-inventory-external-marketplaces).</li><li>É possível alterar pedidos realizados em [marketplaces certificados](/pt/docs/tutorials/estrategias-de-marketplace-na-vtex#integrado-a-marketplaces-certificados) e [marketplaces parceiros](/pt/docs/tutorials/estrategias-de-marketplace-na-vtex#integrado-a-marketplaces-parceiros).</li></ul> |
| Reserva | A [reserva](/pt/docs/tutorials/como-a-reserva-funciona) de itens em cenários de alteração de pedidos é automática. |
| Atualização de inventário | Ao alterar um pedido, o [inventário](/pt/docs/tutorials/gerenciar-itens-em-estoque) da loja não é atualizado automaticamente, isso precisa ser feito pela loja no Admin VTEX em **Catálogo > Estoque > Gerenciamento de inventário**, ou via API, usando o endpoint [Update inventory by SKU and warehouse](https://developers.vtex.com/docs/api-reference/logistics-api#put-/api/logistics/pvt/inventory/skus/-skuId-/warehouses/-warehouseId-). |
| Permissão no Licence Manager | Para um usuário ser capaz de alterar pedidos, o seu [perfil de acesso](/pt/docs/tutorials/perfis-de-acesso) precisa estar associado a pelo menos um dos seguintes [recursos do Licence Manager](/pt/docs/tutorials/recursos-do-license-manager):<ul><li>`Orders Full Access`</li><li>`Change order`</li></ul> |
...
* **Preço menor após alteração:** O comportamento depende do status do pagamento no [fluxo de transação](/pt/docs/tracks/fluxo-de-uma-transacao).
...
| Fatura | Com relação à [fatura](/pt/docs/tracks/faturar-um-pedido), a alteração de pedidos se comporta da seguinte forma:<ul><li>Se o pedido já foi [faturado](/pt/docs/tutorials/faturar-um-pedido-manualmente) por completo, ele não pode mais ser alterado.</li><li>Pedidos ainda não faturados ou apenas [parcialmente faturados](/pt/docs/tracks/faturas-parciais) podem sim ser alterados.</li><li>O valor das faturas parciais do pedido alterado precisa ser igual ou maior que o valor de uma fatura já emitida.</li><li>Se o valor total do pedido alterado for menor do que o valor de uma fatura já emitida, ele não pode ser alterado.</li></ul>Em geral, é o faturamento do pedido que deflagra a liquidação do pagamento. Este comportamento é diferente para lojas que configuraram a [liquidação automática](/pt/docs/tutorials/configurar-tempo-maximo-para-liquidacao-automatica). |
