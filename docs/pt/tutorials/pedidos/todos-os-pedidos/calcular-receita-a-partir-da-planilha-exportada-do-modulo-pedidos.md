...
A tela inicial do módulo **Pedidos** exibe a receita total obtida por sua loja de acordo com os critérios definidos nos [filtros](/pt/tutorial/filtrar-todos-pedidos--tutorials_192) da busca.

No entanto, pode ser que você deseje calcular a receita apurada em determinado período a partir da [planilha de pedidos exportada](/pt/tutorial/exportacao-de-pedidos-no-modulo-pedidos--tutorials_6417) do módulo **Pedidos**.
...
2. [Exporte a planilha de pedidos](/pt/tutorial/exportacao-de-pedidos-gerenciamento-de-pedidos--tutorials_6417) com o intervalo de tempo desejado.
...
Para entender cada coluna, veja o artigo [Relatório de pedidos](/pt/tutorial/planilha-de-pedidos--31m1ewsmsEe0WS4So2aGMY).
