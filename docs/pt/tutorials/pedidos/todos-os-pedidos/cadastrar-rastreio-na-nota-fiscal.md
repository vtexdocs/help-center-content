...
Para cadastrar o rastreio na nota fiscal, siga os passos abaixo:

1. No Admin VTEX, acesse **Pedidos > Todos os pedidos**, ou digite **Todos os pedidos** na barra de busca no topo da página.
2. Selecione o pedido desejado.
3. Na seção **Itens a faturar**, clique no botão `Faturar`.
4. Selecione a opção desejada:
    - Enviar nota fiscal referenciando itens
    - Enviar nota fiscal avulsa
5. Ative o toggle <i class="fas fa-toggle-on"></i> **Rastreamento do pedido**.
...
> ℹ️ No momento de cadastrar o rastreio na nota fiscal, é possível alterar a [transportadora](/pt/tutorial/transportadoras-na-vtex--7u9duMD5UQa2QQwukAWMcE) associada ao pedido. Para isso na etapa de preenchimento do **Rastreamento do pedido**, clique em *Transportadora* e selecione a opção desejada.
