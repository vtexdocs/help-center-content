...
Sempre que um pedido não estiver listado em [Todos os pedidos](/pt/docs/tutorials/todos-os-pedidos) sem nenhum filtro, ele pode estar como **incompleto**.
...
Nos [filtros](/pt/docs/tutorials/filtrar-todos-pedidos) da página **Todos os pedidos**, na aba **Status**, existe a opção **Status de conclusão**. Basta marcar a opção `Incompleto` para que todos os pedidos nessa situação sejam listados.
