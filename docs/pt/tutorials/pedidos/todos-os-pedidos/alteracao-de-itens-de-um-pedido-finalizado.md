...
* É preciso que o [adquirente](/pt/docs/tutorials/agentes-financeiros-no-fluxo-de-pagamento#adquirente) aceite o novo valor da operação para que a alteração ocorra.
