...
Uma das maneiras de saber se um pedido foi realizado com sucesso é verificar se os [emails transacionais](/pt/docs/tracks/como-funciona-o-message-center) correspondentes a ele foram enviados para o cliente final. Para isso, siga os passos abaixo:
