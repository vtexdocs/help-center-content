...
A baixa na reserva não ocorre automaticamente, isso deve ser controlado pelo seu ERP. Para mais detalhes, veja o artigo [Como a reserva funciona](/pt/docs/tutorials/como-a-reserva-funciona).
