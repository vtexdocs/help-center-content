...
![orders VTEX B2B](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/pedidos/entendendo-pedidos-b2b_1.png)
...
> ⚠️ Esta app só está disponível para lojas desenvolvidas usando [VTEX IO](https://developers.vtex.com/docs/guides/store-framework).Antes de prosseguir, é preciso [instalar e configurar Pedidos B2B](https://developers.vtex.com/vtex-developer-docs/docs/querying-b2b-order-statuses) na sua loja.
