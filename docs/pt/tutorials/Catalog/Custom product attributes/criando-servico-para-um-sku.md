...
É possível configurar serviços de SKU pela <b>Catalog API</b> usando os endpoints de <a href="https://developers.vtex.com/docs/api-reference/catalog-api#post-/api/catalog/pvt/skuservicetype">SKU service</a>.
</div>
...
2. Na aba **Tipos de serviço**, clique em `Novo tipo de serviço de SKU`.
3. Preencha os [campos de tipo de serviço](#campos-de-tipo-de-servico).
4. Clique em `Salvar`. 
...
8. Clique na barra ao lado do botão `Select`, destacada abaixo.
  ![Anexos - PT](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/Catalog/Custom%20product%20attributes/criando-servico-para-um-sku_1.png)
