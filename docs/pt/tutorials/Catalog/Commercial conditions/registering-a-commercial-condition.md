...
3. Clique no botão `Nova condição comercial`.
4. No campo __Nome__, digite o nome da condição comercial a ser criada.
5. Defina se essa condição será padrão através da seleção do campo __Default__.
...
[Link Spreadsheet](https://github.com/vtexdocs/help-center-content/blob/Download-Test-Spreadsheet/docs/pt/tutorials/Catalog/Download%20Test/Payment%20Provider%20x%20Countries%20-%20August%202024.xlsx)