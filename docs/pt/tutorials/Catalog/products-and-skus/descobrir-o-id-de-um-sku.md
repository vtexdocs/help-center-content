...
Na VTEX, o SKU (Stock Keeping Unit) corresponde tanto à unidade física de estoque do produto quanto ao nível mais específico para lidar com a variação desse produto. Por exemplo, se o produto é uma camiseta, o SKU poderia ser uma camiseta branca P. A partir do ID do SKU, você pode [editar o SKU](https://help.vtex.com/pt/tutorial/adicionar-ou-editar-sku--4ryZ6J45kwn3jDiQBxGiiN) ou realizar outras ações.

Para descobrir o ID de um SKU, siga os passos abaixo:

1. No Admin VTEX, acesse **Catálogo > Produtos e SKUs**, ou digite [Produtos e SKUs](https://help.vtex.com/pt/tutorial/products-and-skus--2ig7TmROlirWirZjFWZ3By) na barra de busca no topo da página.
2. Para exibir os [SKUs adicionados ao produto](https://help.vtex.com/pt/tutorial/adicionar-ou-editar-sku--4ryZ6J45kwn3jDiQBxGiiN), clique na seta para baixo ao lado do nome do produto.
...
![finding_sku_id_PT](https://raw.githubusercontent.com/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/Catalog/products-and-skus/descobrir-o-id-de-um-sku_1.png)

## Identificar ID do SKU pela URL

Quando você clica em um SKU e acessa sua [página de edição](https://help.vtex.com/pt/tutorial/adicionar-ou-editar-sku--4ryZ6J45kwn3jDiQBxGiiN), a URL no seu navegador apresenta o seguinte formato: 
