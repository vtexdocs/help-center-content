...
>⚠️ A descrição do campo do 3DS 2 (**"Suporte 3DS 2.0"**, informado no Passo 8) pode sofrer variações de acordo com o tipo de provedor de pagamento a ser configurado. Consulte o suporte técnico do provedor de pagamento escolhido para identificar o campo correto a ser selecionado para habilitar a autenticação 3DS 2.
