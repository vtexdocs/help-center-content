...
Para configurar os métodos de pagamento a serem processados pela Fiserv AR, acesse [Configurar condições de Pagamento](https://help.vtex.com/pt/tutorial/condicoes-de-pagamento).
