...
A [iugu](https://partnerportal.vtex.com/iugu-156/p) é uma solução parceira da VTEX que disponibiliza as seguintes opções de pagamentos por meio de [checkout transparente](/pt/tutorial/o-que-e-checkout-transparente--2Y4ECegUmcYUggmck2GOwe): cartão de crédito, pix e boleto bancário. Além disso, é possível realizar [operações de recorrência](/pt/tutorial/configurar-recorrencia-em-condicoes-de-pagamento--6EGuoAytLqU2CqUuaI2GUW) e [split de pagamentos](/pt/tutorial/split-de-pagamento--6k5JidhYRUxileNolY2VLx) (recebíveis e transação) entre marketplaces.
...
Para processar pagamentos em [marketplace com split de pagamento](/pt/tutorial/pagamentos-em-marketplaces-vtex--2kYOfWCZYweJkYl18bw9yD#split-de-pagamentos) na iugu é necessário cadastrar os sellers de sua loja com o mesmo CNPJ no Admin VTEX e na sua área do cliente no portal da iugu. 
...
Para disponibilizar a [recorrência](/pt/tutorial/configurar-recorrencia-em-condicoes-de-pagamento--6EGuoAytLqU2CqUuaI2GUW) como condição especial de pagamento por meio da iugu, é necessário:
