...
Para configurar os métodos de pagamento a serem processados pela Worldline Global Online Pay, acesse [Configurar condições de Pagamento](/pt/tutorial/condicoes-de-pagamento).
