...
Após a conclusão do middleware, o provedor deve abrir um [ticket](/pt/support) na VTEX informando os endpoints a serem utilizados para que os clientes realizem transações de pagamento utilizando o seu sistema de gift card.
