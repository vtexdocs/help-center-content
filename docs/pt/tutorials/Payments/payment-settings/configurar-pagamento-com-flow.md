...
Para configurar os métodos de pagamento a serem processados pela Flow, acesse [Condições de Pagamento](https://help.vtex.com/pt/tutorial/condicoes-de-pagamento). 
