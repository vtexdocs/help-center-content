...
> ⚠️ O 3DS 2 é suportado somente por alguns conectores na VTEX e deve ser implementado via [Payment App](https://developers.vtex.com/docs/guides/payments-integration-payment-app#scenario-2-payment-app-and-3d-secure-2). Verifique junto ao seu provedor de pagamentos se esta funcionalidade está disponível e os passos necessários para realizar a sua configuração.

> ⚠️ Na VTEX, o 3DS 2 não permite realizar compras utilizando dois cartões. Caso um pedido seja realizado nessas condições, o pagamento será cancelado.
