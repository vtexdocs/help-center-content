...
legacySlug: configurar-pagamento-com-placetopaylatam
locale: pt
...
Para configurar os métodos de pagamento a serem processados pela PlaceToPayLatam, acesse [Configurar condições de Pagamento](https://help.vtex.com/pt/tutorial/condicoes-de-pagamento).
