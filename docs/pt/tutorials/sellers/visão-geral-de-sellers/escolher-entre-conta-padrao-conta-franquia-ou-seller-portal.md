...
| **Aspecto** | **Seller Portal** | **Conta padrão** | **Conta franquia** |
| ---------- | ---------- | ---------- | ---------- |
| Integrar com [marketplace externo](/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrado-a-marketplace-externo) | Não. | Sim. | Não é possível integrar uma conta franquia a um marketplace externo, mas a conta franquia pode vender em marketplaces externos com a funcionalidade [Multilevel Omnichannel Inventory](/pt/docs/tutorials/multilevel-omnichannel-inventory). |
