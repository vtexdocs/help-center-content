...
> ℹ️ O que vai definir a melhor opção para você operar no ecossistema VTEX é o modelo e os objetivos do seu negócio. Saiba mais em [Estratégias de marketplace na VTEX](/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402).
...
| Configurar [pagamento com cartão da loja](/pt/tutorial/setting-up-private-label-payments--428FgVdSGQUeAOoogkaIw4) (private label) | Não. | Sim. | Sim, mas apenas quando todos os produtos do pedido pertencem à conta franquia. Se o pedido envolver diferentes sellers ([split de pedidos](/pt/tutorial/split-de-pagamento--6k5JidhYRUxileNolY2VLx)), a configuração de cartão da loja não aparece como disponível. |
| Dispor do módulo [Assinaturas](/pt/tutorial/como-gerenciar-assinaturas--6Jk50FPbv6iuz1OsFypv8x) | Não. | Sim. | Sim. |
| Utilizar o [vale-compra (GiftCard)](/pt/tutorial/gift-card--tutorials_995) da VTEX | Sim, mas a configuração do [GiftCard](/pt/tutorial/gift-card--tutorials_995) é feita na conta do marketplace VTEX. Depois, é necessário habilitar a opção de pagamento no [**Gerenciamento de Sellers**](/pt/tutorial/adicionar-seller--tutorials_392), para o seller aceitar o vale-compra. | Sim, mas a configuração do GiftCard é feita na conta do marketplace VTEX. Depois, é necessário habilitar a opção de pagamento no **Gerenciamento de Sellers**, para o seller aceitar o vale-compra. | Sim, mas a configuração do GiftCard é feita na conta principal. Depois, é necessário habilitar a opção de pagamento no **Gerenciamento de Sellers**, para ele aceitar o vale-compra. |

## Logística

| **Aspecto** | **Seller Portal** | **Conta padrão** | **Conta franquia** |
| ---------- | ---------- | ---------- | ---------- |
| Segmentar [estratégias de envio](/pt/tutorial/estrategia-de-envio--58vLBDbjYVQzJ6rRc5QNz3) para marketplaces diferentes | Não, pois o seller vende em um único marketplace VTEX. | Sim. | Não, somente para a conta principal. |
| Possuir estoque de segurança nativo da plataforma | Não. | Não. | Não. |
| Possuir capacidade de entrega para [Entregas Agendadas](/pt/tutorial/entrega-agendada--22g3HAVCGLFiU7xugShOBi) | Sim. | Sim. | Sim. |
| Configurar [pontos de retirada](/pt/tutorial/pontos-de-retirada--2fljn6wLjn8M4lJHA6HP3R) | Sim. | Sim. | Sim. |
| Cadastrar polígonos de [geolocalização](/pt/tutorial/gerenciar-geolocalizacao--tutorials_138) | Sim. | Sim. | Sim. |
...
| Precisar [mapear categorias, marcas e especificações no marketplace VTEX](/pt/tutorial/mapeando-categorias-e-marcas-para-marketplace--tutorials_1521) | Quando o seller cria o produto, é necessário realizar o mapeamento. [Produtos compartilhados](/pt/tutorial/seller-portal-produtos-compartilhados--6vUGj2UmOuLzQTK9pj04lu) não precisam ser mapeados. | Sim. | Não, pois o catálogo é herdado da conta principal. |

## Marketplace

| **Aspecto** | **Seller Portal** | **Conta padrão** | **Conta franquia** |
| ---------- | ---------- | ---------- | ---------- |
| Integrar com [marketplace externo](/pt/tutorial/estrategias-de-marketplace-na-vtex--tutorials_402#integrado-a-marketplace-externo) | Não. | Sim. | Não é possível integrar uma conta franquia a um marketplace externo, mas a conta franquia pode vender em marketplaces externos com a funcionalidade [Multilevel Omnichannel Inventory](/pt/tutorial/multilevel-omnichannel-inventory--7M1xyCZWUyCB7PcjNtOyw4). |
| Integrar com múltiplos marketplaces VTEX | Cada ambiente do Seller Portal está conectado a um único marketplace VTEX. | Sim. | A conta franquia vende no marketplace VTEX da conta principal e não pode integrar com outros marketplaces. No entanto, a conta franquia pode vender produtos em marketplaces VTEX com a funcionalidade [Multilevel Omnichannel Inventory](/pt/tutorial/multilevel-omnichannel-inventory--7M1xyCZWUyCB7PcjNtOyw4). |
