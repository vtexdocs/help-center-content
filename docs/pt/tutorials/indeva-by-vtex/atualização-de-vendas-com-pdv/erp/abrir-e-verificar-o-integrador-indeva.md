...
2. Quando a aplicação estiver em execução, ela aparecerá na bandeja do sistema, no canto inferior direito do desktop, próximo ao relógio.  
   ...
   ![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/indeva-by-vtex/atualização-de-vendas-com-pdv/erp/abrir-e-verificar-o-integrador-indeva_2.gif)  

3. Ao abrir o Integrador, verifique se os **indicadores de conexão** estão verdes.  

   ![](https://cdn.statically.io/gh/vtexdocs/help-center-content/refs/heads/main/docs/pt/tutorials/indeva-by-vtex/atualização-de-vendas-com-pdv/erp/abrir-e-verificar-o-integrador-indeva_3.png)  
