...
<div class="alert alert-info">
  Os parâmetros UTM não são criados nem gerenciados diretamente na plataforma VTEX. Eles devem ser adicionados manualmente às URLs das campanhas de marketing. A análise dos dados de tráfego com base nesses parâmetros deve ser feita por ferramentas externas, como o 
...
<div class="alert alert-info">
  Na tela de Gerenciamento de Pedidos, apenas o parâmetro <code>utm_source</code> está 
  <a href="https://help.vtex.com/pt/tutorial/como-filtrar-pedidos" target="_blank">disponível para filtro</a>.
</div>
