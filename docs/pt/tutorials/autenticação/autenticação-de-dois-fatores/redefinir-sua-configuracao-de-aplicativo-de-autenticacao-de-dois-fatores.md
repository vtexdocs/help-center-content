...
Se você já [habilitou login por autenticação de dois fatores](/pt/docs/tutorials/habilitar-login-por-autenticacao-de-2-fatores), mas cometeu algum erro durante a configuração ou perdeu acesso ao seu aplicativo de autenticação de dois fatores, pode ser que você não consiga acessar a sua conta VTEX.
