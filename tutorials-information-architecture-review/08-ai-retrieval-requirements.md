...
| Cross-portal terminology drift | Help Center calls a product "Intelligent Search" while the Developer Portal calls it "Search" — AI retrieval surfaces both with inconsistent labels | Align on the canonical name; document intentional divergences in `07-section-naming-rationale.md` |
