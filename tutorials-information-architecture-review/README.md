...
This folder contains the complete Information Architecture (IA) review for all tutorials content across EN, ES, and PT. The IA is designed to serve two audiences simultaneously: **human users** browsing the sidebar and **AI systems** (LLMs, semantic search, RAG pipelines) retrieving individual articles and H2-level chunks. It also governs alignment with the [VTEX Developer Portal](https://developers.vtex.com), which shares the same AI indexing pipeline.
...
| [`08-cross-portal-alignment.md`](08-cross-portal-alignment.md) | Governing rules for Information Architecture alignment between the Help Center and the Developer Portal: content type boundary, canonical section names, cross-portal link conventions, front-matter field alignment |
