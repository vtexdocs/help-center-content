 ...
 * marked for deletion (ending with '_uncompressed.gif')
 * 
...
const walkSync = (dir, fileList = []) => {
    ...
    for (const file of files) {
        ...
        } else if (file.endsWith('_uncompressed.gif')) {
            // If it's a file that ends with '_uncompressed.gif', add it to our list
