---
title: 'Información general de scopes'
...
Para ver y gestionar el scope de una unidad organizativa, el rol de [Storefront Roles](https://developers.vtex.com/docs/guides/storefront-permissions) del usuario debe tener los recursos `View_Organization_Unit` y `Edit_Organization_Unit`.

> ℹ️ Para más información, consulta el artículo [Miembros de la organización compradora](https://help.vtex.com/es/docs/tutorials/membros-da-organizacao-compradora).
